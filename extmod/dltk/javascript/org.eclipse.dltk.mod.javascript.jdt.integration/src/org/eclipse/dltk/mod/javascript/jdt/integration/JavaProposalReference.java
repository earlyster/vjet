...
public class JavaProposalReference extends UnknownReference implements SelfCompletingReference {
	...
	public int getKind() {		
		...
		case CompletionProposal.PACKAGE_REF:
			kind=org.eclipse.dltk.mod.core.CompletionProposal.PACKAGE_REF;
			break;
		case CompletionProposal.FIELD_REF:
			kind=org.eclipse.dltk.mod.core.CompletionProposal.FIELD_REF;
			break;
		case CompletionProposal.METHOD_REF:
			kind=org.eclipse.dltk.mod.core.CompletionProposal.METHOD_REF;
			break;
		case CompletionProposal.TYPE_REF:
			kind=org.eclipse.dltk.mod.core.CompletionProposal.TYPE_REF;
			break;
		default:
			break;
		}
