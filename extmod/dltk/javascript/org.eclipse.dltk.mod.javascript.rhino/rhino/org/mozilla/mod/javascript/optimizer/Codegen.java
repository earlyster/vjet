...
package org.mozilla.mod.javascript.optimizer;

import org.mozilla.mod.javascript.*;
import org.mozilla.mod.classfile.*;
import java.util.*;
...
public class Codegen extends Interpreter
{
                          ...
                          boolean returnFunction)
    {
        ...
        String mainClassName = "org.mozilla.mod.javascript.gen.c"+serial;
    ...
    private byte[] generateCode(String encodedSource)
    {
        ...
        if (hasScript) {
            cfw.addInterface("org.mozilla.mod/javascript/Script");
...
*/
        ...
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "org.mozilla.mod/javascript/BaseFunction",
                      "createObject",
                      "(Lorg.mozilla.mod/javascript/Context;"
                      +"Lorg.mozilla.mod/javascript/Scriptable;"
                      +")Lorg.mozilla.mod/javascript/Scriptable;");
        ...
        cfw.add(ByteCode.INSTANCEOF, "org.mozilla.mod/javascript/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "org.mozilla.mod/javascript/Scriptable");
    ...
    private void generateCallMethod(ClassFileWriter cfw)
    {
        ...
        cfw.addALoad(1); //cx
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "org.mozilla.mod/javascript/ScriptRuntime",
                      "hasTopCall",
                      "(Lorg.mozilla.mod/javascript/Context;"
                      +")Z");
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "org.mozilla.mod/javascript/ScriptRuntime",
                      "doTopCall",
                      "(Lorg.mozilla.mod/javascript/Callable;"
                      +"Lorg.mozilla.mod/javascript/Context;"
                      +"Lorg.mozilla.mod/javascript/Scriptable;"
                      +"Lorg.mozilla.mod/javascript/Scriptable;"
                      +"[Ljava/lang/Object;"
    ...
    private void generateMain(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      mainMethodClass,
                      "main",
                      "(Lorg.mozilla.mod/javascript/Script;[Ljava/lang/String;)V");
                                      ...
                                      OptFunctionNode ofn)
    {
        ...
        cfw.addALoad(SCOPE_ARG);
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "org.mozilla.mod/javascript/NativeFunction",
                      "initScriptFunction",
                      "(Lorg.mozilla.mod/javascript/Context;"
                      +"Lorg.mozilla.mod/javascript/Scriptable;"
                      +")V");
        ...
        for (int i = 0; i != scriptOrFnNodes.length; ++i) {
            ...
            for (int j = 0; j != regCount; ++j) {
                ...
                cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                              "org.mozilla.mod/javascript/RegExpProxy",
                              "compileRegExp",
                              "(Lorg.mozilla.mod/javascript/Context;"
                         ...
                         int contextArg, int scopeArg)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "checkRegExpProxy",
                      "(Lorg.mozilla.mod/javascript/Context;"
                      +")Lorg.mozilla.mod/javascript/RegExpProxy;");
        // Stack: proxy, array
        cfw.add(ByteCode.DUP);
        cfw.addALoad(contextArg);
        ...
        if (num == 0.0) {
            if (1 / num > 0) {
                ...
                cfw.add(ByteCode.GETSTATIC,
                        "org.mozilla.mod/javascript/optimizer/OptRuntime",
    ...
    {
        cfw.add(ByteCode.GETSTATIC, "org.mozilla.mod/javascript/Undefined",
    ...
    String getBodyMethodSignature(ScriptOrFnNode n)
    {
        ...
        sb.append("Lorg.mozilla.mod/javascript/Context;"
                  +"Lorg.mozilla.mod/javascript/Scriptable;"
                  +"Lorg.mozilla.mod/javascript/Scriptable;");
        if (n.getType() == Token.FUNCTION) {
            OptFunctionNode ofn = OptFunctionNode.get(n);
   ...
   static final String FUNCTION_CONSTRUCTOR_SIGNATURE
        = "(Lorg.mozilla.mod/javascript/Scriptable;"
          +"Lorg.mozilla.mod/javascript/Context;I)V";
...
class BodyCodegen
{
    ...
    private void generatePrologue()
    {
        ...
        if (fnCurrent != null) {
            ...
            addScriptRuntimeInvoke("createFunctionActivation",
                                   "(Lorg.mozilla.mod/javascript/NativeFunction;"
                                   +"Lorg.mozilla.mod/javascript/Scriptable;"
                                   +"[Ljava/lang/Object;"
                                   +")Lorg.mozilla.mod/javascript/Scriptable;");
            cfw.addAStore(variableObjectLocal);
        ...
        if (compilerEnv.isGenerateDebugInfo()) {
            cfw.addVariableDescriptor(debugVariableName, "Lorg.mozilla.mod/javascript/Scriptable;", cfw.getCurrentCodeOffset(), variableObjectLocal);
        }
    ...
    private void generateActivationExit()
    {
        ...
        addScriptRuntimeInvoke("exitActivationFunction",
                               "(Lorg.mozilla.mod/javascript/Context;)V");
    }
        ...
        switch (type) {
              ...
              case Token.THROW:
                ...
                cfw.add(ByteCode.NEW,
                        "org.mozilla.mod/javascript/JavaScriptException");
        ...
        switch (type) {
              ...
              case Token.REF_CALL:
                ...
                addScriptRuntimeInvoke(
                    ...
                    +"[Ljava/lang/Object;"
                    +"Lorg.mozilla.mod/javascript/Context;"
                    +")Lorg.mozilla.mod/javascript/Ref;");
                break;
                                  ...
                                  Node child)
    {
        ...
        if (type == Token.NEW) {
            ...
            callSignature = "(Lorg.mozilla.mod/javascript/Context;"
                            +"Ljava/lang/Object;"
                            +"[Ljava/lang/Object;"
                            +"Lorg.mozilla.mod/javascript/Scriptable;"
                            +"Lorg.mozilla.mod/javascript/Scriptable;"
    ...
    private void visitStandardCall(Node node, Node child)
    {
        ...
        if (firstArgChild == null) {
            if (childType == Token.NAME) {
                ...
                generateFunctionAndThisObj(child, node);
                methodName = "call0";
                signature = "(Lorg.mozilla.mod/javascript/Callable;"
                            +"Lorg.mozilla.mod/javascript/Scriptable;"
                            +"Lorg.mozilla.mod/javascript/Context;"
                            +"Lorg.mozilla.mod/javascript/Scriptable;"
                            +")Ljava/lang/Object;";
...
*/
        ...
        if (type == Token.NEW) {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                "org.mozilla.mod/javascript/Callable",
                "call",
                "(Lorg.mozilla.mod/javascript/Context;"
                +"Lorg.mozilla.mod/javascript/Scriptable;"
                +"Lorg.mozilla.mod/javascript/Scriptable;"
                                    ...
                                    int exceptionLocal)
    {
        ...
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            exceptionName = "org.mozilla.mod/javascript/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            exceptionName = "org.mozilla.mod/javascript/EvaluatorException";
        } else {
            if (exceptionType != ECMAERROR_EXCEPTION) Kit.codeBug();
            exceptionName = "org.mozilla.mod/javascript/EcmaError";
        }
