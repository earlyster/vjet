...
import org.mozilla.mod.classfile.ByteCode;
import org.mozilla.mod.classfile.ClassFileWriter;
...
public class PolicySecurityController extends SecurityController
{
    ...
    private static byte[] loadBytecode()
    {
        ...
        cfw.startMethod("call",
                "(Lorg.mozilla.mod/javascript/Callable;" + callableCallSig,
        ...
        cfw.addInvoke(ByteCode.INVOKEINTERFACE, 
                "org.mozilla.mod/javascript/Callable", "call", 
                "(" + callableCallSig);
