...
public interface DebugFrame {
	...
	/**
	 * Called when execution is ready to start bytecode interpretation for
	 * entered a particular function or script.
	 * 
	 * @param cx
	 ...
	 * @param thisObj
	 *            value of the JavaScript <code>this</code> object
	 * @param args
	 ...
	 *            current Context for this thread
	 * @param byThrow
	 *            if true function will leave by throwing exception, otherwise
	 *            it will execute normal return
	 * @param resultOrException
	 *            function result in case of normal return or exception object
	 *            if about to throw exception
	 */
