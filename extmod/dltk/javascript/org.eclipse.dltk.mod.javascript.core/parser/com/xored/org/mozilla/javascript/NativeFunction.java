...
public abstract class NativeFunction extends BaseFunction {
	...
	/**
	 * @deprecated Use {@link BaseFunction#getFunctionName()} instead. For
	...
	/**
	 * Get parameter or variable name. If
	 * <tt>index < {@link #getParamCount()}</tt>, then return the name of the
