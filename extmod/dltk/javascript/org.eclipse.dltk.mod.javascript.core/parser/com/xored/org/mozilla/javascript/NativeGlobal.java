...
public class NativeGlobal implements Serializable, IdFunctionCall {
	...
	public static void init(Context cx, Scriptable scope, boolean sealed) {
		...
		ScriptableObject.defineProperty(scope, "Infinity", ScriptRuntime
				.wrapNumber(Double.POSITIVE_INFINITY),
				ScriptableObject.DONTENUM);
		 ...
		 * the 'name' property set to the name of the error.
		 */
	...
	private static final int Id_decodeURI = 1, Id_decodeURIComponent = 2,
			...
			Id_eval = 6, Id_isFinite = 7, Id_isNaN = 8, Id_isXMLName = 9,
			Id_parseFloat = 10, Id_parseInt = 11, Id_unescape = 12,
			Id_uneval = 13,
