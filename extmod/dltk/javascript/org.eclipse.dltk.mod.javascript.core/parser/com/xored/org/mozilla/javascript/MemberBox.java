...
public final class MemberBox implements Serializable {
	 ...
	 * information about the class, the name, and the parameters and recreate
	...
	private static final Class[] primitives = { Boolean.TYPE, Byte.TYPE,
			Character.TYPE, Double.TYPE, Float.TYPE, Integer.TYPE, Long.TYPE,
