...
/**
 * Represents a type parameter defined by a type of a method in a compilation
 * unit or a class file.
 * <p>
 ...
 * To get a list of the type parameters use {@link IType#getTypeParameters()}
 * for a type and use {@link IMethod#getTypeParameters()} for a method.
 * </p>
 * <p>
...
public interface IJSTypeParameter extends IModelElement, ISourceReference {
	...
	/**
	 * Returns the names of the class and interface bounds of this type
	 * parameter. Returns an empty array if this type parameter has no bounds. A
	 * bound name is the name as it appears in the source (without the
	 * <code>extends</code> keyword) if the type parameter comes from a
	 * compilation unit. It is the dot-separated fully qualified name of the
	 * bound if the type parameter comes from a class file.
	 * 
	...
	/**
	 * Returns the declaring member of this type parameter. This can be either
	 * an <code>IType</code> or an <code>IMethod</code>.
	 * <p>
