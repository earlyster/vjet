...
public class JsonRpcSerializer {
	...
	public Object unmarshall(SerializerState state, Class clazz, Object json,
			IRequestValidator validator) throws SerializationException {
	...
	public Object fromJSON(String s, Class aClass, IRequestValidator validator)
			throws SerializationException {
		...
		return unmarshall(state, aClass, json, validator);
	}

	public Object fromJSON(String s, Class aClass)
			throws SerializationException {
		return fromJSON(s, aClass, null);
	}
