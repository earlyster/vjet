...
import org.eclipse.vjet.dsf.html.dom.DBlockQuote;
import org.eclipse.vjet.dsf.html.dom.EHtmlAttr;
import org.eclipse.vjet.dsf.jsnative.HtmlBlockquote;
import org.eclipse.vjet.dsf.jsnative.anno.BrowserType;

public class AHtmlBlockquote extends AHtmlElement implements HtmlBlockquote {

	private static final long serialVersionUID = 1L;
	
	protected AHtmlBlockquote(AHtmlDocument doc, DBlockQuote dp) {
		super(doc, dp);
		populateScriptable(AHtmlBlockquote.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}
	
	public String getCite() {
		return getDBlockQuote().getHtmlCite();
	}
	
	public void setCite(String cite) {
		getDBlockQuote().setHtmlCite(cite);
	...
	private DBlockQuote getDBlockQuote() {
		return (DBlockQuote) getDNode();
	}
