...
import org.eclipse.vjet.dsf.html.dom.DBb;
import org.eclipse.vjet.dsf.html.dom.EHtmlAttr;
import org.eclipse.vjet.dsf.jsnative.HtmlBb;
import org.eclipse.vjet.dsf.jsnative.anno.BrowserType;

public class AHtmlBb extends AHtmlElement implements HtmlBb {
	...
	// Constructor(s)
	//
	protected AHtmlBb(AHtmlDocument doc, DBb node) {
		super(doc, node);
		populateScriptable(AHtmlBb.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}
	...
	public String getType() {
		return getDBb().getHtmlType();
	}

	public void setType(String type) {
		getDBb().setHtmlType(type);
