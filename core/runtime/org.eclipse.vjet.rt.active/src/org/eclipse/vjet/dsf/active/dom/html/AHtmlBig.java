...
import org.eclipse.vjet.dsf.html.dom.DBig;
import org.eclipse.vjet.dsf.jsnative.HtmlBig;

public class AHtmlBig extends AHtmlElement implements HtmlBig {

	private static final long serialVersionUID = 1L;

	protected AHtmlBig(DBig a) {
		this(null, a);
	}
	
	protected AHtmlBig(AHtmlDocument doc, DBig a) {
		super(doc, a);
	}
