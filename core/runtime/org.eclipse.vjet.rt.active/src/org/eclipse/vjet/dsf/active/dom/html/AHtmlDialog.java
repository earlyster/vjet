...
import org.eclipse.vjet.dsf.html.dom.DDialog;
import org.eclipse.vjet.dsf.jsnative.HtmlDialog;
import org.eclipse.vjet.dsf.jsnative.anno.BrowserType;

public class AHtmlDialog extends AHtmlElement implements HtmlDialog {
	...
	// Constructor(s)
	//
	protected AHtmlDialog(AHtmlDocument doc, DDialog dialog) {
		super(doc, dialog);
		populateScriptable(AHtmlDialog.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}
