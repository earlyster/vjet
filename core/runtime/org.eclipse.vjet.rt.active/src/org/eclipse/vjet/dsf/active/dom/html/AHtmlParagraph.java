...
import org.eclipse.vjet.dsf.html.dom.DP;
import org.eclipse.vjet.dsf.html.dom.EHtmlAttr;
import org.eclipse.vjet.dsf.jsnative.HtmlParagraph;
import org.eclipse.vjet.dsf.jsnative.anno.BrowserType;

public class AHtmlParagraph extends AHtmlElement implements HtmlParagraph {

	private static final long serialVersionUID = 1L;
	
	protected AHtmlParagraph(AHtmlDocument doc, DP dp) {
		super(doc, dp);
		populateScriptable(AHtmlParagraph.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}

	public String getAlign() {
		return getDp().getHtmlAlign();
	}

	public void setAlign(String align) {
		getDp().setHtmlAlign(align);
