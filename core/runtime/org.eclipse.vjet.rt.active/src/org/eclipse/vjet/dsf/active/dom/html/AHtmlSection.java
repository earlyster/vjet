...
import org.eclipse.vjet.dsf.html.dom.DSection;
import org.eclipse.vjet.dsf.html.dom.EHtmlAttr;
import org.eclipse.vjet.dsf.jsnative.HtmlSection;
import org.eclipse.vjet.dsf.jsnative.anno.BrowserType;

public class AHtmlSection extends AHtmlElement implements HtmlSection {
	...
	// Constructor(s)
	//
	protected AHtmlSection(AHtmlDocument doc, DSection section) {
		super(doc, section);
		populateScriptable(AHtmlSection.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}
	...
	public String getCite() {
		return getDSection().getHtmlCite();
	}
	public void setCite(String cite) {
		getDSection().setHtmlCite(cite);
	...
	// Private
	//
	private DSection getDSection() {
		return (DSection) getDNode();
	}
}
