...
import org.eclipse.vjet.dsf.html.dom.DEm;
import org.eclipse.vjet.dsf.jsnative.HtmlEm;

public class AHtmlEm extends AHtmlElement implements HtmlEm {

	private static final long serialVersionUID = 1L;

	protected AHtmlEm(DEm em) {
		this(null, em);
	}
	
	protected AHtmlEm(AHtmlDocument doc, DEm em) {
		super(doc, em);
	}
