...
public class AHtmlDiv extends AHtmlElement implements HtmlDiv {

	private static final long serialVersionUID = 1L;
	
	protected AHtmlDiv(AHtmlDocument doc, DDiv div) {
		super(doc, div);
		populateScriptable(AHtmlDiv.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}
	...
	private DDiv getDDiv() {
		return (DDiv) getDNode();
	}
