...
public class AHtmlDl extends AHtmlElement implements HtmlDl {

	private static final long serialVersionUID = 1L;
	
	protected AHtmlDl(AHtmlDocument doc, DDl node) {
		super(doc, node);
		populateScriptable(AHtmlDl.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}
