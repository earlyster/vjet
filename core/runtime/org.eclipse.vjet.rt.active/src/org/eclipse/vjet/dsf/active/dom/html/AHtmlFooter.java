...
import org.eclipse.vjet.dsf.html.dom.DFooter;
import org.eclipse.vjet.dsf.jsnative.HtmlFooter;
import org.eclipse.vjet.dsf.jsnative.anno.BrowserType;

public class AHtmlFooter extends AHtmlElement implements HtmlFooter {
	...
	// Constructor(s)
	//
	protected AHtmlFooter(AHtmlDocument doc, DFooter footer) {
		super(doc, footer);
		populateScriptable(AHtmlFooter.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}
