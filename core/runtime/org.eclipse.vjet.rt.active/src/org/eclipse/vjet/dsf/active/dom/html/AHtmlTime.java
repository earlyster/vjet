...
import org.eclipse.vjet.dsf.html.dom.DTime;
import org.eclipse.vjet.dsf.html.dom.EHtmlAttr;
import org.eclipse.vjet.dsf.jsnative.HtmlTime;
import org.eclipse.vjet.dsf.jsnative.anno.BrowserType;

public class AHtmlTime extends AHtmlElement implements HtmlTime {
	...
	// Constructor(s)
	//
	protected AHtmlTime(AHtmlDocument doc, DTime time) {
		super(doc, time);
		populateScriptable(AHtmlTime.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}
	...
	public String getDateTime() {
		return getDTime().getHtmlDateTime();
	}
	public void setDateTime(String dateTime) {
		getDTime().setHtmlDateTime(dateTime);
	...
	// Private
	//
	private DTime getDTime() {
		return (DTime) getDNode();
	}
}
