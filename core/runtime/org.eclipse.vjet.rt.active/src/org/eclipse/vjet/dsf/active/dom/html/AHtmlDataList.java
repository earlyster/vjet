...
import org.eclipse.vjet.dsf.html.dom.DDataList;
import org.eclipse.vjet.dsf.jsnative.HtmlDataList;
import org.eclipse.vjet.dsf.jsnative.anno.BrowserType;

public class AHtmlDataList extends AHtmlElement implements HtmlDataList {
	...
	// Constructor(s)
	//
	protected AHtmlDataList(AHtmlDocument doc, DDataList datalist) {
		super(doc, datalist);
		populateScriptable(AHtmlDataList.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}

	// 
	// Satisfy HtmlDataList
	//
