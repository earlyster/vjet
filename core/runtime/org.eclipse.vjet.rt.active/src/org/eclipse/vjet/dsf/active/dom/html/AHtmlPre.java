...
import org.eclipse.vjet.dsf.html.dom.DPre;
import org.eclipse.vjet.dsf.html.dom.EHtmlAttr;
import org.eclipse.vjet.dsf.jsnative.HtmlPre;
import org.eclipse.vjet.dsf.jsnative.anno.BrowserType;

public class AHtmlPre extends AHtmlElement implements HtmlPre {

	private static final long serialVersionUID = 1L;
	
	protected AHtmlPre(AHtmlDocument doc, DPre dp) {
		super(doc, dp);
		populateScriptable(AHtmlPre.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}
	
	public int getWidth() {
		return getDPre().getHtmlWidth();
	}
	
	public void setWidth(int width) {
		getDPre().setHtmlWidth(width);
	...
	private DPre getDPre() {
		return (DPre) getDNode();
	}
