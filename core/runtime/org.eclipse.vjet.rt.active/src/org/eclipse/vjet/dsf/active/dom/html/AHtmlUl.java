...
public class AHtmlUl extends AHtmlElement implements HtmlUl {

	private static final long serialVersionUID = 1L;
	
	protected AHtmlUl(AHtmlDocument doc, DUl node) {
		super(doc, node);
		populateScriptable(AHtmlUl.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}
