...
import org.eclipse.vjet.dsf.html.dom.DDetails;
import org.eclipse.vjet.dsf.html.dom.EHtmlAttr;
import org.eclipse.vjet.dsf.jsnative.HtmlDetails;
import org.eclipse.vjet.dsf.jsnative.anno.BrowserType;

public class AHtmlDetails extends AHtmlElement implements HtmlDetails {
	...
	// Constructor(s)
	//
	protected AHtmlDetails(AHtmlDocument doc, DDetails details) {
		super(doc, details);
		populateScriptable(AHtmlDetails.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}
	...
	public boolean getOpen() {
		return getDDetails().getHtmlOpen();
	}
	public void setOpen(boolean open) {
		getDDetails().setHtmlOpen(open);
		onAttrChange(EHtmlAttr.open, open);
	}
	...
	// Private
	//
	private DDetails getDDetails() {
		return (DDetails) getDNode();
	}
}
