...
import org.eclipse.vjet.dsf.html.dom.DRuby;
import org.eclipse.vjet.dsf.jsnative.HtmlRuby;
import org.eclipse.vjet.dsf.jsnative.anno.BrowserType;

public class AHtmlRuby extends AHtmlElement implements HtmlRuby {
	...
	// Constructor(s)
	//
	protected AHtmlRuby(AHtmlDocument doc, DRuby node) {
		super(doc, node);
		populateScriptable(AHtmlAside.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}
