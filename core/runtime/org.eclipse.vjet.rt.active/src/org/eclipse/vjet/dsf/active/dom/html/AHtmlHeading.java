...
public class AHtmlHeading extends AHtmlElement implements HtmlHeading {

	private static final long serialVersionUID = 1L;
	
	protected AHtmlHeading(AHtmlDocument doc, BaseHeading h) {
		super(doc, h);
		populateScriptable(AHtmlHeading.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}

	public String getAlign() {
		return getDDiv().getHtmlAlign();
	}

	public void setAlign(String align) {
		getDDiv().setHtmlAlign(align);
	...
	private BaseHeading getDDiv() {
		return (BaseHeading) getDNode();
	}
