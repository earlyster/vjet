...
import org.eclipse.vjet.dsf.html.dom.DDataGrid;
import org.eclipse.vjet.dsf.html.dom.EHtmlAttr;
import org.eclipse.vjet.dsf.jsnative.HtmlDataGrid;
import org.eclipse.vjet.dsf.jsnative.anno.BrowserType;

public class AHtmlDataGrid extends AHtmlElement implements HtmlDataGrid {
	...
	// Constructor(s)
	//
	protected AHtmlDataGrid(AHtmlDocument doc, DDataGrid command) {
		super(doc, command);
		populateScriptable(AHtmlDataGrid.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}
	...
	public boolean getDisabled() {
		return getDDataGrid().getHtmlDisabled();
	}
	public void setDisabled(boolean disabled) {
		getDDataGrid().setHtmlDisabled(disabled);
	...
	// Private
	//
	private DDataGrid getDDataGrid() {
		return (DDataGrid) getDNode();
	}
}
