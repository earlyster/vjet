...
import org.eclipse.vjet.dsf.html.dom.DBdo;
import org.eclipse.vjet.dsf.jsnative.HtmlBdo;

public class AHtmlBdo extends AHtmlElement implements HtmlBdo {

	private static final long serialVersionUID = 1L;

	protected AHtmlBdo(DBdo a) {
		this(null, a);
	}
	
	protected AHtmlBdo(AHtmlDocument doc, DBdo a) {
		super(doc, a);
	}
