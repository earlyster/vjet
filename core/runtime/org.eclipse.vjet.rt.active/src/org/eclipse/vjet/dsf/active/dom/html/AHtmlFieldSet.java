...
public class AHtmlFieldSet extends AHtmlElement implements HtmlFieldSet, IDFormControl {

	private static final long serialVersionUID = 1L;
	
	protected AHtmlFieldSet(AHtmlDocument doc, DFieldSet node) {
		super(doc, node);
		populateScriptable(AHtmlFieldSet.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}
