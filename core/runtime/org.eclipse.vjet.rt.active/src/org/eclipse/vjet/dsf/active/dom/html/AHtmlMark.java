...
import org.eclipse.vjet.dsf.html.dom.DMark;
import org.eclipse.vjet.dsf.jsnative.HtmlMark;
import org.eclipse.vjet.dsf.jsnative.anno.BrowserType;

public class AHtmlMark extends AHtmlElement implements HtmlMark {
	...
	// Constructor(s)
	//
	protected AHtmlMark(AHtmlDocument doc, DMark mark) {
		super(doc, mark);
		populateScriptable(AHtmlMark.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}
