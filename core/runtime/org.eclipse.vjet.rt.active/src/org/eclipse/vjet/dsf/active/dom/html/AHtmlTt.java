...
import org.eclipse.vjet.dsf.html.dom.DTt;
import org.eclipse.vjet.dsf.jsnative.HtmlTt;

public class AHtmlTt extends AHtmlElement implements HtmlTt {

	private static final long serialVersionUID = 1L;

	protected AHtmlTt(DTt node) {
		this(null, node);
	}
	
	protected AHtmlTt(AHtmlDocument doc, DTt node) {
		super(doc, node);
	}
