...
public class AHtmlDt extends AHtmlElement implements HtmlDt {

	private static final long serialVersionUID = 1L;
	
	protected AHtmlDt(AHtmlDocument doc, DDt node) {
		super(doc, node);
		populateScriptable(AHtmlDt.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}
