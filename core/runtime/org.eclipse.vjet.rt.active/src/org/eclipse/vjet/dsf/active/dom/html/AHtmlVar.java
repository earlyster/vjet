...
import org.eclipse.vjet.dsf.html.dom.DVar;
import org.eclipse.vjet.dsf.jsnative.HtmlVar;

public class AHtmlVar extends AHtmlElement implements HtmlVar {

	private static final long serialVersionUID = 1L;

	protected AHtmlVar(DVar node) {
		this(null, node);
	}
	
	protected AHtmlVar(AHtmlDocument doc, DVar node) {
		super(doc, node);
	}
