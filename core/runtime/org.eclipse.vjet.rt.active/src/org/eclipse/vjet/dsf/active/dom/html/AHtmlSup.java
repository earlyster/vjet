...
import org.eclipse.vjet.dsf.html.dom.DSup;
import org.eclipse.vjet.dsf.jsnative.HtmlSup;

public class AHtmlSup extends AHtmlElement implements HtmlSup {

	private static final long serialVersionUID = 1L;

	protected AHtmlSup(DSup node) {
		this(null, node);
	}
	
	protected AHtmlSup(AHtmlDocument doc, DSup node) {
		super(doc, node);
	}
