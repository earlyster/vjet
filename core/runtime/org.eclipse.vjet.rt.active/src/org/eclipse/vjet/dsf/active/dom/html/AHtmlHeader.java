...
import org.eclipse.vjet.dsf.html.dom.DHeader;
import org.eclipse.vjet.dsf.jsnative.HtmlHeader;
import org.eclipse.vjet.dsf.jsnative.anno.BrowserType;

public class AHtmlHeader extends AHtmlElement implements HtmlHeader {
	...
	// Constructor(s)
	//
	protected AHtmlHeader(AHtmlDocument doc, DHeader header) {
		super(doc, header);
		populateScriptable(AHtmlHeader.class, doc == null ? BrowserType.IE_6P : doc.getBrowserType());
	}
