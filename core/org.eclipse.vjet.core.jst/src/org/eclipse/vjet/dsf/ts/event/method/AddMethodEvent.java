...
public final class AddMethodEvent extends MethodEvent {
	...
	// Constructors
	//
	public AddMethodEvent(MethodName mtdName, IJstMethod mtd){
	...
	public void dispatch(ISourceEventListener listener){
		...
		((IMethodEventListener)listener).onMethodAdded(this);
	}
