 ...
 *******************************************************************************/
/* 
 * $Id: Parser.java, Jan 25, 2010, 10:42:34 PM, liama. Exp$
 *
...
public abstract class Parser implements CommandLineParser {
     ...
     *            command line option name-value pairs
     * @param stopAtNonOption
     *            stop parsing the arguments when the first non option is
     *            encountered.
     * 
     * @return the list of atomic option and value tokens
     * 
    ...
    public CommandLine parse(Options options, String[] arguments,
        ...
        List tokenList = Arrays.asList(flatten(getOptions(), arguments,
                stopAtNonOption));
    ...
    /**
     * <p>
     * Process the argument values for the specified Option <code>opt</code>
     * using the values retrieved from the specified iterator <code>iter</code>.
     * 
     * @param opt
     *            The current Option
     * @param iter
     ...
     * 
     * @throws ParseException
     *             if an argument value is required and it is has not been
     *             found.
     */
