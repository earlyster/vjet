 ...
 *******************************************************************************/
/* 
 * $Id: CommandLine.java, Jan 25, 2010, 10:31:16 PM, liama. Exp$
 *
...
public class CommandLine implements Serializable {
    ...
    public Object getOptionObject(String opt) {
        try {
            ...
            System.err.println("Exception found converting " + opt
     ...
     *             if there are problems turning the option value into the
     *             desired type
    ...
    public String[] getOptionValues(String opt) {
        ...
        return values.isEmpty() ? null : (String[]) values
     ...
     * -Dparam2=value2</tt>.
     * The first argument of the option is the key, and the 2nd argument is the
     * value. If the option has only one argument (<tt>-Dfoo</tt>) it is
     * considered as a boolean flag and the value is <tt>"true"</tt>.
     * 
     * @param opt
     *            name of the option
     * @return The Properties mapped by the option, never <tt>null</tt> even
     *         if the option doesn't exists
     * @since 1.2
     */
