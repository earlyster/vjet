 ...
 *******************************************************************************/
/* 
 * $Id: PosixParser.java, Jan 25, 2010, 10:44:14 PM, liama. Exp$
 *
...
public class PosixParser {
     ...
     * anymore of <code>arguments</code> entries, just add each successive
     * entry without further processing. Otherwise, ignore
     * <code>stopAtNonOption</code>.</li>
     * <li>if the current <code>arguments</code> entry is "<b>--</b>" just
     * add the entry to the list of processed tokens</li>
     * <li>if the current <code>arguments</code> entry is "<b>-</b>" just
     * add the entry to the list of processed tokens</li>
     ...
     * <li>if the current <code>arguments</code> entry is not handled by any
     * of the previous rules, then the entry is added to the list of processed
     * tokens.</li>
     * </ol>
     * </p>
     * 
    ...
    /**
     * <p>
     * If an {@link Option} exists for <code>token</code> then add the token
    ...
    /**
     * Breaks <code>token</code> into its constituent parts using the
     * following algorithm.
     * 
     * <ul>
     ...
     * <code>stopAtNonOption</code> <b>IS</b> set then add the special token "<b>--</b>"
     * followed by the remaining characters and also the remaining tokens
     * directly to the processed tokens list.</li>
     * <li>if an {@link Option} does <b>NOT</b> exist <b>AND</b>
