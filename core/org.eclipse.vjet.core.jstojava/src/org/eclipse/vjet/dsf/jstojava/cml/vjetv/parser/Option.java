 ...
 *******************************************************************************/
/* 
 * $Id: Option.java, Jan 25, 2010, 10:37:29 PM, liama. Exp$
 *
...
public class Option implements Cloneable, Serializable {
    ...
    /**
     * Returns the specified value of this Option or <code>null</code> if
     * there is no value.
     * 
     ...
     * 
     * @return the specified value of this Option or <code>null</code> if
     *         there is no value.
     * 
     * @throws IndexOutOfBoundsException
     *             if index is less than 1 or greater than the number of the
    ...
    public String[] getValues() {
        return hasNoValues() ? null : (String[]) values
    ...
    /**
     * A rather odd clone method - due to incorrect code in 1.0 it is public and
     * in 1.1 rather than throwing a CloneNotSupportedException it throws a
     * RuntimeException so as to maintain backwards compat at the API level.
     * 
