...
/**
* http://www.w3.org/TR/REC-html40/struct/text.html#edef-VAR
*/
public class DVar extends BaseAttrsHtmlElement
	/* implements IDPhrase, IDStrict, IAttrs */
{
	...
	//
	public DVar() {
		super(HtmlTypeEnum.VAR);
	}

	public DVar(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.VAR);
	}
	
//	public DVar(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	 ...
	 */
	public DVar(final String textValue) {
		this() ;
		setHtmlExtTextValue(textValue) ;
	}
	
	public DVar(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.VAR ;
	}
			
	//
	// Extensions
	//
	public DVar setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DVar add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DVar add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DVar add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DVar addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DVar dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DVar dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DVar setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DVar setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DVar setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DVar setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DVar setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DVar setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DVar setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DVar setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DVar setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DVar setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DVar setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DVar setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DVar setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DVar setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DVar setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DVar setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DVar setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DVar setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DVar setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DVar setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DVar setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DVar setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DVar setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DVar setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DVar setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DVar setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DVar setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DVar setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DVar setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DVar setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DVar setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DVar setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DVar setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DVar setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DVar setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DVar setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DVar setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DVar setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DVar setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DVar setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DVar setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DVar setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DVar setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DVar setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DVar setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DVar setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DVar add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DVar addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DVar addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DVar addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DVar jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DVar _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DVar _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DVar _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DVar _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DVar _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DVar _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DVar _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DVar _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DVar _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DVar _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DVar _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DVar _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DVar _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DVar _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DVar _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DVar _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DVar _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DVar _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DVar _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DVar _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DVar _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DVar _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DVar _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DVar _buttonText_(final String textValue) {
	...
	public DVar _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DVar _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DVar _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DVar _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DVar _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DVar _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DVar _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DVar _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DVar _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DVar _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DVar _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DVar _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DVar _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DVar _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DVar _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DVar _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DVar _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DVar _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DVar _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DVar _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DVar _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DVar _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DVar _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DVar _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DVar _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DVar _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DVar _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DVar _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DVar _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DVar _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DVar _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DVar _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DVar _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DVar _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DVar _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DVar _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DVar _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DVar _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DVar _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DVar _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DVar _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DVar _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DVar _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DVar _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DVar _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DVar _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DVar _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DVar _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DVar _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DVar _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DVar _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DVar _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DVar _labelText_(final String textValue) {
	...
	public DVar _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DVar _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DVar _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DVar _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DVar _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DVar _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DVar _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DVar _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DVar _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DVar _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DVar _meter_(final String min, final String max, final String value) {
	...
	public DVar _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DVar _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DVar _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DVar _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DVar _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DVar _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DVar _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DVar _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DVar _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DVar _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DVar _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DVar _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DVar _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DVar _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DVar _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DVar _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DVar _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DVar _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DVar _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DVar _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DVar _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DVar _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DVar _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DVar _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DVar _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DVar _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DVar _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DVar _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DVar _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DVar _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DVar _scriptText_(final String text, final String type) {
	...
	public DVar _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DVar _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DVar _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DVar _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DVar _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DVar _smallText_(final String textValue) {
	...
	public DVar _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DVar _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DVar _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DVar _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DVar _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DVar _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DVar _strongText_(final String textValue) {
	...
	public DVar _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DVar _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DVar _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DVar _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DVar _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DVar _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DVar _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DVar _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DVar _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DVar _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DVar _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DVar _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DVar _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DVar _timeDateTime_(final String dateTime) {
	...
	public DVar _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DVar _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DVar _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DVar _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DVar _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DVar _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DVar _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DVar _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DVar _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
