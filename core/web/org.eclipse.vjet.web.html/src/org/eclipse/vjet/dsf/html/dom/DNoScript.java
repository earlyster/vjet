...
/**
* http://www.w3.org/TR/REC-html40/interact/scripts.html#edef-NOSCRIPT
* <p>
* Example:
* <pre>
...
* </pre>
*/
public class DNoScript extends BaseAttrsHtmlElement
	implements IDBlock //, IDStrict, IAttrs, /* HTML 5.0 */ IMetadataContent 
{
	...
	//
	public DNoScript() {
		super(HtmlTypeEnum.NOSCRIPT);
	}
	
	public DNoScript(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.NOSCRIPT);
	}
	
	public DNoScript(final String jif) {
		this() ;
		jif(jif) ;
	}
	
	public DNoScript(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	 ...
	 */
	@Override
	public DNoScript add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DNoScript add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoScript add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoScript addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoScript dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DNoScript dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DNoScript setDsfRelationshipVerifier(
	...
	@Override
	public DNoScript cloned() {
		return (DNoScript)super.cloned() ;
	}
     ...
     */
    @Override
    public DNoScript setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DNoScript setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DNoScript setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DNoScript setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DNoScript setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DNoScript setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DNoScript setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DNoScript setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DNoScript setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoScript setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DNoScript setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DNoScript setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DNoScript setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoScript setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DNoScript setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DNoScript setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DNoScript setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DNoScript setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DNoScript setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DNoScript setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DNoScript setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DNoScript setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DNoScript setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoScript setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DNoScript setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DNoScript setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DNoScript setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DNoScript setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DNoScript setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DNoScript setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DNoScript setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DNoScript setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DNoScript setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DNoScript setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DNoScript setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DNoScript setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DNoScript setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DNoScript setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DNoScript setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DNoScript setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DNoScript setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DNoScript setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DNoScript setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DNoScript add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	
//	@Override
//	public DNoScript removeListener(
//		final EventType eventType, final IDomActiveListener listener)
//	{
...
//	}
	...
	//
	@Override
	public DNoScript addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DNoScript addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoScript addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DNoScript addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DNoScript jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DNoScript _link_() {
		_link() ;
		return this ;
	}
	public DLink _link(final int count) {
		 return (DLink)getOrCreate(DLink.class, count) ;
	}
	public DNoScript _link_(final int count) {
		_link(count) ;
		return this ;
	}
	public DLink _link(final String jif) {
		return _link().jif(jif) ;
	}
	public DNoScript _link_(final String jif) {
		_link(jif) ;
		return this ;
	}
	...
	public DNoScript _meta_() {
		_meta() ;
		return this ;
	}
	public DMeta _meta(final int count) {
		 return (DMeta)getOrCreate(DMeta.class, count) ;
	}
	public DNoScript _meta_(final int count) {
		_meta(count) ;
		return this ;
	}
	public DMeta _meta(final String jif) {
		return _meta().jif(jif) ;
	}
	public DNoScript _meta_(final String jif) {
		_meta(jif) ;
		return this ;
	}
	...
	public DNoScript _style_(final int count) {
		_style(count) ;
		return this ;
	}
	...
	public DNoScript _style_(final String jif) {
		_style(jif) ;
		return this ;
	}
	...
	public DNoScript _styleText_(final String styleText) {
