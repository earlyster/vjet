...
form is submitted, the private key is stored in the local keystore, and the 
public key is packaged and sent to the server.
 */
public class DKeyGen extends BaseHtml50Element {
	...
	//
	public DKeyGen() {
		super(HtmlTypeEnum.KEYGEN);
	}
	
	public DKeyGen(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.KEYGEN);
	}
	
	public DKeyGen(final String jif) {
		this() ;
		jif(jif) ;
	}
	...
	public boolean getHtmlAutoFocus() {
		return hasHtmlAttribute(EHtmlAttr.autofocus) ;
	}
	public DKeyGen setHtmlAutoFocus(final boolean autofocus) {
		setHtmlAttribute(EHtmlAttr.autofocus, autofocus) ;
		return this ;
	}
	public DKeyGen setHtmlAutoFocus(final String autofocus) {
		setHtmlAttribute(EHtmlAttr.autofocus, autofocus) ;
		return this ;
	}	
	...
	public String getHtmlChallenge() {
		return getHtmlAttribute(EHtmlAttr.challenge) ;
	}
	public DKeyGen setHtmlChallenge(final String challenge) {
		setHtmlAttribute(EHtmlAttr.challenge, challenge) ;
		return this ;
	}
	public DKeyGen setHtmlChallenge(final boolean challenge) {
		setHtmlAttribute(EHtmlAttr.challenge, challenge) ;
		return this ;
	}
	...
	public DKeyGen setHtmlDisabled(final boolean disabled) {
		setHtmlAttribute(EHtmlAttr.disabled, disabled) ;
		return this ;
	}
	public DKeyGen setHtmlDisabled(final String disabled) {
		setHtmlAttribute(EHtmlAttr.disabled, disabled) ;
		return this ;
	}
	
	// keytype
	public String getHtmlKeyType() {
		return getHtmlAttribute(EHtmlAttr.keytype) ;
	}
	public DKeyGen setHtmlKeyType(final String keytype) {
		setHtmlAttribute(EHtmlAttr.keytype, keytype) ;
		return this ;
	}
	...
	public DKeyGen setHtmlName(final String name) {
	...
	public String toString() {
		return super.toString()
			...
			+ Z.fmt(EHtmlAttr.challenge.getAttributeName(), "" + getHtmlChallenge())
			+ Z.fmt(EHtmlAttr.disabled.getAttributeName(), "" + getHtmlDisabled())
			+ Z.fmt(EHtmlAttr.keytype.getAttributeName(), "" + getHtmlKeyType())
	 ...
	 */
	@Override
	public DKeyGen add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DKeyGen add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DKeyGen addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DKeyGen dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DKeyGen dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DKeyGen setDsfRelationshipVerifier(
	...
	@Override
	public DKeyGen cloned() {
		return (DKeyGen)super.cloned() ;
	}
     ...
     */
    @Override
    public DKeyGen setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DKeyGen setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DKeyGen setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DKeyGen setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DKeyGen setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DKeyGen setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DKeyGen setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DKeyGen setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DKeyGen setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DKeyGen setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DKeyGen setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DKeyGen setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DKeyGen setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DKeyGen setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DKeyGen setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DKeyGen setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DKeyGen setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DKeyGen setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DKeyGen setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DKeyGen setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DKeyGen setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DKeyGen setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DKeyGen setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DKeyGen setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DKeyGen setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DKeyGen setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DKeyGen setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DKeyGen setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DKeyGen setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DKeyGen add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	//
	@Override
	public DKeyGen addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DKeyGen addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DKeyGen addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DKeyGen addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DKeyGen jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
