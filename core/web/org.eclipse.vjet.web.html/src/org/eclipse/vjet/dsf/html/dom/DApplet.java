...
/**
* Deprecated. The following element is not included in HTML 5.0 because it has 
* not been used often, created confusion, or their function can be handled by 
* other elements.  Use object instead.
* <p>
...
* @RestrictedType
*/
public class DApplet extends BaseOrigNonAttrs //BaseCoreHtmlElement
//	implements IDTransitional, ICoreAttributes
{
	...
	public DApplet() {
		super(null, HtmlTypeEnum.APPLET);
	}

	public DApplet(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.APPLET);
	}
	
	public DApplet(final String jif) {
		this() ;
		jif(jif) ;
	}
	...
	public DApplet setHtmlAlign(final String align) {
		setHtmlAttribute(EHtmlAttr.align/* "align"*/, align);
		return this ;
	}
	...
	public DApplet setHtmlAlt(final String alt) {
		setHtmlAttribute(EHtmlAttr.alt/* "alt" */, alt);
		return this ;
	}
	...
	public DApplet setHtmlArchive(final String archive) {
	...
	public DApplet setHtmlCode(final String code) {
	...
	public DApplet setHtmlCodeBase(final String codeBase) {
	...
	public DApplet setHtmlHeight(final String height) {
		setHtmlAttribute(EHtmlAttr.height, height);
		return this ;
	}
	
	public DApplet setHtmlHeight(final int height) {
	...
	public DApplet setHtmlHspace(final String height) {
		setHtmlAttribute(EHtmlAttr.hspace, height);
		return this ;
	}
	
	public DApplet setHtmlHspace(final int height) {
		return setHtmlHspace(String.valueOf(height)) ;
	}
	...
	public DApplet setHtmlName(final String name) {
		setHtmlAttribute(EHtmlAttr.name, name);
		return this ;
	}

	public String getHtmlObject() {
		return getHtmlAttribute(EHtmlAttr.object);
	}

	public DApplet setHtmlObject(final String object) {
		setHtmlAttribute(EHtmlAttr.object, object);
		return this ;
	}
	...
	public DApplet setHtmlVspace(final String vspace) {
		setHtmlAttribute(EHtmlAttr.vspace, vspace);
		return this ;
	}
	
	public DApplet setHtmlVspace(final int vspace) {
	...
	public DApplet setHtmlWidth(final String width) {
		setHtmlAttribute(EHtmlAttr.width, width);
		return this ;
	}
	
	public DApplet setHtmlWidth(final int width) {
	...
	// Extensions
	//
	public DApplet setHtmlExtTextValue(final String value) {
	...
	public String toString() {
		...
		Z.fmt(EHtmlAttr.height.getAttributeName(), getHtmlHspace()) +
		Z.fmt(EHtmlAttr.name.getAttributeName(), getHtmlName()) +
		Z.fmt(EHtmlAttr.object.getAttributeName(), getHtmlObject()) +
	 ...
	 */
	@Override
	public DApplet add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DApplet add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DApplet addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DApplet dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DApplet dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DApplet setDsfRelationshipVerifier(
	...
	@Override
	public DApplet cloned() {
		return (DApplet)super.cloned() ;
	}
     ...
     */
    @Override
    public DApplet setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DApplet setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DApplet setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DApplet setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DApplet setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DApplet setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DApplet setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DApplet setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DApplet setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DApplet setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DApplet setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DApplet setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DApplet setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DApplet setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DApplet setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DApplet setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DApplet setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DApplet setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DApplet setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DApplet setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DApplet setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DApplet setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DApplet setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DApplet setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DApplet setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DApplet setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DApplet setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DApplet setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DApplet setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DApplet setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DApplet setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DApplet setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DApplet setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DApplet setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DApplet setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DApplet setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DApplet setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DApplet setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DApplet setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DApplet setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DApplet setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DApplet setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DApplet setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DApplet add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	//
	@Override
	public DApplet addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DApplet addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DApplet addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DApplet addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DApplet jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}
