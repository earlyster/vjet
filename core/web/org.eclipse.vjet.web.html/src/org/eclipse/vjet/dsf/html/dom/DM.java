...
public class DM extends BaseHtml50Element
{		
	...
	//
	public DM() {
		super(HtmlTypeEnum.M);
	}
	
	public DM(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.M);
	}
	
//	public DM(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	
	public DM(final String className) {
		this() ;
		setHtmlClassName(className) ;
	}
	
	public DM(final CssClassConstant ccc) {
		this(ccc.getName()) ;
	}
	 ...
	 */
	@Override
	public DM add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DM add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DM addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DM dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DM dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DM setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DM setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DM setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DM setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DM setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DM setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DM setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DM setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DM setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DM setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DM setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DM setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */	
	@Override
	public DM setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DM setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DM setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DM setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DM setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DM setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DM setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DM setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DM setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DM setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DM setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DM setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DM setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DM setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DM setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DM setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DM setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DM setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DM setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DM setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DM setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DM setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DM setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DM setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DM setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DM setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DM setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DM setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DM setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DM setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DM setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DM setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DM setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DM add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DM addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DM addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DM addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DM jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}
