 ...
 * <p>
 * DSF type maps to html tag &lt;font&gt;. It is deprecated in HTML 4 and XHTML.
 * Try to avoid it, and use styles instead.
 * <p>
 ...
 * @RestrictedType
 */
public class DFont extends BaseOrigNonAttrs //BaseCoreAndI18nHtmlElement
//	implements IDTransitional, ICoreAttributes, II18nAttributes
{
	...
	//
	public DFont() {
		super(HtmlTypeEnum.FONT);
	}
	
	public DFont(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.FONT);
	}
	
//	public DFont(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	 ...
	 */
	public DFont(final String textValue) {
		this() ;
	...
	public DFont setHtmlColor(final String color) {
	...
	public DFont setHtmlFace(final String face) {
	...
	public DFont setHtmlSize(final String size) {
	 ...
	 * @return
	 */
	public DFont setHtmlSize(final int size) {
	...
	// Helper
	//
	public DFont setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DFont add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFont add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFont addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFont dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DFont dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DFont setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DFont setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DFont setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DFont setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DFont setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DFont setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DFont setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DFont setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DFont setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DFont setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFont setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DFont setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DFont setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DFont setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFont setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DFont setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DFont setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DFont setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DFont setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DFont setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DFont setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DFont setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DFont setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DFont setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFont setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DFont setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DFont setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DFont setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DFont setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DFont setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DFont setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DFont setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DFont setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DFont setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DFont setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DFont setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DFont setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DFont setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DFont setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DFont setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DFont setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DFont setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DFont setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DFont setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DFont setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DFont setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DFont add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DFont addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFont addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DFont addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DFont jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}
