...
* other elements.  Use abbr for abbreviations.
* <p>
...
* </pre>
*/
public class DAcronym extends BaseAttrsHtmlElement
	/* implements IDPhrase, IDStrict, IAttrs */
{
	...
	//
	public DAcronym() {
		super(HtmlTypeEnum.ACRONYM) ;
	}
	
	public DAcronym(final DHtmlDocument doc) {
	 ...
	 */
	public DAcronym(final String textValue) {
		this() ;
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.ACRONYM ;
	}
			
	//
	// Extensions
	//
	public DAcronym setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DAcronym add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAcronym add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAcronym addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAcronym dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DAcronym dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DAcronym setDsfRelationshipVerifier(
	...
	@Override
	public DAcronym cloned() {
		return (DAcronym)super.cloned() ;
	}
     ...
     */
    @Override
    public DAcronym setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DAcronym setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DAcronym setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DAcronym setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DAcronym setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DAcronym setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DAcronym setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DAcronym setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DAcronym setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAcronym setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DAcronym setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DAcronym setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DAcronym setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAcronym setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DAcronym setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DAcronym setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DAcronym setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DAcronym setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DAcronym setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DAcronym setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DAcronym setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DAcronym setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DAcronym setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAcronym setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DAcronym setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DAcronym setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DAcronym setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DAcronym setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DAcronym setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DAcronym setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DAcronym setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DAcronym setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DAcronym setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DAcronym setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DAcronym setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DAcronym setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DAcronym setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DAcronym setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DAcronym setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DAcronym setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DAcronym setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DAcronym setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DAcronym setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DAcronym add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	
//	@Override
//	public DAcronym removeListener(
//		final EventType eventType, final IDomActiveListener listener)
//	{
...
//	}
	...
	//
	@Override
	public DAcronym addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DAcronym addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAcronym addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DAcronym addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DAcronym jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}
