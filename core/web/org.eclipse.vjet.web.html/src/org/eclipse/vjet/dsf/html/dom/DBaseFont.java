...
* <p>
* deprecated in 4.01, not supported in XHTML 1.0
* <p>
* deprecated in 5.0 - does not exist in HTML 5.0 because its' effect is purely
* presentational and its function is better handled by CSS.
* @RestrictedType
*/
public class DBaseFont extends BaseOrigNonAttrs
//	implements IDSpecial, IDTransitional, INoStandardAttributes
{
	...
	//
	public DBaseFont() {
		super(null, HtmlTypeEnum.BASEFONT);
	}
	
	public DBaseFont(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.BASEFONT);
	}
	
	public DBaseFont(final String jif) {
		this() ;
		jif(jif) ;
	}
	...
	public String getHtmlColor() {
		return capitalize(getHtmlAttribute(EHtmlAttr.color));
	}
	public DBaseFont setHtmlColor(final String color) {
		setHtmlAttribute(EHtmlAttr.color, color);
		return this ;
	}

	public String getHtmlFace() {
		return capitalize(getHtmlAttribute(EHtmlAttr.face));
	}
	public DBaseFont setHtmlFace(final String face) {
		setHtmlAttribute(EHtmlAttr.face, face);
		return this ;
	}
	...
	public DBaseFont setHtmlSize(final String size) {
		setHtmlAttribute(EHtmlAttr.size, size);
		return this ;
	}	
	public DBaseFont setHtmlSize(final int size) {
		return setHtmlSize(String.valueOf(size)) ;
	}
	...
	public String toString() {
		...
		Z.fmt("color", getHtmlColor()) + 
		Z.fmt("face", getHtmlFace()) + 
	 ...
	 */
	@Override
	public DBaseFont add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBaseFont add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBaseFont addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBaseFont dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DBaseFont dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DBaseFont setDsfRelationshipVerifier(
	...
	@Override
	public DBaseFont cloned() {
		return (DBaseFont)super.cloned() ;
	}
     ...
     */
    @Override
    public DBaseFont setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DBaseFont setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DBaseFont setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DBaseFont setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBaseFont setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DBaseFont setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DBaseFont setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBaseFont setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DBaseFont setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DBaseFont setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBaseFont setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DBaseFont setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DBaseFont setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DBaseFont setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DBaseFont setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DBaseFont setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DBaseFont setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DBaseFont setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DBaseFont setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DBaseFont setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DBaseFont setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DBaseFont setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DBaseFont setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DBaseFont setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DBaseFont setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DBaseFont setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DBaseFont setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DBaseFont setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DBaseFont setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DBaseFont add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	
//	@Override
//	public DBaseFont removeListener(
//		final EventType eventType, final IDomActiveListener listener)
//	{
...
//	}
	...
	//
	@Override
	public DBaseFont addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DBaseFont addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBaseFont addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DBaseFont addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DBaseFont jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}
