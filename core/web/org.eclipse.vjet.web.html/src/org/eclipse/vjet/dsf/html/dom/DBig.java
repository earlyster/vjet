...
* <p>
* http://www.w3.org/TR/REC-html40/present/graphics.html#edef-BIG
* <p>
* Example:
* <pre>
* <P><b>bold</b>, <i>italic</i>, <b><i>bold italic</i></b>, 
* <tt>teletype text</tt>, and <big>big</big> and <small>small</small> text.
* </pre>
*/
public class DBig extends BaseAttrsHtmlElement
	/*implements IDFontStyle,IDStrict, IAttrs*/
{
	...
	//
	public DBig() {
		super(HtmlTypeEnum.BIG);
	}

	public DBig(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.BIG);
	}
	
//	public DBig(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	
	/**
	 * The extension Constructor which Creates an instance with DText child with the 
	 * passed in value.  If the passed in value is null, no DText child is created.
	 */
	public DBig(final String textValue) {
		this() ;
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.BIG ;
	}
			
	//
	// Extensions
	//
	public DBig setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DBig add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBig add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBig addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBig dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DBig dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DBig setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DBig setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DBig setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DBig setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DBig setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DBig setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DBig setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DBig setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DBig setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DBig setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBig setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DBig setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DBig setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DBig setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBig setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DBig setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DBig setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DBig setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DBig setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DBig setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DBig setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DBig setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DBig setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DBig setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBig setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DBig setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DBig setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DBig setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DBig setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DBig setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DBig setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DBig setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DBig setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DBig setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DBig setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DBig setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DBig setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DBig setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DBig setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DBig setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DBig setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DBig setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DBig setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DBig setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DBig setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DBig setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DBig add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DBig addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBig addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DBig addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DBig jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}
