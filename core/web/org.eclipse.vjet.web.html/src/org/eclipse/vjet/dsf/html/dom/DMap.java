...
* </pre>
*/
public class DMap extends BaseAttrsHtmlElement
//	implements IDSpecial, IDStrict, IAttrs
{
	private static final long serialVersionUID = 3257847692725270834L;

	private DHtmlCollection m_areas;

	//
	// Constructor(s)
	//
	public DMap() {
		super(HtmlTypeEnum.MAP);
	}

	public DMap(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.MAP);
	}
	
	public DMap(final String jif) {
		this() ;
		jif(jif) ;
	}
	
	public DMap(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.MAP ;
	}
	
	//
	// HTML Attributes
	//		
	public DHtmlCollection getHtmlAreas() {
		if (m_areas == null) {
			m_areas = new DHtmlCollection(this, DHtmlCollection.AREA);
		}
		return m_areas;
	}
	...
	public DMap setHtmlName(final String name) {
	...
	public String toString() {
		...
		Z.fmt("areas", "" + getHtmlAreas()) +
		Z.fmt("name", getHtmlName()) ;
	}
		
	@Override
	public Object clone() throws CloneNotSupportedException {
		final DMap clonedNode = (DMap) super.clone();
		clonedNode.m_areas = null;
		return clonedNode;
	}
	 ...
	 */
	@Override
	public DMap add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DMap add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMap add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMap addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMap dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DMap dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DMap setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DMap setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DMap setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DMap setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DMap setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DMap setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DMap setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DMap setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DMap setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DMap setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMap setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DMap setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DMap setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DMap setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMap setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DMap setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DMap setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DMap setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DMap setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DMap setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DMap setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DMap setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DMap setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DMap setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMap setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DMap setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DMap setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DMap setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DMap setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DMap setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DMap setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DMap setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DMap setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DMap setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DMap setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DMap setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DMap setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DMap setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DMap setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DMap setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DMap setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DMap setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DMap setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DMap setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DMap setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DMap setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DMap add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DMap addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMap addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DMap addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DMap jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DMap _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DMap _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DMap _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DMap _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DMap _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DMap _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DMap _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DMap _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DMap _address_(final int count) {
		 _address(count) ;
		 return this ;
	}
	...
	public DMap _address_(final String jif) {
		_address(jif) ;
		return this ;
	}
	...
	public DMap _address_(BaseHtmlElement... elements) {
		_address(elements) ;
		return this ;
	}
	...
	public DMap _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DMap _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DMap _article_(final int count) {
		_article(count) ;
		return this ;
	}
	...
	public DMap _article_(final String jif) {
		_article(jif) ;
		return this ;
	}
	...
	public DMap _articleText_(final String textValue) {
	...
	public DMap _article_(BaseHtmlElement... elements) {
		_article(elements) ;
		return this ;
	}
	...
	public DMap _aside_(final int count) {
		 _aside(count) ;
		 return this ;
	}
	...
	public DMap _aside_(final String jif) {
		_aside(jif) ;
		return this ;
	}
	...
	public DMap _asideText_(final String textValue) {
	...
	public DMap _aside_(BaseHtmlElement... elements) {
		_aside(elements) ;
		return this ;
	}
	...
	public DMap _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DMap _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DMap _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DMap _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DMap _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DMap _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DMap _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DMap _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DMap _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DMap _blockquote_(final int count) {
		_blockquote(count) ;
		return this ;
	}
	...
	public DMap _blockquote_(final String jif) {
		_blockquote(jif) ;
		return this ;
	}
	...
	public DMap _blockquoteText_(final String textValue) {
	...
	public DMap _blockquote_(BaseHtmlElement... elements) {
	...
	public DMap _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DMap _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DMap _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DMap _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DMap _buttonText_(final String textValue) {
	...
	public DMap _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DMap _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DMap _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DMap _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DMap _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DMap _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DMap _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DMap _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DMap _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DMap _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DMap _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DMap _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DMap _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DMap _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DMap _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DMap _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DMap _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DMap _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DMap _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DMap _details_(final int count) {
		_details(count) ;
		return this ;
	}
	...
	public DMap _details_(final String jif) {
		_details(jif) ;
		return this ;
	}
	...
	public DMap _details_(BaseHtmlElement... elements) {
		_details(elements) ;
		return this ;
	}
	...
	public DMap _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DMap _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DMap _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DMap _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DMap _div_(final int count) {
		_div(count) ;
		return this ;
	}
	...
	public DMap _div_(final String jif) {
		_div(jif) ;
		return this ;
	}
	...
	public DMap _div_(BaseHtmlElement... elements) {
		_div(elements) ;
		return this ;
	}
	...
	public DMap _dl_(final int count) {
		_dl(count) ;
		return this ;
	}
	...
	public DMap _dl_(final String jif) {
		_dl().jif(jif) ;
		return this ;
	}
	...
	public DMap _dl_(BaseHtmlElement... elements) {
		_dl(elements) ;
		return this ;
	}
	...
	public DMap _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DMap _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DMap _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DMap _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DMap _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DMap _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DMap _fieldset_(final int count) {
		_fieldset(count) ;
		return this ;
	}
	...
	public DMap _fieldset_(final String jif) {
		_fieldset(jif) ;
		return this ;
	}
	...
	public DMap _fieldsetLegend_(final String legend) {
	...
	public DMap _fieldset_(BaseHtmlElement... elements) {
		_fieldset(elements) ;
		return this ;
	}
	...
	public DMap _figure_(final int count) {
		_figure(count) ;
		return this ;
	}
	...
	public DMap _figure_(final String jif) {
		_figure(jif) ;
		return this ;
	}
	...
	public DMap _figure_(BaseHtmlElement... elements) {
		_figure(elements) ;
		return this ;
	}
	...
	public DMap _footer_(final int count) {
		_footer(count) ;
		return this ;
	}
	...
	public DMap _footer_(final String jif) {
		_footer(jif) ;
		return this ;
	}
	...
	public DMap _footerText_(final String textValue) {
	...
	public DMap _footer_(BaseHtmlElement... elements) {
		_footer(elements) ;
		return this ;
	}
	...
	public DMap _form_(final int count) {
		_form(count) ;
		return this ;
	}
	...
	public DMap _form_(final String jif) {
		_form(jif) ;
		return this ;
	}
	...
	public DMap _form_(BaseHtmlElement... elements) {
		_form(elements) ;
		return this ;
	}
	...
	public DMap _h1_(final int count) {
		_h1(count);
		return this ;
	}
	...
	public DMap _h1_(final String jif) {
		_h1(jif) ;
		return this ;
	}
	...
	public DMap _h1Text_(final String textValue) {
		_h1Text(textValue) ;
		return this ;
	}
	...
	public DMap _h1_(BaseHtmlElement... elements) {
		_h1(elements) ;
		return this ;
	}
	...
	public DMap _h2_(final int count) {
		_h2(count);
		return this ;
	}
	...
	public DMap _h2_(final String jif) {
		_h2(jif) ;
		return this ;
	}
	...
	public DMap _h2Text_(final String textValue) {
		_h2Text(textValue) ;
		return this ;
	}
	...
	public DMap _h2_(BaseHtmlElement... elements) {
		_h2(elements) ;
		return this ;
	}
	...
	public DMap _h3_(final int count) {
		_h3(count);
		return this ;
	}
	...
	public DMap _h3_(final String jif) {
		_h3(jif) ;
		return this ;
	}
	...
	public DMap _h3Text_(final String textValue) {
		_h3Text(textValue) ;
		return this ;
	}
	...
	public DMap _h3_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DMap _h4_(final int count) {
		_h4(count);
		return this ;
	}
	...
	public DMap _h4_(final String jif) {
		_h4(jif) ;
		return this ;
	}
	...
	public DMap _h4Text_(final String textValue) {
		_h4Text(textValue) ;
		return this ;
	}
	...
	public DMap _h4_(BaseHtmlElement... elements) {
		_h4(elements) ;
		return this ;
	}
	...
	public DMap _h5_(final int count) {
		_h5(count);
		return this ;
	}
	...
	public DMap _h5_(final String jif) {
		_h5(jif) ;
		return this ;
	}
	...
	public DMap _h5Text_(final String textValue) {
		_h5Text(textValue) ;
		return this ;
	}
	...
	public DMap _h5_(BaseHtmlElement... elements) {
		_h5(elements) ;
		return this ;
	}
	...
	public DMap _h6_(final int count) {
		_h6(count);
		return this ;
	}
	...
	public DMap _h6_(final String jif) {
		_h6(jif) ;
		return this ;
	}
	...
	public DMap _h6Text_(final String textValue) {
		_h6Text(textValue) ;
		return this ;
	}
	...
	public DMap _h6_(BaseHtmlElement... elements) {
		_h6(elements) ;
		return this ;
	}
	...
	public DMap _header_(final int count) {
		_header(count) ;
		return this ;
	}
	...
	public DMap _header_(final String jif) {
		_header(jif) ;
		return this ;
	}
	...
	public DMap _header_(BaseHtmlElement... elements) {
		_header(elements) ;
		return this ;
	}
	...
	public DMap _hgroup_(final int count) {
		_hgroup(count) ;
		return this ;
	}
	...
	public DMap _hgroup_(final String jif) {
		_hgroup(jif) ;
		return this ;
	}
	...
	public DMap _hgroup_(BaseHtmlElement... elements) {
		_hgroup(elements) ;
		return this ;
	}
	...
	public DMap _hr_(final int count) {
		_hr(count) ;
		return this ;
	}
	...
	public DMap _hr_(final String jif) {
		_hr(jif) ;
		return this ;
	}
	...
	public DMap _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DMap _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DMap _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DMap _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DMap _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DMap _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DMap _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DMap _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DMap _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DMap _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DMap _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DMap _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DMap _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DMap _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DMap _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DMap _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DMap _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DMap _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DMap _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DMap _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DMap _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DMap _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DMap _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DMap _labelText_(final String textValue) {
	...
	public DMap _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DMap _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DMap _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DMap _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DMap _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DMap _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DMap _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
	...
	public DMap _menu_(final int count) {
		_menu(count) ;
		return this ;
	}
	...
	public DMap _menu_(final String jif) {
		_menu(jif) ;
		return this ;
	}
	...
	public DMap _menu_(BaseHtmlElement... elements) {
		_menu(elements) ;
		return this ;
	}
	...
	public DMap _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DMap _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DMap _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
...
value) {
	...
	public DMap _meter_(final String min, final String max, final String value) 

{
	...
	public DMap _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
...
value) {
	...
	public DMap _meter_(final double min, final double max, final double value) 

{
	...
	public DMap _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DMap _nav_(final int count) {
		_nav(count) ;
		return this ;
	}
	...
	public DMap _nav_(final String jif) {
		_nav(jif) ;
		return this ;
	}
	...
	public DMap _nav_(BaseHtmlElement... elements) {
		_nav(elements) ;
		return this ;
	}
	...
	public DMap _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DMap _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DMap _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DMap _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DMap _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DMap _ol_(final int count) {
		_ol(count) ;
		return this ;
	}
	...
	public DMap _ol_(final String jif) {
		_ol(jif) ;
		return this ;
	}
	...
	public DMap _ol_(final Collection<Object> collection) {
		_ol(collection) ;
		return this ;
	}
...

{
	...
	public DMap _ol_(final Collection<Object> collection, final String htmlType) {
	...
	public DMap _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DMap _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DMap _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DMap _p_(final int count) {
		_p(count) ;
		return this ;
	}
	...
	public DMap _p_(final String jif) {
		_p(jif) ;
		return this ;
	}
	...
	public DMap _pText_(final String textValue) {
		_pText(textValue) ;
		return this ;
	}
	...
	public DMap _p_(BaseHtmlElement... elements) {
		_p(elements) ;
		return this ;
	}
	...
	public DMap _pre_(final int count) {
		_pre(count) ;
		return this ;
	}
	...
	public DMap _pre_(final String jif) {
		_pre(jif) ;
		return this ;
	}
	...
	public DMap _preText_(final String textValue) {
		_preText(textValue) ;
		return this ;
	}
	...
	public DMap _pre_(BaseHtmlElement... elements) {
		_pre(elements) ;
		return this ;
	}
	...
	public DMap _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DMap _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DMap _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DMap _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DMap _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DMap _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DMap _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DMap _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DMap _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DMap _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DMap _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DMap _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DMap _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DMap _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DMap _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DMap _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DMap _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DMap _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DMap _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DMap _scriptText_(final String text, final String type) {
	...
	public DMap _section_(final int count) {
		_section(count) ;
		return this ;
	}
	...
	public DMap _section_(final String jif) {
		_section(jif) ;
		return this ;
	}
	...
	public DMap _section_(BaseHtmlElement... elements) {
		_section(elements) ;
		return this ;
	}
	...
	public DMap _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DMap _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DMap _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DMap _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DMap _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DMap _smallText_(final String textValue) {
	...
	public DMap _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DMap _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DMap _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DMap _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DMap _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DMap _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DMap _strongText_(final String textValue) {
	...
	public DMap _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DMap _style_(final int count) {
		_style(count) ;
		return this ;
	}
	...
	public DMap _style_(final String jif) {
		_style(jif) ;
		return this ;
	}
	...
	public DMap _styleText_(final String styleText) {
	...
	public DMap _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DMap _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DMap _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DMap _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DMap _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DMap _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DMap _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DMap _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
	...
	public DMap _table_(final int count) {
		_table(count);
		return this ;
	}
	...
	public DMap _table_(final String jif) {
		_table(jif) ;
		return this ;
	}
	...
	public DMap _table_(BaseHtmlElement... elements) {
		_table(elements) ;
		return this ;
	}
	...
	public DMap _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DMap _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DMap _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DMap _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DMap _timeDateTime_(final String dateTime) {
	...
	public DMap _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DMap _ul_(final int count) {
		_ul(count) ;
		return this ;
	}
	...
	public DMap _ul_(final Collection<Object> collection) {
		_ul(collection) ;
		return this ;
	}
...

{
	...
	public DMap _ul_(final Collection<Object> collection, final String htmlType) {
	...
	public DMap _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DMap _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DMap _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DMap _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DMap _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DMap _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DMap _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DMap _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
