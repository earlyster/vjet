...
public class HtmlBuilder implements ContentHandler, LexicalHandler {

	/**
	 * The document that is being built.
	 */
	protected DHtmlDocument m_document;
	...
	protected static final DElementConstructor m_html = new Html();
	...
	public void endDocument() throws SAXException {
		...
		//m_document.setCreatedByHtmlBuilder(true);
		m_current = null;
		m_done = true;
	}
		...
		final Attributes atts) throws SAXException
	{
		...
		if (m_document == null) {
			...
			m_document = new DHtmlDocument();
			m_current = m_document.getHtml();
			if (m_current == null) {
			...
			final DElement node = m_html.domCreateDynamicElement(localName);
			//DsfQ109_NS
