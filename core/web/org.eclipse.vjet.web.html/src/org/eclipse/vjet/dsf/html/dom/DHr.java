...
* </pre>
*/
public class DHr extends BaseAttrsHtmlElement implements IDBlock /*, IDStrict, IAttrs */{
	...
	//
	public DHr() {
		super(HtmlTypeEnum.HR);
	}
	
	public DHr(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.HR);
	}
	
	public DHr(final String jif) {
		this() ;
		jif(jif) ;
	}
	 ...
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */
	public DHr setHtmlAlign(final String align) {
		setHtmlAttribute(EHtmlAttr.align, align);
		return this ;
	}

	public boolean getHtmlNoShade() {
		return getHtmlAttributeExists(EHtmlAttr.noshade);
	}
	/**
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */
	public DHr setHtmlNoShade(final String noShade) {
		return setHtmlNoShade(toBoolean("noshade", noShade)) ;
	}
	/**
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */	
	public DHr setHtmlNoShade(final boolean noShade) {
		setHtmlAttribute(EHtmlAttr.noshade, noShade);
		return this ;
	}
	 ...
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */
	public DHr setHtmlSize(final String size) {
	 ...
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */	
	public DHr setHtmlSize(final int size) {
	 ...
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */
	public DHr setHtmlWidth(final String width) {
	 ...
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */	
	public DHr setHtmlWidth(final int width) {
	...
	public String toString() {
		...
		Z.fmt(EHtmlAttr.noshade.getAttributeName(), "" + getHtmlNoShade()) +
	 ...
	 */
	@Override
	public DHr add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DHr add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DHr addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DHr dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DHr dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DHr setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DHr setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DHr setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DHr setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DHr setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DHr setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DHr setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DHr setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DHr setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DHr setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DHr setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DHr setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DHr setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DHr setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DHr setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DHr setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DHr setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DHr setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DHr setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DHr setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DHr setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DHr setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DHr setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DHr setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DHr setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DHr setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DHr setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DHr setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DHr setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DHr setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DHr setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DHr setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DHr setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DHr setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DHr setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DHr setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DHr setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DHr setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DHr setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DHr setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DHr setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DHr setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DHr setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DHr setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DHr setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DHr setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DHr add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DHr addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DHr addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DHr addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DHr jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
