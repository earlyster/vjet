...
* <p>
* http://www.w3.org/TR/REC-html40/present/graphics.html#edef-TT
*/
public class DTt extends BaseAttrsHtmlElement
	/*implements IDFontStyle, IDStrict, IAttrs*/
{
	...
	//
	public DTt() {
		super(HtmlTypeEnum.TT);
	}

	public DTt(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.TT);
	}
	
//	public DTt(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	 ...
	 */
	public DTt(final String textValue) {
		this() ;
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.TT ;
	}
			
	//
	// Extensions
	//
	public DTt setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DTt add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTt add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTt addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTt dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DTt dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DTt setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DTt setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DTt setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DTt setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DTt setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DTt setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DTt setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DTt setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DTt setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DTt setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTt setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DTt setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DTt setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DTt setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTt setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DTt setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DTt setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DTt setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DTt setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DTt setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DTt setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DTt setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DTt setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DTt setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTt setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DTt setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DTt setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DTt setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DTt setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DTt setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DTt setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DTt setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DTt setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DTt setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DTt setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DTt setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DTt setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DTt setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DTt setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DTt setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DTt setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DTt setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DTt setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DTt setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DTt setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DTt setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DTt add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DTt addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTt addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DTt addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DTt jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}
