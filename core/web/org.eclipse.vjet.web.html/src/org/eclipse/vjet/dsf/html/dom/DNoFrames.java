...
* negative way.
* <p>
* http://www.w3.org/TR/REC-html40/present/frames.html#edef-NOFRAMES
* <p>
* Example:
* <pre>
*   <HTML>
...
* </pre>
*/
public class DNoFrames extends BaseAttrsHtmlElement
	implements IDBlock //, IDTransitional, IAttrs
{
	...
	//
	public DNoFrames() {
		super(HtmlTypeEnum.NOFRAMES);
	}
	
	public DNoFrames(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.NOFRAMES);
	}
	
	public DNoFrames(final String jif) {
		this() ;
		jif(jif) ;
	}
	 ...
	 */
	@Override
	public DNoFrames add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoFrames add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoFrames addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoFrames dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DNoFrames dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DNoFrames setDsfRelationshipVerifier(
	...
	@Override
	public DNoFrames cloned() {
		return (DNoFrames)super.cloned() ;
	}
     ...
     */
    @Override
    public DNoFrames setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DNoFrames setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DNoFrames setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DNoFrames setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoFrames setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DNoFrames setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DNoFrames setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoFrames setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DNoFrames setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DNoFrames setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoFrames setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DNoFrames setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DNoFrames setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DNoFrames setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DNoFrames setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DNoFrames setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DNoFrames setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DNoFrames setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DNoFrames setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DNoFrames setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DNoFrames setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DNoFrames setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DNoFrames setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DNoFrames setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DNoFrames setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DNoFrames setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DNoFrames setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DNoFrames setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DNoFrames setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DNoFrames add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	
//	@Override
//	public DNoFrames removeListener(
//		final EventType eventType, final IDomActiveListener listener)
//	{
...
//	}
	...
	//
	@Override
	public DNoFrames addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DNoFrames addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoFrames addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DNoFrames addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DNoFrames jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}