...
/**
<a href='http://dev.w3.org/html5/spec/Overview.html#the-datalist-element'>W3C datalist</a>
<p>
 ...
 */
public class DDataList extends BaseHtml50Element {
	...
	//
	public DDataList() {
		super(HtmlTypeEnum.DATALIST);
	}
	
	public DDataList(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.DATALIST);
	}
	
	public DDataList(final String jif) {
		this() ;
		jif(jif) ;
	}
	
	public DDataList(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
...
//	}
//
//	public DDataList setHtmlData(final String data) {
...
//	}
	 ...
	 */
	@Override
	public DDataList add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DDataList add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDataList add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDataList addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDataList dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DDataList dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DDataList setDsfRelationshipVerifier(
	...
	@Override
	public DDataList cloned() {
		return (DDataList)super.cloned() ;
	}
     ...
     */
    @Override
    public DDataList setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DDataList setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DDataList setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DDataList setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DDataList setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DDataList setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DDataList setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DDataList setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DDataList setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDataList setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DDataList setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DDataList setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DDataList setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDataList setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DDataList setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DDataList setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DDataList setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DDataList setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DDataList setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DDataList setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DDataList setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DDataList setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DDataList setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDataList setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DDataList setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DDataList setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DDataList setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DDataList setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DDataList setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DDataList setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DDataList setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DDataList setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DDataList setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DDataList setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DDataList setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DDataList setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DDataList setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DDataList setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DDataList setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DDataList setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DDataList setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DDataList setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DDataList setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DDataList add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	
//	@Override
//	public DDataList removeListener(
//		final EventType eventType, final IDomActiveListener listener)
//	{
...
//	}
	...
	//
	@Override
	public DDataList addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DDataList addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDataList addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DDataList addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DDataList jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DDataList _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DDataList _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DDataList _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DDataList _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DDataList _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DDataList _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DDataList _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DDataList _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DDataList _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DDataList _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DDataList _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DDataList _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DDataList _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DDataList _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DDataList _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DDataList _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DDataList _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DDataList _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DDataList _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DDataList _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DDataList _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DDataList _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DDataList _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DDataList _buttonText_(final String textValue) {
	...
	public DDataList _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DDataList _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DDataList _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DDataList _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DDataList _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DDataList _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DDataList _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DDataList _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DDataList _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DDataList _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DDataList _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DDataList _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DDataList _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DDataList _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DDataList _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DDataList _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DDataList _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DDataList _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DDataList _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DDataList _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DDataList _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DDataList _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DDataList _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DDataList _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DDataList _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DDataList _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DDataList _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DDataList _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DDataList _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DDataList _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DDataList _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DDataList _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DDataList _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DDataList _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DDataList _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DDataList _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DDataList _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DDataList _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DDataList _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DDataList _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DDataList _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DDataList _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DDataList _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DDataList _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DDataList _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DDataList _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DDataList _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DDataList _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DDataList _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DDataList _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DDataList _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DDataList _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DDataList _labelText_(final String textValue) {
	...
	public DDataList _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DDataList _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DDataList _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DDataList _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DDataList _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DDataList _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DDataList _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DDataList _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DDataList _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DDataList _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DDataList _meter_(final String min, final String max, final String value) {
	...
	public DDataList _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DDataList _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DDataList _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DDataList _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DDataList _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DDataList _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DDataList _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DDataList _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DDataList _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DDataList _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DDataList _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DDataList _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DDataList _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DDataList _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DDataList _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DDataList _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DDataList _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DDataList _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DDataList _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DDataList _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DDataList _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DDataList _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DDataList _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DDataList _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DDataList _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DDataList _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DDataList _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DDataList _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DDataList _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DDataList _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DDataList _scriptText_(final String text, final String type) {
	...
	public DDataList _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DDataList _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DDataList _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DDataList _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DDataList _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DDataList _smallText_(final String textValue) {
	...
	public DDataList _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DDataList _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DDataList _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DDataList _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DDataList _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DDataList _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DDataList _strongText_(final String textValue) {
	...
	public DDataList _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DDataList _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DDataList _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DDataList _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DDataList _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DDataList _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DDataList _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DDataList _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DDataList _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DDataList _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DDataList _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DDataList _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DDataList _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DDataList _timeDateTime_(final String dateTime) {
	...
	public DDataList _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DDataList _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DDataList _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DDataList _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DDataList _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DDataList _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DDataList _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DDataList _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DDataList _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
	...
	public DDataList _option_(final int count) {
		_option(count) ;
		return this ;
	}
	public DOption _option(final String jif) {
		return _option().jif(jif) ;
	}
	public DDataList _option_(final String jif) {
		_option(jif) ;
		return this ;
	}
}
