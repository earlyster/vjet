...
/**
* http://www.w3.org/TR/REC-html40/struct/text.html#edef-SAMP
*/
public class DSamp extends BaseAttrsHtmlElement
	/* implements IDPhrase, IDStrict, IAttrs */
{
	...
	//
	public DSamp() {
		super(HtmlTypeEnum.SAMP);
	}

	public DSamp(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.SAMP);
	}
	
//	public DSamp(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	 ...
	 */
	public DSamp(final String textValue) {
		this() ;
		setHtmlExtTextValue(textValue) ;
	}

	public DSamp(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.SAMP ;
	}
			
	//
	// Extensions
	//
	public DSamp setHtmlExtTextValue(final  String value) {
	 ...
	 */
	@Override
	public DSamp add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DSamp add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSamp add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSamp addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSamp dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DSamp dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DSamp setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DSamp setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DSamp setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DSamp setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DSamp setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DSamp setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DSamp setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DSamp setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DSamp setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DSamp setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSamp setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DSamp setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DSamp setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DSamp setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSamp setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DSamp setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DSamp setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DSamp setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DSamp setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DSamp setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DSamp setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DSamp setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DSamp setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DSamp setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSamp setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DSamp setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DSamp setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DSamp setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DSamp setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DSamp setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DSamp setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DSamp setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DSamp setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DSamp setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DSamp setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DSamp setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DSamp setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DSamp setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DSamp setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DSamp setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DSamp setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DSamp setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DSamp setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DSamp setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DSamp add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DSamp addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSamp addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DSamp addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DSamp jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DSamp _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DSamp _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DSamp _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DSamp _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DSamp _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DSamp _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DSamp _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DSamp _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DSamp _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DSamp _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DSamp _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DSamp _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DSamp _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DSamp _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DSamp _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DSamp _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DSamp _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DSamp _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DSamp _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DSamp _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DSamp _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DSamp _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DSamp _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DSamp _buttonText_(final String textValue) {
	...
	public DSamp _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DSamp _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DSamp _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DSamp _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DSamp _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DSamp _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DSamp _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DSamp _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DSamp _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DSamp _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DSamp _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DSamp _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DSamp _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DSamp _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DSamp _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DSamp _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DSamp _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DSamp _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DSamp _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DSamp _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DSamp _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DSamp _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DSamp _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DSamp _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DSamp _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DSamp _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DSamp _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DSamp _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DSamp _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DSamp _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DSamp _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DSamp _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DSamp _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DSamp _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DSamp _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DSamp _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DSamp _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DSamp _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DSamp _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DSamp _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DSamp _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DSamp _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DSamp _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DSamp _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DSamp _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DSamp _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DSamp _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DSamp _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DSamp _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DSamp _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DSamp _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DSamp _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DSamp _labelText_(final String textValue) {
	...
	public DSamp _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DSamp _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DSamp _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DSamp _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DSamp _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DSamp _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DSamp _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DSamp _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DSamp _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DSamp _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DSamp _meter_(final String min, final String max, final String value) {
	...
	public DSamp _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DSamp _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DSamp _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DSamp _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DSamp _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DSamp _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DSamp _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DSamp _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DSamp _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DSamp _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DSamp _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DSamp _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DSamp _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DSamp _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DSamp _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DSamp _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DSamp _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DSamp _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DSamp _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DSamp _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DSamp _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DSamp _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DSamp _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DSamp _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DSamp _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DSamp _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DSamp _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DSamp _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DSamp _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DSamp _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DSamp _scriptText_(final String text, final String type) {
	...
	public DSamp _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DSamp _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DSamp _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DSamp _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DSamp _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DSamp _smallText_(final String textValue) {
	...
	public DSamp _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DSamp _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DSamp _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DSamp _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DSamp _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DSamp _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DSamp _strongText_(final String textValue) {
	...
	public DSamp _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DSamp _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DSamp _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DSamp _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DSamp _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DSamp _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DSamp _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DSamp _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DSamp _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DSamp _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DSamp _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DSamp _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DSamp _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DSamp _timeDateTime_(final String dateTime) {
	...
	public DSamp _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DSamp _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DSamp _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DSamp _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DSamp _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DSamp _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DSamp _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DSamp _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DSamp _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}