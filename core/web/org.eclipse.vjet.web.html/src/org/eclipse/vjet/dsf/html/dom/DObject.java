...
//	implements IDRepeatableHeadElement, IDSpecial, IDStrict, IAttrs,
//		/* HTML 5.0 */ IEmbeddedContent
{
	...
	//
	public DObject() {
		super(HtmlTypeEnum.OBJECT);
	}
	
	public DObject(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.OBJECT);
	}
	
	public DObject(final String jif) {
		this() ;
		jif(jif) ;
	}
	
	public DObject(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public String getHtmlCode() {
		return getHtmlAttribute(EHtmlAttr.code);
	}
	public DObject setHtmlCode(final String code) {
		setHtmlAttribute(EHtmlAttr.code, code);
		return this ;
	}
	 ...
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */
	public DObject setHtmlAlign(final String align) {
	 ...
	 */
	public String getHtmlArchive() {
		return getHtmlAttribute(EHtmlAttr.archive);
	}
	/**
	 * @deprecated - Not supported in HTML 5.0
	 */
	public DObject setHtmlArchive(final String archive) {
		setHtmlAttribute(EHtmlAttr.archive, archive);
		return this ;
	}
	 ...
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */
	public DObject setHtmlBorder(final String border) {
	 ...
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */	
	public DObject setHtmlBorder(final int border) {
		return setHtmlBorder(String.valueOf(border)) ;
	}

	/**
	 * @deprecated - Not supported in HTML 5.0
	 */
	public String getHtmlCodeBase() {
		return getHtmlAttribute(EHtmlAttr.codebase);
	}
	/**
	 * @deprecated - Not supported in HTML 5.0
	 */
	public DObject setHtmlCodeBase(final String codeBase) {
		setHtmlAttribute(EHtmlAttr.codebase, codeBase);
		return this ;
	}
	...
	public String getHtmlCodeType() { 
		return getHtmlAttribute(EHtmlAttr.codetype);
	}
	/**
	 * @deprecated - Not supported in HTML 5.0
	 */
	public DObject setHtmlCodeType(final String type) { 
		setHtmlAttribute(EHtmlAttr.codetype, type);
		return this ;
	}

	public String getHtmlData() {
		return getHtmlAttribute(EHtmlAttr.data);
	}

	public DObject setHtmlData(final String data) {
		setHtmlAttribute(EHtmlAttr.data, data);
		return this ;
	}
	 ...
	 * @deprecated - Not supported in HTML 5.0
	 */
	public String getHtmlClassId() {
		return getHtmlAttribute(EHtmlAttr.classid);
	}
	/**
	 * @deprecated - Not supported in HTML 5.0
	 */
	public DObject setHtmlClassId(final String classid) {
		setHtmlAttribute(EHtmlAttr.classid, classid);
		return this ;
	}
	 ...
	 * @deprecated - Not supported in HTML 5.0
	 */
	public boolean getHtmlDeclare() {
		return getHtmlAttributeExists(EHtmlAttr.declare);
	}
	/**
	 * @deprecated - Not supported in HTML 5.0
	 */
	public DObject setHtmlDeclare(final String declare) {
		return setHtmlDeclare(toBoolean("declare", declare)) ;
	}
	/**
	 * @deprecated - Not supported in HTML 5.0
	 */
	public DObject setHtmlDeclare(final boolean declare) {
	 ...
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */
	public DObject setHtmlHeight(final String height) {
	 ...
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */	
	public DObject setHtmlHeight(final int height) {
	...
	public DObject setHtmlHspace(final String hspace) {
		setHtmlAttribute(EHtmlAttr.hspace, hspace);
		return this ;
	}	
	public DObject setHtmlHspace(final int hspace) {
		return setHtmlHspace(String.valueOf(hspace)) ;
	}

	public String getHtmlName() {
		return getHtmlAttribute(EHtmlAttr.name);
	}
	public DObject setHtmlName(final String name) {
	 ...
	 * @deprecated - Not supported in HTML 5.0
	 */
	public String getHtmlStandby() {
		return getHtmlAttribute(EHtmlAttr.standby);
	}
	/**
	 * @deprecated - Not supported in HTML 5.0
	 */
	public DObject setHtmlStandby(final String standby) {
		setHtmlAttribute(EHtmlAttr.standby, standby);
		return this ;
	}
	...
	public DObject setHtmlType(final String type) {
	...
	public DObject setHtmlUseMap(final String useMap) {
		setHtmlAttribute(EHtmlAttr.usemap, useMap);
		return this ;
	}
	...
	public DObject setHtmlVspace(final String vspace) {
		setHtmlAttribute(EHtmlAttr.vspace, vspace);
		return this ;
	}	
	public DObject setHtmlVspace(final int vspace) {
		return setHtmlVspace(String.valueOf(vspace)) ;
	}
	 ...
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */
	public DObject setHtmlWidth(final String width) {
	 ...
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */	
	public DObject setHtmlWidth(final int width) {
	...
	public String toString() {
		...
		Z.fmt(EHtmlAttr.archive.getAttributeName(), getHtmlArchive()) +
		Z.fmt(EHtmlAttr.border.getAttributeName(), getHtmlBorder()) +
		Z.fmt(EHtmlAttr.classid.getAttributeName(), getHtmlClassId()) +
		Z.fmt(EHtmlAttr.code.getAttributeName(), getHtmlCode()) +
		Z.fmt(EHtmlAttr.codebase.getAttributeName(), "" + getHtmlCodeBase()) +
		Z.fmt(EHtmlAttr.codetype.getAttributeName(), "" + getHtmlCodeType()) +
		Z.fmt(EHtmlAttr.data.getAttributeName(), "" + getHtmlData()) +
		Z.fmt(EHtmlAttr.declare.getAttributeName(), "" + getHtmlDeclare()) +
		Z.fmt(EHtmlAttr.height.getAttributeName(), "" + getHtmlHeight()) +
		Z.fmt(EHtmlAttr.hspace.getAttributeName(), "" + getHtmlHspace()) +
		Z.fmt(EHtmlAttr.name.getAttributeName(), "" + getHtmlName()) +
		Z.fmt(EHtmlAttr.standby.getAttributeName(), "" + getHtmlStandby()) +
		Z.fmt(EHtmlAttr.tabindex.getAttributeName(), "" + getHtmlTabIndex()) +
		Z.fmt(EHtmlAttr.type.getAttributeName(), "" + getHtmlType()) +
		Z.fmt(EHtmlAttr.usemap.getAttributeName(), "" + getHtmlUseMap()) +
		Z.fmt(EHtmlAttr.vspace.getAttributeName(), "" + getHtmlVspace()) +
	 ...
	 */
	@Override
	public DObject add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DObject add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DObject add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DObject addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DObject dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DObject dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DObject setDsfRelationshipVerifier(
	...
	@Override
	public DObject cloned() {
		return (DObject)super.cloned() ;
	}
     ...
     */
    @Override
    public DObject setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DObject setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DObject setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DObject setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DObject setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DObject setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DObject setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DObject setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DObject setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DObject setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DObject setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DObject setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DObject setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DObject setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DObject setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DObject setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DObject setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DObject setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DObject setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DObject setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DObject setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DObject setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DObject setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DObject setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DObject setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DObject setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DObject setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DObject setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DObject setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DObject setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DObject setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DObject setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DObject setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DObject setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DObject setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DObject setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DObject setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DObject setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DObject setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DObject setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DObject setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DObject setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DObject setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DObject setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DObject setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DObject add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	//
	@Override
	public DObject addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DObject addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DObject addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DObject addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DObject jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DObject _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DObject _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DObject _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DObject _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DObject _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DObject _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DObject _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DObject _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DObject _address_(final int count) {
		 _address(count) ;
		 return this ;
	}
	...
	public DObject _address_(final String jif) {
		_address(jif) ;
		return this ;
	}
	...
	public DObject _address_(BaseHtmlElement... elements) {
		_address(elements) ;
		return this ;
	}
	...
	public DObject _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DObject _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DObject _article_(final int count) {
		_article(count) ;
		return this ;
	}
	...
	public DObject _article_(final String jif) {
		_article(jif) ;
		return this ;
	}
	...
	public DObject _articleText_(final String textValue) {
	...
	public DObject _article_(BaseHtmlElement... elements) {
		_article(elements) ;
		return this ;
	}
	...
	public DObject _aside_(final int count) {
		 _aside(count) ;
		 return this ;
	}
	...
	public DObject _aside_(final String jif) {
		_aside(jif) ;
		return this ;
	}
	...
	public DObject _asideText_(final String textValue) {
	...
	public DObject _aside_(BaseHtmlElement... elements) {
		_aside(elements) ;
		return this ;
	}
	...
	public DObject _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DObject _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DObject _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DObject _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DObject _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DObject _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DObject _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DObject _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DObject _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DObject _blockquote_(final int count) {
		_blockquote(count) ;
		return this ;
	}
	...
	public DObject _blockquote_(final String jif) {
		_blockquote(jif) ;
		return this ;
	}
	...
	public DObject _blockquoteText_(final String textValue) {
	...
	public DObject _blockquote_(BaseHtmlElement... elements) {
	...
	public DObject _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DObject _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DObject _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DObject _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DObject _buttonText_(final String textValue) {
	...
	public DObject _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DObject _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DObject _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DObject _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DObject _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DObject _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DObject _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DObject _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DObject _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DObject _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DObject _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DObject _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DObject _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DObject _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DObject _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DObject _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DObject _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DObject _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DObject _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DObject _details_(final int count) {
		_details(count) ;
		return this ;
	}
	...
	public DObject _details_(final String jif) {
		_details(jif) ;
		return this ;
	}
	...
	public DObject _details_(BaseHtmlElement... elements) {
		_details(elements) ;
		return this ;
	}
	...
	public DObject _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DObject _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DObject _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DObject _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DObject _div_(final int count) {
		_div(count) ;
		return this ;
	}
	...
	public DObject _div_(final String jif) {
		_div(jif) ;
		return this ;
	}
	...
	public DObject _div_(BaseHtmlElement... elements) {
		_div(elements) ;
		return this ;
	}
	...
	public DObject _dl_(final int count) {
		_dl(count) ;
		return this ;
	}
	...
	public DObject _dl_(final String jif) {
		_dl().jif(jif) ;
		return this ;
	}
	...
	public DObject _dl_(BaseHtmlElement... elements) {
		_dl(elements) ;
		return this ;
	}
	...
	public DObject _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DObject _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DObject _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DObject _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DObject _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DObject _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DObject _fieldset_(final int count) {
		_fieldset(count) ;
		return this ;
	}
	...
	public DObject _fieldset_(final String jif) {
		_fieldset(jif) ;
		return this ;
	}
	...
	public DObject _fieldsetLegend_(final String legend) {
	...
	public DObject _fieldset_(BaseHtmlElement... elements) {
		_fieldset(elements) ;
		return this ;
	}
	...
	public DObject _figure_(final int count) {
		_figure(count) ;
		return this ;
	}
	...
	public DObject _figure_(final String jif) {
		_figure(jif) ;
		return this ;
	}
	...
	public DObject _figure_(BaseHtmlElement... elements) {
		_figure(elements) ;
		return this ;
	}
	...
	public DObject _footer_(final int count) {
		_footer(count) ;
		return this ;
	}
	...
	public DObject _footer_(final String jif) {
		_footer(jif) ;
		return this ;
	}
	...
	public DObject _footerText_(final String textValue) {
	...
	public DObject _footer_(BaseHtmlElement... elements) {
		_footer(elements) ;
		return this ;
	}
	...
	public DObject _form_(final int count) {
		_form(count) ;
		return this ;
	}
	...
	public DObject _form_(final String jif) {
		_form(jif) ;
		return this ;
	}
	...
	public DObject _form_(BaseHtmlElement... elements) {
		_form(elements) ;
		return this ;
	}
	...
	public DObject _h1_(final int count) {
		_h1(count);
		return this ;
	}
	...
	public DObject _h1_(final String jif) {
		_h1(jif) ;
		return this ;
	}
	...
	public DObject _h1Text_(final String textValue) {
		_h1Text(textValue) ;
		return this ;
	}
	...
	public DObject _h1_(BaseHtmlElement... elements) {
		_h1(elements) ;
		return this ;
	}
	...
	public DObject _h2_(final int count) {
		_h2(count);
		return this ;
	}
	...
	public DObject _h2_(final String jif) {
		_h2(jif) ;
		return this ;
	}
	...
	public DObject _h2Text_(final String textValue) {
		_h2Text(textValue) ;
		return this ;
	}
	...
	public DObject _h2_(BaseHtmlElement... elements) {
		_h2(elements) ;
		return this ;
	}
	...
	public DObject _h3_(final int count) {
		_h3(count);
		return this ;
	}
	...
	public DObject _h3_(final String jif) {
		_h3(jif) ;
		return this ;
	}
	...
	public DObject _h3Text_(final String textValue) {
		_h3Text(textValue) ;
		return this ;
	}
	...
	public DObject _h3_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DObject _h4_(final int count) {
		_h4(count);
		return this ;
	}
	...
	public DObject _h4_(final String jif) {
		_h4(jif) ;
		return this ;
	}
	...
	public DObject _h4Text_(final String textValue) {
		_h4Text(textValue) ;
		return this ;
	}
	...
	public DObject _h4_(BaseHtmlElement... elements) {
		_h4(elements) ;
		return this ;
	}
	...
	public DObject _h5_(final int count) {
		_h5(count);
		return this ;
	}
	...
	public DObject _h5_(final String jif) {
		_h5(jif) ;
		return this ;
	}
	...
	public DObject _h5Text_(final String textValue) {
		_h5Text(textValue) ;
		return this ;
	}
	...
	public DObject _h5_(BaseHtmlElement... elements) {
		_h5(elements) ;
		return this ;
	}
	...
	public DObject _h6_(final int count) {
		_h6(count);
		return this ;
	}
	...
	public DObject _h6_(final String jif) {
		_h6(jif) ;
		return this ;
	}
	...
	public DObject _h6Text_(final String textValue) {
		_h6Text(textValue) ;
		return this ;
	}
	...
	public DObject _h6_(BaseHtmlElement... elements) {
		_h6(elements) ;
		return this ;
	}
	...
	public DObject _header_(final int count) {
		_header(count) ;
		return this ;
	}
	...
	public DObject _header_(final String jif) {
		_header(jif) ;
		return this ;
	}
	...
	public DObject _header_(BaseHtmlElement... elements) {
		_header(elements) ;
		return this ;
	}
	...
	public DObject _hgroup_(final int count) {
		_hgroup(count) ;
		return this ;
	}
	...
	public DObject _hgroup_(final String jif) {
		_hgroup(jif) ;
		return this ;
	}
	...
	public DObject _hgroup_(BaseHtmlElement... elements) {
		_hgroup(elements) ;
		return this ;
	}
	...
	public DObject _hr_(final int count) {
		_hr(count) ;
		return this ;
	}
	...
	public DObject _hr_(final String jif) {
		_hr(jif) ;
		return this ;
	}
	...
	public DObject _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DObject _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DObject _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DObject _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DObject _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DObject _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DObject _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DObject _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DObject _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DObject _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DObject _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DObject _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DObject _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DObject _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DObject _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DObject _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DObject _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DObject _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DObject _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DObject _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DObject _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DObject _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DObject _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DObject _labelText_(final String textValue) {
	...
	public DObject _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DObject _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DObject _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DObject _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DObject _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DObject _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DObject _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
	...
	public DObject _menu_(final int count) {
		_menu(count) ;
		return this ;
	}
	...
	public DObject _menu_(final String jif) {
		_menu(jif) ;
		return this ;
	}
	...
	public DObject _menu_(BaseHtmlElement... elements) {
		_menu(elements) ;
		return this ;
	}
	...
	public DObject _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DObject _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DObject _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
...
value) {
	...
	public DObject _meter_(final String min, final String max, final String value) 

{
	...
	public DObject _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
...
value) {
	...
	public DObject _meter_(final double min, final double max, final double value) 

{
	...
	public DObject _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DObject _nav_(final int count) {
		_nav(count) ;
		return this ;
	}
	...
	public DObject _nav_(final String jif) {
		_nav(jif) ;
		return this ;
	}
	...
	public DObject _nav_(BaseHtmlElement... elements) {
		_nav(elements) ;
		return this ;
	}
	...
	public DObject _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DObject _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DObject _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DObject _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DObject _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DObject _ol_(final int count) {
		_ol(count) ;
		return this ;
	}
	...
	public DObject _ol_(final String jif) {
		_ol(jif) ;
		return this ;
	}
	...
	public DObject _ol_(final Collection<Object> collection) {
		_ol(collection) ;
		return this ;
	}
	...
	public DObject _ol_(final Collection<Object> collection, final String htmlType) {
	...
	public DObject _ol_(DLi... elements) {
		_ol(elements) ;
		return this ;
	}
	...
	public DObject _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DObject _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DObject _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DObject _p_(final int count) {
		_p(count) ;
		return this ;
	}
	...
	public DObject _p_(final String jif) {
		_p(jif) ;
		return this ;
	}
	...
	public DObject _pText_(final String textValue) {
		_pText(textValue) ;
		return this ;
	}
	...
	public DObject _p_(BaseHtmlElement... elements) {
		_p(elements) ;
		return this ;
	}
	...
	public DObject _pre_(final int count) {
		_pre(count) ;
		return this ;
	}
	...
	public DObject _pre_(final String jif) {
		_pre(jif) ;
		return this ;
	}
	...
	public DObject _preText_(final String textValue) {
		_preText(textValue) ;
		return this ;
	}
	...
	public DObject _pre_(BaseHtmlElement... elements) {
		_pre(elements) ;
		return this ;
	}
	...
	public DObject _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DObject _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DObject _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DObject _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DObject _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DObject _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DObject _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DObject _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DObject _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DObject _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DObject _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DObject _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DObject _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DObject _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DObject _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DObject _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DObject _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DObject _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DObject _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DObject _scriptText_(final String text, final String type) {
	...
	public DObject _section_(final int count) {
		_section(count) ;
		return this ;
	}
	...
	public DObject _section_(final String jif) {
		_section(jif) ;
		return this ;
	}
	...
	public DObject _section_(BaseHtmlElement... elements) {
		_section(elements) ;
		return this ;
	}
	...
	public DObject _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DObject _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DObject _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DObject _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DObject _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DObject _smallText_(final String textValue) {
	...
	public DObject _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DObject _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DObject _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DObject _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DObject _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DObject _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DObject _strongText_(final String textValue) {
	...
	public DObject _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DObject _style_(final int count) {
		_style(count) ;
		return this ;
	}
	...
	public DObject _style_(final String jif) {
		_style(jif) ;
		return this ;
	}
	...
	public DObject _styleText_(final String styleText) {
	...
	public DObject _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DObject _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DObject _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DObject _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DObject _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DObject _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DObject _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DObject _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
	...
	public DObject _table_(final int count) {
		_table(count);
		return this ;
	}
	...
	public DObject _table_(final String jif) {
		_table(jif) ;
		return this ;
	}
	...
	public DObject _table_(DTr... rows) {
		_table(rows) ;
		return this ;
	}
	...
	public DObject _table_(BaseHtmlElement... elements) {
		_table(elements) ;
		return this ;
	}
	...
	public DObject _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DObject _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DObject _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DObject _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DObject _timeDateTime_(final String dateTime) {
	...
	public DObject _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DObject _ul_(final int count) {
		_ul(count) ;
		return this ;
	}
	...
	public DObject _ul_(final Collection<Object> collection) {
		_ul(collection) ;
		return this ;
	}
...

{
	...
	public DObject _ul_(final Collection<Object> collection, final String htmlType) {
	...
	public DObject _ul_(DLi... elements) {
		_ul(elements) ;
		return this ;
	}
	...
	public DObject _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DObject _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DObject _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DObject _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DObject _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DObject _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DObject _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DObject _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
	...
	//
	public DParam _param() {
		 return _param(-1) ;
	}
	public DObject _param_() {
		_param() ;
		return this ;
	}
	public DParam _param(final int count) {
		 return (DParam)getOrCreate(DParam.class, count) ;
	}
	public DObject _param_(final int count) {
		_param(count);
		return this ;
	}
	public DParam _param(final String jif) {
		return _param().jif(jif) ;
	}
	public DObject _param_(final String jif) {
		_param(jif) ;
		return this ;
	}
}
