...
/**
 * IE Specific tag.  Renders text without line breaks. 
 * 
 * http://msdn2.microsoft.com/en-us/library/ms535856.aspx
 * 
 * @see DWbr
 */

public class DNoBr extends BaseAttrsHtmlElement /* implements IEventAttributes */{
	...
	// Constructors
	public DNoBr() {
		super(HtmlTypeEnum.NOBR);
	}
	
	public DNoBr(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.NOBR);
	}
	
//	public DNoBr(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	
	public DNoBr(final String text) { 
		this() ; 
		setHtmlExtTextValue(text) ; 
	}
	...
	/**
	 * Returns whether the element and its contents be selected as a whole unit 
	 */ 
	public String getHtmlAtomicSelection() { 
		return getHtmlAttribute(EHtmlAttr.atomicselection) ;
	}	
	public DNoBr setHtmlAtomicSelection(final String atomic ) { 
		setHtmlAttribute(EHtmlAttr.atomicselection, atomic) ;
		return this ; 
	}
	public DNoBr setHtmlAtomicSelection(final boolean atomic) { 
		setHtmlAtomicSelection(String.valueOf(atomic)) ; 
		return this ; 
	}
	
	/**
	 * Returns the height of the object. Can be an integer or an integer 
	 * followed by the percent (%) sign
	 */
	public String getHtmlHeight() { 
		return getHtmlAttribute(EHtmlAttr.height) ;
	}	
	public DNoBr setHtmlHeight(final String height) {
		setHtmlAttribute(EHtmlAttr.height, height) ;
		return this ; 
	}	
	public DNoBr setHtmlHeight(final int height) { 
	...
	public DNoBr setHtmlLanguage(final String language) { 
	...
	public DNoBr setHtmlUnselectable(final String unselectable) { 
		setHtmlAttribute(EHtmlAttr.unselectable, unselectable) ; 
		return this ;
	}
	
	// Events
	public DNoBr setHtmlOnBeforeActivate(final String script) {
		setInlineEvent(EHtmlAttr.onbeforeactivate, script, EventType.BEFOREACTIVATE);
		return this ; 
	}
	
	public DNoBr setHtmlOnBeforeCopy(final String script) { 
		setInlineEvent(EHtmlAttr.onbeforecopy, script, EventType.BEFORECOPY);
		return this ; 
	}
	
	public DNoBr setHtmlOnBeforeCut(final String script) {
		setInlineEvent(EHtmlAttr.onbeforecut, script, EventType.BEFORECUT);
		return this ; 
	}
	
	public DNoBr setHtmlOnBeforeEditFocus(final String script) {
		setInlineEvent(EHtmlAttr.onbeforeeditfocus, script, EventType.BEFOREEDITFOCUS);
		return this ; 
	}
	
	public DNoBr setHtmlOnBeforePaste(final String script) {
		setInlineEvent(EHtmlAttr.onbeforepaste, script, EventType.BEFOREPASTE);
		return this ; 
	}
	
	public DNoBr setHtmlOnCopy(final String script) {
		setInlineEvent(EHtmlAttr.oncopy, script, EventType.COPY);
		return this ; 
	}
	
	public DNoBr setHtmlOnCut(final String script) {
		setInlineEvent(EHtmlAttr.oncut, script, EventType.CUT);
		return this ; 
	}
	
	@Override
	public DNoBr setHtmlOnDoubleClick(final String script) {
		super.setHtmlOnDoubleClick(script) ;
		return this ; 
	}
	
	public DNoBr setHtmlOnFocusIn(final String script) {
		setInlineEvent(EHtmlAttr.onfocusin, script, EventType.FOCUSIN);
		return this ; 
	}
	
	public DNoBr setHtmlOnFocusOut(final String script) {
		setInlineEvent(EHtmlAttr.onfocusout, script, EventType.FOCUSOUT);
		return this ; 
	}
	
	public DNoBr setHtmlOnHelp(final String script) {
		setInlineEvent(EHtmlAttr.onhelp, script, EventType.HELP);
		return this ; 
	}
	
	public DNoBr setHtmlOnLoseCapture(final String script) { 
		setInlineEvent(EHtmlAttr.onlosecapture, script, EventType.LOSECAPTURE);
		return this ; 
	}
	
	public DNoBr setHtmlOnMouseEnter(final String script) {
		setInlineEvent(EHtmlAttr.onmouseenter, script, EventType.MOUSEENTER);
		return this ; 
	}
	
	public DNoBr setHtmlOnMouseLeave(final String script) {
		setInlineEvent(EHtmlAttr.onmouseleave, script, EventType.MOUSELEAVE);
		return this ; 
	}
	
	public DNoBr setHtmlOnPaste(final String script) {
		setInlineEvent(EHtmlAttr.onpaste, script, EventType.PASTE);
		return this ; 
	}
	
	public DNoBr setHtmlOnPropertyChange(final String script) { 
		setInlineEvent(EHtmlAttr.onpropertychange, script, EventType.PROPERTYCHANGE);
		return this ; 
	}
	
	public DNoBr setHtmlOnSelectStart(final String script) {
	...
	// Extensions
	//
	public DNoBr setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DNoBr add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoBr add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoBr addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoBr dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DNoBr dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DNoBr setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DNoBr setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DNoBr setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DNoBr setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DNoBr setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DNoBr setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DNoBr setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DNoBr setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DNoBr setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DNoBr setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoBr setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DNoBr setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DNoBr setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DNoBr setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoBr setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DNoBr setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DNoBr setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DNoBr setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DNoBr setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DNoBr setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DNoBr setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DNoBr setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DNoBr setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DNoBr setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoBr setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DNoBr setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DNoBr setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DNoBr setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DNoBr setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DNoBr setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DNoBr setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DNoBr setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DNoBr setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DNoBr setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DNoBr setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DNoBr setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DNoBr setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DNoBr setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DNoBr setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DNoBr setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DNoBr setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DNoBr setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DNoBr setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DNoBr setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DNoBr add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DNoBr addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DNoBr addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DNoBr addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DNoBr jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}
