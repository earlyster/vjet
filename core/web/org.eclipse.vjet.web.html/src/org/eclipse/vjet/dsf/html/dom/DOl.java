...
* </pre>
*/
public class DOl extends BaseAttrsHtmlElement /* implements IDList, IDStrict, IAttrs */ {

	private static final long serialVersionUID = 3544958748826349621L;

	/** value = "1" -- arabic - 1, 2, 3, ...*/
	public static final String TYPE_1 = "1" ;	// arabic - 1, 2, 3, ...
	/** value = "a" -- lower alpha - a, b, c, ...*/
	public static final String TYPE_a = "a" ;	// lower alpha - a, b, c, ...
	/** value = "A" -- upper alpha - A, B, C, ...*/
	public static final String TYPE_A = "A" ;	// upper alpha - A, B, C, ...
	/** value = "i" -- lower Roman - i, ii, iii, ...*/
	public static final String TYPE_i = "i" ;	// lower Roman - i, ii, iii, ... // ignoreHtmlKeyword
	/** value = "I" -- upper Roman - I, II, III, ...*/
	public static final String TYPE_I = "I" ;	// upper Roman - I, II, III, ... // ignoreHtmlKeyword
	...
	public DOl(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.OL);
	}
	
	public DOl(final String jif) {
		this() ;
		jif(jif) ;
	}
	...
	// DSF Extensions
	//
	public DOl(final Collection collection) {
		this(collection, null) ;
	}
	public DOl(final Collection collection, final String htmlType) {
		this() ;
		if (collection == null) {
			return ;
		}
	 ...
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */
	public DOl setHtmlCompact(final String compact) {
		return setHtmlCompact(toBoolean("compact", compact)) ;
	}
	/**
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */
	public DOl setHtmlCompact(final boolean compact) {
	...
	public DOl setHtmlStart(final String start) {
		setHtmlAttribute(EHtmlAttr.start, start);
		return this;
	}
	public DOl setHtmlStart(final int start) {
	 ...
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */
	public DOl setHtmlType(final String type) {
	...
	public DOl setHtmlValue(final String value) {
		setHtmlAttribute(EHtmlAttr.value, value);
		return this;
	}
	public DOl setHtmlValue(final int value) {
		return setHtmlValue(String.valueOf(value)) ;
	}
	
	public boolean getHtmlReversed() {  // HTML 5.0
		return getHtmlAttributeExists(EHtmlAttr.reversed);
	}
	public DOl setHtmlReversed(final String reversed) {  // HTML 5.0
		return setHtmlReversed(toBoolean("reversed", reversed)) ;
	}	
	public DOl setHtmlReversed(final boolean reversed) {  // HTML 5.0
		setHtmlAttribute(EHtmlAttr.reversed, reversed);
		return this;
	}
	...
	public DLi htmlAddLI() {
		final DLi li = new DLi() ;
		add(li) ;
		return li ;
	}
	
	public DLi htmlAddLI(final String value) {
		final DLi li = new DLi(value) ;
		add(li) ;
		return li ;
	}
	...
	public String toString() {
		...
		Z.fmt("start", "" + getHtmlStart()) +
		Z.fmt("type", getHtmlType()) +
		Z.fmt("value", getHtmlValue()) +
		Z.fmt("reversed", getHtmlReversed()) ;
	}
	 ...
	 */
	@Override
	public DOl add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	public DOl add(DLi... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DOl add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DOl addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DOl dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DOl dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DOl setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DOl setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DOl setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DOl setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DOl setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DOl setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DOl setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DOl setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DOl setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DOl setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DOl setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DOl setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DOl setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DOl setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DOl setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DOl setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DOl setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DOl setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DOl setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DOl setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DOl setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DOl setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DOl setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DOl setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DOl setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DOl setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DOl setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DOl setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DOl setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DOl setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DOl setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DOl setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DOl setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DOl setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DOl setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DOl setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DOl setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DOl setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DOl setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DOl setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DOl setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DOl setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DOl setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DOl setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DOl setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DOl setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DOl add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DOl addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DOl addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DOl addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DOl jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DLi _li(final String textValue) {
		return _li().setHtmlExtTextValue(textValue) ;
	}
	public DLi _li(final String textValue, final String htmlType) {
		return _li(textValue).setHtmlType(htmlType) ;
	}
}
