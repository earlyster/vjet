...
* </pre>
*/
public class DTitle extends BaseOrigNonAttrs //BaseI18nHtmlElement
//	implements IDHeadContent, IDTransitional, II18nAttributes, 
//		/* HTML 5.0 */ IMetadataContent
{
	...
	//
	public DTitle() {
		super(HtmlTypeEnum.TITLE);
	}

	public DTitle(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.TITLE);
	}
	
//	public DTitle(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	 ...
	 */
	public DTitle(final String textValue) {
		this() ;
		setHtmlText(textValue) ;
	}
	...
	// TODO: Use TextChildOperationUtil?
	public DTitle setHtmlText(final String text) {
		...
		insertBefore(new DText(text), getFirstChild());
		return this ;
	}
	 ...
	 */
	@Override
	public DTitle add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTitle add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTitle addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTitle dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DTitle dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DTitle setDsfRelationshipVerifier(
	...
	@Override
	public DTitle cloned() {
		return (DTitle)super.cloned() ;
	}
     ...
     */
    @Override
    public DTitle setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DTitle setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DTitle setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DTitle setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DTitle setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DTitle setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DTitle setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DTitle setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DTitle setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTitle setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DTitle setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DTitle setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DTitle setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTitle setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DTitle setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DTitle setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DTitle setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DTitle setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DTitle setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DTitle setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DTitle setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DTitle setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DTitle setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTitle setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DTitle setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DTitle setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DTitle setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DTitle setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DTitle setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DTitle setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DTitle setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DTitle setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DTitle setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DTitle setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DTitle setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DTitle setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DTitle setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DTitle setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DTitle setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DTitle setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DTitle setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DTitle setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DTitle setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DTitle add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DTitle addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTitle addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DTitle addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DTitle jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
