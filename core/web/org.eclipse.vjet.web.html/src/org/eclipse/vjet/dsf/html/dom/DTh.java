...
* </pre>
*/
public class DTh extends BaseTableCell { //implements IDTransitional, IAttrs {
	...
	//
	public DTh() {
		super(HtmlTypeEnum.TH);
	}

	public DTh(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.TH);
	}
	
//	public DTh(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	 ...
	 */
	public DTh(final String textValue) {
		this() ;
		setHtmlExtTextValue(textValue) ;
	}
	
	public DTh(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	//
	@Override
	public DTh setHtmlCellIndex(final String cellIndex) {
		super.setHtmlCellIndex(cellIndex) ;
		return this ;
	}	
	@Override
	public DTh setHtmlCellIndex(int cellIndex) {
		super.setHtmlCellIndex(cellIndex) ;
		return this ;
	}

	@Override
	public DTh setHtmlAbbr(final String abbr) {
	 ...
	 */
	@Override
	public DTh setHtmlAlign(final String align) {
		super.setHtmlAlign(align) ;
		return this ;
	}
	
	@Override
	public DTh setHtmlAxis(final String axis) {
	 ...
	 */
	@Override
	public DTh setHtmlBgColor(final String bgColor) {
	...
	@Override
	public DTh setHtmlCh(String _char) {
	...
	// Purposefully did not use full name "char" to avoid confusion
	@Override
	public DTh setHtmlChOff(final String charoff) {
		super.setHtmlChOff(charoff) ;
		return this ;
	}

	@Override
	public DTh setHtmlColSpan(final String colspan) {
		super.setHtmlColSpan(colspan) ;
		return this ;
	}	
	@Override
	public DTh setHtmlColSpan(final int colspan) {
		super.setHtmlColSpan(colspan) ;
		return this ;
	}

	@Override
	public DTh setHtmlHeaders(final String headers) {
	 ...
	 */
	@Override
	public DTh setHtmlHeight(final String height) {
	 ...
	 */
	@Override
	public DTh setHtmlHeight(final int height) {
		super.setHtmlHeight(height) ;
		return this ;
	}

	@Override
	public DTh setHtmlNoWrap(final String noWrap) {
		super.setHtmlNoWrap(noWrap) ;
		return this ;
	}	
	@Override
	public DTh setHtmlNoWrap(final boolean noWrap) {
		super.setHtmlNoWrap(noWrap) ;
		return this ;
	}

	@Override
	public DTh setHtmlRowSpan(final String rowspan) {
		super.setHtmlRowSpan(rowspan) ;
		return this ;
	}	
	@Override
	public DTh setHtmlRowSpan(final int rowspan) {
		super.setHtmlRowSpan(rowspan) ;
		return this ;
	}

	@Override
	public DTh setHtmlScope(final String scope) {
	 ...
	 */
	@Override
	public DTh setHtmlValign(final String valign) {
	 ...
	 */
	@Override
	public DTh setHtmlWidth(final String width) {
	 ...
	 */	
	@Override
	public DTh setHtmlWidth(final int width) {
		super.setHtmlWidth(width) ;
		return this ;
	}
	...
	// Helper
	//
	public DTh setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DTh add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DTh add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTh add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTh addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTh dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DTh dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DTh setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DTh setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DTh setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DTh setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DTh setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DTh setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DTh setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DTh setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DTh setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DTh setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTh setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DTh setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DTh setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DTh setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTh setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DTh setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DTh setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DTh setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DTh setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DTh setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DTh setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DTh setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DTh setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DTh setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTh setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DTh setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DTh setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DTh setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DTh setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DTh setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DTh setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DTh setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DTh setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DTh setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DTh setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DTh setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DTh setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DTh setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DTh setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DTh setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DTh setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DTh setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DTh setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DTh setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DTh setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DTh setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DTh add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DTh addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTh addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DTh addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DTh jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DTh _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DTh _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DTh _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DTh _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DTh _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DTh _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DTh _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DTh _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DTh _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DTh _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DTh _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DTh _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DTh _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DTh _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DTh _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DTh _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DTh _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DTh _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DTh _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DTh _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DTh _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DTh _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DTh _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DTh _buttonText_(final String textValue) {
	...
	public DTh _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DTh _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DTh _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DTh _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DTh _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DTh _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DTh _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DTh _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DTh _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DTh _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DTh _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DTh _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DTh _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DTh _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DTh _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DTh _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DTh _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DTh _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DTh _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DTh _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DTh _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DTh _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DTh _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DTh _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DTh _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DTh _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DTh _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DTh _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DTh _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DTh _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DTh _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DTh _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DTh _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DTh _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DTh _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DTh _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DTh _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DTh _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DTh _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DTh _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DTh _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DTh _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DTh _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DTh _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DTh _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DTh _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DTh _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DTh _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DTh _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DTh _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DTh _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DTh _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DTh _labelText_(final String textValue) {
	...
	public DTh _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DTh _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DTh _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DTh _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DTh _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DTh _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DTh _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DTh _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DTh _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DTh _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DTh _meter_(final String min, final String max, final String value) {
	...
	public DTh _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DTh _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DTh _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DTh _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DTh _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DTh _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DTh _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DTh _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DTh _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DTh _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DTh _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DTh _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DTh _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DTh _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DTh _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DTh _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DTh _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DTh _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DTh _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DTh _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DTh _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DTh _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DTh _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DTh _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DTh _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DTh _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DTh _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DTh _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DTh _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DTh _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DTh _scriptText_(final String text, final String type) {
	...
	public DTh _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DTh _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DTh _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DTh _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DTh _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DTh _smallText_(final String textValue) {
	...
	public DTh _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DTh _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DTh _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DTh _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DTh _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DTh _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DTh _strongText_(final String textValue) {
	...
	public DTh _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DTh _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DTh _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DTh _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DTh _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DTh _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DTh _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DTh _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DTh _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DTh _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DTh _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DTh _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DTh _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DTh _timeDateTime_(final String dateTime) {
	...
	public DTh _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DTh _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DTh _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DTh _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DTh _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DTh _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DTh _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DTh _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DTh _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
