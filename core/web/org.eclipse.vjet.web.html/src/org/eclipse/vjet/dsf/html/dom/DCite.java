...
* </pre>
*/
public class DCite extends BaseAttrsHtmlElement
	/* implements IDPhrase, IDStrict, IAttrs */
{
	...
	//
	public DCite() {
		super(HtmlTypeEnum.CITE);
	}

	public DCite(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.CITE);
	}
	
//	public DCite(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	 ...
	 * created.
	 */
	public DCite(final String textValue) {
		this() ;
		setHtmlExtTextValue(textValue) ;
	}
	
	public DCite(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.CITE ;
	}
			
	//
	// Extensions
	//
	public DCite setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DCite add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DCite add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCite add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCite addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCite dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DCite dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DCite setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DCite setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DCite setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DCite setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DCite setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DCite setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DCite setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DCite setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DCite setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DCite setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCite setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DCite setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DCite setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DCite setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCite setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DCite setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DCite setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DCite setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DCite setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DCite setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DCite setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DCite setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DCite setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DCite setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCite setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DCite setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DCite setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DCite setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DCite setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DCite setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DCite setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DCite setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DCite setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DCite setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DCite setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DCite setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DCite setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DCite setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DCite setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DCite setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DCite setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DCite setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DCite setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DCite setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DCite setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DCite setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DCite add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DCite addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCite addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DCite addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DCite jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DCite _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DCite _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DCite _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DCite _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DCite _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DCite _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DCite _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DCite _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DCite _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DCite _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DCite _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DCite _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DCite _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DCite _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DCite _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DCite _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DCite _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DCite _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DCite _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DCite _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DCite _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DCite _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DCite _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DCite _buttonText_(final String textValue) {
	...
	public DCite _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DCite _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DCite _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DCite _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DCite _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DCite _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DCite _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DCite _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DCite _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DCite _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DCite _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DCite _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DCite _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DCite _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DCite _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DCite _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DCite _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DCite _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DCite _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DCite _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DCite _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DCite _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DCite _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DCite _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DCite _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DCite _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DCite _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DCite _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DCite _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DCite _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DCite _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DCite _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DCite _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DCite _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DCite _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DCite _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DCite _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DCite _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DCite _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DCite _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DCite _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DCite _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DCite _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DCite _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DCite _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DCite _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DCite _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DCite _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DCite _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DCite _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DCite _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DCite _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DCite _labelText_(final String textValue) {
	...
	public DCite _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DCite _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DCite _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DCite _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DCite _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DCite _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DCite _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DCite _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DCite _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DCite _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DCite _meter_(final String min, final String max, final String value) {
	...
	public DCite _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DCite _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DCite _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DCite _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DCite _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DCite _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DCite _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DCite _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DCite _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DCite _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DCite _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DCite _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DCite _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DCite _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DCite _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DCite _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DCite _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DCite _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DCite _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DCite _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DCite _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DCite _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DCite _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DCite _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DCite _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DCite _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DCite _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DCite _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DCite _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DCite _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DCite _scriptText_(final String text, final String type) {
	...
	public DCite _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DCite _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DCite _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DCite _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DCite _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DCite _smallText_(final String textValue) {
	...
	public DCite _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DCite _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DCite _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DCite _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DCite _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DCite _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DCite _strongText_(final String textValue) {
	...
	public DCite _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DCite _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DCite _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DCite _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DCite _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DCite _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DCite _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DCite _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DCite _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DCite _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DCite _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DCite _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DCite _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DCite _timeDateTime_(final String dateTime) {
	...
	public DCite _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DCite _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DCite _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DCite _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DCite _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DCite _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DCite _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DCite _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DCite _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
