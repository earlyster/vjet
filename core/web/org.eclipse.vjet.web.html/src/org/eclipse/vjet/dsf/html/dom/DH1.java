...
* </pre>
*/
public class DH1 extends BaseHeading 
	/* implements IAttrs, // HTML 5.0 // IHeadingContent */
{
	...
	//
	public DH1() {
		super(HtmlTypeEnum.H1);
	}

	public DH1(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.H1);
	}
	
//	public DH1(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	 ...
	 */
	public DH1(final String textValue) {
		this() ;
		setHtmlExtTextValue(textValue) ;
	}
	
	public DH1(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	 ...
	 */
	public DH1 setHtmlAlign(final String align) {
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.H1 ;
	}
			
	//
	// Extensions
	//
	public DH1 setHtmlExtTextValue(final String value) {
	...
	@Override
	public DH1 jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DH1 add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DH1 add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DH1 add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DH1 addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DH1 dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DH1 dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DH1 setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DH1 setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DH1 setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DH1 setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DH1 setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DH1 setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DH1 setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DH1 setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DH1 setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DH1 setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DH1 setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DH1 setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DH1 setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DH1 setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DH1 setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DH1 setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DH1 setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DH1 setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DH1 setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DH1 setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DH1 setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DH1 setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DH1 setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DH1 setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DH1 setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DH1 setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DH1 setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DH1 setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DH1 setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DH1 setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DH1 setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DH1 setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DH1 setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DH1 setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DH1 setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DH1 setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DH1 setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DH1 setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DH1 setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DH1 setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DH1 setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DH1 setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DH1 setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DH1 setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DH1 add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DH1 addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DH1 addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DH1 addHtmlClassName(final CssClassConstant ccc) {
	...
	public DH1 _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DH1 _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DH1 _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DH1 _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DH1 _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DH1 _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DH1 _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DH1 _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DH1 _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DH1 _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DH1 _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DH1 _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DH1 _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DH1 _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DH1 _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DH1 _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DH1 _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DH1 _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DH1 _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DH1 _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DH1 _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DH1 _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DH1 _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DH1 _buttonText_(final String textValue) {
	...
	public DH1 _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DH1 _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DH1 _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DH1 _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DH1 _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DH1 _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DH1 _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DH1 _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DH1 _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DH1 _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DH1 _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DH1 _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DH1 _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DH1 _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DH1 _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DH1 _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DH1 _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DH1 _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DH1 _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DH1 _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DH1 _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DH1 _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DH1 _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DH1 _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DH1 _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DH1 _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DH1 _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DH1 _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DH1 _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DH1 _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DH1 _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DH1 _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DH1 _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DH1 _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DH1 _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DH1 _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DH1 _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DH1 _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DH1 _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DH1 _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DH1 _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DH1 _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DH1 _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DH1 _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DH1 _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DH1 _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DH1 _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DH1 _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DH1 _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DH1 _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DH1 _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DH1 _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DH1 _labelText_(final String textValue) {
	...
	public DH1 _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DH1 _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DH1 _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DH1 _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DH1 _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DH1 _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DH1 _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DH1 _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DH1 _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DH1 _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DH1 _meter_(final String min, final String max, final String value) {
	...
	public DH1 _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DH1 _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DH1 _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DH1 _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DH1 _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DH1 _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DH1 _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DH1 _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DH1 _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DH1 _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DH1 _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DH1 _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DH1 _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DH1 _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DH1 _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DH1 _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DH1 _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DH1 _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DH1 _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DH1 _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DH1 _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DH1 _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DH1 _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DH1 _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DH1 _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DH1 _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DH1 _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DH1 _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DH1 _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DH1 _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DH1 _scriptText_(final String text, final String type) {
	...
	public DH1 _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DH1 _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DH1 _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DH1 _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DH1 _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DH1 _smallText_(final String textValue) {
	...
	public DH1 _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DH1 _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DH1 _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DH1 _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DH1 _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DH1 _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DH1 _strongText_(final String textValue) {
	...
	public DH1 _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DH1 _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DH1 _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DH1 _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DH1 _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DH1 _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DH1 _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DH1 _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DH1 _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DH1 _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DH1 _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DH1 _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DH1 _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DH1 _timeDateTime_(final String dateTime) {
	...
	public DH1 _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DH1 _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DH1 _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DH1 _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DH1 _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DH1 _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DH1 _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DH1 _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DH1 _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
