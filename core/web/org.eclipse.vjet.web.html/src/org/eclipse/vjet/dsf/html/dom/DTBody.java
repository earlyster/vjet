...
*/
public class DTBody extends BaseTableSection { //implements IDTransitional, IAttrs {
	...
	//
	public DTBody() {
		super(HtmlTypeEnum.TBODY);
	}
	
	public DTBody(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.TBODY);
	}
	
	public DTBody(final String jif) {
		this() ;
		jif(jif) ;
	}

	public DTBody(DTr... elems) {
		this() ;
		add(elems) ;
	}
	
	//
	// Overrides from BaseTableSection
	//
	/**
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */
	@Override
	public DTBody setHtmlAlign(final String align) {
	 ...
	 */
	@Override
	public DTBody setHtmlCh(final String _char) {
	 ...
	 */	
	@Override
	public DTBody setHtmlChOff(final String charoff) {
	 ...
	 */
	@Override
	public DTBody setHtmlValign(final String valign) {
	 ...
	 */
	@Override
	public DTBody add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	public DTBody add(DTr... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTBody add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTBody addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTBody dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DTBody dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DTBody setDsfRelationshipVerifier(
	...
	@Override
	public DTBody cloned() {
		return (DTBody)super.cloned() ;
	}
     ...
     */
    @Override
    public DTBody setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DTBody setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DTBody setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DTBody setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DTBody setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DTBody setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DTBody setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DTBody setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DTBody setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTBody setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DTBody setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DTBody setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DTBody setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTBody setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DTBody setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DTBody setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DTBody setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DTBody setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DTBody setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DTBody setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DTBody setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DTBody setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DTBody setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTBody setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DTBody setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DTBody setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DTBody setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DTBody setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DTBody setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DTBody setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DTBody setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DTBody setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DTBody setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DTBody setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DTBody setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DTBody setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DTBody setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DTBody setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DTBody setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DTBody setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DTBody setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DTBody setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DTBody setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DTBody add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DTBody addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTBody addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DTBody addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DTBody jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
