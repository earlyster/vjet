	...
	implements IDBlock /*, IDStrict, IAttrs */
{
	...
	// For use with target.  Target will also accept a user defined name
	/** "_blank" */
	...
	//
	public DForm() {
		super(HtmlTypeEnum.FORM);
	}

	public DForm(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.FORM);
	}
	
	public DForm(final String jif) {
		this() ;
		jif(jif) ;
	}
	
	public DForm(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	 ...
	 */
	public DHtmlCollection getHtmlElements() {
		if (m_elements == null) {
			m_elements = new DHtmlCollection(this, DHtmlCollection.ELEMENT);
		}
		return m_elements;
	}

	public int getHtmlLength() {
		return getHtmlElements().getLength();
	}

	public String getHtmlName() {
		return getHtmlAttribute(EHtmlAttr.name);
	}
	public DForm setHtmlName(final String name) {
		setHtmlAttribute(EHtmlAttr.name, name);
		return this ;
	}

	public String getHtmlAcceptCharset() {
		return getHtmlAttribute(EHtmlAttr.accept_charset);
	}
	public DForm setHtmlAcceptCharset(final String acceptCharset) {
		setHtmlAttribute(EHtmlAttr.accept_charset, acceptCharset);
		return this ;
	}

	public String getHtmlAction() {
		return getHtmlAttribute(EHtmlAttr.action);
	}
	public DForm setHtmlAction(final String action) {
		setHtmlAttribute(EHtmlAttr.action, action);
		return this ;
	}
	public DForm setHtmlAction(final IValueBinding binding) {
		getDsfAttributes().setValueBinding(ATTR_ACTION, binding);
		return this ;
	}

	public String getHtmlEnctype() {
		return getHtmlAttribute(EHtmlAttr.enctype);
	}

	/**
	 * @see See http://www.iana.org/assignments/media-types
	 */
	public DForm setHtmlEnctype(final String enctype) {
		setHtmlAttribute(EHtmlAttr.enctype, enctype);
		return this ;
	}

	public String getHtmlMethod() {
		return capitalize(getHtmlAttribute(EHtmlAttr.method));
	}

	public DForm setHtmlMethod(final String method) {
		setHtmlAttribute(EHtmlAttr.method, method);
		return this ;
	}
	...
	public DForm setHtmlTarget(final String target) {
	 ...
	 * during submission.
	 */
	public boolean getHtmlNoValidate() {	// HTML 5.0
		return getHtmlAttributeExists(EHtmlAttr.novalidate);
	}
	public DForm setHtmlNoValidate(final String novalidate) {  // HTML 5.0
		return setHtmlNoValidate(toBoolean("novalidate", novalidate)) ;
	}
	public DForm setHtmlNoValidate(final boolean novalidate) {  // HTML 5.0
		setHtmlAttribute(EHtmlAttr.novalidate, novalidate);
		return this ;
	}
	...
	// HTML Events
	//
	public String getHtmlOnReset() {
		return getHtmlAttribute(EHtmlAttr.onreset);
	}
	public DForm setHtmlOnReset(final String script) {
		super.setInlineEvent(EHtmlAttr.onreset, script, EventType.RESET);
		return this ;
	}
	...
	public String toString() {
		...
		Z.fmt("accept-charset", getHtmlAcceptCharset()) + 
		Z.fmt("action", getHtmlAction()) +
		Z.fmt("enctype", getHtmlEnctype()) +
		Z.fmt("length", "" + getHtmlLength()) +
		Z.fmt("method", getHtmlMethod()) +
		Z.fmt("name", getHtmlName()) +
		Z.fmt("target", getHtmlTarget()) +
		Z.fmt("novalidate", getHtmlNoValidate()) ;	
	}
		
	@Override
	public Object clone() throws CloneNotSupportedException {
		DForm clonedNode = (DForm) super.clone();
		clonedNode.m_elements = null;
		return clonedNode;
	}
	 ...
	 */
	@Override
	public DForm add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DForm add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DForm add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DForm addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DForm dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DForm dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DForm setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DForm setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DForm setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DForm setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DForm setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DForm setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DForm setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DForm setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DForm setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DForm setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DForm setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DForm setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DForm setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DForm setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DForm setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DForm setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DForm setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DForm setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DForm setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DForm setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DForm setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DForm setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DForm setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DForm setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DForm setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DForm setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DForm setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DForm setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DForm setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DForm setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DForm setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DForm setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DForm setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DForm setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DForm setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DForm setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DForm setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DForm setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DForm setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DForm setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DForm setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DForm setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DForm setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DForm setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DForm setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DForm setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DForm add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DForm addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DForm addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DForm addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DForm jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DForm _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DForm _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DForm _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DForm _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DForm _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DForm _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DForm _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DForm _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DForm _address_(final int count) {
		 _address(count) ;
		 return this ;
	}
	...
	public DForm _address_(final String jif) {
		_address(jif) ;
		return this ;
	}
	...
	public DForm _address_(BaseHtmlElement... elements) {
		_address(elements) ;
		return this ;
	}
	...
	public DForm _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DForm _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DForm _article_(final int count) {
		_article(count) ;
		return this ;
	}
	...
	public DForm _article_(final String jif) {
		_article(jif) ;
		return this ;
	}
	...
	public DForm _articleText_(final String textValue) {
	...
	public DForm _article_(BaseHtmlElement... elements) {
		_article(elements) ;
		return this ;
	}
	...
	public DForm _aside_(final int count) {
		 _aside(count) ;
		 return this ;
	}
	...
	public DForm _aside_(final String jif) {
		_aside(jif) ;
		return this ;
	}
	...
	public DForm _asideText_(final String textValue) {
	...
	public DForm _aside_(BaseHtmlElement... elements) {
		_aside(elements) ;
		return this ;
	}
	...
	public DForm _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DForm _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DForm _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DForm _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DForm _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DForm _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DForm _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DForm _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DForm _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DForm _blockquote_(final int count) {
		_blockquote(count) ;
		return this ;
	}
	...
	public DForm _blockquote_(final String jif) {
		_blockquote(jif) ;
		return this ;
	}
	...
	public DForm _blockquoteText_(final String textValue) {
	...
	public DForm _blockquote_(BaseHtmlElement... elements) {
	...
	public DForm _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DForm _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DForm _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DForm _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DForm _buttonText_(final String textValue) {
	...
	public DForm _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DForm _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DForm _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DForm _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DForm _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DForm _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DForm _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DForm _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DForm _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DForm _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DForm _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DForm _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DForm _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DForm _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DForm _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DForm _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DForm _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DForm _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DForm _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DForm _details_(final int count) {
		_details(count) ;
		return this ;
	}
	...
	public DForm _details_(final String jif) {
		_details(jif) ;
		return this ;
	}
	...
	public DForm _details_(BaseHtmlElement... elements) {
		_details(elements) ;
		return this ;
	}
	...
	public DForm _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DForm _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DForm _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DForm _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DForm _div_(final int count) {
		_div(count) ;
		return this ;
	}
	...
	public DForm _div_(final String jif) {
		_div(jif) ;
		return this ;
	}
	...
	public DForm _div_(BaseHtmlElement... elements) {
		_div(elements) ;
		return this ;
	}
	...
	public DForm _dl_(final int count) {
		_dl(count) ;
		return this ;
	}
	...
	public DForm _dl_(final String jif) {
		_dl().jif(jif) ;
		return this ;
	}
	...
	public DForm _dl_(BaseHtmlElement... elements) {
		_dl(elements) ;
		return this ;
	}
	...
	public DForm _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DForm _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DForm _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DForm _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DForm _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DForm _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DForm _fieldset_(final int count) {
		_fieldset(count) ;
		return this ;
	}
	...
	public DForm _fieldset_(final String jif) {
		_fieldset(jif) ;
		return this ;
	}
	...
	public DForm _fieldsetLegend_(final String legend) {
	...
	public DForm _fieldset_(BaseHtmlElement... elements) {
		_fieldset(elements) ;
		return this ;
	}
	...
	public DForm _figure_(final int count) {
		_figure(count) ;
		return this ;
	}
	...
	public DForm _figure_(final String jif) {
		_figure(jif) ;
		return this ;
	}
	...
	public DForm _figure_(BaseHtmlElement... elements) {
		_figure(elements) ;
		return this ;
	}
	...
	public DForm _footer_(final int count) {
		_footer(count) ;
		return this ;
	}
	...
	public DForm _footer_(final String jif) {
		_footer(jif) ;
		return this ;
	}
	...
	public DForm _footerText_(final String textValue) {
	...
	public DForm _footer_(BaseHtmlElement... elements) {
		_footer(elements) ;
		return this ;
	}
	...
	public DForm _form_(final int count) {
		_form(count) ;
		return this ;
	}
	...
	public DForm _form_(final String jif) {
		_form(jif) ;
		return this ;
	}
	...
	public DForm _form_(BaseHtmlElement... elements) {
		_form(elements) ;
		return this ;
	}
	...
	public DForm _h1_(final int count) {
		_h1(count);
		return this ;
	}
	...
	public DForm _h1_(final String jif) {
		_h1(jif) ;
		return this ;
	}
	...
	public DForm _h1Text_(final String textValue) {
		_h1Text(textValue) ;
		return this ;
	}
	...
	public DForm _h1_(BaseHtmlElement... elements) {
		_h1(elements) ;
		return this ;
	}
	...
	public DForm _h2_(final int count) {
		_h2(count);
		return this ;
	}
	...
	public DForm _h2_(final String jif) {
		_h2(jif) ;
		return this ;
	}
	...
	public DForm _h2Text_(final String textValue) {
		_h2Text(textValue) ;
		return this ;
	}
	...
	public DForm _h2_(BaseHtmlElement... elements) {
		_h2(elements) ;
		return this ;
	}
	...
	public DForm _h3_(final int count) {
		_h3(count);
		return this ;
	}
	...
	public DForm _h3_(final String jif) {
		_h3(jif) ;
		return this ;
	}
	...
	public DForm _h3Text_(final String textValue) {
		_h3Text(textValue) ;
		return this ;
	}
	...
	public DForm _h3_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DForm _h4_(final int count) {
		_h4(count);
		return this ;
	}
	...
	public DForm _h4_(final String jif) {
		_h4(jif) ;
		return this ;
	}
	...
	public DForm _h4Text_(final String textValue) {
		_h4Text(textValue) ;
		return this ;
	}
	...
	public DForm _h4_(BaseHtmlElement... elements) {
		_h4(elements) ;
		return this ;
	}
	...
	public DForm _h5_(final int count) {
		_h5(count);
		return this ;
	}
	...
	public DForm _h5_(final String jif) {
		_h5(jif) ;
		return this ;
	}
	...
	public DForm _h5Text_(final String textValue) {
		_h5Text(textValue) ;
		return this ;
	}
	...
	public DForm _h5_(BaseHtmlElement... elements) {
		_h5(elements) ;
		return this ;
	}
	...
	public DForm _h6_(final int count) {
		_h6(count);
		return this ;
	}
	...
	public DForm _h6_(final String jif) {
		_h6(jif) ;
		return this ;
	}
	...
	public DForm _h6Text_(final String textValue) {
		_h6Text(textValue) ;
		return this ;
	}
	...
	public DForm _h6_(BaseHtmlElement... elements) {
		_h6(elements) ;
		return this ;
	}
	...
	public DForm _header_(final int count) {
		_header(count) ;
		return this ;
	}
	...
	public DForm _header_(final String jif) {
		_header(jif) ;
		return this ;
	}
	...
	public DForm _header_(BaseHtmlElement... elements) {
		_header(elements) ;
		return this ;
	}
	...
	public DForm _hgroup_(final int count) {
		_hgroup(count) ;
		return this ;
	}
	...
	public DForm _hgroup_(final String jif) {
		_hgroup(jif) ;
		return this ;
	}
	...
	public DForm _hgroup_(BaseHtmlElement... elements) {
		_hgroup(elements) ;
		return this ;
	}
	...
	public DForm _hr_(final int count) {
		_hr(count) ;
		return this ;
	}
	...
	public DForm _hr_(final String jif) {
		_hr(jif) ;
		return this ;
	}
	...
	public DForm _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DForm _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DForm _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DForm _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DForm _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DForm _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DForm _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DForm _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DForm _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DForm _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DForm _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DForm _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DForm _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DForm _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DForm _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DForm _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DForm _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DForm _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DForm _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DForm _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DForm _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DForm _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DForm _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DForm _labelText_(final String textValue) {
	...
	public DForm _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DForm _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DForm _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DForm _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DForm _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DForm _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DForm _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
	...
	public DForm _menu_(final int count) {
		_menu(count) ;
		return this ;
	}
	...
	public DForm _menu_(final String jif) {
		_menu(jif) ;
		return this ;
	}
	...
	public DForm _menu_(BaseHtmlElement... elements) {
		_menu(elements) ;
		return this ;
	}
	...
	public DForm _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DForm _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DForm _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
...
value) {
	...
	public DForm _meter_(final String min, final String max, final String value) 

{
	...
	public DForm _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
...
value) {
	...
	public DForm _meter_(final double min, final double max, final double value) 

{
	...
	public DForm _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DForm _nav_(final int count) {
		_nav(count) ;
		return this ;
	}
	...
	public DForm _nav_(final String jif) {
		_nav(jif) ;
		return this ;
	}
	...
	public DForm _nav_(BaseHtmlElement... elements) {
		_nav(elements) ;
		return this ;
	}
	...
	public DForm _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DForm _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DForm _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DForm _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DForm _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DForm _ol_(final int count) {
		_ol(count) ;
		return this ;
	}
	...
	public DForm _ol_(final String jif) {
		_ol(jif) ;
		return this ;
	}
	...
	public DForm _ol_(final Collection<Object> collection) {
		_ol(collection) ;
		return this ;
	}
...

{
	...
	public DForm _ol_(final Collection<Object> collection, final String 
...
htmlType) {
	...
	public DForm _ol_(DLi... elements) {
		_ol(elements) ;
		return this ;
	}
	...
	public DForm _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DForm _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DForm _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DForm _p_(final int count) {
		_p(count) ;
		return this ;
	}
	...
	public DForm _p_(final String jif) {
		_p(jif) ;
		return this ;
	}
	...
	public DForm _pText_(final String textValue) {
		_pText(textValue) ;
		return this ;
	}
	...
	public DForm _p_(BaseHtmlElement... elements) {
		_p(elements) ;
		return this ;
	}
	...
	public DForm _pre_(final int count) {
		_pre(count) ;
		return this ;
	}
	...
	public DForm _pre_(final String jif) {
		_pre(jif) ;
		return this ;
	}
	...
	public DForm _preText_(final String textValue) {
		_preText(textValue) ;
		return this ;
	}
	...
	public DForm _pre_(BaseHtmlElement... elements) {
		_pre(elements) ;
		return this ;
	}
	...
	public DForm _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DForm _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DForm _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DForm _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DForm _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DForm _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DForm _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DForm _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DForm _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DForm _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DForm _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DForm _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DForm _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DForm _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DForm _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DForm _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DForm _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DForm _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DForm _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DForm _scriptText_(final String text, final String type) {
	...
	public DForm _section_(final int count) {
		_section(count) ;
		return this ;
	}
	...
	public DForm _section_(final String jif) {
		_section(jif) ;
		return this ;
	}
	...
	public DForm _section_(BaseHtmlElement... elements) {
		_section(elements) ;
		return this ;
	}
	...
	public DForm _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DForm _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DForm _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DForm _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DForm _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DForm _smallText_(final String textValue) {
	...
	public DForm _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DForm _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DForm _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DForm _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DForm _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DForm _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DForm _strongText_(final String textValue) {
	...
	public DForm _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DForm _style_(final int count) {
		_style(count) ;
		return this ;
	}
	...
	public DForm _style_(final String jif) {
		_style(jif) ;
		return this ;
	}
	...
	public DForm _styleText_(final String styleText) {
	...
	public DForm _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DForm _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DForm _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DForm _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DForm _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DForm _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DForm _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DForm _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
	...
	public DForm _table_(final int count) {
		_table(count);
		return this ;
	}
	...
	public DForm _table_(final String jif) {
		_table(jif) ;
		return this ;
	}
	...
	public DForm _table_(BaseHtmlElement... elements) {
		_table(elements) ;
		return this ;
	}
	...
	public DForm _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DForm _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DForm _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DForm _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DForm _timeDateTime_(final String dateTime) {
	...
	public DForm _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DForm _ul_(final int count) {
		_ul(count) ;
		return this ;
	}
	...
	public DForm _ul_(final Collection<Object> collection) {
		_ul(collection) ;
		return this ;
	}
...

{
	...
	public DForm _ul_(final Collection<Object> collection, final String 
...
htmlType) {
	...
	public DForm _ul_(DLi... elements) {
		_ul(elements) ;
		return this ;
	}
	...
	public DForm _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DForm _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DForm _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DForm _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DForm _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DForm _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DForm _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DForm _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
