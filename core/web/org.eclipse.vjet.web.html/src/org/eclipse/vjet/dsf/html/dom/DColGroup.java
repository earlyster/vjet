...
public class DColGroup extends DColBase
	/* implements IDTransitional, IAttrs */
{
	...
	//
	public DColGroup() {
		super(HtmlTypeEnum.COLGROUP);
	}
	
	public DColGroup(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.COLGROUP);
	}
	
	public DColGroup(final String jif) {
		this() ;
		jif(jif) ;
	}
	
	public DColGroup(DCol... elems) {
		this() ;
		add(elems) ;
	}
	 ...
	 */
	@Override
	public DColGroup setHtmlAlign(final String align) {
	...
	@Override
	public DColGroup setHtmlCh(final String _char) {
	...
	// purposefully did not use full name "char" to avoid confusion
	@Override
	public DColGroup setHtmlChOff(final String charoff) {
		super.setHtmlChOff(charoff) ;
		return this ;
	}

	@Override
	public DColGroup setHtmlSpan(final String span) {
		super.setHtmlSpan(span) ;
		return this ;
	}
	
	@Override
	public DColGroup setHtmlSpan(final int span) {
		super.setHtmlSpan(span) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DColGroup setHtmlValign(final String valign) {
	 ...
	 */
	@Override
	public DColGroup setHtmlWidth(final String width) {
	 ...
	 */	
	@Override
	public DColGroup setHtmlWidth(final int width) {
		super.setHtmlWidth(width) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DColGroup add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	public DColGroup add(DCol... elems) throws DOMException {
	 ...
	 */
	@Override
	public DColGroup add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DColGroup addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DColGroup dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DColGroup dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DColGroup setDsfRelationshipVerifier(
	...
	@Override
	public DColGroup cloned() {
		return (DColGroup)super.cloned() ;
	}
     ...
     */
    @Override
    public DColGroup setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DColGroup setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DColGroup setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DColGroup setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DColGroup setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DColGroup setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DColGroup setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DColGroup setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DColGroup setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DColGroup setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DColGroup setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DColGroup setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DColGroup setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DColGroup setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DColGroup setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DColGroup setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DColGroup setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DColGroup setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DColGroup setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DColGroup setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DColGroup setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DColGroup setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DColGroup setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DColGroup setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DColGroup setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DColGroup setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DColGroup setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DColGroup setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DColGroup setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DColGroup setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DColGroup setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DColGroup setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DColGroup setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DColGroup setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DColGroup setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DColGroup setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DColGroup setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DColGroup setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DColGroup setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DColGroup setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DColGroup setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DColGroup setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DColGroup setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DColGroup add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	
//	@Override
//	public DColGroup removeListener(
//		final EventType eventType, final IDomActiveListener listener)
//	{
...
//	}
	...
	//
	@Override
	public DColGroup addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DColGroup addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DColGroup addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DColGroup addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DColGroup jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DCol _col(final int count) {
		 return (DCol)getOrCreate(DCol.class, count) ;
	}
