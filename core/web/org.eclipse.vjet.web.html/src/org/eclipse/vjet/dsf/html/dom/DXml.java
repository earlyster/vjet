 ...
 * 
 */
public class DXml extends BaseAttrsHtmlElement /* implements IEventAttributes */{
	private static final long serialVersionUID = 1L;
	
	// Constructors
	public DXml() {
		super(HtmlTypeEnum.XML);
	}
	
	public DXml(final String src) { 
		this()  ; 
	...
	/**
	 * Returns the URL to be loaded by the object
	 */
	public String getHtmlSrc() { 
		return getHtmlAttribute(EHtmlAttr.src) ;
	}
	public DXml setHtmlSrc(final String src) { 
		setHtmlAttribute(EHtmlAttr.src, src) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DXml add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DXml add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DXml addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DXml dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DXml dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DXml setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DXml setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DXml setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DXml setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DXml setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DXml setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DXml setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DXml setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DXml setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DXml setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DXml setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DXml setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DXml setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DXml setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DXml setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DXml setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DXml setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DXml setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DXml setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DXml setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DXml setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DXml setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DXml setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DXml setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DXml setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DXml setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DXml setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DXml setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DXml setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DXml setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DXml setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DXml setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DXml setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DXml setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DXml setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DXml setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DXml setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DXml setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DXml setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DXml setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DXml setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DXml setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DXml setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DXml setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DXml setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DXml setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DXml add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DXml addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DXml addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DXml addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DXml jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}
