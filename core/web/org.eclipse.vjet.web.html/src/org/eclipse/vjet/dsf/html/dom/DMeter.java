...
/**
<a href='http://dev.w3.org/html5/spec/Overview.html#the-meter-element'>W3C meter</a>
<p>
 ...
 */
public class DMeter extends BaseHtml50Element {		
	...
	//
	public DMeter() {
		super(HtmlTypeEnum.METER);
	}
	
	public DMeter(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.METER);
	}
	
	public DMeter(final String jif) {
		this() ;
		jif(jif) ;
	}
	
//	public DMeter(final String className) {
//		this() ;
//		setHtmlClassName(className) ;
//	}
//	
//	public DMeter(final CssClassConstant ccc) {
//		this(ccc.getName()) ;
//	}
	
	public DMeter(final String min, final String max) {
		this() ;
		setHtmlMin(min) ;
		setHtmlMax(max) ;
	}
	public DMeter(final String min, final String max, final String value) {
		this(min, max) ;
		setHtmlValue(value) ;
	}
	public DMeter(final double min, final double max) {
		this() ;
		setHtmlMin(min) ;
		setHtmlMax(max) ;
	}
	public DMeter(final double min, final double max, final double value) {
		this(min, max) ;
		setHtmlValue(value) ;
	}
	
	public DMeter(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	//
	// high
	public String getHtmlHigh() {
		return getHtmlAttribute(EHtmlAttr.high);
	}
	public DMeter setHtmlHigh(final String high) {
		setHtmlAttribute(EHtmlAttr.high, high);
		return this ;
	}
	public DMeter setHtmlHigh(final double high) {
		setHtmlAttribute(EHtmlAttr.high, high);
		return this ;
	}
	
	// low
	public String getHtmlLow() {
		return getHtmlAttribute(EHtmlAttr.low);
	}
	public DMeter setHtmlLow(final String low) {
		setHtmlAttribute(EHtmlAttr.low, low);
		return this ;
	}
	public DMeter setHtmlLow(final double low) {
		setHtmlAttribute(EHtmlAttr.low, low);
		return this ;
	}
	...
	public DMeter setHtmlMax(final String max) {
		setHtmlAttribute(EHtmlAttr.max, max);
		return this ;
	}
	public DMeter setHtmlMax(final double max) {
		setHtmlAttribute(EHtmlAttr.max, max);
		return this ;
	}
	
	// low
	public String getHtmlMin() {
		return getHtmlAttribute(EHtmlAttr.min);
	}
	public DMeter setHtmlMin(final String min) {
		setHtmlAttribute(EHtmlAttr.min, min);
		return this ;
	}
	public DMeter setHtmlMin(final double min) {
		setHtmlAttribute(EHtmlAttr.min, min);
		return this ;
	}
	
	// optimum
	public String getHtmlOptimum() {
		return getHtmlAttribute(EHtmlAttr.optimum);
	}
	public DMeter setHtmlOptimum(final String optimum) {
		setHtmlAttribute(EHtmlAttr.optimum, optimum);
		return this ;
	}
	public DMeter setHtmlOptimum(final double optimum) {
		setHtmlAttribute(EHtmlAttr.optimum, optimum);
		return this ;
	}
	...
	public DMeter setHtmlValue(final String value) {
		setHtmlAttribute(EHtmlAttr.value, value);
		return this ;
	}
	public DMeter setHtmlValue(final double value) {
		setHtmlAttribute(EHtmlAttr.value, value);
		return this ;
	}	
	...
	public String toString() {
		return super.toString()
			+ Z.fmt(EHtmlAttr.high.getAttributeName(), "" + getHtmlHigh()) 
			+ Z.fmt(EHtmlAttr.low.getAttributeName(), "" + getHtmlLow())
			+ Z.fmt(EHtmlAttr.max.getAttributeName(), getHtmlMax())
			+ Z.fmt(EHtmlAttr.min.getAttributeName(), "" + getHtmlMin())
			+ Z.fmt(EHtmlAttr.optimum.getAttributeName(), getHtmlOptimum())
	 ...
	 */
	@Override
	public DMeter add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DMeter add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMeter add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMeter addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMeter dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DMeter dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DMeter setDsfRelationshipVerifier(
	...
	@Override
	public DMeter cloned() {
		return (DMeter)super.cloned() ;
	}
     ...
     */
    @Override
    public DMeter setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DMeter setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DMeter setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DMeter setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DMeter setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DMeter setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DMeter setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DMeter setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DMeter setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMeter setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DMeter setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DMeter setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DMeter setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMeter setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DMeter setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DMeter setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DMeter setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DMeter setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DMeter setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DMeter setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DMeter setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DMeter setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DMeter setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMeter setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DMeter setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DMeter setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DMeter setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DMeter setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DMeter setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DMeter setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DMeter setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DMeter setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DMeter setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DMeter setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DMeter setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DMeter setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DMeter setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DMeter setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DMeter setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DMeter setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DMeter setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DMeter setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DMeter setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DMeter add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DMeter addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMeter addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DMeter addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DMeter jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DMeter _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DMeter _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DMeter _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DMeter _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DMeter _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DMeter _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DMeter _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DMeter _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DMeter _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DMeter _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DMeter _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DMeter _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DMeter _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DMeter _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DMeter _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DMeter _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DMeter _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DMeter _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DMeter _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DMeter _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DMeter _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DMeter _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DMeter _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DMeter _buttonText_(final String textValue) {
	...
	public DMeter _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DMeter _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DMeter _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DMeter _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DMeter _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DMeter _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DMeter _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DMeter _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DMeter _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DMeter _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DMeter _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DMeter _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DMeter _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DMeter _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DMeter _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DMeter _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DMeter _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DMeter _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DMeter _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DMeter _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DMeter _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DMeter _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DMeter _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DMeter _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DMeter _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DMeter _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DMeter _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DMeter _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DMeter _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DMeter _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DMeter _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DMeter _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DMeter _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DMeter _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DMeter _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DMeter _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DMeter _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DMeter _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DMeter _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DMeter _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DMeter _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DMeter _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DMeter _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DMeter _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DMeter _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DMeter _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DMeter _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DMeter _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DMeter _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DMeter _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DMeter _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DMeter _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DMeter _labelText_(final String textValue) {
	...
	public DMeter _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DMeter _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DMeter _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DMeter _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DMeter _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DMeter _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DMeter _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DMeter _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DMeter _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DMeter _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DMeter _meter_(final String min, final String max, final String value) {
	...
	public DMeter _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DMeter _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DMeter _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DMeter _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DMeter _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DMeter _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DMeter _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DMeter _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DMeter _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DMeter _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DMeter _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DMeter _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DMeter _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DMeter _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DMeter _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DMeter _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DMeter _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DMeter _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DMeter _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DMeter _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DMeter _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DMeter _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DMeter _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DMeter _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DMeter _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DMeter _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DMeter _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DMeter _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DMeter _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DMeter _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DMeter _scriptText_(final String text, final String type) {
	...
	public DMeter _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DMeter _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DMeter _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DMeter _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DMeter _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DMeter _smallText_(final String textValue) {
	...
	public DMeter _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DMeter _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DMeter _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DMeter _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DMeter _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DMeter _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DMeter _strongText_(final String textValue) {
	...
	public DMeter _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DMeter _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DMeter _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DMeter _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DMeter _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DMeter _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DMeter _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DMeter _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DMeter _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DMeter _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DMeter _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DMeter _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DMeter _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DMeter _timeDateTime_(final String dateTime) {
	...
	public DMeter _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DMeter _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DMeter _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DMeter _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DMeter _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DMeter _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DMeter _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DMeter _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DMeter _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
