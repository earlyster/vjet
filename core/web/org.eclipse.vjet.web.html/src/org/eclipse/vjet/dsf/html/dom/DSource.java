...
/**
<a href='http://dev.w3.org/html5/spec/Overview.html#the-section-element'>W3C source</a>
<p>
...
valid URL. This attribute must be present.
<p>
The type attribute gives the type of the media resource, to help the user agent 
determine if it can play this media resource before fetching it. If specified, 
its value must be a MIME type. The codecs parameter may be specified and might 
be necessary to specify exactly how the resource is encoded. [RFC2046] [RFC4281]
<p>
Simple baseline profile video (main and extended video compatible) level 3 and 
Low-Complexity AAC audio in MP4 container
<p>
    <source src='video.mp4' type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'>
 */
public class DSource extends BaseHtml50Element {
	...
	//
	public DSource() {
		super(HtmlTypeEnum.SOURCE);
	}
	
	public DSource(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.SOURCE);
	}
	
//	public DSource(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	
	public DSource(final String srcUrl) {
		this() ;
		setHtmlSrc(srcUrl) ;
	}
	
	public DSource(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public DSource setHtmlMedia(final String mediaQuery) {
		setHtmlAttribute(EHtmlAttr.media, mediaQuery) ;
		return this ;
	}
	...
	public DSource setHtmlSrc(final String srcUrl) {
	...
	public DSource setHtmlType(final String type) {
	 ...
	 */
	@Override
	public DSource add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DSource add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSource add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSource addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSource dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DSource dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DSource setDsfRelationshipVerifier(
	...
	@Override
	public DSource cloned() {
		return (DSource)super.cloned() ;
	}
     ...
     */
    @Override
    public DSource setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DSource setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DSource setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DSource setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DSource setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DSource setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DSource setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DSource setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DSource setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSource setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DSource setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DSource setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DSource setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSource setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DSource setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DSource setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DSource setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DSource setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DSource setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DSource setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DSource setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DSource setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DSource setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSource setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DSource setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DSource setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DSource setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DSource setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DSource setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DSource setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DSource setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DSource setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DSource setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DSource setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DSource setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DSource setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DSource setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DSource setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DSource setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DSource setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DSource setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DSource setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DSource setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DSource setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DSource setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DSource add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	//
	@Override
	public DSource addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DSource addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSource addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DSource addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DSource jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
