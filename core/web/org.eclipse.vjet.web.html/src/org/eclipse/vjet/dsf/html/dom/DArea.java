...
/**
* http://www.w3.org/TR/REC-html40/struct/objects.html#edef-AREA
*/
public class DArea extends BaseAttrsHtmlElement
	/*implements IDTransitional, IAttrs*/
{
	...
	//
	public DArea() {
		super(HtmlTypeEnum.AREA);
	}
	
	public DArea(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.AREA);
	}
	
	public DArea(final String jif) {
		this() ;
		jif(jif) ;
	}
	...
	public DArea setHtmlAlt(final String alt) {
	...
	public DArea setHtmlCoords(final String coords) {
		setHtmlAttribute(EHtmlAttr.coords, coords);
		return this ;
	}
	...
	public DArea setHtmlName(final String name) {
	 ...
	 */
	public DArea setHtmlHref(final String href) {
	 ...
	 * @deprecated - Not supported in HTML 5.0
	 */
	public boolean getHtmlNoHref() {
		return getHtmlAttributeExists(EHtmlAttr.nohref);
	}
	public DArea setHtmlNoHref(final String nohref) {
		return setHtmlNoHref(toBoolean("nohref", nohref)) ;
	}	
	public DArea setHtmlNoHref(final boolean noHref) {
	...
	public DArea setHtmlShape(final String shape) {
	...
	public DArea setHtmlTarget(final String target) {
	...
	public DArea setHtmlMedia(final String media) {	// HTML 5.0
	...
	public DArea setHtmlPing(final String ping) {	// HTML 5.0
		setHtmlAttribute(EHtmlAttr.ping, ping);
		return this ;
	}
	
	public String getHtmlHreflang() {  // HTML 5.0
		return getHtmlAttribute(EHtmlAttr.lang);
	}
	public DArea setHtmlHreflang(final String hreflang) {  // HTML 5.0
		setHtmlAttribute(EHtmlAttr.hreflang, hreflang);
		return this ;
	}
	
	public String getHtmlRel() {  // HTML 5.0
		return getHtmlAttribute(EHtmlAttr.rel);
	}
	public DArea setHtmlRel(final String rel) {  // HTML 5.0
	 ...
	 */
	@Override
	public DArea add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DArea add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DArea addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DArea dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DArea dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DArea setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DArea setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DArea setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DArea setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DArea setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DArea setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DArea setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DArea setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DArea setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DArea setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DArea setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DArea setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DArea setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DArea setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DArea setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DArea setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DArea setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DArea setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DArea setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DArea setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DArea setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DArea setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DArea setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DArea setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DArea setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DArea setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DArea setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DArea setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DArea setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DArea setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DArea setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DArea setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DArea setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DArea setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DArea setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DArea setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DArea setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DArea setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DArea setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DArea setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DArea setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DArea setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DArea setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DArea setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DArea setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DArea setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DArea add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DArea addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DArea addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DArea addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DArea jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
