...
*/
public class DStyle extends BaseOrigNonAttrs //BaseI18nHtmlElement
//	implements IDRepeatableHeadElement, IDStrict, II18nAttributes, 
//		/* HTML 5.0 */ IMetadataContent
{
	...
	//
	public DStyle() {
		super(HtmlTypeEnum.STYLE);
	}

	public DStyle(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.STYLE);
	}
	
	public DStyle(final String jif) {
		this() ;
		jif(jif) ;
	}
	...
	public DStyle setHtmlDisabled(final String disabled) {
		return setHtmlDisabled(toBoolean("disabled", disabled)) ;
	}	
	public DStyle setHtmlDisabled(final boolean disabled) {
	...
	public DStyle setHtmlMedia(final String media) {
		setHtmlAttribute(EHtmlAttr.media, media);
		return this ;
	}

	/**
	 * Look at http://www.iana.org/assignments/media-types/ for the list
	 * of MIME types
	 * @return Answer the MIME type String such as "text/css"
	 */
	...
	/**
	 * Set the MIME type for this Style.  The type must not be null.
	 * 
	 * Look at http://www.iana.org/assignments/media-types/ for the list
	 * of MIME types
	 * 
	 ...
	 * @return
	 */
	public DStyle setHtmlType(final String type) {
		setHtmlAttribute(EHtmlAttr.type, type);
		return this ;
	}
	
	public String getStyleRules() {
		DText textNode = (DText)super.getFirstChild();
		if (textNode == null) {
			return null;
		}
	...
	public DStyle setStyleRules(final String text) {
		DText textNode = (DText)super.getFirstChild();
		if (textNode == null) {
			textNode = new DText(text);
			add(textNode);
		} 
		else {
	...
	public boolean getHtmlScoped() {	// HTML 5.0
		return getHtmlAttributeExists(EHtmlAttr.scoped);
	}
	public DStyle setHtmlScoped(final String scoped) {  // HTML 5.0
		return setHtmlScoped(toBoolean("scoped", scoped)) ;
	}	
	public DStyle setHtmlScoped(final boolean scoped) {  // HTML 5.0
		setHtmlAttribute(EHtmlAttr.scoped, scoped);
		return this ;
	}
	...
	public String toString() {
		...
		Z.fmt(EHtmlAttr.media.getAttributeName(), getHtmlMedia()) +
		Z.fmt(EHtmlAttr.type.getAttributeName(), "" + getHtmlType()) +
		Z.fmt(EHtmlAttr.disabled.getAttributeName(), getHtmlDisabled())	+
		Z.fmt(EHtmlAttr.scoped.getAttributeName(), getHtmlScoped()) ;
	}
	 ...
	 */
	@Override
	public DStyle add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DStyle add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DStyle addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DStyle dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DStyle dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DStyle setDsfRelationshipVerifier(
	...
	@Override
	public DStyle cloned() {
		return (DStyle)super.cloned() ;
	}
     ...
     */
    @Override
    public DStyle setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DStyle setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DStyle setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DStyle setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DStyle setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DStyle setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DStyle setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DStyle setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DStyle setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DStyle setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DStyle setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DStyle setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DStyle setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DStyle setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DStyle setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DStyle setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DStyle setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DStyle setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DStyle setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DStyle setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DStyle setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DStyle setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DStyle setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DStyle setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DStyle setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DStyle setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DStyle setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DStyle setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DStyle setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DStyle setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DStyle setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DStyle setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DStyle setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DStyle setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DStyle setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DStyle setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DStyle setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DStyle setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DStyle setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DStyle setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DStyle setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DStyle setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DStyle setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DStyle add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DStyle addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DStyle addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DStyle addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DStyle jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
