...
* </pre>
*/
public class DSpan extends BaseAttrsHtmlElement
//	implements IDSpecial, IDStrict, IAttrs
{
	...
	public DSpan() {
		super(HtmlTypeEnum.SPAN);
	}
	
	public DSpan(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.SPAN);
	}
	
//	public DSpan(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	
	public DSpan(final String className) {
		this() ;
		this.setHtmlClassName(className) ;
	}
	
	public DSpan(final CssClassConstant ccc) {
		this(ccc.getName()) ;
	}
	
	public DSpan(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.SPAN ;
	}
	
	//
	// HTML Attributes
	//
	//TODO: is align correct here?
	public String getHtmlAlign() {
		return capitalize(getHtmlAttribute(EHtmlAttr.align));
	}
	public DSpan setHtmlAlign(final String align) {
	 ...
	 */
	@Override
	public DSpan add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DSpan add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSpan add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSpan addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSpan dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DSpan dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DSpan setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DSpan setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DSpan setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DSpan setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DSpan setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DSpan setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DSpan setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DSpan setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DSpan setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DSpan setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSpan setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DSpan setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DSpan setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DSpan setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSpan setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DSpan setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DSpan setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DSpan setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DSpan setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DSpan setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DSpan setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DSpan setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DSpan setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DSpan setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSpan setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DSpan setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DSpan setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DSpan setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DSpan setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DSpan setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DSpan setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DSpan setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DSpan setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DSpan setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DSpan setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DSpan setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DSpan setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DSpan setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DSpan setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DSpan setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DSpan setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DSpan setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DSpan setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DSpan setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DSpan add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DSpan addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSpan addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DSpan addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DSpan jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DSpan _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DSpan _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DSpan _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DSpan _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DSpan _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DSpan _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DSpan _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DSpan _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DSpan _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DSpan _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DSpan _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DSpan _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DSpan _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DSpan _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DSpan _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DSpan _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DSpan _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DSpan _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DSpan _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DSpan _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DSpan _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DSpan _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DSpan _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DSpan _buttonText_(final String textValue) {
	...
	public DSpan _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DSpan _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DSpan _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DSpan _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DSpan _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DSpan _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DSpan _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DSpan _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DSpan _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DSpan _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DSpan _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DSpan _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DSpan _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DSpan _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DSpan _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DSpan _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DSpan _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DSpan _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DSpan _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DSpan _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DSpan _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DSpan _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DSpan _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DSpan _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DSpan _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DSpan _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DSpan _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DSpan _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DSpan _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DSpan _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DSpan _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DSpan _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DSpan _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DSpan _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DSpan _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DSpan _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DSpan _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DSpan _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DSpan _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DSpan _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DSpan _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DSpan _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DSpan _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DSpan _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DSpan _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DSpan _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DSpan _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DSpan _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DSpan _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DSpan _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DSpan _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DSpan _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DSpan _labelText_(final String textValue) {
	...
	public DSpan _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DSpan _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DSpan _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DSpan _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DSpan _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DSpan _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DSpan _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DSpan _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DSpan _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DSpan _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DSpan _meter_(final String min, final String max, final String value) {
	...
	public DSpan _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DSpan _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DSpan _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DSpan _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DSpan _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DSpan _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DSpan _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DSpan _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DSpan _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DSpan _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DSpan _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DSpan _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DSpan _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DSpan _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DSpan _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DSpan _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DSpan _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DSpan _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DSpan _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DSpan _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DSpan _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DSpan _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DSpan _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DSpan _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DSpan _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DSpan _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DSpan _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DSpan _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DSpan _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DSpan _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DSpan _scriptText_(final String text, final String type) {
	...
	public DSpan _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DSpan _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DSpan _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DSpan _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DSpan _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DSpan _smallText_(final String textValue) {
	...
	public DSpan _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DSpan _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DSpan _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DSpan _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DSpan _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DSpan _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DSpan _strongText_(final String textValue) {
	...
	public DSpan _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DSpan _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DSpan _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DSpan _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DSpan _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DSpan _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DSpan _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DSpan _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DSpan _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DSpan _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DSpan _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DSpan _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DSpan _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DSpan _timeDateTime_(final String dateTime) {
	...
	public DSpan _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DSpan _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DSpan _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DSpan _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DSpan _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DSpan _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DSpan _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DSpan _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DSpan _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
