...
public class DFrameSet extends BaseOrigNonAttrs //BaseCoreHtmlElement
//	implements IDTransitional, ICoreAttributes
{
	...
	//
	public DFrameSet() {
		super(null, HtmlTypeEnum.FRAMESET);
	}
	
	public DFrameSet(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.FRAMESET);
	}
	
	public DFrameSet(final String jif) {
		this() ;
		jif(jif) ;
	}
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.FRAMESET ;
	}
	
	//
	// HTML Attributes
	//	
	public String getHtmlCols() {
		return getHtmlAttribute(EHtmlAttr.cols);
	}
	public DFrameSet setHtmlCols(final String cols) {
		setHtmlAttribute(EHtmlAttr.cols, cols);
		return this ;
	}	
	public DFrameSet setHtmlCols(final int cols) {
		return setHtmlCols(String.valueOf(cols)) ;
	}

	public String getHtmlRows() {
		return getHtmlAttribute(EHtmlAttr.rows);
	}
	public DFrameSet setHtmlRows(final String rows) {
		setHtmlAttribute(EHtmlAttr.rows, rows);
		return this ;
	}	
	public DFrameSet setHtmlRows(final int rows) {
		return setHtmlRows(String.valueOf(rows)) ;
	}
	...
	public DFrameSet setHtmlOnUnload(final String script) {
		setHtmlAttribute(EHtmlAttr.onunload, script);
		return this ;
	}
	 ...
	 */
	@Override
	public DFrameSet add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFrameSet add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFrameSet addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFrameSet dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DFrameSet dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DFrameSet setDsfRelationshipVerifier(
	...
	@Override
	public DFrameSet cloned() {
		return (DFrameSet)super.cloned() ;
	}
     ...
     */
    @Override
    public DFrameSet setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DFrameSet setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DFrameSet setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DFrameSet setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFrameSet setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DFrameSet setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DFrameSet setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFrameSet setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DFrameSet setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DFrameSet setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFrameSet setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DFrameSet setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DFrameSet setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DFrameSet setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DFrameSet setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DFrameSet setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DFrameSet setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DFrameSet setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DFrameSet setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DFrameSet setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DFrameSet setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DFrameSet setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DFrameSet setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DFrameSet setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DFrameSet setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DFrameSet setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DFrameSet setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DFrameSet setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DFrameSet setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DFrameSet add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	
//	@Override
//	public DFrameSet removeListener(
//		final EventType eventType, final IDomActiveListener listener)
//	{
...
//	}
	...
	//
	@Override
	public DFrameSet addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DFrameSet addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFrameSet addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DFrameSet addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DFrameSet jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}
