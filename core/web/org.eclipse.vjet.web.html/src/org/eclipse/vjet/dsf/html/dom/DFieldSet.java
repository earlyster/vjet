...
* </pre>
*/
public class DFieldSet
	extends BaseAttrsHtmlElement
	implements IDFormControl, IDBlock /*, IDStrict, IAttrs */{
	...
	//
	public DFieldSet() {
		super(HtmlTypeEnum.FIELDSET);
	}
	
	public DFieldSet(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.FIELDSET);
	}
	
//	public DFieldSet(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	
	public DFieldSet(final String legend) {
		this() ;
		add(new DLegend(legend)) ;
	}
	
	public DFieldSet(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public DFieldSet setHtmlAlign(final String align) {
		setHtmlAttribute(EHtmlAttr.align, align);
		return this ;
	}
	
	public boolean getHtmlDisabled() {	// HTML 5.0
		return getHtmlAttributeExists(EHtmlAttr.disabled);
	}
	public DFieldSet setHtmlDisabled(final String disabled) {  // HTML 5.0
		return setHtmlDisabled(toBoolean("disabled", disabled)) ;
	}
	public DFieldSet setHtmlDisabled(final boolean disabled) {  // HTML 5.0
	...
	// Assembly helpers
	//
	public DLegend htmlExtAddLegend(final String legendString) {
		DLegend legend = htmlExtAddLegend();
		legend.add(legendString) ;
		return legend;	
	}
	
	public DLegend htmlExtAddLegend() {
		final DLegend legend = new DLegend() ;
		this.add(legend) ;
		return legend ;
	}
	 ...
	 */
	@Override
	public DFieldSet add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DFieldSet add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFieldSet add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFieldSet addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFieldSet dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DFieldSet dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DFieldSet setDsfRelationshipVerifier(
	...
	@Override
	public DFieldSet cloned() {
		return (DFieldSet)super.cloned() ;
	}
     ...
     */
    @Override
    public DFieldSet setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DFieldSet setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DFieldSet setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DFieldSet setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFieldSet setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DFieldSet setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DFieldSet setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFieldSet setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DFieldSet setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DFieldSet setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFieldSet setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DFieldSet setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DFieldSet setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DFieldSet setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DFieldSet setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DFieldSet setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DFieldSet setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DFieldSet setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DFieldSet setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DFieldSet setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DFieldSet setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DFieldSet setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DFieldSet setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DFieldSet setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DFieldSet setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DFieldSet setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DFieldSet setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DFieldSet setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DFieldSet setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DFieldSet add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	
//	@Override
//	public DFieldSet removeListener(
//		final EventType eventType, final IDomActiveListener listener)
//	{
...
//	}
	...
	//
	@Override
	public DFieldSet addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DFieldSet addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFieldSet addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DFieldSet addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DFieldSet jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DFieldSet _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DFieldSet _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DFieldSet _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DFieldSet _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DFieldSet _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DFieldSet _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DFieldSet _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DFieldSet _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DFieldSet _address_(final int count) {
		 _address(count) ;
		 return this ;
	}
	...
	public DFieldSet _address_(final String jif) {
		_address(jif) ;
		return this ;
	}
	...
	public DFieldSet _address_(BaseHtmlElement... elements) {
		_address(elements) ;
		return this ;
	}
	...
	public DFieldSet _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DFieldSet _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DFieldSet _article_(final int count) {
		_article(count) ;
		return this ;
	}
	...
	public DFieldSet _article_(final String jif) {
		_article(jif) ;
		return this ;
	}
	...
	public DFieldSet _articleText_(final String textValue) {
	...
	public DFieldSet _article_(BaseHtmlElement... elements) {
		_article(elements) ;
		return this ;
	}
	...
	public DFieldSet _aside_(final int count) {
		 _aside(count) ;
		 return this ;
	}
	...
	public DFieldSet _aside_(final String jif) {
		_aside(jif) ;
		return this ;
	}
	...
	public DFieldSet _asideText_(final String textValue) {
	...
	public DFieldSet _aside_(BaseHtmlElement... elements) {
		_aside(elements) ;
		return this ;
	}
	...
	public DFieldSet _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DFieldSet _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DFieldSet _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DFieldSet _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DFieldSet _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DFieldSet _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DFieldSet _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DFieldSet _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DFieldSet _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DFieldSet _blockquote_(final int count) {
		_blockquote(count) ;
		return this ;
	}
	...
	public DFieldSet _blockquote_(final String jif) {
		_blockquote(jif) ;
		return this ;
	}
	...
	public DFieldSet _blockquoteText_(final String textValue) {
	...
	public DFieldSet _blockquote_(BaseHtmlElement... elements) {
	...
	public DFieldSet _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DFieldSet _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DFieldSet _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DFieldSet _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DFieldSet _buttonText_(final String textValue) {
	...
	public DFieldSet _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DFieldSet _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DFieldSet _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DFieldSet _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DFieldSet _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DFieldSet _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DFieldSet _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DFieldSet _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DFieldSet _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DFieldSet _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DFieldSet _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DFieldSet _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DFieldSet _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DFieldSet _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DFieldSet _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DFieldSet _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DFieldSet _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DFieldSet _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DFieldSet _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DFieldSet _details_(final int count) {
		_details(count) ;
		return this ;
	}
	...
	public DFieldSet _details_(final String jif) {
		_details(jif) ;
		return this ;
	}
	...
	public DFieldSet _details_(BaseHtmlElement... elements) {
		_details(elements) ;
		return this ;
	}
	...
	public DFieldSet _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DFieldSet _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DFieldSet _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DFieldSet _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DFieldSet _div_(final int count) {
		_div(count) ;
		return this ;
	}
	...
	public DFieldSet _div_(final String jif) {
		_div(jif) ;
		return this ;
	}
	...
	public DFieldSet _div_(BaseHtmlElement... elements) {
		_div(elements) ;
		return this ;
	}
	...
	public DFieldSet _dl_(final int count) {
		_dl(count) ;
		return this ;
	}
	...
	public DFieldSet _dl_(final String jif) {
		_dl().jif(jif) ;
		return this ;
	}
	...
	public DFieldSet _dl_(BaseHtmlElement... elements) {
		_dl(elements) ;
		return this ;
	}
	...
	public DFieldSet _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DFieldSet _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DFieldSet _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DFieldSet _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DFieldSet _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DFieldSet _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DFieldSet _fieldset_(final int count) {
		_fieldset(count) ;
		return this ;
	}
	...
	public DFieldSet _fieldset_(final String jif) {
		_fieldset(jif) ;
		return this ;
	}
	...
	public DFieldSet _fieldsetLegend_(final String legend) {
	...
	public DFieldSet _fieldset_(BaseHtmlElement... elements) {
		_fieldset(elements) ;
		return this ;
	}
	...
	public DFieldSet _figure_(final int count) {
		_figure(count) ;
		return this ;
	}
	...
	public DFieldSet _figure_(final String jif) {
		_figure(jif) ;
		return this ;
	}
	...
	public DFieldSet _figure_(BaseHtmlElement... elements) {
		_figure(elements) ;
		return this ;
	}
	...
	public DFieldSet _footer_(final int count) {
		_footer(count) ;
		return this ;
	}
	...
	public DFieldSet _footer_(final String jif) {
		_footer(jif) ;
		return this ;
	}
	...
	public DFieldSet _footerText_(final String textValue) {
	...
	public DFieldSet _footer_(BaseHtmlElement... elements) {
		_footer(elements) ;
		return this ;
	}
	...
	public DFieldSet _form_(final int count) {
		_form(count) ;
		return this ;
	}
	...
	public DFieldSet _form_(final String jif) {
		_form(jif) ;
		return this ;
	}
	...
	public DFieldSet _form_(BaseHtmlElement... elements) {
		_form(elements) ;
		return this ;
	}
	...
	public DFieldSet _h1_(final int count) {
		_h1(count);
		return this ;
	}
	...
	public DFieldSet _h1_(final String jif) {
		_h1(jif) ;
		return this ;
	}
	...
	public DFieldSet _h1Text_(final String textValue) {
		_h1Text(textValue) ;
		return this ;
	}
	...
	public DFieldSet _h1_(BaseHtmlElement... elements) {
		_h1(elements) ;
		return this ;
	}
	...
	public DFieldSet _h2_(final int count) {
		_h2(count);
		return this ;
	}
	...
	public DFieldSet _h2_(final String jif) {
		_h2(jif) ;
		return this ;
	}
	...
	public DFieldSet _h2Text_(final String textValue) {
		_h2Text(textValue) ;
		return this ;
	}
	...
	public DFieldSet _h2_(BaseHtmlElement... elements) {
		_h2(elements) ;
		return this ;
	}
	...
	public DFieldSet _h3_(final int count) {
		_h3(count);
		return this ;
	}
	...
	public DFieldSet _h3_(final String jif) {
		_h3(jif) ;
		return this ;
	}
	...
	public DFieldSet _h3Text_(final String textValue) {
		_h3Text(textValue) ;
		return this ;
	}
	...
	public DFieldSet _h3_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DFieldSet _h4_(final int count) {
		_h4(count);
		return this ;
	}
	...
	public DFieldSet _h4_(final String jif) {
		_h4(jif) ;
		return this ;
	}
	...
	public DFieldSet _h4Text_(final String textValue) {
		_h4Text(textValue) ;
		return this ;
	}
	...
	public DFieldSet _h4_(BaseHtmlElement... elements) {
		_h4(elements) ;
		return this ;
	}
	...
	public DFieldSet _h5_(final int count) {
		_h5(count);
		return this ;
	}
	...
	public DFieldSet _h5_(final String jif) {
		_h5(jif) ;
		return this ;
	}
	...
	public DFieldSet _h5Text_(final String textValue) {
		_h5Text(textValue) ;
		return this ;
	}
	...
	public DFieldSet _h5_(BaseHtmlElement... elements) {
		_h5(elements) ;
		return this ;
	}
	...
	public DFieldSet _h6_(final int count) {
		_h6(count);
		return this ;
	}
	...
	public DFieldSet _h6_(final String jif) {
		_h6(jif) ;
		return this ;
	}
	...
	public DFieldSet _h6Text_(final String textValue) {
		_h6Text(textValue) ;
		return this ;
	}
	...
	public DFieldSet _h6_(BaseHtmlElement... elements) {
		_h6(elements) ;
		return this ;
	}
	...
	public DFieldSet _header_(final int count) {
		_header(count) ;
		return this ;
	}
	...
	public DFieldSet _header_(final String jif) {
		_header(jif) ;
		return this ;
	}
	...
	public DFieldSet _header_(BaseHtmlElement... elements) {
		_header(elements) ;
		return this ;
	}
	...
	public DFieldSet _hgroup_(final int count) {
		_hgroup(count) ;
		return this ;
	}
	...
	public DFieldSet _hgroup_(final String jif) {
		_hgroup(jif) ;
		return this ;
	}
	...
	public DFieldSet _hgroup_(BaseHtmlElement... elements) {
		_hgroup(elements) ;
		return this ;
	}
	...
	public DFieldSet _hr_(final int count) {
		_hr(count) ;
		return this ;
	}
	...
	public DFieldSet _hr_(final String jif) {
		_hr(jif) ;
		return this ;
	}
	...
	public DFieldSet _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DFieldSet _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DFieldSet _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DFieldSet _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DFieldSet _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DFieldSet _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DFieldSet _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DFieldSet _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DFieldSet _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DFieldSet _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DFieldSet _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DFieldSet _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DFieldSet _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DFieldSet _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DFieldSet _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DFieldSet _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DFieldSet _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DFieldSet _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DFieldSet _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DFieldSet _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DFieldSet _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DFieldSet _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DFieldSet _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DFieldSet _labelText_(final String textValue) {
	...
	public DFieldSet _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DFieldSet _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DFieldSet _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DFieldSet _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DFieldSet _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DFieldSet _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DFieldSet _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
	...
	public DFieldSet _menu_(final int count) {
		_menu(count) ;
		return this ;
	}
	...
	public DFieldSet _menu_(final String jif) {
		_menu(jif) ;
		return this ;
	}
	...
	public DFieldSet _menu_(BaseHtmlElement... elements) {
		_menu(elements) ;
		return this ;
	}
	...
	public DFieldSet _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DFieldSet _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DFieldSet _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
...
value) {
	...
	public DFieldSet _meter_(final String min, final String max, final String value) 

{
	...
	public DFieldSet _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
...
value) {
	...
	public DFieldSet _meter_(final double min, final double max, final double value) 

{
	...
	public DFieldSet _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DFieldSet _nav_(final int count) {
		_nav(count) ;
		return this ;
	}
	...
	public DFieldSet _nav_(final String jif) {
		_nav(jif) ;
		return this ;
	}
	...
	public DFieldSet _nav_(BaseHtmlElement... elements) {
		_nav(elements) ;
		return this ;
	}
	...
	public DFieldSet _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DFieldSet _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DFieldSet _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DFieldSet _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DFieldSet _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DFieldSet _ol_(final int count) {
		_ol(count) ;
		return this ;
	}
	...
	public DFieldSet _ol_(final String jif) {
		_ol(jif) ;
		return this ;
	}
	...
	public DFieldSet _ol_(final Collection<Object> collection) {
		_ol(collection) ;
		return this ;
	}
...

{
	...
	public DFieldSet _ol_(final Collection<Object> collection, final String 
...
htmlType) {
	...
	public DFieldSet _ol_(DLi... elements) {
		_ol(elements) ;
		return this ;
	}
	...
	public DFieldSet _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DFieldSet _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DFieldSet _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DFieldSet _p_(final int count) {
		_p(count) ;
		return this ;
	}
	...
	public DFieldSet _p_(final String jif) {
		_p(jif) ;
		return this ;
	}
	...
	public DFieldSet _pText_(final String textValue) {
		_pText(textValue) ;
		return this ;
	}
	...
	public DFieldSet _p_(BaseHtmlElement... elements) {
		_p(elements) ;
		return this ;
	}
	...
	public DFieldSet _pre_(final int count) {
		_pre(count) ;
		return this ;
	}
	...
	public DFieldSet _pre_(final String jif) {
		_pre(jif) ;
		return this ;
	}
	...
	public DFieldSet _preText_(final String textValue) {
		_preText(textValue) ;
		return this ;
	}
	...
	public DFieldSet _pre_(BaseHtmlElement... elements) {
		_pre(elements) ;
		return this ;
	}
	...
	public DFieldSet _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DFieldSet _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DFieldSet _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DFieldSet _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DFieldSet _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DFieldSet _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DFieldSet _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DFieldSet _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DFieldSet _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DFieldSet _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DFieldSet _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DFieldSet _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DFieldSet _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DFieldSet _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DFieldSet _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DFieldSet _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DFieldSet _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DFieldSet _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DFieldSet _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DFieldSet _scriptText_(final String text, final String type) {
	...
	public DFieldSet _section_(final int count) {
		_section(count) ;
		return this ;
	}
	...
	public DFieldSet _section_(final String jif) {
		_section(jif) ;
		return this ;
	}
	...
	public DFieldSet _section_(BaseHtmlElement... elements) {
		_section(elements) ;
		return this ;
	}
	...
	public DFieldSet _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DFieldSet _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DFieldSet _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DFieldSet _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DFieldSet _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DFieldSet _smallText_(final String textValue) {
	...
	public DFieldSet _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DFieldSet _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DFieldSet _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DFieldSet _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DFieldSet _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DFieldSet _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DFieldSet _strongText_(final String textValue) {
	...
	public DFieldSet _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DFieldSet _style_(final int count) {
		_style(count) ;
		return this ;
	}
	...
	public DFieldSet _style_(final String jif) {
		_style(jif) ;
		return this ;
	}
	...
	public DFieldSet _styleText_(final String styleText) {
	...
	public DFieldSet _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DFieldSet _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DFieldSet _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DFieldSet _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DFieldSet _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DFieldSet _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DFieldSet _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DFieldSet _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
	...
	public DFieldSet _table_(final int count) {
		_table(count);
		return this ;
	}
	...
	public DFieldSet _table_(final String jif) {
		_table(jif) ;
		return this ;
	}
	...
	public DFieldSet _table_(DTr... rows) {
		_table(rows) ;
		return this ;
	}
	...
	public DFieldSet _table_(BaseHtmlElement... elements) {
		_table(elements) ;
		return this ;
	}
	...
	public DFieldSet _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DFieldSet _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DFieldSet _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DFieldSet _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DFieldSet _timeDateTime_(final String dateTime) {
	...
	public DFieldSet _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DFieldSet _ul_(final int count) {
		_ul(count) ;
		return this ;
	}
	...
	public DFieldSet _ul_(final Collection<Object> collection) {
		_ul(collection) ;
		return this ;
	}
...

{
	...
	public DFieldSet _ul_(final Collection<Object> collection, final String 
...
htmlType) {
	...
	public DFieldSet _ul_(DLi... elements) {
		_ul(elements) ;
		return this ;
	}
	...
	public DFieldSet _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DFieldSet _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DFieldSet _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DFieldSet _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DFieldSet _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DFieldSet _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DFieldSet _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DFieldSet _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
	...
	//
	public DLegend _legend() {
		 return _legend(-1) ;
	}
	public DFieldSet _legend_() {
		_legend() ;
		return this ;
	}
	public DLegend _legend(final int count) {
		 return (DLegend)getOrCreate(DLegend.class, count) ;
	}
	public DFieldSet _legend_(final int count) {
		_legend(count) ;
		return this ;
	}
	public DLegend _legendText(final String textValue) {
		return _legend().setHtmlExtTextValue(textValue) ;
	}
	public DFieldSet _legendText_(final String textValue) {
		_legendText(textValue) ;
		return this ;
	}
	public DLegend _legend(final String jif) {
		return _legend().jif(jif) ;
	}
	public DFieldSet _legend_(final String jif) {
		_legend(jif) ;
		return this ;
	}
}
