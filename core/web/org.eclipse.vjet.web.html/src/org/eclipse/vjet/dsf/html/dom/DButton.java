	...
	implements IDFormControl /*, IDStrict, IAttrs */
{
	...
	/** "button" */
	public static final String TYPE_BUTTON = "button" ; // ignoreHtmlKeyword
	/** "reset" */
	...
	//
	public DButton() {
		super(HtmlTypeEnum.BUTTON);
	}

	public DButton(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.BUTTON);
	}
	
//	public DButon(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	
	/**
	 * The extension Constructor that creates an instance with DText child with the 
	 * passed in value. If the passed in value is null, no DText child is created.
	 */
	public DButton(final String textValue) {
		this() ;
		setHtmlExtTextValue(textValue) ;
	}
	
	public DButton(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public DButton setHtmlDisabled(final String disabled) {
		return setHtmlDisabled(toBoolean("disabled", disabled)) ;
	}	
	public DButton setHtmlDisabled(final boolean disabled) {
	...
	public DButton setHtmlName(final String name) {
		setHtmlAttribute(EHtmlAttr.name, name);
		return this ;
	}

	public DButton setHtmlType(final String type) {
		setHtmlAttribute(EHtmlAttr.type, type) ;
		return this ;
	}	
	public String getHtmlType() {
		return capitalize(getHtmlAttribute(EHtmlAttr.type));
	}

	public String getHtmlValue() {
		return getHtmlAttribute(EHtmlAttr.value);
	}
	public DButton setHtmlValue(final String value) {
	...
	public DButton setHtmlAutoFocus(final String autofocus) {  // HTML 5.0
		return setHtmlAutoFocus(toBoolean("autofocus", autofocus)) ;
	}
	public DButton setHtmlAutoFocus(final boolean autofocus) {  // HTML 5.0
		setHtmlAttribute(EHtmlAttr.autofocus, autofocus);
		return this ;
	}
	
	public String getHtmlFormAction() { // HTML 5.0
		return getHtmlAttribute(EHtmlAttr.formaction);
	}
	public DButton setHtmlFormAction(final String formaction) { // HTML 5.0
		setHtmlAttribute(EHtmlAttr.formaction, formaction);
		return this ;
	}

	public String getHtmlFormEnctype() { // HTML 5.0
		return getHtmlAttribute(EHtmlAttr.formenctype);
	}
	public DButton setHtmlFormEnctype(final String formenctype) { // HTML 5.0
		setHtmlAttribute(EHtmlAttr.formenctype, formenctype);
		return this ;
	}
	
	public String getHtmlFormMethod() { // HTML 5.0
		return getHtmlAttribute(EHtmlAttr.formmethod);
	}
	public DButton setHtmlFormMethod(final String formmethod) { // HTML 5.0
		setHtmlAttribute(EHtmlAttr.formmethod, formmethod);
		return this ;
	}
	
	public boolean getHtmlFormNoValidate() {	// HTML 5.0
		return getHtmlAttributeExists(EHtmlAttr.formnovalidate);
	}
	public DButton setHtmlFormNoValidate(final String formnovalidate) {  // HTML 5.0
		return setHtmlFormNoValidate(toBoolean("formnovalidate", formnovalidate)) ;
	}
	public DButton setHtmlFormNoValidate(final boolean formnovalidate) {  // HTML 5.0
		setHtmlAttribute(EHtmlAttr.formnovalidate, formnovalidate);
		return this ;
	}
	
	public String getHtmlFormTarget() { // HTML 5.0
		return getHtmlAttribute(EHtmlAttr.formtarget);
	}
	public DButton setHtmlFormTarget(final String formtarget) { // HTML 5.0
		setHtmlAttribute(EHtmlAttr.formtarget, formtarget);
		return this ;
	}
	...
	// Extensions
	//
	public DButton setHtmlExtTextValue(final String value) {
	...
	public String toString() {
		...
		Z.fmt("formaction", getHtmlFormAction()) +
		Z.fmt("formenctype", getHtmlFormEnctype()) +
		Z.fmt("formmethod", getHtmlFormMethod()) +
		Z.fmt("formnovalidate", getHtmlFormNoValidate()) +
		Z.fmt("formtarget", getHtmlFormTarget()) ;
	}
	 ...
	 */
	@Override
	public DButton add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DButton add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DButton add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DButton addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DButton dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DButton dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DButton setDsfRelationshipVerifier(
	...
	@Override
	public DButton cloned() {
		return (DButton)super.cloned() ;
	}
     ...
     */
    @Override
    public DButton setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DButton setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DButton setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DButton setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DButton setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DButton setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DButton setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DButton setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DButton setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DButton setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DButton setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DButton setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DButton setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DButton setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DButton setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DButton setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DButton setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DButton setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DButton setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DButton setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DButton setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DButton setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DButton setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DButton setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DButton setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DButton setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DButton setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DButton setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DButton setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DButton setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DButton setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DButton setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DButton setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DButton setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DButton setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DButton setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DButton setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DButton setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DButton setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DButton setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DButton setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DButton setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DButton setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DButton setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DButton setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DButton add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	//
	@Override
	public DButton addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DButton addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DButton addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DButton addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DButton jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DButton _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DButton _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DButton _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DButton _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DButton _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DButton _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DButton _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DButton _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DButton _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DButton _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DButton _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DButton _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DButton _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DButton _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DButton _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DButton _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DButton _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DButton _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DButton _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DButton _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DButton _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DButton _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DButton _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DButton _buttonText_(final String textValue) {
	...
	public DButton _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DButton _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DButton _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DButton _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DButton _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DButton _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DButton _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DButton _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DButton _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DButton _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DButton _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DButton _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DButton _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DButton _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DButton _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DButton _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DButton _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DButton _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DButton _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DButton _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DButton _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DButton _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DButton _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DButton _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DButton _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DButton _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DButton _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DButton _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DButton _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DButton _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DButton _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DButton _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DButton _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DButton _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DButton _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DButton _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DButton _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DButton _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DButton _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DButton _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DButton _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DButton _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DButton _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DButton _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DButton _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DButton _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DButton _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DButton _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DButton _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DButton _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DButton _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DButton _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DButton _labelText_(final String textValue) {
	...
	public DButton _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DButton _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DButton _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DButton _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DButton _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DButton _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DButton _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DButton _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DButton _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DButton _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DButton _meter_(final String min, final String max, final String value) {
	...
	public DButton _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DButton _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DButton _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DButton _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DButton _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DButton _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DButton _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DButton _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DButton _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DButton _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DButton _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DButton _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DButton _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DButton _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DButton _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DButton _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DButton _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DButton _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DButton _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DButton _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DButton _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DButton _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DButton _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DButton _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DButton _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DButton _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DButton _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DButton _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DButton _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DButton _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DButton _scriptText_(final String text, final String type) {
	...
	public DButton _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DButton _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DButton _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DButton _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DButton _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DButton _smallText_(final String textValue) {
	...
	public DButton _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DButton _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DButton _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DButton _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DButton _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DButton _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DButton _strongText_(final String textValue) {
	...
	public DButton _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DButton _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DButton _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DButton _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DButton _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DButton _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DButton _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DButton _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DButton _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DButton _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DButton _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DButton _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DButton _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DButton _timeDateTime_(final String dateTime) {
	...
	public DButton _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DButton _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DButton _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DButton _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DButton _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DButton _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DButton _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DButton _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DButton _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
