...
/**
<a href='http://dev.w3.org/html5/spec/Overview.html#the-command'>W3C command</a>
<p>
The command element represents a command that the user can invoke.
<p>
The type attribute indicates the kind of command: either a normal command with 
an associated action, or a state or option that can be toggled, or a selection 
of one item from a list of items.
<p>
The attribute is an enumerated attribute with three keywords and states. The 
keyword "command" maps to the Command state, the checkbox" maps to the Checkbox, 
and the "radio" keyword maps to the Radio state. The missing value default is 
the Command state.
 */
public class DCommand extends BaseHtml50Element 
//	implements /* HTML 5.0 */ IMetadataContent
{
	...
	//
	public DCommand() {
		super(HtmlTypeEnum.COMMAND);
	}
	
	public DCommand(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.COMMAND);
	}
	
	public DCommand(final String jif) {
		this() ;
		jif(jif) ;
	}
	...
	public boolean getHtmlChecked() {
		return hasHtmlAttribute(EHtmlAttr.checked) ;
	}
	public DCommand setHtmlChecked(final boolean checked) {
		setHtmlAttribute(EHtmlAttr.checked, checked) ;
		return this ;
	}
	public DCommand setHtmlChecked(final String checked) {
		setHtmlAttribute(EHtmlAttr.checked, checked) ;
		return this ;
	}
	
//	// default
//	public boolean getHtmlDefault() {
//		return hasHtmlAttribute(EHtmlAttr._default) ;
//	}
//	public DCommand setHtmlDefault(final boolean _default) {
//		setHtmlAttribute(EHtmlAttr._default, _default) ;
//		return this ;
//	}
//	public DCommand setHtmlDefault(final String _default) {
//		setHtmlAttribute(EHtmlAttr._default, _default) ;
//		return this ;
//	}
	...
	public DCommand setHtmlDisabled(final boolean disabled) {
		setHtmlAttribute(EHtmlAttr.disabled, disabled) ;
		return this ;
	}
	public DCommand setHtmlDisabled(final String disabled) {
		setHtmlAttribute(EHtmlAttr.disabled, disabled) ;
		return this ;
	}
	
//	// hidden
//	public boolean getHtmlHidden() {
//		return hasHtmlAttribute(EHtmlAttr.hidden) ;
//	}
//	public DCommand setHtmlHidden(final boolean hidden) {
//		setHtmlAttribute(EHtmlAttr.hidden, hidden) ;
//		return this ;
//	}
//	public DCommand setHtmlHidden(final String hidden) {
//		setHtmlAttribute(EHtmlAttr.hidden, hidden) ;
//		return this ;
//	}
	...
	public String getHtmlIcon() {
		return getHtmlAttribute(EHtmlAttr.icon) ;
	}
	public DCommand setHtmlIcon(final String iconUrl) {
		setHtmlAttribute(EHtmlAttr.icon, iconUrl) ;
		return this ;
	}
	
	// label
	public String getHtmlLabel() {
		return getHtmlAttribute(EHtmlAttr.label) ;
	}
	public DCommand setHtmlLabel(final String label) {
		setHtmlAttribute(EHtmlAttr.label, label) ;
		return this ;
	}
	
	// radiogroup
	public String getHtmlRadioGroup() {
		return getHtmlAttribute(EHtmlAttr.radiogroup) ;
	}
	public DCommand setHtmlRadioGroup(final String radioGroupName) {
		setHtmlAttribute(EHtmlAttr.radiogroup, radioGroupName) ;
		return this ;
	}
	...
	public DCommand setHtmlType(final String type) {
...
//		Z.fmt(EHtmlAttr._default.getAttributeName(), "" + getHtmlDefault()) +
		Z.fmt(EHtmlAttr.disabled.getAttributeName(), "" + getHtmlDisabled()) +
//		Z.fmt(EHtmlAttr.hidden.getAttributeName(), "" + getHtmlHidden()) +
		Z.fmt(EHtmlAttr.icon.getAttributeName(), "" + getHtmlIcon()) +
		Z.fmt(EHtmlAttr.label.getAttributeName(), "" + getHtmlLabel()) +
		Z.fmt(EHtmlAttr.radiogroup.getAttributeName(), "" + getHtmlRadioGroup()) +
	 ...
	 */
	@Override
	public DCommand add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCommand add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCommand addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCommand dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DCommand dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DCommand setDsfRelationshipVerifier(
	...
	@Override
	public DCommand cloned() {
		return (DCommand)super.cloned() ;
	}
     ...
     */
    @Override
    public DCommand setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DCommand setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DCommand setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DCommand setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DCommand setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DCommand setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DCommand setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DCommand setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DCommand setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCommand setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DCommand setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCommand setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DCommand setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DCommand setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DCommand setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DCommand setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DCommand setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DCommand setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DCommand setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DCommand setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DCommand setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCommand setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DCommand setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DCommand setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DCommand setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DCommand setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DCommand setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DCommand setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DCommand setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DCommand setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DCommand setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DCommand setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DCommand setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DCommand setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DCommand setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DCommand setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DCommand setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DCommand setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DCommand setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DCommand setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DCommand setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DCommand add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	
//	@Override
//	public DCommand removeListener(
//		final EventType eventType, final IDomActiveListener listener)
//	{
...
//	}
	...
	//
	@Override
	public DCommand addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DCommand addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCommand addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DCommand addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DCommand jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
