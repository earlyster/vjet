 ...
 */
public class DTHead extends BaseTableSection
//	implements IDTransitional, IAttrs
{
	...
	//
	public DTHead() {
		super(HtmlTypeEnum.THEAD);
	}
	
	public DTHead(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.THEAD);
	}
	
	public DTHead(final String jif) {
		this() ;
		jif(jif) ;
	}

	public DTHead(DTr... elems) {
		this() ;
		add(elems) ;
	}
	 ...
	 */
	@Override
	public DTHead setHtmlAlign(final String align) {
	 ...
	 */
	@Override
	public DTHead setHtmlCh(final String _char) {
	 ...
	 */
	@Override
	public DTHead setHtmlChOff(final String charoff) {
		super.setHtmlChOff(charoff) ;
		return this ;
	}

	@Override
	public DTHead setHtmlValign(final String valign) {
	 ...
	 */
	@Override
	public DTHead add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	public DTHead add(DTr... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTHead add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTHead addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTHead dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DTHead dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DTHead setDsfRelationshipVerifier(
	...
	@Override
	public DTHead cloned() {
		return (DTHead)super.cloned() ;
	}
     ...
     */
    @Override
    public DTHead setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DTHead setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DTHead setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DTHead setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DTHead setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DTHead setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DTHead setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DTHead setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DTHead setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTHead setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DTHead setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DTHead setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DTHead setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTHead setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DTHead setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DTHead setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DTHead setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DTHead setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DTHead setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DTHead setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DTHead setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DTHead setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DTHead setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTHead setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DTHead setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DTHead setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DTHead setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DTHead setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DTHead setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DTHead setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DTHead setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DTHead setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DTHead setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DTHead setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DTHead setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DTHead setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DTHead setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DTHead setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DTHead setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DTHead setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DTHead setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DTHead setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DTHead setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DTHead add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DTHead addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTHead addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DTHead addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DTHead jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
