...
/**
 * For background sounds or soundtracks.
 * Microsoft extension to HTML; IE Specific.
 * 
 * http://msdn2.microsoft.com/en-us/library/ms535198.aspx
 * 
 */

public class DBgSound extends BaseAttrsHtmlElement /* implements IEventAttributes */{ 

	private static final long serialVersionUID = 1L;
	
	// Constructors
	public DBgSound() {
		super(HtmlTypeEnum.BGSOUND);
	}

	public DBgSound(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.BGSOUND);
	}
	
//	public DBgSound(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	
	public DBgSound(final String src) { 
		this() ; 
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.BGSOUND;
	}
	
	// HTML Attributes
	
	/**
	 * Returns how the background sound is divided between the left and right 
	 * speakers.  IE range is -10000 to +10000.  -10000 indicates all sound 
	 * directed to * the left speaker.  +10000 indicates all sound directed 
	 * to the right speaker.  0 indicates sound is balanced between right and 
	 * left speakers.
	 */
	public String getHtmlBalance() { 
		return getHtmlAttribute(EHtmlAttr.balance) ;
	}
	public DBgSound setHtmlBalance(final String balance) {
		setHtmlAttribute(EHtmlAttr.balance, balance) ;
		return this ; 
	}	
	public DBgSound setHtmlBalance(final int balance) {
		return setHtmlBalance(String.valueOf(balance)) ; 
	}
	
	/**
	 * Returns the number of times a sound will loop when activated.
	 */
	public String getHtmlLoop() { 
		return getHtmlAttribute(EHtmlAttr.loop) ;
	}	
	public DBgSound setHtmlLoop(final String loop) { 
		setHtmlAttribute(EHtmlAttr.loop, loop) ;
		return this ; 
	}	
	public DBgSound setHtmlLoop(final int loop) { 
		return setHtmlLoop(String.valueOf(loop)) ;
	}
	
	
	/**
	 * Returns the URL for the sound.
	 */
	public String getHtmlSrc() { 
		return getHtmlAttribute(EHtmlAttr.src) ;
	}	
	public DBgSound setHtmlSrc(final String src) { 
		setHtmlAttribute(EHtmlAttr.src, src) ;
		return this ;
	}
	
	/**
	 * Returns the volume settings. IE valid values range from -10000 to zero.
	 * Zero is full Wave Output Volume.
	 */ 
	public String getHtmlVolume() { 
		return getHtmlAttribute(EHtmlAttr.volume) ;
	}	
	public DBgSound setHtmlVolume(final String volume) { 
		setHtmlAttribute(EHtmlAttr.volume, volume) ;
		return this ; 
	}	
	public DBgSound setHtmlVolume(final int volume) { 
		return setHtmlVolume(String.valueOf(volume)) ;
	}
	 ...
	 * current the LayoutRect object with content from the source document.
	 */
	public DBgSound setHtmlOnLayoutComplete(final String script){
		super.setInlineEvent(EHtmlAttr.onlayoutcomplete, script, EventType.LAYOUTCOMPLETE);
		return this ;
	} 
	 ...
	 */
	public DBgSound setHtmlOnMouseEnter(final String script) {
	 ...
	 * the object.
	 */
	public DBgSound setHtmlOnMouseLeave(final String script) {
	...
	public String toString() {
		...
		Z.fmt("balance", getHtmlBalance()) + 
		Z.fmt("loop", getHtmlLoop()) + 
		Z.fmt("src", getHtmlSrc()) + 
		Z.fmt("volume", getHtmlVolume()) ;		
	}
	 ...
	 */
	@Override
	public DBgSound add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBgSound add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBgSound addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBgSound dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DBgSound dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DBgSound setDsfRelationshipVerifier(
	...
	@Override
	public DBgSound cloned() {
		return (DBgSound)super.cloned() ;
	}
     ...
     */
    @Override
    public DBgSound setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DBgSound setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DBgSound setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DBgSound setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DBgSound setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DBgSound setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DBgSound setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DBgSound setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DBgSound setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBgSound setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DBgSound setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DBgSound setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DBgSound setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBgSound setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DBgSound setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DBgSound setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DBgSound setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DBgSound setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DBgSound setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DBgSound setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DBgSound setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DBgSound setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DBgSound setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBgSound setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DBgSound setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DBgSound setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DBgSound setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DBgSound setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DBgSound setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DBgSound setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DBgSound setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DBgSound setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DBgSound setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DBgSound setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DBgSound setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DBgSound setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DBgSound setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DBgSound setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DBgSound setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DBgSound setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DBgSound setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DBgSound setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DBgSound setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DBgSound add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	
//	@Override
//	public DBgSound removeListener(
//		final EventType eventType, final IDomActiveListener listener)
//	{
...
//	}
	...
	//
	@Override
	public DBgSound addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DBgSound addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBgSound addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DBgSound addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DBgSound jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}
