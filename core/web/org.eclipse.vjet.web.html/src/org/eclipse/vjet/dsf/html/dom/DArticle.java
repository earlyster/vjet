...
<p>
An article element is "independent" in the sense that its contents could stand 
alone, for example in syndication.
<p>
When article elements are nested, the inner article elements represent articles 
that are in principle related to the contents of the outer article. For instance, 
a Web log entry on a site that accepts user-submitted comments could represent 
the comments as article elements nested within the article element for the Web 
log entry.
<p>
Author information associated with an article element (q.v. the address element) 
does not apply to nested article elements.
<p>
The cite attribute may be used if the content of the article was taken from 
another page (e.g. syndicating content from multiple sources on one page). The 
attribute, if present, must contain a valid URL referencing the original source. 
To obtain the corresponding citation link, the value of the attribute must be 
resolved relative to the element. User agents should allow users to follow such 
citation links.
<p>
The pubdate attribute may be used to specify the time and date that the article 
was first published. If present, the pubdate attribute must be a valid global 
date and time string value.
<p>
The cite DOM attribute must reflect the element's cite content attribute. The 
pubDate DOM attribute must reflect the element's pubdate content attribute.
 */
public class DArticle extends BaseHtml50Element 
...
{		
	...
	//
	public DArticle() {
		super(HtmlTypeEnum.ARTICLE);
	}
	
	public DArticle(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.ADDRESS);
	}
	
	public DArticle(String textValue) {
		this() ;
		setHtmlExtTextValue(textValue) ;
	}
	
	public DArticle(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	//
	/**
	 * The cite  attribute may be used if the content of the article was taken 
	 * from another page (e.g. syndicating content from multiple sources on one 
	 * page). The attribute, if present, must contain a valid URL referencing 
	 * the original source. To obtain the corresponding citation link, the value 
	 * of the attribute must be resolved relative to the element. User agents 
	 ...
	 * should allow users to follow such citation links.
	 */
	public DArticle setHtmlCite(final String cite) {
		setHtmlAttribute(EHtmlAttr.cite, cite) ;
		return this ;
	}
	
	/**
	 * The pubdate attribute may be used to specify the time and date that the 
	 * article was first published. If present, the pubdate attribute must be a 
	 * valid global date and time string value.
	 */
	public String getHtmlPubDate() {
		return getHtmlAttribute(EHtmlAttr.pubdate) ;
	}
	/**
	 * The pubdate attribute may be used to specify the time and date that the 
	 * article was first published. If present, the pubdate attribute must be a 
	 * valid global date and time string value.
	 */
	public DArticle setHtmlPubDate(final String pubdate) {
		setHtmlAttribute(EHtmlAttr.pubdate, pubdate) ;
		return this ;
	}
	...
	// Extensions
	//
	public DArticle setHtmlExtTextValue(final String value) {
	...
	@Override
	public DArticle jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public String toString() {
		return super.toString()
			...
			+ Z.fmt(EHtmlAttr.pubdate.getAttributeName(), "" + getHtmlPubDate()) ;
	}
	 ...
	 */
	@Override
	public DArticle add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DArticle add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DArticle add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DArticle addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DArticle dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DArticle dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DArticle setDsfRelationshipVerifier(
	...
	@Override
	public DArticle cloned() {
		return (DArticle)super.cloned() ;
	}
     ...
     */
    @Override
    public DArticle setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DArticle setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DArticle setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DArticle setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DArticle setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DArticle setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DArticle setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DArticle setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DArticle setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DArticle setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DArticle setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DArticle setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DArticle setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DArticle setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DArticle setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DArticle setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DArticle setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DArticle setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DArticle setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DArticle setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DArticle setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DArticle setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DArticle setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DArticle setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DArticle setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DArticle setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DArticle setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DArticle setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DArticle setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DArticle setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DArticle setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DArticle setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DArticle setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DArticle setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DArticle setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DArticle setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DArticle setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DArticle setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DArticle setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DArticle setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DArticle setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DArticle setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DArticle setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DArticle add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	
//	@Override
//	public DArticle removeListener(
//		final EventType eventType, final IDomActiveListener listener)
//	{
...
//	}
	...
	//
	@Override
	public DArticle addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DArticle addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DArticle addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DArticle addHtmlClassName(final CssClassConstant ccc) {
	...
	public DArticle _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DArticle _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DArticle _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DArticle _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DArticle _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DArticle _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DArticle _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DArticle _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ; ;
		return this ;
	}
	...
	public DArticle _address_(final int count) {
		 _address(count) ;
		 return this ;
	}
	...
	public DArticle _address_(final String jif) {
		_address(jif) ;
		return this ;
	}
	...
	public DArticle _address_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DArticle _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DArticle _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DArticle _article_(final int count) {
		_article(count) ;
		return this ;
	}
	...
	public DArticle _article_(final String jif) {
		_article(jif) ;
		return this ;
	}
	...
	public DArticle _articleText_(final String textValue) {
	...
	public DArticle _article_(BaseHtmlElement... elements) {
		_article(elements) ;
		return this ;
	}
	...
	public DArticle _aside_(final int count) {
		 _aside(count) ;
		 return this ;
	}
	...
	public DArticle _aside_(final String jif) {
		_aside(jif) ;
		return this ;
	}
	...
	public DArticle _asideText_(final String textValue) {
	...
	public DArticle _aside_(BaseHtmlElement... elements) {
		_aside(elements) ;
		return this ;
	}
	...
	public DArticle _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DArticle _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DArticle _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DArticle _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DArticle _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DArticle _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DArticle _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DArticle _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DArticle _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DArticle _blockquote_(final int count) {
		_blockquote(count) ;
		return this ;
	}
	...
	public DArticle _blockquote_(final String jif) {
		_blockquote(jif) ;
		return this ;
	}
	...
	public DArticle _blockquoteText_(final String textValue) {
	...
	public DArticle _blockquote_(BaseHtmlElement... elements) {
	...
	public DArticle _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DArticle _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DArticle _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DArticle _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DArticle _buttonText_(final String textValue) {
	...
	public DArticle _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DArticle _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DArticle _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DArticle _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DArticle _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DArticle _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DArticle _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DArticle _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DArticle _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DArticle _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DArticle _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DArticle _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DArticle _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DArticle _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DArticle _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DArticle _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DArticle _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DArticle _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DArticle _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DArticle _details_(final int count) {
		_details(count) ;
		return this ;
	}
	...
	public DArticle _details_(final String jif) {
		_details(jif) ;
		return this ;
	}
	...
	public DArticle _details_(BaseHtmlElement... elements) {
		_details(elements) ;
		return this ;
	}
	...
	public DArticle _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DArticle _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DArticle _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DArticle _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DArticle _div_(final int count) {
		_div(count) ;
		return this ;
	}
	...
	public DArticle _div_(final String jif) {
		_div(jif) ;
		return this ;
	}
	...
	public DArticle _div_(BaseHtmlElement... elements) {
		_div(elements) ;
		return this ;
	}
	...
	public DArticle _dl_(final int count) {
		_dl(count) ;
		return this ;
	}
	...
	public DArticle _dl_(final String jif) {
		_dl().jif(jif) ;
		return this ;
	}
	...
	public DArticle _dl_(BaseHtmlElement... elements) {
		_dl(elements) ;
		return this ;
	}
	...
	public DArticle _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DArticle _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DArticle _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DArticle _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DArticle _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DArticle _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DArticle _fieldset_(final int count) {
		_fieldset(count) ;
		return this ;
	}
	...
	public DArticle _fieldset_(final String jif) {
		_fieldset(jif) ;
		return this ;
	}
	...
	public DArticle _fieldsetLegend_(final String legend) {
	...
	public DArticle _fieldset_(BaseHtmlElement... elements) {
		_fieldset(elements) ;
		return this ;
	}
	...
	public DArticle _figure_(final int count) {
		_figure(count) ;
		return this ;
	}
	...
	public DArticle _figure_(final String jif) {
		_figure(jif) ;
		return this ;
	}
	...
	public DArticle _figure_(BaseHtmlElement... elements) {
		_figure(elements) ;
		return this ;
	}
	...
	public DArticle _footer_(final int count) {
		_footer(count) ;
		return this ;
	}
	...
	public DArticle _footer_(final String jif) {
		_footer(jif) ;
		return this ;
	}
	...
	public DArticle _footerText_(final String textValue) {
	...
	public DArticle _footer_(BaseHtmlElement... elements) {
		_footer(elements) ;
		return this ;
	}
	...
	public DArticle _form_(final int count) {
		_form(count) ;
		return this ;
	}
	...
	public DArticle _form_(final String jif) {
		_form(jif) ;
		return this ;
	}
	...
	public DArticle _form_(BaseHtmlElement... elements) {
		_form(elements) ;
		return this ;
	}
	...
	public DArticle _h1_(final int count) {
		_h1(count);
		return this ;
	}
	...
	public DArticle _h1_(final String jif) {
		_h1(jif) ;
		return this ;
	}
	...
	public DArticle _h1Text_(final String textValue) {
		_h1Text(textValue) ;
		return this ;
	}
	...
	public DArticle _h1_(BaseHtmlElement... elements) {
		_h1(elements) ;
		return this ;
	}
	...
	public DArticle _h2_(final int count) {
		_h2(count);
		return this ;
	}
	...
	public DArticle _h2_(final String jif) {
		_h2(jif) ;
		return this ;
	}
	...
	public DArticle _h2Text_(final String textValue) {
		_h2Text(textValue) ;
		return this ;
	}
	...
	public DArticle _h2_(BaseHtmlElement... elements) {
		_h2(elements) ;
		return this ;
	}
	...
	public DArticle _h3_(final int count) {
		_h3(count);
		return this ;
	}
	...
	public DArticle _h3_(final String jif) {
		_h3(jif) ;
		return this ;
	}
	...
	public DArticle _h3Text_(final String textValue) {
		_h3Text(textValue) ;
		return this ;
	}
	...
	public DArticle _h3_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DArticle _h4_(final int count) {
		_h4(count);
		return this ;
	}
	...
	public DArticle _h4_(final String jif) {
		_h4(jif) ;
		return this ;
	}
	...
	public DArticle _h4Text_(final String textValue) {
		_h4Text(textValue) ;
		return this ;
	}
	...
	public DArticle _h4_(BaseHtmlElement... elements) {
		_h4(elements) ;
		return this ;
	}
	...
	public DArticle _h5_(final int count) {
		_h5(count);
		return this ;
	}
	...
	public DArticle _h5_(final String jif) {
		_h5(jif) ;
		return this ;
	}
	...
	public DArticle _h5Text_(final String textValue) {
		_h5Text(textValue) ;
		return this ;
	}
	...
	public DArticle _h5_(BaseHtmlElement... elements) {
		_h5(elements) ;
		return this ;
	}
	...
	public DArticle _h6_(final int count) {
		_h6(count);
		return this ;
	}
	...
	public DArticle _h6_(final String jif) {
		_h6(jif) ;
		return this ;
	}
	...
	public DArticle _h6Text_(final String textValue) {
		_h6Text(textValue) ;
		return this ;
	}
	...
	public DArticle _h6_(BaseHtmlElement... elements) {
		_h6(elements) ;
		return this ;
	}
	...
	public DArticle _header_(final int count) {
		_header(count) ;
		return this ;
	}
	...
	public DArticle _header_(final String jif) {
		_header(jif) ;
		return this ;
	}
	...
	public DArticle _header_(BaseHtmlElement... elements) {
		_header(elements) ;
		return this ;
	}
	...
	public DArticle _hgroup_(final int count) {
		_hgroup(count) ;
		return this ;
	}
	...
	public DArticle _hgroup_(final String jif) {
		_hgroup(jif) ;
		return this ;
	}
	...
	public DArticle _hgroup_(BaseHtmlElement... elements) {
		_hgroup(elements) ;
		return this ;
	}
	...
	public DArticle _hr_(final int count) {
		_hr(count) ;
		return this ;
	}
	...
	public DArticle _hr_(final String jif) {
		_hr(jif) ;
		return this ;
	}
	...
	public DArticle _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DArticle _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DArticle _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DArticle _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DArticle _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DArticle _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DArticle _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DArticle _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DArticle _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DArticle _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DArticle _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DArticle _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DArticle _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DArticle _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DArticle _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DArticle _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DArticle _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DArticle _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DArticle _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DArticle _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DArticle _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DArticle _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DArticle _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DArticle _labelText_(final String textValue) {
	...
	public DArticle _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DArticle _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DArticle _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DArticle _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DArticle _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DArticle _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DArticle _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
	...
	public DArticle _menu_(final int count) {
		_menu(count) ;
		return this ;
	}
	...
	public DArticle _menu_(final String jif) {
		_menu(jif) ;
		return this ;
	}
	...
	public DArticle _menu_(BaseHtmlElement... elements) {
		_menu(elements) ;
		return this ;
	}
	...
	public DArticle _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DArticle _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DArticle _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
...
value) {
	...
	public DArticle _meter_(final String min, final String max, final String value) 

{
	...
	public DArticle _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
...
value) {
	...
	public DArticle _meter_(final double min, final double max, final double value) 

{
	...
	public DArticle _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DArticle _nav_(final int count) {
		_nav(count) ;
		return this ;
	}
	...
	public DArticle _nav_(final String jif) {
		_nav(jif) ;
		return this ;
	}
	...
	public DArticle _nav_(BaseHtmlElement... elements) {
		_nav(elements) ;
		return this ;
	}
	...
	public DArticle _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DArticle _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DArticle _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DArticle _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DArticle _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DArticle _ol_(final int count) {
		_ol(count) ;
		return this ;
	}
	...
	public DArticle _ol_(final String jif) {
		_ol(jif) ;
		return this ;
	}
	...
	public DArticle _ol_(final Collection<Object> collection) {
		_ol(collection) ;
		return this ;
	}
...

{
	...
	public DArticle _ol_(final Collection<Object> collection, final String 
...
htmlType) {
	...
	public DArticle _ol_(DLi... elements) {
		_ol(elements) ;
		return this ;
	}
	...
	public DArticle _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DArticle _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DArticle _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DArticle _p_(final int count) {
		_p(count) ;
		return this ;
	}
	...
	public DArticle _p_(final String jif) {
		_p(jif) ;
		return this ;
	}
	...
	public DArticle _pText_(final String textValue) {
		_pText(textValue) ;
		return this ;
	}
	...
	public DArticle _p_(BaseHtmlElement... elements) {
		_p(elements) ;
		return this ;
	}
	...
	public DArticle _pre_(final int count) {
		_pre(count) ;
		return this ;
	}
	...
	public DArticle _pre_(final String jif) {
		_pre(jif) ;
		return this ;
	}
	...
	public DArticle _preText_(final String textValue) {
		_preText(textValue) ;
		return this ;
	}
	...
	public DArticle _pre_(BaseHtmlElement... elements) {
		_pre(elements) ;
		return this ;
	}
	...
	public DArticle _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DArticle _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DArticle _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DArticle _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DArticle _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DArticle _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DArticle _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DArticle _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DArticle _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DArticle _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DArticle _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DArticle _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DArticle _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DArticle _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DArticle _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DArticle _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DArticle _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DArticle _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DArticle _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DArticle _scriptText_(final String text, final String type) {
	...
	public DArticle _section_(final int count) {
		_section(count) ;
		return this ;
	}
	...
	public DArticle _section_(final String jif) {
		_section(jif) ;
		return this ;
	}
	...
	public DArticle _section_(BaseHtmlElement... elements) {
		_section(elements) ;
		return this ;
	}
	...
	public DArticle _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DArticle _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DArticle _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DArticle _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DArticle _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DArticle _smallText_(final String textValue) {
	...
	public DArticle _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DArticle _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DArticle _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DArticle _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DArticle _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DArticle _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DArticle _strongText_(final String textValue) {
	...
	public DArticle _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DArticle _style_(final int count) {
		_style(count) ;
		return this ;
	}
	...
	public DArticle _style_(final String jif) {
		_style(jif) ;
		return this ;
	}
	...
	public DArticle _styleText_(final String styleText) {
	...
	public DArticle _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DArticle _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DArticle _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DArticle _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DArticle _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DArticle _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DArticle _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DArticle _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
	...
	public DArticle _table_(final int count) {
		_table(count);
		return this ;
	}
	...
	public DArticle _table_(final String jif) {
		_table(jif) ;
		return this ;
	}
	...
	public DArticle _table_(DTr... rows) {
		_table(rows) ;
		return this ;
	}
	...
	public DArticle _table_(BaseHtmlElement... elements) {
		_table(elements) ;
		return this ;
	}
	...
	public DArticle _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DArticle _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DArticle _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DArticle _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DArticle _timeDateTime_(final String dateTime) {
	...
	public DArticle _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DArticle _ul_(final int count) {
		_ul(count) ;
		return this ;
	}
	...
	public DArticle _ul_(final Collection<Object> collection) {
		_ul(collection) ;
		return this ;
	}
...

{
	...
	public DArticle _ul_(final Collection<Object> collection, final String 
...
htmlType) {
	...
	public DArticle _ul_(DLi... elements) {
		_ul(elements) ;
		return this ;
	}
	...
	public DArticle _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DArticle _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DArticle _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DArticle _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DArticle _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DArticle _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DArticle _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DArticle _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
