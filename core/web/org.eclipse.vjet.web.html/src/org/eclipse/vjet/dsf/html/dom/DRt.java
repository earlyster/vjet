...
/**
<a href='http://dev.w3.org/html5/spec/Overview.html#the-rt-element'>W3C rt</a>
<p>
The rt element marks the ruby text component of a ruby annotation.
<p>
An rt element that is a child of a ruby element represents an annotation (given 
by its children) for the zero or more nodes of phrasing content that immediately 
precedes it in the ruby element, ignoring rp elements.
<p>
An rt element that is not a child of a ruby element represents the same thing as 
its children.
 */
public class DRt extends BaseHtml50Element {
	...
	//
	public DRt() {
		super(HtmlTypeEnum.RT);
	}
	
	public DRt(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.RT);
	}
	
	public DRt(final String jif) {
		this() ;
		jif(jif) ;
	}
	
	public DRt(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	 ...
	 */
	@Override
	public DRt add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DRt add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DRt add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DRt addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DRt dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DRt dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DRt setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DRt setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DRt setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DRt setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DRt setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DRt setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DRt setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DRt setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DRt setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DRt setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DRt setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DRt setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DRt setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DRt setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DRt setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DRt setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DRt setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DRt setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DRt setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DRt setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DRt setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DRt setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DRt setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DRt setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DRt setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DRt setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DRt setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DRt setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DRt setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DRt setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DRt setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DRt setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DRt setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DRt setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DRt setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DRt setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DRt setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DRt setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DRt setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DRt setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DRt setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DRt setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DRt setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DRt setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DRt setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DRt setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DRt add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DRt addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DRt addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DRt addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DRt jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DRt _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DRt _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DRt _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DRt _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DRt _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DRt _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DRt _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DRt _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DRt _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DRt _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DRt _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DRt _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DRt _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DRt _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DRt _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DRt _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DRt _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DRt _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DRt _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DRt _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DRt _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DRt _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DRt _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DRt _buttonText_(final String textValue) {
	...
	public DRt _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DRt _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DRt _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DRt _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DRt _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DRt _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DRt _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DRt _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DRt _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DRt _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DRt _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DRt _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DRt _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DRt _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DRt _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DRt _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DRt _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DRt _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DRt _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DRt _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DRt _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DRt _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DRt _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DRt _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DRt _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DRt _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DRt _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DRt _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DRt _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DRt _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DRt _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DRt _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DRt _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DRt _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DRt _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DRt _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DRt _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DRt _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DRt _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DRt _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DRt _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DRt _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DRt _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DRt _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DRt _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DRt _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DRt _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DRt _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DRt _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DRt _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DRt _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DRt _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DRt _labelText_(final String textValue) {
	...
	public DRt _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DRt _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DRt _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DRt _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DRt _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DRt _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DRt _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DRt _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DRt _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DRt _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DRt _meter_(final String min, final String max, final String value) {
	...
	public DRt _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DRt _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DRt _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DRt _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DRt _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DRt _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DRt _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DRt _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DRt _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DRt _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DRt _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DRt _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DRt _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DRt _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DRt _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DRt _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DRt _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DRt _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DRt _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DRt _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DRt _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DRt _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DRt _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DRt _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DRt _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DRt _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DRt _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DRt _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DRt _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DRt _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DRt _scriptText_(final String text, final String type) {
	...
	public DRt _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DRt _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DRt _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DRt _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DRt _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DRt _smallText_(final String textValue) {
	...
	public DRt _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DRt _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DRt _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DRt _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DRt _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DRt _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DRt _strongText_(final String textValue) {
	...
	public DRt _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DRt _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DRt _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DRt _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DRt _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DRt _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DRt _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DRt _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DRt _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DRt _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DRt _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DRt _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DRt _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DRt _timeDateTime_(final String dateTime) {
	...
	public DRt _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DRt _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DRt _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DRt _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DRt _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DRt _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DRt _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DRt _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DRt _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
