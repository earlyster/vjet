...
public class DSelect
	...
	public DSelect(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.SELECT);
	}
	
	public DSelect(final String jif) {
		this() ;
		jif(jif) ;
	}
	...
	public String getHtmlValue() {
		...
		final NodeList options = getElementsByTagName(HtmlTypeEnum.OPTION);
		for (int i = 0; i < options.getLength(); ++i) {
			DOption opt = (DOption)options.item(i);
	...
	public DSelect setHtmlValue(final String value) {
		if (getHtmlMultiple()) {
			throw new DsfRuntimeException("unsupported method for multi-select element");
		}
		final NodeList options = getElementsByTagName(HtmlTypeEnum.OPTION);
	...
	public int getHtmlSelectedIndex() {
		...
		final NodeList options = getElementsByTagName(HtmlTypeEnum.OPTION);
		for (int i = 0; i < options.getLength(); ++i) {
			if (((DOption) options.item(i)).getHtmlSelected()) {
				return i;
			}
		}
		return -1;
	...
	public DSelect setHtmlSelectedIndex(final String selectedIndex) {
		return setHtmlSelectedIndex(toInt("DSelect:selectedindex", selectedIndex)) ;
	}
	
	public DSelect setHtmlSelectedIndex(final int selectedIndex) {
		if (getHtmlMultiple()) {
			throw new DsfRuntimeException("unsupported method for multi-select element");
		}
		// Use getElementsByTagName() which creates a snapshot of all the
		...
		final NodeList options = getElementsByTagName(HtmlTypeEnum.OPTION);
		for (int i = 0; i < options.getLength(); ++i) {
			((DOption) options.item(i)).setHtmlSelected(
				i == selectedIndex);
		}
		return this ;
	}
	...
	public DHtmlCollection getHtmlOptions() {
		if (m_options == null) {
			m_options = new DHtmlCollection(this, DHtmlCollection.OPTION);
		}
		return m_options;
	}

	public int getHtmlLength() {
		return getHtmlOptions().getLength();
	}
	...
	public DSelect setHtmlDisabled(final String disabled) {
		return setHtmlDisabled(toBoolean("disabled", disabled)) ;
	}
	
	public DSelect setHtmlDisabled(final boolean disabled) {
	...
	public DSelect setHtmlMultiple(final String multiple) {
		return setHtmlMultiple(toBoolean("multiple", multiple)) ;
	}
	
	public DSelect setHtmlMultiple(final boolean multiple) {
	...
	public DSelect setHtmlName(final String name) {
		setHtmlAttribute(EHtmlAttr.name, name);
		return this ;
	}

	public int getHtmlSize() {
		return getHtmlAttributeInteger(EHtmlAttr.size);
	}

	public DSelect setHtmlSize(final String size) {
		return setHtmlSize(toInt("DSelect:size", size)) ;
	}
	
	public DSelect setHtmlSize(final int size) {
		setHtmlAttribute(EHtmlAttr.size, size);
		return this ;
	}

	public DSelect htmlAdd(
		final BaseHtmlElement element,
		final BaseHtmlElement before)
	{
		insertBefore(element, before);
		return this ;
	}

	public DSelect htmlRemove(final int index) {
		// Use getElementsByTagName() which creates a snapshot of all the
		// OPTION elements under this SELECT. Access to the returned NodeList
		// is very fast and the snapshot solves many synchronization problems.
	...
	public DSelect setHtmlAutoFocus(final String autofocus) {  // HTML 5.0
		return setHtmlAutoFocus(toBoolean("autofocus", autofocus)) ;
	}
	public DSelect setHtmlAutoFocus(final boolean autofocus) {  // HTML 5.0
...
//		Z.fmt("options", "" + getHtmlOptions()) +
		Z.fmt("seletedindex", "" + getHtmlSelectedIndex()) +
		Z.fmt("size", "" + getHtmlSize()) +
	 ...
	 */
	@Override
	public DSelect add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSelect add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSelect addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSelect dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DSelect dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DSelect setDsfRelationshipVerifier(
	 ...
	 */
	@Override
	public DSelect setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DSelect setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DSelect setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DSelect setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DSelect setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DSelect setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DSelect setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DSelect setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSelect setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DSelect setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DSelect setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DSelect setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DSelect setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DSelect setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DSelect setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DSelect setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DSelect setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DSelect setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DSelect setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DSelect setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSelect setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DSelect setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DSelect setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DSelect setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DSelect setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DSelect setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DSelect setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DSelect setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DSelect setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DSelect setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DSelect setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DSelect setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DSelect setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DSelect setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DSelect setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DSelect setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DSelect setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DSelect setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DSelect setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DSelect setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DSelect add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DSelect addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSelect addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DSelect addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DSelect jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DOptGroup _optgroup(final int count) {
		 return (DOptGroup)getOrCreate(DOptGroup.class, count) ;
	}
