...
*/
public class DP extends BaseAttrsHtmlElement
	implements IDBlock //, IDTransitional, IAttrs
{
	private static final long serialVersionUID = 4048796766621415217L;

	// For use with the align property
	/** "left" */
	...
	//
	public DP() {
		super(HtmlTypeEnum.P);
	}

	public DP(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.P);
	}
	
//	public DP(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	 ...
	 */
	public DP(final String textValue) {
		this() ;
		setHtmlExtTextValue(textValue) ;
	}
	
	public DP(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	 ...
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */
	public DP setHtmlAlign(final String align) {
	...
	// Extensions
	//
	public DP setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DP add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DP add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DP add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DP addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DP dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DP dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DP setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DP setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DP setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DP setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DP setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DP setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DP setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DP setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DP setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DP setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DP setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DP setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */	
	@Override
	public DP setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DP setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DP setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DP setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DP setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DP setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DP setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DP setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DP setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DP setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DP setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DP setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DP setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DP setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DP setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DP setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DP setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DP setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DP setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DP setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DP setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DP setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DP setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DP setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DP setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DP setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DP setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DP setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DP setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DP setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DP setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DP setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DP setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DP add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DP addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DP addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DP addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DP jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DP _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DP _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DP _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DP _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DP _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DP _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DP _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DP _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DP _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DP _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DP _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DP _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DP _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DP _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DP _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DP _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DP _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DP _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DP _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DP _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DP _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DP _buttonText_(final String textValue) {
	...
	public DP _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DP _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DP _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DP _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DP _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DP _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DP _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DP _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DP _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DP _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DP _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DP _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DP _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DP _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DP _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DP _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DP _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DP _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DP _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DP _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DP _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DP _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DP _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DP _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DP _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DP _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DP _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DP _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DP _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DP _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DP _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DP _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DP _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DP _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DP _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DP _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DP _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DP _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DP _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DP _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DP _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DP _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DP _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DP _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DP _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DP _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DP _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DP _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DP _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DP _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DP _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DP _labelText_(final String textValue) {
	...
	public DP _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DP _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DP _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DP _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DP _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DP _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DP _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DP _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DP _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DP _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DP _meter_(final String min, final String max, final String value) {
	...
	public DP _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DP _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DP _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DP _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DP _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DP _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DP _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DP _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DP _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DP _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DP _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DP _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DP _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DP _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DP _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DP _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DP _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DP _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DP _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DP _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DP _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DP _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DP _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DP _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DP _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DP _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DP _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DP _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DP _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DP _scriptText_(final String text, final String type) {
	...
	public DP _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DP _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DP _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DP _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DP _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DP _smallText_(final String textValue) {
	...
	public DP _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DP _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DP _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DP _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DP _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DP _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DP _strongText_(final String textValue) {
	...
	public DP _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DP _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DP _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DP _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DP _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DP _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DP _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DP _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DP _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DP _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DP _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DP _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DP _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DP _timeDateTime_(final String dateTime) {
	...
	public DP _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DP _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DP _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DP _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DP _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DP _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DP _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DP _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DP _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
