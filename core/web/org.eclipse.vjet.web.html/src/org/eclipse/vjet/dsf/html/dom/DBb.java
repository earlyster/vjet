...
/**
<a href='http://dev.w3.org/html5/spec/Overview.html#the-bb-element'>W3C bb</a>
<p>
The bb element represents a user agent command that the user can invoke.
 */
public class DBb extends BaseHtml50Element {
	private static final long serialVersionUID = 3258416110138046776L;
	
	/** "makeapp" */
	public static final String TYPE_MAKEAPP = "makeapp" ;

	//
	// Constructor(s)
	//
	public DBb() {
		super(HtmlTypeEnum.BB);
	}
	
	public DBb(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.BB);
	}
	
	public DBb(final String jif) {
		this() ;
		jif(jif) ;
	}
	...
	public DBb setHtmlType(final String type) {
	 ...
	 */
	@Override
	public DBb add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBb add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBb addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBb dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DBb dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DBb setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DBb setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DBb setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DBb setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DBb setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DBb setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DBb setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DBb setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DBb setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DBb setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBb setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DBb setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DBb setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DBb setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBb setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DBb setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DBb setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DBb setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DBb setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DBb setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DBb setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DBb setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DBb setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DBb setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBb setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DBb setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DBb setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DBb setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DBb setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DBb setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DBb setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DBb setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DBb setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DBb setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DBb setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DBb setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DBb setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DBb setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DBb setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DBb setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DBb setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DBb setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DBb setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DBb setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DBb setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DBb setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DBb add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DBb jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	@Override
	public DBb addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBb addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DBb addHtmlClassName(final CssClassConstant ccc) {
