...
* </pre>
*/
public class DMeta extends BaseOrigNonAttrs //BaseI18nHtmlElement
//	implements IDRepeatableHeadElement, IDTransitional, II18nAttributes,
//		/* HTML 5.0 */ IMetadataContent
{
	...
	//
	public DMeta() {
		super(HtmlTypeEnum.META);
	}
	
	public DMeta(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.META);
	}
	
	public DMeta(final String jif) {
		this() ;
		jif(jif) ;
	}
	...
	public String getHtmlContent() {
		return getHtmlAttribute(EHtmlAttr.content);
	}
	public DMeta setHtmlContent(final String content) {
		setHtmlAttribute(EHtmlAttr.content, content);
		return this ;
	}

	public String getHtmlHttpEquiv() {
		return getHtmlAttribute(EHtmlAttr.http_equiv);
	}
	public DMeta setHtmlHttpEquiv(final String httpEquiv) {
		setHtmlAttribute(EHtmlAttr.http_equiv, httpEquiv);
		return this ;
	}
	...
	public DMeta setHtmlName(final String name) {
	...
	public String getHtmlScheme() {
		return getHtmlAttribute(EHtmlAttr.scheme);
	}
	/**
	 * @deprecated - Not supported in HTML 5.0
	 */
	public DMeta setHtmlScheme(final String scheme) {
		setHtmlAttribute(EHtmlAttr.scheme, scheme);
		return this ;
	}
	
	public String getHtmlCharset() {	// HTML 5.0
		return getHtmlAttribute(EHtmlAttr.charset);
	}
	public DMeta setHtmlCharset(final String charset) {  // HTML 5.0
	...
	public String toString() {
		...
		Z.fmt("content", "" + getHtmlContent()) +
		Z.fmt("http-eqiv", "" + getHtmlHttpEquiv()) +
		Z.fmt("name", "" + getHtmlName()) +
		Z.fmt("scheme", getHtmlScheme()) +
	 ...
	 */
	@Override
	public DMeta add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMeta add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMeta addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMeta dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DMeta dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DMeta setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DMeta setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DMeta setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DMeta setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DMeta setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DMeta setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DMeta setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DMeta setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DMeta setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DMeta setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMeta setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DMeta setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DMeta setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DMeta setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMeta setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DMeta setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DMeta setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DMeta setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DMeta setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DMeta setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DMeta setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DMeta setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DMeta setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DMeta setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMeta setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DMeta setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DMeta setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DMeta setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DMeta setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DMeta setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DMeta setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DMeta setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DMeta setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DMeta setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DMeta setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DMeta setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DMeta setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DMeta setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DMeta setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DMeta setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DMeta setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DMeta setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DMeta setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DMeta setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DMeta add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DMeta addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMeta addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DMeta addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DMeta jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
