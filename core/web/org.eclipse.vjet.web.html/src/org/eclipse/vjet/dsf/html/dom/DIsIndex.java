...
* other elements.  Usage can be replaced by usage of form controls.
* <p>
...
* </FORM>
* </pre>
* deprecated deprecated in favor of input element.
* @RestrictedType
*/
public class DIsIndex extends BaseOrigNonAttrs //BaseCoreAndI18nHtmlElement
	implements /*IDHeadContent, */ IDBlock /*,IDTransitional , ICoreAttributes,II18nAttributes */
{
	...
	//
	public DIsIndex() {
		super(HtmlTypeEnum.ISINDEX);
	}
	
	public DIsIndex(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.ISINDEX);
	}
	
	public DIsIndex(final String jif) {
		this() ;
		jif(jif) ;
	}
	...
	public String getHtmlPrompt() {
		return getHtmlAttribute(EHtmlAttr.prompt);
	}
	public DIsIndex setHtmlPrompt(final String prompt) {
		setHtmlAttribute(EHtmlAttr.prompt, prompt);
		return this ;
	}
	 ...
	 */
	@Override
	public DIsIndex add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DIsIndex add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DIsIndex addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DIsIndex dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DIsIndex dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DIsIndex setDsfRelationshipVerifier(
	...
	@Override
	public DIsIndex cloned() {
		return (DIsIndex)super.cloned() ;
	}
     ...
     */
    @Override
    public DIsIndex setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DIsIndex setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DIsIndex setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DIsIndex setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DIsIndex setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DIsIndex setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DIsIndex setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DIsIndex setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DIsIndex setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DIsIndex setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DIsIndex setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DIsIndex setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DIsIndex setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DIsIndex setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DIsIndex setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DIsIndex setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DIsIndex setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DIsIndex setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DIsIndex setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DIsIndex setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DIsIndex setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DIsIndex setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DIsIndex setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DIsIndex setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DIsIndex setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DIsIndex setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DIsIndex setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DIsIndex setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DIsIndex setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DIsIndex add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	
//	@Override
//	public DIsIndex removeListener(
//		final EventType eventType, final IDomActiveListener listener)
//	{
...
//	}
	...
	//
	@Override
	public DIsIndex addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DIsIndex addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DIsIndex addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DIsIndex addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DIsIndex jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}
