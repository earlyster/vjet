...
public class Xhtml10Transitional {
	...
	private static final AttributeInfoEnumeration SHAPE_ATTR_INFO =
		new AttributeInfoEnumeration(
			...
			ShapeEnum.RECT);
	private static final AttributeInfoEnumeration IALIGN_ATTR_INFO =
		new AttributeInfoEnumeration("align", IAlignEnum.class);
	private static final AttributeInfoEnumeration DIR_ATTR_INFO =
		new AttributeInfoEnumeration("dir", DirEnum.class);
	private static final AttributeInfoEnumeration TEXT_ALIGN_ATTR_INFO =
		new AttributeInfoEnumeration("align", TextAlignEnum.class);
	...
	private static void addA(final Map<HtmlTypeEnum,IElementInfo> map) {
		...
		final XhtmlElementInfo elementInfo = new XhtmlElementInfo(HtmlTypeEnum.A,
			attrs, 
	...
	private static void addAbbr(final Map<HtmlTypeEnum,IElementInfo> map) {
		final XhtmlElementInfo elementInfo = new XhtmlElementInfo(
	 ...
	 * >
	 */
	private static void addApplet(final Map<HtmlTypeEnum,IElementInfo> map) {
		final HtmlTypeSet includeElements = new HtmlTypeSet();
	...
	private static void addArea(final Map<HtmlTypeEnum,IElementInfo> map) {
		...
		attrs.put(new AttributeInfoImpl("onblur"));
		final XhtmlElementInfo elementInfo = new XhtmlElementInfo(
			HtmlTypeEnum.AREA, attrs, IContentModel.EMPTY);
		map.put(elementInfo.getType(), elementInfo);	
	}
	...
	private static void addBase(final Map<HtmlTypeEnum,IElementInfo> map) {
		...
		attrs.put(new AttributeInfoImpl("target"));
		final XhtmlElementInfo elementInfo = new XhtmlElementInfo(
			HtmlTypeEnum.BASE, attrs, IContentModel.EMPTY);
		map.put(elementInfo.getType(), elementInfo);	
	}
	 ...
	 * >
	 */
	private static void addBaseFont(final Map<HtmlTypeEnum,IElementInfo> map) {
		final IAttributeInfoMap attrs = new AttributeInfoMapImpl();
		attrs.put(new AttributeInfoImpl("id", AttributeDataType.ID));
		attrs.put(new AttributeInfoImpl("size"));
		attrs.put(new AttributeInfoImpl("color"));
		attrs.put(new AttributeInfoImpl("face"));
		final XhtmlElementInfo elementInfo = new XhtmlElementInfo(
			HtmlTypeEnum.BASEFONT, attrs, IContentModel.EMPTY);
		map.put(elementInfo.getType(), elementInfo);	
	}
	...
	private static void addBody(final Map<HtmlTypeEnum,IElementInfo> map) {
		...
		attrs.put(new AttributeInfoImpl("background"));
		add(attrs, ATTRS_BODY_COLORS);
		final HtmlTypeSet includeElements = new HtmlTypeSet();
		includeElements.merge(SET_FLOW);
	...
	private static void addBr(final Map<HtmlTypeEnum,IElementInfo> map) {
		...
		final XhtmlElementInfo elementInfo = new XhtmlElementInfo(
			HtmlTypeEnum.BR, attrs, IContentModel.EMPTY);
		map.put(elementInfo.getType(), elementInfo);		
	}
	/** <!ELEMENT BUTTON - -
	...
	private static void addCaption(final Map<HtmlTypeEnum,IElementInfo> map) {
		final IAttributeInfoMap attrs = new AttributeInfoMapImpl();
		add(attrs,ATTRS_ATTRS);
		attrs.put(new AttributeInfoImpl("align"));
		final XhtmlElementInfo elementInfo = new XhtmlElementInfo(
	 ...
	 * >
	 */
	private static void addCenter(final Map<HtmlTypeEnum,IElementInfo> map) {
		final XhtmlElementInfo elementInfo = new XhtmlElementInfo(
			HtmlTypeEnum.CENTER, ATTRS_ATTRS, new ContentModelSets(SET_FLOW));
		map.put(elementInfo.getType(), elementInfo);		
	}
	/**
	 * <!ENTITY % phrase "EM | STRONG | DFN | CODE |
	...
	private static void addCol(final Map<HtmlTypeEnum,IElementInfo> map) {
		...
		final XhtmlElementInfo elementInfo = new XhtmlElementInfo(
			HtmlTypeEnum.COL, attrs, IContentModel.EMPTY);
		map.put(elementInfo.getType(), elementInfo);		
	}
	...
	private static void addColGroup(final Map<HtmlTypeEnum,IElementInfo> map) {
		...
		add(attrs,ATTRS_CELL_VALIGN);
		final XhtmlElementInfo elementInfo = new XhtmlElementInfo(
			HtmlTypeEnum.COLGROUP,attrs,new ContentModelSets(includeElements));
		map.put(elementInfo.getType(), elementInfo);		
	}
	...
	private static void addDelAndIns(final Map<HtmlTypeEnum,IElementInfo> map) {
		...
		final XhtmlElementInfo del = new XhtmlElementInfo(
			HtmlTypeEnum.DEL,
			attrs,
			new ContentModelSets(SET_FLOW));
		map.put(del.getType(), del);		
		final XhtmlElementInfo ins = new XhtmlElementInfo(
			HtmlTypeEnum.INS,
			attrs,
			new ContentModelSets(SET_FLOW));
	 ...
	 * >
	 */
	private static void addDirAndMenu(final Map<HtmlTypeEnum,IElementInfo> map) {
		final IAttributeInfoMap attrs = new AttributeInfoMapImpl();
		add(attrs,ATTRS_ATTRS);
		attrs.put(ATTR_COMPACT);
		final HtmlTypeSet includeElements = new HtmlTypeSet();
		includeElements.add(HtmlTypeEnum.LI);
		final XhtmlElementInfo dir = new XhtmlElementInfo(
			HtmlTypeEnum.DIR,
			attrs,
			new ContentModelSets(includeElements,SET_BLOCK));
		map.put(dir.getType(), dir);
		final XhtmlElementInfo menu = new XhtmlElementInfo(
			HtmlTypeEnum.MENU,
			new AttributeInfoMapImpl(),
			new ContentModelSets(includeElements,SET_BLOCK));
		map.put(menu.getType(), menu);
	}
	 ...
	 * >
	 */
	private static void addFont(final Map<HtmlTypeEnum,IElementInfo> map) {
		final IAttributeInfoMap attrs = new AttributeInfoMapImpl();
		add(attrs,ATTRS_CORE);
	...
	private static void addHeadings(final Map<HtmlTypeEnum,IElementInfo> map) {
		...
		add(attrs,ATTRS_ATTRS);
		add(attrs,ATTRS_ALIGN);
		map.put(HtmlTypeEnum.H1, new XhtmlElementInfo(
			HtmlTypeEnum.H1,
			attrs,
			new ContentModelSets(SET_INLINE) ));
		map.put(HtmlTypeEnum.H2, new XhtmlElementInfo(
			HtmlTypeEnum.H2,
			attrs,
			new ContentModelSets(SET_INLINE) ));
		map.put(HtmlTypeEnum.H3, new XhtmlElementInfo(
			HtmlTypeEnum.H3,
			attrs,
			new ContentModelSets(SET_INLINE) ));
		map.put(HtmlTypeEnum.H4, new XhtmlElementInfo(
			HtmlTypeEnum.H4,
			attrs,
			new ContentModelSets(SET_INLINE) ));
		map.put(HtmlTypeEnum.H5, new XhtmlElementInfo(
			HtmlTypeEnum.H5,
			attrs,
			new ContentModelSets(SET_INLINE) ));
		map.put(HtmlTypeEnum.H6, new XhtmlElementInfo(
			HtmlTypeEnum.H6,
			attrs,
			new ContentModelSets(SET_INLINE) ));
	}
	...
	private static void addHr(final Map<HtmlTypeEnum,IElementInfo> map) {
		final IAttributeInfoMap attrs = new AttributeInfoMapImpl();
		add(attrs,ATTRS_ATTRS);
		attrs.put(new AttributeInfoEnumeration("align", HrAlignEnum.class));		
		attrs.put(new AttributeInfoBoolean("noshade"));		
		attrs.put(new AttributeInfoImpl("size"));		
		attrs.put(new AttributeInfoImpl("width"));		
		final XhtmlElementInfo elementInfo = new XhtmlElementInfo(
			HtmlTypeEnum.HR,
	 ...
	 * >
	 */
	private static void addIframe(final Map<HtmlTypeEnum,IElementInfo> map) {
		final IAttributeInfoMap attrs = new AttributeInfoMapImpl();
		add(attrs,ATTRS_CORE);
		attrs.put(new AttributeInfoImpl("longdesc"));		
		attrs.put(new AttributeInfoImpl("name"));		
		attrs.put(new AttributeInfoImpl("src"));
		attrs.put(new AttributeInfoEnumeration("frameborder",
			FrameBorder.class, AttributeDefault.IMPLIED, FrameBorder.ONE));		
		attrs.put(new AttributeInfoImpl("marginwidth"));		
		attrs.put(new AttributeInfoImpl("marginheight"));		
		attrs.put(new AttributeInfoEnumeration("scrolling",
			ScrollingEnum.class, AttributeDefault.IMPLIED, ScrollingEnum.AUTO));		
		attrs.put(IALIGN_ATTR_INFO);		
		attrs.put(new AttributeInfoImpl("height"));		
		attrs.put(new AttributeInfoImpl("width"));		
		final XhtmlElementInfo elementInfo = new XhtmlElementInfo(
	 ...
	 * >
	 */
	private static void addIsIndex(final Map<HtmlTypeEnum,IElementInfo> map) {
		final IAttributeInfoMap attrs = new AttributeInfoMapImpl();
		add(attrs,ATTRS_CORE);
		add(attrs,ATTRS_I18N);
		attrs.put(new AttributeInfoImpl("prompt"));		
		final XhtmlElementInfo elementInfo = new XhtmlElementInfo(
			HtmlTypeEnum.ISINDEX,
			attrs,
			IContentModel.EMPTY);
		map.put(elementInfo.getType(), elementInfo);		
	}
	...
	private static void addLegend(final Map<HtmlTypeEnum,IElementInfo> map) {
		...
		add(attrs,ATTRS_ATTRS);
		attrs.put(new AttributeInfoImpl("accesskey"));
		attrs.put(new AttributeInfoEnumeration("align", LegendAlignEnum.class));		
		final XhtmlElementInfo elementInfo = new XhtmlElementInfo(
			HtmlTypeEnum.LEGEND,
			attrs,
			new ContentModelSets(SET_INLINE));
	 ...
	 */
	private static void addNoFrames(final Map<HtmlTypeEnum,IElementInfo> map) {
		final IAttributeInfoMap attrs = new AttributeInfoMapImpl();
		add(attrs,ATTRS_ATTRS);
		final XhtmlElementInfo elementInfo = new XhtmlElementInfo(
			HtmlTypeEnum.NOFRAMES,
			attrs,
			new ContentModelSets(SET_FLOW));
		map.put(elementInfo.getType(), elementInfo);
	}
	 ...
	 * >
	 */
	private static void addS(final Map<HtmlTypeEnum,IElementInfo> map) {
		final XhtmlElementInfo elementInfo = new XhtmlElementInfo(
			HtmlTypeEnum.S, ATTRS_ATTRS,
			new ContentModelSets(SET_INLINE,null));
		map.put(elementInfo.getType(), elementInfo);
	}
	/**
	 ...
	 * >
	 */
	private static void addStrike(final Map<HtmlTypeEnum,IElementInfo> map) {
		final XhtmlElementInfo elementInfo = new XhtmlElementInfo(
			HtmlTypeEnum.STRIKE, ATTRS_ATTRS,
			new ContentModelSets(SET_INLINE,null));
		map.put(elementInfo.getType(), elementInfo);
	}
	/**
	...
	private static void addSubAndSup(final Map<HtmlTypeEnum,IElementInfo> map) {
		final IAttributeInfoMap attrs = new AttributeInfoMapImpl();
		add(attrs,ATTRS_ATTRS);
		final XhtmlElementInfo sub = new XhtmlElementInfo(
			HtmlTypeEnum.SUB,
			attrs,
			new ContentModelSets(SET_INLINE));
		map.put(sub.getType(), sub);
		final XhtmlElementInfo sup = new XhtmlElementInfo(
			HtmlTypeEnum.SUP,
			attrs,
			new ContentModelSets(SET_INLINE));
	...
	private static void addTable(final Map<HtmlTypeEnum,IElementInfo> map) {
		...
		attrs.put(new AttributeInfoEnumeration("align", TableAlignEnum.class));
		attrs.put(new AttributeInfoImpl("bgcolor"));
		add(attrs, ATTRS_RESERVED);
	...
	private static void addTbodyTfootThead(final Map<HtmlTypeEnum,IElementInfo> map) {
		...
		map.put(HtmlTypeEnum.TBODY, new XhtmlElementInfo(
			HtmlTypeEnum.TBODY,
			attrs,
			new ContentModelSets(includeElements) ));
		map.put(HtmlTypeEnum.TFOOT, new XhtmlElementInfo(
			HtmlTypeEnum.TFOOT,
			attrs,
			new ContentModelSets(includeElements) ));
		map.put(HtmlTypeEnum.THEAD, new XhtmlElementInfo(
			HtmlTypeEnum.THEAD,
			attrs,
			new ContentModelSets(includeElements) ));
	}
	...
	private static void addTdAndTh(final Map<HtmlTypeEnum,IElementInfo> map) {
		...
		add(attrs,ATTRS_CELL_HALIGN);
		add(attrs,ATTRS_CELL_VALIGN);
		attrs.put(new AttributeInfoBoolean("nowrap"));
		attrs.put(new AttributeInfoImpl("bgcolor"));
		attrs.put(new AttributeInfoImpl("width"));
		attrs.put(new AttributeInfoImpl("height"));
		map.put(HtmlTypeEnum.TD, new XhtmlElementInfo(
			HtmlTypeEnum.TD,
			attrs,
			new ContentModelSets(SET_FLOW)));
		map.put(HtmlTypeEnum.TH, new XhtmlElementInfo(
			HtmlTypeEnum.TH,
			attrs,
			new ContentModelSets(SET_FLOW)));
	}
	...
	private static void addTr(final Map<HtmlTypeEnum,IElementInfo> map) {
		...
		map.put(HtmlTypeEnum.TR, new XhtmlElementInfo(
			HtmlTypeEnum.TR,
			attrs,
			new ContentModelSets(includeElements)));
	}
	 ...
	 * >
	 */
	private static void addU(final Map<HtmlTypeEnum,IElementInfo> map) {
		final XhtmlElementInfo elementInfo = new XhtmlElementInfo(
			HtmlTypeEnum.U, ATTRS_ATTRS,
			new ContentModelSets(SET_INLINE,null));
		map.put(elementInfo.getType(), elementInfo);
	}
	 ...
	 * >
	 */
	private static void addVar(final Map<HtmlTypeEnum,IElementInfo> map) {
		final XhtmlElementInfo elementInfo = new XhtmlElementInfo(
			HtmlTypeEnum.VAR, ATTRS_ATTRS,
			new ContentModelSets(SET_INLINE,null));
		map.put(elementInfo.getType(), elementInfo);
	}
	...
	private static IAttributeInfoMap createBodyColorsAttrs() {
		final IAttributeInfoMap map = new AttributeInfoMapImpl();
		map.put(new AttributeInfoImpl("bgcolor"));
		map.put(new AttributeInfoImpl("text"));
		map.put(new AttributeInfoImpl("link"));
		map.put(new AttributeInfoImpl("vlink"));
		map.put(new AttributeInfoImpl("alink"));
		return AttributeInfoMapImpl.createUnmodifiable(map);
	}
	/** <!ENTITY % cellhalign
	...
	private static HtmlTypeSet createFontStyleSet(){
		...
		set.add(HtmlTypeEnum.U);
		set.add(HtmlTypeEnum.S);
		set.add(HtmlTypeEnum.STRIKE);
