...
*/
public class DCode extends BaseAttrsHtmlElement
	/* implements IDPhrase, IDStrict, IAttrs */
{
	...
	//
	public DCode() {
		super(HtmlTypeEnum.CODE);
	}

	public DCode(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.CODE);
	}
	
//	public DCode(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	
	/**
	 * The extension Constructor which creates an instance with DText child with 
	 * the passed in value.  If the passed in value is null, no DText child is 
	 * created.
	 */
	public DCode(final String textValue) {
		this() ;
		setHtmlExtTextValue(textValue) ;
	}
	
	public DCode(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.CODE ;
	}
		
	//
	// Extensions
	//
	public DCode setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DCode add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DCode add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCode add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCode addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCode dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DCode dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DCode setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DCode setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DCode setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DCode setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DCode setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DCode setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DCode setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DCode setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DCode setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DCode setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCode setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DCode setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DCode setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DCode setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCode setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DCode setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DCode setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DCode setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DCode setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DCode setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DCode setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DCode setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DCode setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DCode setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCode setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DCode setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DCode setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DCode setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DCode setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DCode setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DCode setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DCode setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DCode setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DCode setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DCode setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DCode setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DCode setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DCode setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DCode setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DCode setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DCode setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DCode setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DCode setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DCode setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DCode setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DCode setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DCode add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DCode addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCode addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DCode addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DCode jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DCode _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DCode _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DCode _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DCode _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DCode _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DCode _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DCode _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DCode _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DCode _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DCode _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DCode _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DCode _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DCode _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DCode _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DCode _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DCode _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DCode _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DCode _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DCode _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DCode _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DCode _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DCode _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DCode _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DCode _buttonText_(final String textValue) {
	...
	public DCode _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DCode _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DCode _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DCode _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DCode _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DCode _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DCode _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DCode _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DCode _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DCode _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DCode _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DCode _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DCode _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DCode _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DCode _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DCode _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DCode _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DCode _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DCode _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DCode _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DCode _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DCode _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DCode _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DCode _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DCode _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DCode _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DCode _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DCode _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DCode _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DCode _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DCode _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DCode _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DCode _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DCode _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DCode _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DCode _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DCode _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DCode _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DCode _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DCode _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DCode _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DCode _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DCode _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DCode _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DCode _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DCode _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DCode _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DCode _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DCode _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DCode _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DCode _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DCode _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DCode _labelText_(final String textValue) {
	...
	public DCode _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DCode _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DCode _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DCode _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DCode _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DCode _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DCode _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DCode _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DCode _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DCode _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DCode _meter_(final String min, final String max, final String value) {
	...
	public DCode _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DCode _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DCode _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DCode _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DCode _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DCode _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DCode _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DCode _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DCode _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DCode _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DCode _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DCode _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DCode _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DCode _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DCode _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DCode _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DCode _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DCode _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DCode _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DCode _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DCode _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DCode _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DCode _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DCode _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DCode _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DCode _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DCode _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DCode _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DCode _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DCode _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DCode _scriptText_(final String text, final String type) {
	...
	public DCode _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DCode _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DCode _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DCode _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DCode _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DCode _smallText_(final String textValue) {
	...
	public DCode _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DCode _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DCode _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DCode _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DCode _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DCode _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DCode _strongText_(final String textValue) {
	...
	public DCode _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DCode _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DCode _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DCode _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DCode _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DCode _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DCode _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DCode _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DCode _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DCode _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DCode _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DCode _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DCode _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DCode _timeDateTime_(final String dateTime) {
	...
	public DCode _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DCode _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DCode _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DCode _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DCode _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DCode _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DCode _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DCode _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DCode _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}