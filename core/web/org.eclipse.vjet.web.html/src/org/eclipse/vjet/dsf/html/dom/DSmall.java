...
/**
* http://www.w3.org/TR/REC-html40/present/graphics.html#edef-SMALL
*/
public class DSmall extends BaseAttrsHtmlElement
	/*implements IDFontStyle, IDStrict, IAttrs*/
{
	...
	//
	public DSmall() {
		super(HtmlTypeEnum.SMALL);
	}
	
	public DSmall(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.SMALL);
	}
	
//	public DSmall(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	
	public DSmall(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}	
	 ...
	 */
	public DSmall(final String textValue) {
		this() ;
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.SMALL ;
	}
			
	//
	// Extensions
	//
	public DSmall setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DSmall add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DSmall add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSmall add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSmall addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSmall dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DSmall dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DSmall setDsfRelationshipVerifier(
	...
	@Override
	public DSmall cloned() {
		return (DSmall)super.cloned() ;
	}
     ...
     */
    @Override
    public DSmall setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DSmall setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DSmall setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DSmall setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DSmall setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DSmall setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DSmall setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DSmall setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DSmall setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSmall setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DSmall setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DSmall setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DSmall setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSmall setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DSmall setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DSmall setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DSmall setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DSmall setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DSmall setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DSmall setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DSmall setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DSmall setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DSmall setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSmall setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DSmall setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DSmall setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DSmall setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DSmall setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DSmall setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DSmall setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DSmall setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DSmall setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DSmall setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DSmall setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DSmall setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DSmall setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DSmall setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DSmall setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DSmall setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DSmall setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DSmall setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DSmall setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DSmall setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DSmall add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DSmall addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSmall addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DSmall addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DSmall jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DSmall _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DSmall _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DSmall _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DSmall _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DSmall _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DSmall _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DSmall _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DSmall _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DSmall _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DSmall _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DSmall _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DSmall _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DSmall _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DSmall _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DSmall _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DSmall _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DSmall _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DSmall _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DSmall _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DSmall _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DSmall _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DSmall _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DSmall _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DSmall _buttonText_(final String textValue) {
	...
	public DSmall _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DSmall _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DSmall _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DSmall _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DSmall _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DSmall _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DSmall _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DSmall _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DSmall _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DSmall _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DSmall _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DSmall _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DSmall _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DSmall _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DSmall _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DSmall _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DSmall _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DSmall _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DSmall _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DSmall _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DSmall _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DSmall _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DSmall _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DSmall _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DSmall _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DSmall _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DSmall _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DSmall _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DSmall _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DSmall _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DSmall _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DSmall _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DSmall _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DSmall _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DSmall _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DSmall _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DSmall _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DSmall _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DSmall _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DSmall _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DSmall _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DSmall _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DSmall _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DSmall _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DSmall _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DSmall _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DSmall _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DSmall _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DSmall _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DSmall _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DSmall _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DSmall _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DSmall _labelText_(final String textValue) {
	...
	public DSmall _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DSmall _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DSmall _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DSmall _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DSmall _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DSmall _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DSmall _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DSmall _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DSmall _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DSmall _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DSmall _meter_(final String min, final String max, final String value) {
	...
	public DSmall _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DSmall _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DSmall _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DSmall _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DSmall _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DSmall _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DSmall _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DSmall _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DSmall _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DSmall _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DSmall _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DSmall _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DSmall _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DSmall _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DSmall _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DSmall _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DSmall _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DSmall _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DSmall _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DSmall _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DSmall _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DSmall _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DSmall _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DSmall _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DSmall _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DSmall _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DSmall _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DSmall _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DSmall _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DSmall _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DSmall _scriptText_(final String text, final String type) {
	...
	public DSmall _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DSmall _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DSmall _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DSmall _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DSmall _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DSmall _smallText_(final String textValue) {
	...
	public DSmall _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DSmall _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DSmall _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DSmall _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DSmall _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DSmall _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DSmall _strongText_(final String textValue) {
	...
	public DSmall _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DSmall _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DSmall _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DSmall _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DSmall _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DSmall _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DSmall _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DSmall _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DSmall _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DSmall _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DSmall _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DSmall _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DSmall _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DSmall _timeDateTime_(final String dateTime) {
	...
	public DSmall _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DSmall _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DSmall _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DSmall _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DSmall _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DSmall _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DSmall _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DSmall _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DSmall _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
