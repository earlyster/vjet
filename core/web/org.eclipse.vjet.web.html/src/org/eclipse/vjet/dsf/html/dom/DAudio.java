...
/**
<a href='http://dev.w3.org/html5/spec/Overview.html#audio'>W3C audio</a>
<p>
 ...
 */
public class DAudio extends BaseHtml50Element 
//	implements /* HTML 5.0 */ IEmbeddedContent
{
	...
	//
	public DAudio() {
		super(HtmlTypeEnum.AUDIO);
	}
	
	public DAudio(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.ADDRESS);
	}
	
	public DAudio(final String jif) {
		this() ;
		jif(jif) ;
	}
	
	public DAudio(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public DAudio setHtmlSrc(final String srcUrl) {
	...
	public DAudio setHtmlAutoBuffer(final boolean autobuffer) {
		setHtmlAttribute(EHtmlAttr.autobuffer, autobuffer) ;
		return this ;
	}
	public DAudio setHtmlAutoBuffer(final String autobuffer) {
		setHtmlAttribute(EHtmlAttr.autobuffer, autobuffer) ;
		return this ;
	}
	...
	public DAudio setHtmlAutoPlay(final boolean autoPlay) {
		setHtmlAttribute(EHtmlAttr.autoplay, autoPlay) ;
		return this ;
	}
	public DAudio setHtmlAutoPlay(final String autoPlay) {
		setHtmlAttribute(EHtmlAttr.autoplay, autoPlay) ;
		return this ;
	}
	...
	public DAudio setHtmlLoop(final boolean loop) {
		setHtmlAttribute(EHtmlAttr.loop, loop) ;
		return this ;
	}
	public DAudio setHtmlLoop(final String loop) {
		setHtmlAttribute(EHtmlAttr.loop, loop) ;
		return this ;
	}
	...
	public DAudio setHtmlControls(final boolean controls) {
		setHtmlAttribute(EHtmlAttr.controls, controls) ;
		return this ;
	}
	public DAudio setHtmlControls(final String controls) {
		setHtmlAttribute(EHtmlAttr.controls, controls) ;
		return this ;
	}
...
//	}
//	public DAudio setHtmlEnd(final String end) {
//		setHtmlAttribute(EHtmlAttr.end, end);
//		return this ;
//	}
//	public DAudio setHtmlEnd(final int end) {
//		setHtmlAttribute(EHtmlAttr.end, end);
//		return this ;
//	}
...
//	}
//	public DAudio setHtmlLoopEnd(final String loopend) {
//		setHtmlAttribute(EHtmlAttr.loopend, loopend);
//		return this ;
//	}
//	public DAudio setHtmlLoopEnd(final int loopend) {
//		setHtmlAttribute(EHtmlAttr.loopend, loopend);
//		return this ;
//	}
...
//	}
//	public DAudio setHtmlLoopStart(final String loopstart) {
//		setHtmlAttribute(EHtmlAttr.loopstart, loopstart);
//		return this ;
//	}
//	public DAudio setHtmlLoopStart(final int loopstart) {
//		setHtmlAttribute(EHtmlAttr.loopstart, loopstart);
//		return this ;
//	}
...
//	}
//	public DAudio setHtmlPlayCount(final String playcount) {
//		setHtmlAttribute(EHtmlAttr.playcount, playcount);
//		return this ;
//	}
//	public DAudio setHtmlPlayCount(final int playcount) {
//		setHtmlAttribute(EHtmlAttr.playcount, playcount);
//		return this ;
//	}
...
//	}
//	public DAudio setHtmlStart(final String start) {
//		setHtmlAttribute(EHtmlAttr.start, start);
//		return this ;
//	}
//	public DAudio setHtmlStart(final int start) {
//		setHtmlAttribute(EHtmlAttr.start, start);
//		return this ;
//	}
	...
	//
	@Override
	public DAudio jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAudio add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DAudio add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAudio add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAudio addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAudio dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DAudio dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DAudio setDsfRelationshipVerifier(
	...
	@Override
	public DAudio cloned() {
		return (DAudio)super.cloned() ;
	}
     ...
     */
    @Override
    public DAudio setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DAudio setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DAudio setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DAudio setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DAudio setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DAudio setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DAudio setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DAudio setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DAudio setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAudio setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DAudio setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DAudio setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DAudio setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAudio setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DAudio setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DAudio setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DAudio setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DAudio setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DAudio setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DAudio setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DAudio setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DAudio setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DAudio setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAudio setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DAudio setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DAudio setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DAudio setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DAudio setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DAudio setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DAudio setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DAudio setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DAudio setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DAudio setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DAudio setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DAudio setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DAudio setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DAudio setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DAudio setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DAudio setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DAudio setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DAudio setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DAudio setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DAudio setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DAudio add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DAudio addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAudio addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DAudio addHtmlClassName(final CssClassConstant ccc) {
	...
	public DAudio _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DAudio _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DAudio _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DAudio _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DAudio _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DAudio _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DAudio _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DAudio _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DAudio _address_(final int count) {
		 _address(count) ;
		 return this ;
	}
	...
	public DAudio _address_(final String jif) {
		_address(jif) ;
		return this ;
	}
	...
	public DAudio _address_(BaseHtmlElement... elements) {
		_address(elements) ;
		return this ;
	}
	...
	public DAudio _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DAudio _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DAudio _article_(final int count) {
		_article(count) ;
		return this ;
	}
	...
	public DAudio _article_(final String jif) {
		_article(jif) ;
		return this ;
	}
	...
	public DAudio _articleText_(final String textValue) {
	...
	public DAudio _article_(BaseHtmlElement... elements) {
		_article(elements) ;
		return this ;
	}
	...
	public DAudio _aside_(final int count) {
		 _aside(count) ;
		 return this ;
	}
	...
	public DAudio _aside_(final String jif) {
		_aside(jif) ;
		return this ;
	}
	...
	public DAudio _asideText_(final String textValue) {
	...
	public DAudio _aside_(BaseHtmlElement... elements) {
		_aside(elements) ;
		return this ;
	}
	...
	public DAudio _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DAudio _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DAudio _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DAudio _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DAudio _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DAudio _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DAudio _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DAudio _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DAudio _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DAudio _blockquote_(final int count) {
		_blockquote(count) ;
		return this ;
	}
	...
	public DAudio _blockquote_(final String jif) {
		_blockquote(jif) ;
		return this ;
	}
	...
	public DAudio _blockquoteText_(final String textValue) {
	...
	public DAudio _blockquote_(BaseHtmlElement... elements) {
	...
	public DAudio _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DAudio _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DAudio _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DAudio _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DAudio _buttonText_(final String textValue) {
	...
	public DAudio _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DAudio _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DAudio _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DAudio _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DAudio _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DAudio _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DAudio _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DAudio _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DAudio _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DAudio _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DAudio _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DAudio _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DAudio _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DAudio _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DAudio _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DAudio _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DAudio _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DAudio _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DAudio _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DAudio _details_(final int count) {
		_details(count) ;
		return this ;
	}
	...
	public DAudio _details_(final String jif) {
		_details(jif) ;
		return this ;
	}
	...
	public DAudio _details_(BaseHtmlElement... elements) {
		_details(elements) ;
		return this ;
	}
	...
	public DAudio _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DAudio _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DAudio _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DAudio _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DAudio _div_(final int count) {
		_div(count) ;
		return this ;
	}
	...
	public DAudio _div_(final String jif) {
		_div(jif) ;
		return this ;
	}
	...
	public DAudio _div_(BaseHtmlElement... elements) {
		_div(elements) ;
		return this ;
	}
	...
	public DAudio _dl_(final int count) {
		_dl(count) ;
		return this ;
	}
	...
	public DAudio _dl_(final String jif) {
		_dl().jif(jif) ;
		return this ;
	}
	...
	public DAudio _dl_(BaseHtmlElement... elements) {
		_dl(elements) ;
		return this ;
	}
	...
	public DAudio _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DAudio _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DAudio _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DAudio _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DAudio _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DAudio _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DAudio _fieldset_(final int count) {
		_fieldset(count) ;
		return this ;
	}
	...
	public DAudio _fieldset_(final String jif) {
		_fieldset(jif) ;
		return this ;
	}
	...
	public DAudio _fieldsetLegend_(final String legend) {
	...
	public DAudio _fieldset_(BaseHtmlElement... elements) {
		_fieldset(elements) ;
		return this ;
	}
	...
	public DAudio _figure_(final int count) {
		_figure(count) ;
		return this ;
	}
	...
	public DAudio _figure_(final String jif) {
		_figure(jif) ;
		return this ;
	}
	...
	public DAudio _figure_(BaseHtmlElement... elements) {
		_figure(elements) ;
		return this ;
	}
	...
	public DAudio _footer_(final int count) {
		_footer(count) ;
		return this ;
	}
	...
	public DAudio _footer_(final String jif) {
		_footer(jif) ;
		return this ;
	}
	...
	public DAudio _footerText_(final String textValue) {
	...
	public DAudio _footer_(BaseHtmlElement... elements) {
		_footer(elements) ;
		return this ;
	}
	...
	public DAudio _form_(final int count) {
		_form(count) ;
		return this ;
	}
	...
	public DAudio _form_(final String jif) {
		_form(jif) ;
		return this ;
	}
	...
	public DAudio _form_(BaseHtmlElement... elements) {
		_form(elements) ;
		return this ;
	}
	...
	public DAudio _h1_(final int count) {
		_h1(count);
		return this ;
	}
	...
	public DAudio _h1_(final String jif) {
		_h1(jif) ;
		return this ;
	}
	...
	public DAudio _h1Text_(final String textValue) {
		_h1Text(textValue) ;
		return this ;
	}
	...
	public DAudio _h1_(BaseHtmlElement... elements) {
		_h1(elements) ;
		return this ;
	}
	...
	public DAudio _h2_(final int count) {
		_h2(count);
		return this ;
	}
	...
	public DAudio _h2_(final String jif) {
		_h2(jif) ;
		return this ;
	}
	...
	public DAudio _h2Text_(final String textValue) {
		_h2Text(textValue) ;
		return this ;
	}
	...
	public DAudio _h2_(BaseHtmlElement... elements) {
		_h2(elements) ;
		return this ;
	}
	...
	public DAudio _h3_(final int count) {
		_h3(count);
		return this ;
	}
	...
	public DAudio _h3_(final String jif) {
		_h3(jif) ;
		return this ;
	}
	...
	public DAudio _h3Text_(final String textValue) {
		_h3Text(textValue) ;
		return this ;
	}
	...
	public DAudio _h3_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DAudio _h4_(final int count) {
		_h4(count);
		return this ;
	}
	...
	public DAudio _h4_(final String jif) {
		_h4(jif) ;
		return this ;
	}
	...
	public DAudio _h4Text_(final String textValue) {
		_h4Text(textValue) ;
		return this ;
	}
	...
	public DAudio _h4_(BaseHtmlElement... elements) {
		_h4(elements) ;
		return this ;
	}
	...
	public DAudio _h5_(final int count) {
		_h5(count);
		return this ;
	}
	...
	public DAudio _h5_(final String jif) {
		_h5(jif) ;
		return this ;
	}
	...
	public DAudio _h5Text_(final String textValue) {
		_h5Text(textValue) ;
		return this ;
	}
	...
	public DAudio _h5_(BaseHtmlElement... elements) {
		_h5(elements) ;
		return this ;
	}
	...
	public DAudio _h6_(final int count) {
		_h6(count);
		return this ;
	}
	...
	public DAudio _h6_(final String jif) {
		_h6(jif) ;
		return this ;
	}
	...
	public DAudio _h6Text_(final String textValue) {
		_h6Text(textValue) ;
		return this ;
	}
	...
	public DAudio _h6_(BaseHtmlElement... elements) {
		_h6(elements) ;
		return this ;
	}
	...
	public DAudio _header_(final int count) {
		_header(count) ;
		return this ;
	}
	...
	public DAudio _header_(final String jif) {
		_header(jif) ;
		return this ;
	}
	...
	public DAudio _header_(BaseHtmlElement... elements) {
		_header(elements) ;
		return this ;
	}
	...
	public DAudio _hgroup_(final int count) {
		_hgroup(count) ;
		return this ;
	}
	...
	public DAudio _hgroup_(final String jif) {
		_hgroup(jif) ;
		return this ;
	}
	...
	public DAudio _hgroup_(BaseHtmlElement... elements) {
		_hgroup(elements) ;
		return this ;
	}
	...
	public DAudio _hr_(final int count) {
		_hr(count) ;
		return this ;
	}
	...
	public DAudio _hr_(final String jif) {
		_hr(jif) ;
		return this ;
	}
	...
	public DAudio _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DAudio _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DAudio _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DAudio _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DAudio _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DAudio _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DAudio _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DAudio _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DAudio _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DAudio _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DAudio _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DAudio _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DAudio _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DAudio _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DAudio _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DAudio _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DAudio _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DAudio _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DAudio _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DAudio _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DAudio _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DAudio _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DAudio _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DAudio _labelText_(final String textValue) {
	...
	public DAudio _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DAudio _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DAudio _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DAudio _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DAudio _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DAudio _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DAudio _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
	...
	public DAudio _menu_(final int count) {
		_menu(count) ;
		return this ;
	}
	...
	public DAudio _menu_(final String jif) {
		_menu(jif) ;
		return this ;
	}
	...
	public DAudio _menu_(BaseHtmlElement... elements) {
		_menu(elements) ;
		return this ;
	}
	...
	public DAudio _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DAudio _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DAudio _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
...
value) {
	...
	public DAudio _meter_(final String min, final String max, final String value) 

{
	...
	public DAudio _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
...
value) {
	...
	public DAudio _meter_(final double min, final double max, final double value) 

{
	...
	public DAudio _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DAudio _nav_(final int count) {
		_nav(count) ;
		return this ;
	}
	...
	public DAudio _nav_(final String jif) {
		_nav(jif) ;
		return this ;
	}
	...
	public DAudio _nav_(BaseHtmlElement... elements) {
		_nav(elements) ;
		return this ;
	}
	...
	public DAudio _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DAudio _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DAudio _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DAudio _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DAudio _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DAudio _ol_(final int count) {
		_ol(count) ;
		return this ;
	}
	...
	public DAudio _ol_(final String jif) {
		_ol(jif) ;
		return this ;
	}
	...
	public DAudio _ol_(final Collection<Object> collection) {
		_ol(collection) ;
		return this ;
	}
...

{
	...
	public DAudio _ol_(final Collection<Object> collection, final String 
...
htmlType) {
	...
	public DAudio _ol_(DLi... elements) {
		_ol(elements) ;
		return this ;
	}
	...
	public DAudio _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DAudio _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DAudio _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DAudio _p_(final int count) {
		_p(count) ;
		return this ;
	}
	...
	public DAudio _p_(final String jif) {
		_p(jif) ;
		return this ;
	}
	...
	public DAudio _pText_(final String textValue) {
		_pText(textValue) ;
		return this ;
	}
	...
	public DAudio _p_(BaseHtmlElement... elements) {
		_p(elements) ;
		return this ;
	}
	...
	public DAudio _pre_(final int count) {
		_pre(count) ;
		return this ;
	}
	...
	public DAudio _pre_(final String jif) {
		_pre(jif) ;
		return this ;
	}
	...
	public DAudio _preText_(final String textValue) {
		_preText(textValue) ;
		return this ;
	}
	...
	public DAudio _pre_(BaseHtmlElement... elements) {
		_pre(elements) ;
		return this ;
	}
	...
	public DAudio _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DAudio _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DAudio _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DAudio _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DAudio _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DAudio _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DAudio _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DAudio _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DAudio _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DAudio _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DAudio _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DAudio _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DAudio _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DAudio _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DAudio _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DAudio _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DAudio _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DAudio _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DAudio _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DAudio _scriptText_(final String text, final String type) {
	...
	public DAudio _section_(final int count) {
		_section(count) ;
		return this ;
	}
	...
	public DAudio _section_(final String jif) {
		_section(jif) ;
		return this ;
	}
	...
	public DAudio _section_(BaseHtmlElement... elements) {
		_section(elements) ;
		return this ;
	}
	...
	public DAudio _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DAudio _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DAudio _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DAudio _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DAudio _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DAudio _smallText_(final String textValue) {
	...
	public DAudio _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DAudio _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DAudio _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DAudio _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DAudio _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DAudio _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DAudio _strongText_(final String textValue) {
	...
	public DAudio _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DAudio _style_(final int count) {
		_style(count) ;
		return this ;
	}
	...
	public DAudio _style_(final String jif) {
		_style(jif) ;
		return this ;
	}
	...
	public DAudio _styleText_(final String styleText) {
	...
	public DAudio _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DAudio _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DAudio _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DAudio _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DAudio _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DAudio _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DAudio _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DAudio _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
	...
	public DAudio _table_(final int count) {
		_table(count);
		return this ;
	}
	...
	public DAudio _table_(final String jif) {
		_table(jif) ;
		return this ;
	}
	...
	public DAudio _table_(DTr... rows) {
		_table(rows) ;
		return this ;
	}
	...
	public DAudio _table_(BaseHtmlElement... elements) {
		_table(elements) ;
		return this ;
	}
	...
	public DAudio _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DAudio _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DAudio _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DAudio _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DAudio _timeDateTime_(final String dateTime) {
	...
	public DAudio _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DAudio _ul_(final int count) {
		_ul(count) ;
		return this ;
	}
	...
	public DAudio _ul_(final Collection<Object> collection) {
		_ul(collection) ;
		return this ;
	}
...

{
	...
	public DAudio _ul_(final Collection<Object> collection, final String 
...
htmlType) {
	...
	public DAudio _ul_(DLi... elements) {
		_ul(elements) ;
		return this ;
	}
	...
	public DAudio _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DAudio _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DAudio _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DAudio _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DAudio _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DAudio _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DAudio _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DAudio _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
	...
	public DAudio _source_(final int count) {
		_source(count);
		return this ;
	}
	...
	public DAudio _source_(final String jif) {
		_source(jif) ;
		return this ;
	}	
}
