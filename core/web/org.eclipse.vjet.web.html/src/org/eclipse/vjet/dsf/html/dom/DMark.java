...
/**
<a href='http://dev.w3.org/html5/spec/Overview.html#the-mark-element'>W3C mark</a>
<p>
The mark element represents a run of text in one document marked or highlighted 
for reference purposes, due to its relevance in another context. When used in a 
quotation or other block of text referred to from the prose, it indicates a 
...
important by the original author when the block was originally written, but 
which is now under previously unexpected scrutiny. When used in the main prose 
of a document, it indicates a part of the document that has been highlighted due 
...
*/
public class DMark extends BaseHtml50Element {		
	...
	//
	public DMark() {
		super(HtmlTypeEnum.MARK);
	}
	
	public DMark(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.MARK);
	}
	
//	public DMark(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	
	public DMark(final String className) {
		this() ;
		setHtmlClassName(className) ;
	}
	
	public DMark(final CssClassConstant ccc) {
		this(ccc.getName()) ;
	}

	public DMark(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	 ...
	 */
	@Override
	public DMark add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DMark add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMark add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMark addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMark dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DMark dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DMark setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DMark setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DMark setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DMark setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DMark setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DMark setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DMark setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DMark setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DMark setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DMark setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMark setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DMark setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DMark setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DMark setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMark setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DMark setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DMark setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DMark setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DMark setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DMark setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DMark setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DMark setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DMark setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DMark setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMark setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DMark setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DMark setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DMark setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DMark setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DMark setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DMark setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DMark setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DMark setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DMark setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DMark setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DMark setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DMark setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DMark setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DMark setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DMark setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DMark setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DMark setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DMark setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DMark setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DMark setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DMark setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DMark add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DMark addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DMark addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DMark addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DMark jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DMark _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DMark _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DMark _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DMark _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DMark _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DMark _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DMark _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DMark _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DMark _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DMark _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DMark _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DMark _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DMark _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DMark _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DMark _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DMark _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DMark _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DMark _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DMark _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DMark _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DMark _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DMark _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DMark _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DMark _buttonText_(final String textValue) {
	...
	public DMark _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DMark _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DMark _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DMark _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DMark _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DMark _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DMark _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DMark _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DMark _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DMark _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DMark _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DMark _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DMark _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DMark _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DMark _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DMark _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DMark _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DMark _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DMark _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DMark _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DMark _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DMark _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DMark _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DMark _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DMark _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DMark _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DMark _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DMark _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DMark _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DMark _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DMark _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DMark _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DMark _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DMark _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DMark _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DMark _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DMark _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DMark _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DMark _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DMark _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DMark _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DMark _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DMark _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DMark _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DMark _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DMark _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DMark _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DMark _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DMark _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DMark _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DMark _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DMark _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DMark _labelText_(final String textValue) {
	...
	public DMark _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DMark _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DMark _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DMark _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DMark _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DMark _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DMark _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DMark _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DMark _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DMark _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DMark _meter_(final String min, final String max, final String value) {
	...
	public DMark _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DMark _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DMark _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DMark _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DMark _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DMark _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DMark _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DMark _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DMark _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DMark _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DMark _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DMark _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DMark _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DMark _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DMark _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DMark _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DMark _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DMark _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DMark _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DMark _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DMark _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DMark _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DMark _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DMark _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DMark _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DMark _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DMark _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DMark _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DMark _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DMark _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DMark _scriptText_(final String text, final String type) {
	...
	public DMark _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DMark _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DMark _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DMark _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DMark _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DMark _smallText_(final String textValue) {
	...
	public DMark _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DMark _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DMark _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DMark _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DMark _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DMark _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DMark _strongText_(final String textValue) {
	...
	public DMark _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DMark _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DMark _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DMark _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DMark _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DMark _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DMark _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DMark _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DMark _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DMark _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DMark _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DMark _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DMark _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DMark _timeDateTime_(final String dateTime) {
	...
	public DMark _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DMark _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DMark _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DMark _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DMark _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DMark _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DMark _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DMark _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DMark _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
