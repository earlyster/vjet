...
/**
 * http://www.w3.org/TR/REC-html40/struct/tables.html#edef-TFOOT
 */
public class DTFoot extends BaseTableSection
//	implements IDTransitional, IAttrs
{
	...
	//
	public DTFoot() {
		super(HtmlTypeEnum.TFOOT);
	}
	
	public DTFoot(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.TFOOT);
	}
	
	public DTFoot(final String jif) {
		this() ;
		jif(jif) ;
	}
	 ...
	 */
	@Override
	public DTFoot add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTFoot add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTFoot addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTFoot dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DTFoot dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DTFoot setDsfRelationshipVerifier(
	...
	@Override
	public DTFoot cloned() {
		return (DTFoot)super.cloned() ;
	}
     ...
     */
    @Override
    public DTFoot setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DTFoot setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DTFoot setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DTFoot setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DTFoot setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DTFoot setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DTFoot setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DTFoot setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DTFoot setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTFoot setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DTFoot setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DTFoot setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DTFoot setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTFoot setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DTFoot setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DTFoot setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DTFoot setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DTFoot setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DTFoot setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DTFoot setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DTFoot setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DTFoot setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DTFoot setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTFoot setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DTFoot setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DTFoot setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DTFoot setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DTFoot setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DTFoot setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DTFoot setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DTFoot setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DTFoot setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DTFoot setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DTFoot setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DTFoot setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DTFoot setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DTFoot setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DTFoot setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DTFoot setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DTFoot setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DTFoot setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DTFoot setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DTFoot setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DTFoot add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DTFoot addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DTFoot addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DTFoot addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DTFoot jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
