...
/**
* The definition term (or label) used in a DL (definition list) element.
* <p>
* http://www.w3.org/TR/REC-html40/struct/lists.html#edef-DT
* 
* Example:
* <pre>
* <DL>
...
* </pre>
*/
public class DDt extends BaseAttrsHtmlElement /* implements IDTransitional, IAttrs */{
	...
	//
	public DDt() {
		super(HtmlTypeEnum.DT);
	}
	
	public DDt(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.DT);
	}
	
//	public DDt(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	
	public DDt(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	 ...
	 */
	public DDt(final String textValue) {
		this() ;
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.DT ;
	}
	
	//
	// Helper
	//
	public DDt setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DDt add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DDt add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDt add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDt addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDt dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DDt dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DDt setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DDt setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DDt setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DDt setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DDt setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DDt setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DDt setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DDt setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DDt setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DDt setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDt setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DDt setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DDt setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DDt setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDt setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DDt setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DDt setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DDt setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DDt setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DDt setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DDt setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DDt setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DDt setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DDt setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDt setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DDt setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DDt setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DDt setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DDt setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DDt setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DDt setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DDt setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DDt setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DDt setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DDt setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DDt setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DDt setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DDt setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DDt setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DDt setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DDt setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DDt setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DDt setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DDt setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DDt setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DDt setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DDt add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DDt addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDt addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DDt addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DDt jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
