...
/**
* http://www.w3.org/TR/REC-html40/present/graphics.html#edef-SUB
* <p>
* Example:
* <pre>
*       H<sub>2</sub>O
...
* </pre>
*/
public class DSub extends BaseAttrsHtmlElement
//	implements IDSpecial, IDStrict, IAttrs
{
	...
	//
	public DSub() {
		super(HtmlTypeEnum.SUB) ;
	}

	public DSub(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.SUB);
	}
	
//	public DSub(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	 ...
	 */
	public DSub(final String textValue) {
		this() ;
		setHtmlExtTextValue(textValue) ;
	}

	public DSub(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.SUB ;
	}
			
	//
	// Extensions
	//
	public DSub setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DSub add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DSub add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSub add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSub addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSub dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DSub dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DSub setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DSub setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DSub setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DSub setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DSub setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DSub setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DSub setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DSub setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DSub setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DSub setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSub setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DSub setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DSub setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DSub setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSub setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DSub setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DSub setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DSub setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DSub setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DSub setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DSub setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DSub setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DSub setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DSub setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSub setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DSub setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DSub setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DSub setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DSub setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DSub setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DSub setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DSub setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DSub setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DSub setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DSub setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DSub setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DSub setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DSub setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DSub setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DSub setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DSub setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DSub setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DSub setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DSub setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DSub setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DSub setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DSub add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	
	...
	@Override
	public DSub addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSub addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DSub addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DSub jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DSub _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DSub _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DSub _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DSub _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DSub _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DSub _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DSub _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DSub _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DSub _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DSub _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DSub _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DSub _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DSub _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DSub _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DSub _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DSub _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DSub _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DSub _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DSub _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DSub _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DSub _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DSub _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DSub _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DSub _buttonText_(final String textValue) {
	...
	public DSub _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DSub _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DSub _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DSub _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DSub _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DSub _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DSub _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DSub _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DSub _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DSub _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DSub _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DSub _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DSub _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DSub _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DSub _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DSub _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DSub _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DSub _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DSub _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DSub _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DSub _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DSub _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DSub _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DSub _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DSub _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DSub _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DSub _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DSub _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DSub _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DSub _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DSub _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DSub _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DSub _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DSub _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DSub _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DSub _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DSub _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DSub _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DSub _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DSub _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DSub _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DSub _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DSub _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DSub _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DSub _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DSub _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DSub _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DSub _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DSub _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DSub _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DSub _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DSub _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DSub _labelText_(final String textValue) {
	...
	public DSub _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DSub _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DSub _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DSub _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DSub _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DSub _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DSub _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DSub _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DSub _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DSub _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DSub _meter_(final String min, final String max, final String value) {
	...
	public DSub _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DSub _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DSub _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DSub _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DSub _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DSub _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DSub _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DSub _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DSub _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DSub _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DSub _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DSub _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DSub _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DSub _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DSub _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DSub _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DSub _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DSub _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DSub _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DSub _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DSub _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DSub _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DSub _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DSub _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DSub _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DSub _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DSub _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DSub _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DSub _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DSub _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DSub _scriptText_(final String text, final String type) {
	...
	public DSub _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DSub _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DSub _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DSub _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DSub _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DSub _smallText_(final String textValue) {
	...
	public DSub _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DSub _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DSub _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DSub _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DSub _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DSub _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DSub _strongText_(final String textValue) {
	...
	public DSub _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DSub _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DSub _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DSub _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DSub _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DSub _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DSub _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DSub _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DSub _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DSub _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DSub _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DSub _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DSub _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DSub _timeDateTime_(final String dateTime) {
	...
	public DSub _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DSub _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DSub _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DSub _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DSub _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DSub _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DSub _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DSub _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DSub _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
