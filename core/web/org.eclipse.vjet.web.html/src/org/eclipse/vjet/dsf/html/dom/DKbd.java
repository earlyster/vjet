...
/**
* http://www.w3.org/TR/REC-html40/struct/text.html#edef-KBD
*/
public class DKbd extends BaseAttrsHtmlElement
	/* implements IDPhrase, IDStrict, IAttrs */
{
	...
	//
	public DKbd() {
		super(HtmlTypeEnum.KBD);
	}

	public DKbd(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.KBD);
	}
	
//	public DKbd(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	 ...
	 */
	public DKbd(final String textValue) {
		this() ;
		setHtmlExtTextValue(textValue) ;
	}

	public DKbd(BaseHtmlElement... elems) {
		this() ;
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.KBD ;
	}
			
	//
	// Extensions
	//
	public DKbd setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DKbd add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DKbd add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DKbd addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DKbd dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DKbd dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DKbd setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DKbd setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DKbd setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DKbd setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DKbd setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DKbd setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DKbd setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DKbd setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DKbd setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DKbd setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DKbd setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DKbd setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DKbd setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DKbd setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DKbd setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DKbd setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DKbd setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DKbd setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DKbd setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DKbd setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DKbd setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DKbd setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DKbd setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DKbd setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DKbd setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DKbd setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DKbd setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DKbd setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DKbd setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DKbd setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DKbd setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DKbd setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DKbd setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DKbd setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DKbd setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DKbd setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DKbd setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DKbd setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DKbd setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DKbd setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DKbd setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DKbd setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DKbd add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DKbd addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DKbd addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DKbd addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DKbd jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
