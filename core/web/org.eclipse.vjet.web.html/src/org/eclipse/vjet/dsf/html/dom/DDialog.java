...
/**
<a href='http://dev.w3.org/html5/spec/Overview.html#the-dialog-element'>W3C dialog</a>
<p>
The dialog element represents a conversation, meeting minutes, a chat transcript, 
a dialog in a screenplay, an instant message log, or some other construct in 
which different players take turns in discourse.
<p>
 ...
 */
public class DDialog extends BaseHtml50Element {		
	...
	//
	public DDialog() {
		super(HtmlTypeEnum.DIALOG);
	}
	
	public DDialog(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.DIALOG);
	}
	
//	public DDialog(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	
	public DDialog(final String className) {
		this() ;
		setHtmlClassName(className) ;
	}
	
	public DDialog(final CssClassConstant ccc) {
		this(ccc.getName()) ;
	}
	 ...
	 */
	@Override
	public DDialog add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDialog add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDialog addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDialog dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DDialog dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DDialog setDsfRelationshipVerifier(
	...
	@Override
	public DDialog cloned() {
		return (DDialog)super.cloned() ;
	}
     ...
     */
    @Override
    public DDialog setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DDialog setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DDialog setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DDialog setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DDialog setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DDialog setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DDialog setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DDialog setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DDialog setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDialog setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DDialog setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DDialog setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DDialog setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDialog setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DDialog setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DDialog setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DDialog setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DDialog setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DDialog setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DDialog setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DDialog setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DDialog setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DDialog setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDialog setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DDialog setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DDialog setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DDialog setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DDialog setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DDialog setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DDialog setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DDialog setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DDialog setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DDialog setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DDialog setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DDialog setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DDialog setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DDialog setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DDialog setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DDialog setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DDialog setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DDialog setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DDialog setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DDialog setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DDialog add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	//
	@Override
	public DDialog addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DDialog addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDialog addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DDialog addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DDialog jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}
