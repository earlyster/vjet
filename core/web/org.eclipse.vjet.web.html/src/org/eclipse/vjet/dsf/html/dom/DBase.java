...
* </HTML>
* </pre>
* This is an odd element because the attributes vary depending on the spec:
* xhtml 1.0 strict - href and id
* xhtml 1.0 transitional - href, id and target
* html 4.01 strict - href
*/
public class DBase extends BaseOrigNonAttrs
//	implements IDHeadContent, IDStrict, INoStandardAttributes, 
//		/* HTML 5.0 */ IMetadataContent
{
	...
	//
	public DBase() {
		super(null, HtmlTypeEnum.BASE);
	}
	
	public DBase(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.BASE);
	}
	
	public DBase(final String jif) {
		this() ;
		jif(jif) ;
	}
	...
	public DBase setHtmlHref(final String href) {
	...
	public DBase setHtmlTarget(final String target) {
	 ...
	 */
	@Override
	public DBase add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBase add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBase addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBase dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DBase dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DBase setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DBase setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DBase setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DBase setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DBase setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DBase setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DBase setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DBase setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DBase setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DBase setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBase setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DBase setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DBase setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DBase setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBase setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DBase setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DBase setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DBase setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DBase setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DBase setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DBase setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DBase setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DBase setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DBase setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBase setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DBase setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DBase setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DBase setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DBase setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DBase setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DBase setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DBase setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DBase setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DBase setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DBase setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DBase setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DBase setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DBase setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DBase setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DBase setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DBase setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DBase setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DBase setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DBase setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DBase setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DBase setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DBase add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DBase addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBase addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DBase addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DBase jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
