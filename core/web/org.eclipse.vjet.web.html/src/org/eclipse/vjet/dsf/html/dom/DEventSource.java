 ...
 */
public class DEventSource extends BaseHtml50Element {
	...
	//
	public DEventSource() {
		super(HtmlTypeEnum.EVENTSOURCE);
	}
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.EVENTSOURCE ;
	}
	...
	public DEventSource setHtmlSrc(final String srcUrl) {
	 ...
	 */
	@Override
	public DEventSource add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DEventSource add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DEventSource addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DEventSource dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DEventSource dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DEventSource setDsfRelationshipVerifier(
	...
	@Override
	public DEventSource cloned() {
		return (DEventSource)super.cloned() ;
	}
     ...
     */
    @Override
    public DEventSource setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DEventSource setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DEventSource setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DEventSource setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DEventSource setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DEventSource setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DEventSource setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DEventSource setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DEventSource setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DEventSource setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DEventSource setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DEventSource setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DEventSource setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DEventSource setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DEventSource setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DEventSource setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DEventSource setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DEventSource setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DEventSource setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DEventSource setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DEventSource setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DEventSource setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DEventSource setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DEventSource setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DEventSource setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DEventSource setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DEventSource setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DEventSource setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DEventSource setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DEventSource setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DEventSource setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DEventSource setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DEventSource setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DEventSource setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DEventSource setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DEventSource setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DEventSource setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DEventSource setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DEventSource setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DEventSource setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DEventSource setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DEventSource setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DEventSource setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DEventSource add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	
//	@Override
//	public DEventSource removeListener(
//		final EventType eventType, final IDomActiveListener listener)
//	{
...
//	}
	...
	//
	@Override
	public DEventSource addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DEventSource addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DEventSource addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DEventSource addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DEventSource jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}
