...
* </pre>
*/
public class DI extends BaseAttrsHtmlElement
	/*implements IDFontStyle, IDStrict, IAttrs*/
{
	...
	//
	public DI() {
		super(HtmlTypeEnum.I) ;
	}

	public DI(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.I);
	}
	
//	public DI(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	 ...
	 */
	public DI(final String textValue) {
		this() ;
		setHtmlExtTextValue(textValue) ;
	}

	public DI(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.I ;
	}
		
	//
	// Extensions
	//
	public DI setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DI add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DI add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DI add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DI addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DI dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DI dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DI setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DI setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DI setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DI setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DI setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DI setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DI setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DI setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DI setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DI setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DI setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DI setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */	
	@Override
	public DI setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DI setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DI setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DI setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DI setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DI setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DI setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DI setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DI setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DI setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DI setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DI setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DI setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DI setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DI setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DI setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DI setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DI setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DI setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DI setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DI setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DI setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DI setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DI setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DI setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DI setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DI setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DI setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DI setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DI setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DI setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DI setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DI setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DI add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DI addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DI addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DI addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DI jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DI _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DI _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DI _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DI _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DI _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DI _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DI _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DI _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DI _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DI _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DI _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DI _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DI _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DI _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DI _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DI _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DI _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DI _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DI _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DI _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DI _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DI _buttonText_(final String textValue) {
	...
	public DI _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DI _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DI _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DI _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DI _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DI _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DI _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DI _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DI _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DI _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DI _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DI _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DI _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DI _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DI _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DI _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DI _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DI _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DI _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DI _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DI _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DI _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DI _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DI _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DI _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DI _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DI _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DI _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DI _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DI _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DI _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DI _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DI _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DI _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DI _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DI _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DI _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DI _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DI _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DI _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DI _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DI _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DI _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DI _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DI _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DI _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DI _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DI _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DI _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DI _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DI _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DI _labelText_(final String textValue) {
	...
	public DI _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DI _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DI _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DI _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DI _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DI _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DI _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DI _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DI _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DI _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DI _meter_(final String min, final String max, final String value) {
	...
	public DI _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DI _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DI _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DI _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DI _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DI _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DI _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DI _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DI _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DI _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DI _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DI _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DI _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DI _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DI _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DI _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DI _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DI _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DI _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DI _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DI _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DI _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DI _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DI _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DI _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DI _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DI _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DI _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DI _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DI _scriptText_(final String text, final String type) {
	...
	public DI _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DI _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DI _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DI _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DI _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DI _smallText_(final String textValue) {
	...
	public DI _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DI _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DI _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DI _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DI _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DI _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DI _strongText_(final String textValue) {
	...
	public DI _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DI _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DI _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DI _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DI _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DI _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DI _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DI _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DI _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DI _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DI _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DI _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DI _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DI _timeDateTime_(final String dateTime) {
	...
	public DI _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DI _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DI _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DI _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DI _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DI _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DI _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DI _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DI _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
