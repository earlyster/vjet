...
* @RestrictedType
*/
public class DCenter extends BaseAttrsHtmlElement
	implements IDBlock /*, IDTransitional, IAttrs */
{
	...
	//
	public DCenter() {
		super(HtmlTypeEnum.CENTER);
	}
	
	public DCenter(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.ADDRESS);
	}
	
	public DCenter(final String jif) {
		this() ;
		jif(jif) ;
	}
	 ...
	 */
	@Override
	public DCenter add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCenter add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCenter addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCenter dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DCenter dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DCenter setDsfRelationshipVerifier(
	...
	@Override
	public DCenter cloned() {
		return (DCenter)super.cloned() ;
	}
     ...
     */
    @Override
    public DCenter setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DCenter setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DCenter setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DCenter setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DCenter setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DCenter setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DCenter setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DCenter setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DCenter setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCenter setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DCenter setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DCenter setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DCenter setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCenter setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DCenter setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DCenter setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DCenter setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DCenter setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DCenter setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DCenter setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DCenter setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DCenter setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DCenter setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCenter setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DCenter setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DCenter setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DCenter setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DCenter setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DCenter setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DCenter setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DCenter setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DCenter setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DCenter setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DCenter setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DCenter setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DCenter setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DCenter setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DCenter setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DCenter setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DCenter setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DCenter setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DCenter setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DCenter setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DCenter add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	//
	@Override
	public DCenter addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DCenter addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DCenter addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DCenter addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DCenter jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}