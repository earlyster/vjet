...
*/
public class DEm extends BaseAttrsHtmlElement
	/*implements IDPhrase, IDStrict, IAttrs*/
{
	...
	//
	public DEm() {
		super(HtmlTypeEnum.EM);
	}

	public DEm(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.EM);
	}
	
//	public DEm(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	 ...
	 */
	public DEm(final String textValue) {
		this() ;
		setHtmlExtTextValue(textValue) ;
	}

	public DEm(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.EM ;
	}
			
	//
	// Extensions
	//
	public DEm setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DEm add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DEm add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DEm add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DEm addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DEm dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DEm dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DEm setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DEm setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DEm setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DEm setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DEm setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DEm setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DEm setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DEm setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DEm setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DEm setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DEm setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DEm setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DEm setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DEm setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DEm setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DEm setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DEm setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DEm setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DEm setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DEm setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DEm setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DEm setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DEm setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DEm setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DEm setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DEm setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DEm setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DEm setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DEm setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DEm setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DEm setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DEm setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DEm setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DEm setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DEm setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DEm setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DEm setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DEm setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DEm setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DEm setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DEm setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DEm setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DEm setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DEm setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DEm setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DEm setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DEm add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DEm addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DEm addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DEm addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DEm jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DEm _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DEm _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DEm _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DEm _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DEm _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DEm _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DEm _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DEm _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DEm _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DEm _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DEm _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DEm _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DEm _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DEm _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DEm _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DEm _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DEm _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DEm _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DEm _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DEm _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DEm _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DEm _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DEm _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DEm _buttonText_(final String textValue) {
	...
	public DEm _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DEm _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DEm _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DEm _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DEm _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DEm _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DEm _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DEm _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DEm _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DEm _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DEm _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DEm _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DEm _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DEm _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DEm _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DEm _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DEm _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DEm _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DEm _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DEm _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DEm _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DEm _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DEm _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DEm _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DEm _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DEm _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DEm _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DEm _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DEm _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DEm _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DEm _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DEm _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DEm _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DEm _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DEm _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DEm _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DEm _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DEm _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DEm _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DEm _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DEm _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DEm _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DEm _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DEm _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DEm _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DEm _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DEm _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DEm _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DEm _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DEm _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DEm _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DEm _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DEm _labelText_(final String textValue) {
	...
	public DEm _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DEm _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DEm _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DEm _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DEm _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DEm _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DEm _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DEm _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DEm _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DEm _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DEm _meter_(final String min, final String max, final String value) {
	...
	public DEm _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DEm _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DEm _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DEm _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DEm _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DEm _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DEm _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DEm _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DEm _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DEm _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DEm _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DEm _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DEm _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DEm _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DEm _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DEm _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DEm _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DEm _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DEm _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DEm _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DEm _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DEm _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DEm _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DEm _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DEm _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DEm _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DEm _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DEm _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DEm _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DEm _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DEm _scriptText_(final String text, final String type) {
	...
	public DEm _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DEm _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DEm _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DEm _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DEm _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DEm _smallText_(final String textValue) {
	...
	public DEm _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DEm _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DEm _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DEm _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DEm _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DEm _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DEm _strongText_(final String textValue) {
	...
	public DEm _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DEm _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DEm _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DEm _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DEm _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DEm _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DEm _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DEm _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DEm _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DEm _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DEm _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DEm _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DEm _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DEm _timeDateTime_(final String dateTime) {
	...
	public DEm _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DEm _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DEm _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DEm _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DEm _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DEm _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DEm _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DEm _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DEm _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}