...
*/
public class DU extends BaseAttrsHtmlElement
//	implements /*IDFontStyle, IDTransitional, IAttrs*/
{
	...
	//
	public DU() {
		super(HtmlTypeEnum.U);
	}
	
	public DU(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.U);
	}
	
//	public DU(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	 ...
	 */
	public DU(final String textValue) {
		this() ;
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.U ;
	}
			
	//
	// Extensions
	//
	public DU setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DU add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DU add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DU addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DU dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DU dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DU setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DU setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DU setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DU setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DU setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DU setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DU setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DU setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DU setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DU setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DU setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DU setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */	
	@Override
	public DU setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DU setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DU setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DU setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DU setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DU setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DU setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DU setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DU setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DU setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DU setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DU setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DU setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DU setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DU setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DU setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DU setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DU setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DU setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DU setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DU setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DU setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DU setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DU setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DU setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DU setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DU setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DU setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DU setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DU setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DU setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DU setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DU setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DU add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DU addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DU addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DU addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DU jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}