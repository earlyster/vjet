...
*/
public class DQ extends BaseAttrsHtmlElement
//	implements IDSpecial, IDStrict, IAttrs
{
	private static final long serialVersionUID = 3257852082097764401L;
	
	public DQ() {
		super(HtmlTypeEnum.Q);
	}

	public DQ(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.Q);
	}
	
//	public DQ(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	 ...
	 */
	public DQ(final String textValue) {
		this() ;
		setHtmlExtTextValue(textValue) ;
	}
	
	public DQ(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public DQ setHtmlCite(final String cite) {
	...
	// Extensions
	//
	public DQ setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DQ add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DQ add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DQ add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DQ addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DQ dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DQ dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DQ setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DQ setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DQ setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DQ setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DQ setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DQ setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DQ setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DQ setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DQ setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DQ setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DQ setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DQ setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */	
	@Override
	public DQ setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DQ setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DQ setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DQ setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DQ setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DQ setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DQ setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DQ setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DQ setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DQ setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DQ setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DQ setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DQ setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DQ setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DQ setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DQ setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DQ setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DQ setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DQ setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DQ setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DQ setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DQ setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DQ setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DQ setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DQ setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DQ setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DQ setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DQ setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DQ setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DQ setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DQ setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DQ setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DQ setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DQ add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DQ addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DQ addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DQ addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DQ jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DQ _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DQ _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DQ _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DQ _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DQ _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DQ _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DQ _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DQ _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DQ _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DQ _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DQ _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DQ _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DQ _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DQ _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DQ _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DQ _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DQ _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DQ _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DQ _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DQ _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DQ _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DQ _buttonText_(final String textValue) {
	...
	public DQ _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DQ _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DQ _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DQ _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DQ _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DQ _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DQ _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DQ _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DQ _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DQ _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DQ _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DQ _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DQ _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DQ _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DQ _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DQ _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DQ _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DQ _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DQ _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DQ _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DQ _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DQ _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DQ _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DQ _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DQ _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DQ _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DQ _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DQ _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DQ _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DQ _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DQ _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DQ _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DQ _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DQ _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DQ _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DQ _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DQ _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DQ _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DQ _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DQ _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DQ _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DQ _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DQ _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DQ _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DQ _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DQ _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DQ _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DQ _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DQ _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DQ _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DQ _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DQ _labelText_(final String textValue) {
	...
	public DQ _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DQ _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DQ _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DQ _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DQ _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DQ _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DQ _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DQ _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DQ _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DQ _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DQ _meter_(final String min, final String max, final String value) {
	...
	public DQ _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DQ _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DQ _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DQ _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DQ _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DQ _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DQ _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DQ _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DQ _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DQ _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DQ _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DQ _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DQ _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DQ _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DQ _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DQ _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DQ _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DQ _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DQ _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DQ _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DQ _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DQ _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DQ _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DQ _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DQ _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DQ _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DQ _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DQ _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DQ _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DQ _scriptText_(final String text, final String type) {
	...
	public DQ _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DQ _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DQ _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DQ _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DQ _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DQ _smallText_(final String textValue) {
	...
	public DQ _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DQ _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DQ _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DQ _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DQ _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DQ _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DQ _strongText_(final String textValue) {
	...
	public DQ _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DQ _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DQ _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DQ _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DQ _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DQ _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DQ _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DQ _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DQ _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DQ _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DQ _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DQ _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DQ _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DQ _timeDateTime_(final String dateTime) {
	...
	public DQ _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DQ _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DQ _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DQ _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DQ _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DQ _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DQ _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DQ _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DQ _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
