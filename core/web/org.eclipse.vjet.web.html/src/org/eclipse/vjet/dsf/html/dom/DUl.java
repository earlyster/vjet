 ...
 */
public class DUl extends BaseAttrsHtmlElement /* implements IDList, IDStrict, IAttrs */{
	...
	//
	public DUl() {
		super(HtmlTypeEnum.UL);
	}

	public DUl(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.UL);
	}
	
	public DUl(final String jif) {
		this() ;
		jif(jif) ;
	}
	...
	// DSF Extensions
	//
	public DUl(final Collection collection) {
		this(collection, null) ;
	}
	public DUl(final Collection collection, final String htmlType) {
		this() ;
		if (collection != null) {
			for (Object listElement : collection) {
				DLi li = new DLi(listElement.toString()) ;
				if (htmlType != null) {
	 ...
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */
	public DUl setHtmlCompact(final String compact) {
		return setHtmlCompact(toBoolean("compact", compact)) ;
	}
	/**
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */	
	public DUl setHtmlCompact(final boolean compact) {
	...
	public DUl setHtmlType(final String type) {
	 ...
	 */
	@Override
	public DUl add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	public DUl add(DLi... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DUl add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DUl addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DUl dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DUl dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DUl setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DUl setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DUl setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DUl setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DUl setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DUl setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DUl setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DUl setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DUl setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DUl setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DUl setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DUl setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DUl setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DUl setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DUl setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DUl setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DUl setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DUl setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DUl setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DUl setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DUl setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DUl setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DUl setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DUl setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DUl setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DUl setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DUl setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DUl setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DUl setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DUl setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DUl setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DUl setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DUl setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DUl setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DUl setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DUl setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DUl setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DUl setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DUl setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DUl setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DUl setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DUl setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DUl setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DUl setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DUl setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DUl setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DUl add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DUl addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DUl addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DUl addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DUl jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
