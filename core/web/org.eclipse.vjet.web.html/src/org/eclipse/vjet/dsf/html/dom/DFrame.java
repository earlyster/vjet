...
/**
* Deprecated.  Does not exist in HTML 5.0.  This element is not in HTML 5.0 
* because its' usage affected usability and accessibility for the end user in a 
* negative way.
* <p>
...
public class DFrame extends BaseOrigNonAttrs //BaseCoreHtmlElement
//	implements IDTransitional, ICoreAttributes
{
	...
	public DFrame(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.FRAME);
	}
	
//	public DFrame(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	 ...
	 * @param source
	 */
	public DFrame(final String source) {
		this() ;
		setHtmlSrc(source) ;
	}
	...
	public DFrame setHtmlFrameBorder(final String frameBorder) {
	...
	public DFrame setHtmlLongDesc(final String longDesc) {
	...
	public DFrame setHtmlMarginHeight(final String marginHeight) {
		setHtmlAttribute(EHtmlAttr.marginheight, marginHeight);
		return this ;
	}
	
	public DFrame setHtmlMarginHeight(final int marginHeight) {
		return setHtmlMarginHeight(String.valueOf(marginHeight)) ;
	}
	public String getHtmlMarginWidth() {
		return getHtmlAttribute(EHtmlAttr.marginwidth);
	}

	public DFrame setHtmlMarginWidth(final String marginWidth) {
		setHtmlAttribute(EHtmlAttr.marginwidth, marginWidth);
		return this ;
	}	
	public DFrame setHtmlMarginWidth(final int marginWidth) {
		return setHtmlMarginWidth(String.valueOf(marginWidth)) ;
	}

	public String getHtmlName() {
		return getHtmlAttribute(EHtmlAttr.name);
	}
	public DFrame setHtmlName(final String name) {
	...
	public DFrame setHtmlNoResize(final String noResize) {
		return setHtmlNoResize(toBoolean("noresize", noResize)) ;
	}	
	public DFrame setHtmlNoResize(final boolean noResize) {
	...
	public DFrame setHtmlScrolling(final String scrolling) {
	...
	public DFrame setHtmlSrc(final String src) {
	...
	public String toString() {
		...
		Z.fmt("frameborder", getHtmlFrameBorder()) + 
		Z.fmt("longdesc", getHtmlLongDesc()) +
		Z.fmt("marginheight", getHtmlMarginHeight()) +
		Z.fmt("marginwidth", "" + getHtmlMarginWidth()) +
		Z.fmt("name", getHtmlName()) +
		Z.fmt("noresize", "" + getHtmlNoResize()) +
		Z.fmt("scrolling", getHtmlScrolling()) + 
	 ...
	 */
	@Override
	public DFrame add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFrame add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFrame addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFrame dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DFrame dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DFrame setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DFrame setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DFrame setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DFrame setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DFrame setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DFrame setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DFrame setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DFrame setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DFrame setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DFrame setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFrame setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DFrame setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DFrame setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DFrame setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFrame setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DFrame setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DFrame setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DFrame setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DFrame setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DFrame setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DFrame setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DFrame setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DFrame setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DFrame setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFrame setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DFrame setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DFrame setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DFrame setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DFrame setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DFrame setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DFrame setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DFrame setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DFrame setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DFrame setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DFrame setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DFrame setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DFrame setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DFrame setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DFrame setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DFrame setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DFrame setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DFrame setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DFrame setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DFrame setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DFrame add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DFrame addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DFrame addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DFrame addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DFrame jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}
