...
* </pre>
*/
public class DDl extends BaseAttrsHtmlElement 
	implements IDBlock /*, IDStrict, IAttrs */
{
	...
	//
	public DDl() {
		super(HtmlTypeEnum.DL);
	}
	
	public DDl(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.DL);
	}
	
	public DDl(final String jif) {
		this() ;
		jif(jif) ;
	}
	
	public DDl(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public DDl setHtmlCompact(final String compact) {
		return setHtmlCompact(toBoolean("compact", compact)) ;
	}	
	public DDl setHtmlCompact(final boolean compact) {
	 ...
	 */
	@Override
	public DDl add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DDl add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDl add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDl addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDl dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DDl dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DDl setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DDl setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DDl setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DDl setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DDl setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DDl setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DDl setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DDl setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DDl setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DDl setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDl setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DDl setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DDl setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DDl setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDl setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DDl setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DDl setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DDl setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DDl setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DDl setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DDl setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DDl setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DDl setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DDl setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDl setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DDl setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DDl setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DDl setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DDl setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DDl setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DDl setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DDl setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DDl setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DDl setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DDl setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DDl setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DDl setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DDl setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DDl setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DDl setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DDl setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DDl setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DDl setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DDl setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DDl setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DDl setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DDl add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DDl addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDl addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DDl addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DDl jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DDd _dd(final int count) {
		 return (DDd)getOrCreate(DDd.class, count) ;
	}
	public DDd _dd(final String textValue) {
		return _dd().setHtmlExtTextValue(textValue) ;
	}

	public DDt _dt() {
		 return _dt(-1) ;
	}
	public DDt _dt(final int count) {
		 return (DDt)getOrCreate(DDt.class, count) ;
	}
	public DDt _dt(final String textValue) {
		return _dt().setHtmlExtTextValue(textValue) ;
	}
