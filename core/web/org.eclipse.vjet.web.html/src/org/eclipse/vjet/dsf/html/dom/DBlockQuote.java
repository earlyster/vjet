...
public class DBlockQuote extends BaseAttrsHtmlElement
	implements IDBlock /*, IDStrict, IAttrs*/
{
	...
	//
	public DBlockQuote() {
		super(HtmlTypeEnum.BLOCKQUOTE);
	}

	public DBlockQuote(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.BLOCKQUOTE);
	}
	
//	public DBlockQuote(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	
	/**
	 * The extension Constructor that create an instance with DText child with 
	 * the passed in value.  If the passed in value is null, no DText child is created.
	 */
	public DBlockQuote(final String textValue) {
		this() ;
		setHtmlExtTextValue(textValue) ;
	}
	
	public DBlockQuote(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.BLOCKQUOTE ;
	}
	...
	public DBlockQuote setHtmlCite(final String cite) {
	...
	// Extensions
	//
	public DBlockQuote setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DBlockQuote add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DBlockQuote add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBlockQuote add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBlockQuote addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBlockQuote dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DBlockQuote dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DBlockQuote setDsfRelationshipVerifier(
	...
	@Override
	public DBlockQuote cloned() {
		return (DBlockQuote)super.cloned() ;
	}
     ...
     */
    @Override
    public DBlockQuote setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DBlockQuote setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DBlockQuote setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DBlockQuote setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBlockQuote setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DBlockQuote setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DBlockQuote setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBlockQuote setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DBlockQuote setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DBlockQuote setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBlockQuote setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DBlockQuote setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DBlockQuote setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DBlockQuote setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DBlockQuote setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DBlockQuote setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DBlockQuote setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DBlockQuote setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DBlockQuote setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DBlockQuote setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DBlockQuote setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DBlockQuote setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DBlockQuote setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DBlockQuote setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DBlockQuote setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DBlockQuote setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DBlockQuote setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DBlockQuote setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DBlockQuote setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DBlockQuote add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	
//	@Override
//	public DBlockQuote removeListener(
//		final EventType eventType, final IDomActiveListener listener)
//	{
...
//	}
	...
	//
	@Override
	public DBlockQuote addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DBlockQuote addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DBlockQuote addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DBlockQuote addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DBlockQuote jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DBlockQuote _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DBlockQuote _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DBlockQuote _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DBlockQuote _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DBlockQuote _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DBlockQuote _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DBlockQuote _address_(final int count) {
		 _address(count) ;
		 return this ;
	}
	...
	public DBlockQuote _address_(final String jif) {
		_address(jif) ;
		return this ;
	}
	...
	public DBlockQuote _address_(BaseHtmlElement... elements) {
		_address(elements) ;
		return this ;
	}
	...
	public DBlockQuote _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DBlockQuote _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DBlockQuote _article_(final int count) {
		_article(count) ;
		return this ;
	}
	...
	public DBlockQuote _article_(final String jif) {
		_article(jif) ;
		return this ;
	}
	...
	public DBlockQuote _articleText_(final String textValue) {
	...
	public DBlockQuote _article_(BaseHtmlElement... elements) {
		_article(elements) ;
		return this ;
	}
	...
	public DBlockQuote _aside_(final int count) {
		 _aside(count) ;
		 return this ;
	}
	...
	public DBlockQuote _aside_(final String jif) {
		_aside(jif) ;
		return this ;
	}
	...
	public DBlockQuote _asideText_(final String textValue) {
	...
	public DBlockQuote _aside_(BaseHtmlElement... elements) {
		_aside(elements) ;
		return this ;
	}
	...
	public DBlockQuote _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DBlockQuote _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DBlockQuote _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DBlockQuote _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DBlockQuote _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DBlockQuote _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DBlockQuote _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DBlockQuote _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DBlockQuote _blockquote_() {
		_blockquote() ;
		return this ;
	}
	...
	public DBlockQuote _blockquote_(final int count) {
		_blockquote(count) ;
		return this ;
	}
	...
	public DBlockQuote _blockquote_(final String jif) {
		_blockquote(jif) ;
		return this ;
	}
	...
	public DBlockQuote _blockquoteText_(final String textValue) {
	...
	public DBlockQuote _blockquote_(BaseHtmlElement... elements) {
	...
	public DBlockQuote _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DBlockQuote _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DBlockQuote _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DBlockQuote _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DBlockQuote _buttonText_(final String textValue) {
	...
	public DBlockQuote _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DBlockQuote _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DBlockQuote _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DBlockQuote _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DBlockQuote _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DBlockQuote _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DBlockQuote _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DBlockQuote _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DBlockQuote _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DBlockQuote _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DBlockQuote _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DBlockQuote _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DBlockQuote _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DBlockQuote _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DBlockQuote _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DBlockQuote _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DBlockQuote _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DBlockQuote _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _details_(final int count) {
		_details(count) ;
		return this ;
	}
	...
	public DBlockQuote _details_(final String jif) {
		_details(jif) ;
		return this ;
	}
	...
	public DBlockQuote _details_(BaseHtmlElement... elements) {
		_details(elements) ;
		return this ;
	}
	...
	public DBlockQuote _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DBlockQuote _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DBlockQuote _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DBlockQuote _div_(final int count) {
		_div(count) ;
		return this ;
	}
	...
	public DBlockQuote _div_(final String jif) {
		_div(jif) ;
		return this ;
	}
	...
	public DBlockQuote _div_(BaseHtmlElement... elements) {
		_div(elements) ;
		return this ;
	}
	...
	public DBlockQuote _dl_(final int count) {
		_dl(count) ;
		return this ;
	}
	...
	public DBlockQuote _dl_(final String jif) {
		_dl().jif(jif) ;
		return this ;
	}
	...
	public DBlockQuote _dl_(BaseHtmlElement... elements) {
		_dl(elements) ;
		return this ;
	}
	...
	public DBlockQuote _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DBlockQuote _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DBlockQuote _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DBlockQuote _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DBlockQuote _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DBlockQuote _fieldset_(final int count) {
		_fieldset(count) ;
		return this ;
	}
	...
	public DBlockQuote _fieldset_(final String jif) {
		_fieldset(jif) ;
		return this ;
	}
	...
	public DBlockQuote _fieldsetLegend_(final String legend) {
	...
	public DBlockQuote _fieldset_(BaseHtmlElement... elements) {
		_fieldset(elements) ;
		return this ;
	}
	...
	public DBlockQuote _figure_(final int count) {
		_figure(count) ;
		return this ;
	}
	...
	public DBlockQuote _figure_(final String jif) {
		_figure(jif) ;
		return this ;
	}
	...
	public DBlockQuote _figure_(BaseHtmlElement... elements) {
		_figure(elements) ;
		return this ;
	}
	...
	public DBlockQuote _footer_(final int count) {
		_footer(count) ;
		return this ;
	}
	...
	public DBlockQuote _footer_(final String jif) {
		_footer(jif) ;
		return this ;
	}
	...
	public DBlockQuote _footerText_(final String textValue) {
	...
	public DBlockQuote _footer_(BaseHtmlElement... elements) {
		_footer(elements) ;
		return this ;
	}
	...
	public DBlockQuote _form_(final int count) {
		_form(count) ;
		return this ;
	}
	...
	public DBlockQuote _form_(final String jif) {
		_form(jif) ;
		return this ;
	}
	...
	public DBlockQuote _form_(BaseHtmlElement... elements) {
		_form(elements) ;
		return this ;
	}
	...
	public DBlockQuote _h1_(final int count) {
		_h1(count);
		return this ;
	}
	...
	public DBlockQuote _h1_(final String jif) {
		_h1(jif) ;
		return this ;
	}
	...
	public DBlockQuote _h1Text_(final String textValue) {
		_h1Text(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _h1_(BaseHtmlElement... elements) {
		_h1(elements) ;
		return this ;
	}
	...
	public DBlockQuote _h2_(final int count) {
		_h2(count);
		return this ;
	}
	...
	public DBlockQuote _h2_(final String jif) {
		_h2(jif) ;
		return this ;
	}
	...
	public DBlockQuote _h2Text_(final String textValue) {
		_h2Text(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _h2_(BaseHtmlElement... elements) {
		_h2(elements) ;
		return this ;
	}
	...
	public DBlockQuote _h3_(final int count) {
		_h3(count);
		return this ;
	}
	...
	public DBlockQuote _h3_(final String jif) {
		_h3(jif) ;
		return this ;
	}
	...
	public DBlockQuote _h3Text_(final String textValue) {
		_h3Text(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _h3_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DBlockQuote _h4_(final int count) {
		_h4(count);
		return this ;
	}
	...
	public DBlockQuote _h4_(final String jif) {
		_h4(jif) ;
		return this ;
	}
	...
	public DBlockQuote _h4Text_(final String textValue) {
		_h4Text(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _h4_(BaseHtmlElement... elements) {
		_h4(elements) ;
		return this ;
	}
	...
	public DBlockQuote _h5_(final int count) {
		_h5(count);
		return this ;
	}
	...
	public DBlockQuote _h5_(final String jif) {
		_h5(jif) ;
		return this ;
	}
	...
	public DBlockQuote _h5Text_(final String textValue) {
		_h5Text(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _h5_(BaseHtmlElement... elements) {
		_h5(elements) ;
		return this ;
	}
	...
	public DBlockQuote _h6_(final int count) {
		_h6(count);
		return this ;
	}
	...
	public DBlockQuote _h6_(final String jif) {
		_h6(jif) ;
		return this ;
	}
	...
	public DBlockQuote _h6Text_(final String textValue) {
		_h6Text(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _h6_(BaseHtmlElement... elements) {
		_h6(elements) ;
		return this ;
	}
	...
	public DBlockQuote _header_(final int count) {
		_header(count) ;
		return this ;
	}
	...
	public DBlockQuote _header_(final String jif) {
		_header(jif) ;
		return this ;
	}
	...
	public DBlockQuote _header_(BaseHtmlElement... elements) {
		_header(elements) ;
		return this ;
	}
	...
	public DBlockQuote _hgroup_(final int count) {
		_hgroup(count) ;
		return this ;
	}
	...
	public DBlockQuote _hgroup_(final String jif) {
		_hgroup(jif) ;
		return this ;
	}
	...
	public DBlockQuote _hgroup_(BaseHtmlElement... elements) {
		_hgroup(elements) ;
		return this ;
	}
	...
	public DBlockQuote _hr_(final int count) {
		_hr(count) ;
		return this ;
	}
	...
	public DBlockQuote _hr_(final String jif) {
		_hr(jif) ;
		return this ;
	}
	...
	public DBlockQuote _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DBlockQuote _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DBlockQuote _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DBlockQuote _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DBlockQuote _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DBlockQuote _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DBlockQuote _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DBlockQuote _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DBlockQuote _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DBlockQuote _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DBlockQuote _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DBlockQuote _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DBlockQuote _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DBlockQuote _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DBlockQuote _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DBlockQuote _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DBlockQuote _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DBlockQuote _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DBlockQuote _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DBlockQuote _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DBlockQuote _labelText_(final String textValue) {
	...
	public DBlockQuote _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DBlockQuote _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DBlockQuote _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DBlockQuote _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DBlockQuote _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DBlockQuote _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DBlockQuote _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
	...
	public DBlockQuote _menu_(final int count) {
		_menu(count) ;
		return this ;
	}
	...
	public DBlockQuote _menu_(final String jif) {
		_menu(jif) ;
		return this ;
	}
	...
	public DBlockQuote _menu_(BaseHtmlElement... elements) {
		_menu(elements) ;
		return this ;
	}
	...
	public DBlockQuote _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DBlockQuote _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DBlockQuote _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
...
value) {
	...
	public DBlockQuote _meter_(final String min, final String max, final String value) 

{
	...
	public DBlockQuote _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
...
value) {
	...
	public DBlockQuote _meter_(final double min, final double max, final double value) 

{
	...
	public DBlockQuote _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DBlockQuote _nav_(final int count) {
		_nav(count) ;
		return this ;
	}
	...
	public DBlockQuote _nav_(final String jif) {
		_nav(jif) ;
		return this ;
	}
	...
	public DBlockQuote _nav_(BaseHtmlElement... elements) {
		_nav(elements) ;
		return this ;
	}
	...
	public DBlockQuote _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DBlockQuote _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DBlockQuote _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DBlockQuote _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DBlockQuote _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DBlockQuote _ol_(final int count) {
		_ol(count) ;
		return this ;
	}
	...
	public DBlockQuote _ol_(final String jif) {
		_ol(jif) ;
		return this ;
	}
	...
	public DBlockQuote _ol_(final Collection<Object> collection) {
		_ol(collection) ;
		return this ;
	}
...

{
	...
	public DBlockQuote _ol_(final Collection<Object> collection, final String 
...
htmlType) {
	...
	public DBlockQuote _ol_(DLi... elements) {
		_ol(elements) ;
		return this ;
	}
	...
	public DBlockQuote _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DBlockQuote _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DBlockQuote _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DBlockQuote _p_(final int count) {
		_p(count) ;
		return this ;
	}
	...
	public DBlockQuote _p_(final String jif) {
		_p(jif) ;
		return this ;
	}
	...
	public DBlockQuote _pText_(final String textValue) {
		_pText(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _p_(BaseHtmlElement... elements) {
		_p(elements) ;
		return this ;
	}
	...
	public DBlockQuote _pre_(final int count) {
		_pre(count) ;
		return this ;
	}
	...
	public DBlockQuote _pre_(final String jif) {
		_pre(jif) ;
		return this ;
	}
	...
	public DBlockQuote _preText_(final String textValue) {
		_preText(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _pre_(BaseHtmlElement... elements) {
		_pre(elements) ;
		return this ;
	}
	...
	public DBlockQuote _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DBlockQuote _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DBlockQuote _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DBlockQuote _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DBlockQuote _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DBlockQuote _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DBlockQuote _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DBlockQuote _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DBlockQuote _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DBlockQuote _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DBlockQuote _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DBlockQuote _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DBlockQuote _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DBlockQuote _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DBlockQuote _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DBlockQuote _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DBlockQuote _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DBlockQuote _scriptText_(final String text, final String type) {
	...
	public DBlockQuote _section_(final int count) {
		_section(count) ;
		return this ;
	}
	...
	public DBlockQuote _section_(final String jif) {
		_section(jif) ;
		return this ;
	}
	...
	public DBlockQuote _section_(BaseHtmlElement... elements) {
		_section(elements) ;
		return this ;
	}
	...
	public DBlockQuote _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DBlockQuote _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DBlockQuote _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DBlockQuote _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DBlockQuote _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DBlockQuote _smallText_(final String textValue) {
	...
	public DBlockQuote _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DBlockQuote _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DBlockQuote _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DBlockQuote _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DBlockQuote _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DBlockQuote _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DBlockQuote _strongText_(final String textValue) {
	...
	public DBlockQuote _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DBlockQuote _style_(final int count) {
		_style(count) ;
		return this ;
	}
	...
	public DBlockQuote _style_(final String jif) {
		_style(jif) ;
		return this ;
	}
	...
	public DBlockQuote _styleText_(final String styleText) {
	...
	public DBlockQuote _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DBlockQuote _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DBlockQuote _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DBlockQuote _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DBlockQuote _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DBlockQuote _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
	...
	public DBlockQuote _table_(final int count) {
		_table(count);
		return this ;
	}
	...
	public DBlockQuote _table_(final String jif) {
		_table(jif) ;
		return this ;
	}
	...
	public DBlockQuote _table_(DTr... rows) {
		_table(rows) ;
		return this ;
	}
	...
	public DBlockQuote _table_(BaseHtmlElement... elements) {
		_table(elements) ;
		return this ;
	}
	...
	public DBlockQuote _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DBlockQuote _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DBlockQuote _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DBlockQuote _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DBlockQuote _timeDateTime_(final String dateTime) {
	...
	public DBlockQuote _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DBlockQuote _ul_(final int count) {
		_ul(count) ;
		return this ;
	}
	...
	public DBlockQuote _ul_(final Collection<Object> collection) {
		_ul(collection) ;
		return this ;
	}
...

{
	...
	public DBlockQuote _ul_(final Collection<Object> collection, final String 
...
htmlType) {
	...
	public DBlockQuote _ul_(DLi... elements) {
		_ul(elements) ;
		return this ;
	}
	...
	public DBlockQuote _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DBlockQuote _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DBlockQuote _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DBlockQuote _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DBlockQuote _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DBlockQuote _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DBlockQuote _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DBlockQuote _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
