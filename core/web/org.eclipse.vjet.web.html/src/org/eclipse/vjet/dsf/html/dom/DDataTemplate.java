...
public class DDataTemplate extends BaseHtml50Element
{		
	//
	// Constructor(s)
	//
	public DDataTemplate() {
		super(HtmlTypeEnum.DATATEMPLATE);
	}
	
	public DDataTemplate(final String className) {
		this() ;
		setHtmlClassName(className) ;
	}
	
	public DDataTemplate(final CssClassConstant ccc) {
		this(ccc.getName()) ;
	}
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.DATATEMPLATE ;
	}
	 ...
	 */
	@Override
	public DDataTemplate add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDataTemplate add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDataTemplate addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDataTemplate dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DDataTemplate dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DDataTemplate setDsfRelationshipVerifier(
	...
	@Override
	public DDataTemplate cloned() {
		return (DDataTemplate)super.cloned() ;
	}
     ...
     */
    @Override
    public DDataTemplate setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DDataTemplate setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DDataTemplate setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DDataTemplate setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDataTemplate setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DDataTemplate setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DDataTemplate setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDataTemplate setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DDataTemplate setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DDataTemplate setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDataTemplate setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DDataTemplate setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DDataTemplate setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DDataTemplate setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DDataTemplate setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DDataTemplate setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DDataTemplate setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DDataTemplate setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DDataTemplate setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DDataTemplate setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DDataTemplate setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DDataTemplate setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DDataTemplate setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DDataTemplate setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DDataTemplate setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DDataTemplate setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DDataTemplate setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DDataTemplate setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DDataTemplate setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DDataTemplate add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	
//	@Override
//	public DDataTemplate removeListener(
//		final EventType eventType, final IDomActiveListener listener)
//	{
...
//	}
	...
	//
	@Override
	public DDataTemplate addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DDataTemplate addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DDataTemplate addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DDataTemplate addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DDataTemplate jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}
