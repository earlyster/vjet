 ...
 */
public class DPre extends BaseAttrsHtmlElement
	implements IDBlock //, IDStrict, IAttrs
{
	private static final long serialVersionUID = 3257282552271156784L;
	
	public DPre() {
		super(HtmlTypeEnum.PRE);
	}

	public DPre(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.PRE);
	}
	
//	public DPre(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	 ...
	 */
	public DPre(final String textValue) {
		this() ;
		setHtmlExtTextValue(textValue) ;
	}
	
	public DPre(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public int getHtmlWidth() {
		return getHtmlAttributeInteger(EHtmlAttr.width);
	}
	/**
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */
	public DPre setHtmlWidth(final String width) {
	 ...
	 * @deprecated - Not supported in HTML 5.0, better handled by CSS
	 */	
	public DPre setHtmlWidth(final int width) {
	...
	// Extensions
	//
	public DPre setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DPre add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DPre add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DPre add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DPre addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DPre dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DPre dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DPre setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DPre setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DPre setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DPre setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DPre setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DPre setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DPre setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DPre setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DPre setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DPre setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DPre setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DPre setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DPre setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DPre setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DPre setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DPre setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DPre setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DPre setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DPre setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DPre setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DPre setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DPre setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DPre setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DPre setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DPre setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DPre setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DPre setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DPre setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DPre setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DPre setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DPre setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DPre setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DPre setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DPre setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DPre setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DPre setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DPre setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DPre setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DPre setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DPre setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DPre setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DPre setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DPre setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DPre setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DPre setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DPre setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DPre add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DPre addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DPre addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DPre addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DPre jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DPre _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DPre _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DPre _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DPre _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DPre _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DPre _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DPre _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DPre _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DPre _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DPre _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DPre _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DPre _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DPre _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DPre _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DPre _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DPre _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DPre _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DPre _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DPre _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DPre _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DPre _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DPre _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DPre _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DPre _buttonText_(final String textValue) {
	...
	public DPre _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DPre _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DPre _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DPre _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DPre _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DPre _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DPre _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DPre _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DPre _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DPre _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DPre _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DPre _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DPre _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DPre _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DPre _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DPre _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DPre _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DPre _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DPre _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DPre _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DPre _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DPre _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DPre _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DPre _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DPre _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DPre _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DPre _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DPre _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DPre _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DPre _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DPre _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DPre _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DPre _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DPre _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DPre _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DPre _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DPre _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DPre _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DPre _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DPre _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DPre _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DPre _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DPre _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DPre _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DPre _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DPre _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DPre _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DPre _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DPre _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DPre _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DPre _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DPre _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DPre _labelText_(final String textValue) {
	...
	public DPre _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DPre _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DPre _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DPre _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DPre _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DPre _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DPre _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DPre _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DPre _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DPre _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DPre _meter_(final String min, final String max, final String value) {
	...
	public DPre _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DPre _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DPre _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DPre _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DPre _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DPre _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DPre _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DPre _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DPre _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DPre _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DPre _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DPre _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DPre _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DPre _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DPre _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DPre _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DPre _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DPre _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DPre _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DPre _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DPre _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DPre _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DPre _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DPre _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DPre _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DPre _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DPre _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DPre _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DPre _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DPre _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DPre _scriptText_(final String text, final String type) {
	...
	public DPre _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DPre _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DPre _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DPre _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DPre _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DPre _smallText_(final String textValue) {
	...
	public DPre _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DPre _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DPre _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DPre _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DPre _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DPre _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DPre _strongText_(final String textValue) {
	...
	public DPre _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DPre _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DPre _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DPre _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DPre _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DPre _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DPre _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DPre _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DPre _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DPre _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DPre _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DPre _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DPre _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DPre _timeDateTime_(final String dateTime) {
	...
	public DPre _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DPre _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DPre _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DPre _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DPre _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DPre _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DPre _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DPre _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DPre _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
