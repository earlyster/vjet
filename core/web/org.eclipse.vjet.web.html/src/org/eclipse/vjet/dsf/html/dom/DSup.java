...
/**
* http://www.w3.org/TR/REC-html40/present/graphics.html#edef-SUP
* <p>
* Example:
* <pre>
*       H<sub>2</sub>O
...
* </pre>
*/
public class DSup extends BaseAttrsHtmlElement
//	implements IDSpecial, IDStrict, IAttrs
{
	...
	//
	public DSup() {
		super(HtmlTypeEnum.SUP);
	}

	public DSup(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.SUP);
	}
	
//	public DSup(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	 ...
	 */
	public DSup(final String textValue) {
		this() ;
		setHtmlExtTextValue(textValue) ;
	}

	public DSup(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.SUP ;
	}
			
	//
	// Extensions
	//
	public DSup setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DSup add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DSup add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSup add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSup addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSup dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DSup dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DSup setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DSup setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DSup setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DSup setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DSup setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DSup setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DSup setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DSup setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DSup setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DSup setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSup setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DSup setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DSup setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DSup setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSup setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DSup setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DSup setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DSup setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DSup setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DSup setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DSup setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DSup setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DSup setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DSup setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSup setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DSup setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DSup setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DSup setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DSup setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DSup setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DSup setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DSup setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DSup setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DSup setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DSup setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DSup setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DSup setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DSup setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DSup setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DSup setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DSup setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DSup setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DSup setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DSup setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DSup setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DSup setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DSup add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DSup addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DSup addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DSup addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DSup jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DSup _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DSup _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DSup _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DSup _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DSup _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DSup _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DSup _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DSup _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DSup _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DSup _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DSup _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DSup _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DSup _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DSup _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DSup _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DSup _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DSup _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DSup _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DSup _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DSup _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DSup _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DSup _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DSup _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DSup _buttonText_(final String textValue) {
	...
	public DSup _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DSup _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DSup _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DSup _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DSup _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DSup _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DSup _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DSup _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DSup _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DSup _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DSup _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DSup _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DSup _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DSup _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DSup _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DSup _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DSup _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DSup _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DSup _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DSup _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DSup _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DSup _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DSup _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DSup _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DSup _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DSup _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DSup _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DSup _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DSup _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DSup _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DSup _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DSup _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DSup _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DSup _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DSup _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DSup _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DSup _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DSup _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DSup _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DSup _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DSup _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DSup _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DSup _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DSup _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DSup _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DSup _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DSup _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DSup _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DSup _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DSup _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DSup _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DSup _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DSup _labelText_(final String textValue) {
	...
	public DSup _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DSup _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DSup _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DSup _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DSup _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DSup _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DSup _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DSup _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DSup _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DSup _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DSup _meter_(final String min, final String max, final String value) {
	...
	public DSup _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DSup _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DSup _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DSup _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DSup _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DSup _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DSup _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DSup _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DSup _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DSup _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DSup _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DSup _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DSup _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DSup _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DSup _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DSup _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DSup _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DSup _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DSup _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DSup _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DSup _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DSup _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DSup _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DSup _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DSup _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DSup _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DSup _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DSup _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DSup _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DSup _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DSup _scriptText_(final String text, final String type) {
	...
	public DSup _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DSup _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DSup _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DSup _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DSup _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DSup _smallText_(final String textValue) {
	...
	public DSup _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DSup _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DSup _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DSup _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DSup _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DSup _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DSup _strongText_(final String textValue) {
	...
	public DSup _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DSup _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DSup _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DSup _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DSup _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DSup _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DSup _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DSup _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DSup _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DSup _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DSup _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DSup _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DSup _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DSup _timeDateTime_(final String dateTime) {
	...
	public DSup _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DSup _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DSup _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DSup _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DSup _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DSup _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DSup _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DSup _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DSup _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
