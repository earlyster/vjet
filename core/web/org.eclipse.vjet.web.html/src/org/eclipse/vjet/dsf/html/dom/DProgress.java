...
/**
<a href='http://dev.w3.org/html5/spec/Overview.html#the-progress-element'>W3C progress</a>
<p>
 ...
 */
public class DProgress extends BaseHtml50Element {		
	...
	//
	public DProgress() {
		super(HtmlTypeEnum.PROGRESS);
	}
	
	public DProgress(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.PROGRESS);
	}
	
	public DProgress(final String jif) {
		this() ;
		jif(jif) ;
	}
	
	public DProgress(final double max, final double value) {
		this() ;
		setHtmlMax(max) ;
		setHtmlValue(value) ;
	}
	public DProgress(final String max, final String value) {
		this() ;
		setHtmlMax(max) ;
		setHtmlValue(value) ;
	}
	
//	public DProgress(final String className) {
//		this() ;
//		setHtmlClassName(className) ;
//	}
	
	public DProgress(final CssClassConstant ccc) {
		this(ccc.getName()) ;
	}
	
	public DProgress(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	//
	// max
	public String getHtmlMax() {
		return getHtmlAttribute(EHtmlAttr.max);
	}
	public DProgress setHtmlMax(final String max) {
		setHtmlAttribute(EHtmlAttr.max, max);
		return this ;
	}
	public DProgress setHtmlMax(final double max) {
		setHtmlAttribute(EHtmlAttr.max, max);
		return this ;
	}
	...
	public DProgress setHtmlValue(final String value) {
		setHtmlAttribute(EHtmlAttr.value, value);
		return this ;
	}
	public DProgress setHtmlValue(final double value) {
		setHtmlAttribute(EHtmlAttr.value, value);
		return this ;
	}	
	...
	public String toString() {
		return super.toString()
			+ Z.fmt(EHtmlAttr.max.getAttributeName(), getHtmlMax())
	 ...
	 */
	@Override
	public DProgress add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DProgress add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DProgress add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DProgress addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DProgress dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DProgress dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DProgress setDsfRelationshipVerifier(
	...
	@Override
	public DProgress cloned() {
		return (DProgress)super.cloned() ;
	}
     ...
     */
    @Override
    public DProgress setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DProgress setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DProgress setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DProgress setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DProgress setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DProgress setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DProgress setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DProgress setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DProgress setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DProgress setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DProgress setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DProgress setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DProgress setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DProgress setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DProgress setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DProgress setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DProgress setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DProgress setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DProgress setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DProgress setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DProgress setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DProgress setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DProgress setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DProgress setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DProgress setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DProgress setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DProgress setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DProgress setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DProgress setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DProgress setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DProgress setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DProgress setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DProgress setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DProgress setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DProgress setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DProgress setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DProgress setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DProgress setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DProgress setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DProgress setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DProgress setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DProgress setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DProgress setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DProgress add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	
//	@Override
//	public DProgress removeListener(
//		final EventType eventType, final IDomActiveListener listener)
//	{
...
//	}
	...
	//
	@Override
	public DProgress addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DProgress addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DProgress addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DProgress addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DProgress jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DProgress _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DProgress _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DProgress _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DProgress _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DProgress _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DProgress _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DProgress _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DProgress _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DProgress _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DProgress _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DProgress _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DProgress _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DProgress _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DProgress _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DProgress _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DProgress _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DProgress _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DProgress _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DProgress _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DProgress _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DProgress _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DProgress _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DProgress _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DProgress _buttonText_(final String textValue) {
	...
	public DProgress _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DProgress _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DProgress _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DProgress _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DProgress _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DProgress _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DProgress _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DProgress _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DProgress _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DProgress _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DProgress _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DProgress _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DProgress _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DProgress _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DProgress _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DProgress _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DProgress _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DProgress _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DProgress _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DProgress _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DProgress _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DProgress _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DProgress _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DProgress _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DProgress _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DProgress _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DProgress _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DProgress _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DProgress _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DProgress _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DProgress _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DProgress _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DProgress _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DProgress _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DProgress _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DProgress _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DProgress _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DProgress _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DProgress _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DProgress _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DProgress _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DProgress _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DProgress _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DProgress _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DProgress _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DProgress _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DProgress _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DProgress _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DProgress _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DProgress _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DProgress _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DProgress _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DProgress _labelText_(final String textValue) {
	...
	public DProgress _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DProgress _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DProgress _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DProgress _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DProgress _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DProgress _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DProgress _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DProgress _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DProgress _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DProgress _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DProgress _meter_(final String min, final String max, final String value) {
	...
	public DProgress _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DProgress _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DProgress _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DProgress _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DProgress _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DProgress _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DProgress _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DProgress _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DProgress _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DProgress _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DProgress _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DProgress _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DProgress _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DProgress _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DProgress _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DProgress _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DProgress _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DProgress _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DProgress _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DProgress _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DProgress _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DProgress _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DProgress _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DProgress _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DProgress _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DProgress _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DProgress _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DProgress _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DProgress _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DProgress _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DProgress _scriptText_(final String text, final String type) {
	...
	public DProgress _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DProgress _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DProgress _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DProgress _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DProgress _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DProgress _smallText_(final String textValue) {
	...
	public DProgress _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DProgress _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DProgress _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DProgress _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DProgress _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DProgress _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DProgress _strongText_(final String textValue) {
	...
	public DProgress _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DProgress _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DProgress _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DProgress _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DProgress _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DProgress _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DProgress _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DProgress _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DProgress _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DProgress _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DProgress _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DProgress _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DProgress _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DProgress _timeDateTime_(final String dateTime) {
	...
	public DProgress _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DProgress _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DProgress _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DProgress _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DProgress _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DProgress _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DProgress _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DProgress _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DProgress _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
