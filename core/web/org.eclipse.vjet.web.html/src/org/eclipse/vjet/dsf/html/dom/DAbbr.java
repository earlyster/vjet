...
* </pre>
*/
public class DAbbr extends BaseAttrsHtmlElement
	/* implements  IDPhrase, IDStrict, IAttrs*/
{
	...
	//
	public DAbbr() {
		super(HtmlTypeEnum.ABBR) ;
	}
	
	public DAbbr(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.ABBR);
	}
	 ...
	 */
	public DAbbr(final String textValue) {
		this() ;
		setHtmlExtTextValue(textValue) ;
	}

	public DAbbr(BaseHtmlElement... elems) {
		this() ;
		add(elems) ;
	}
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.ABBR ;
	}
		
	//
	// Extensions
	//
	public DAbbr setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DAbbr add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	
	@Override
	public DAbbr add(BaseHtmlElement... elems) throws DOMException {
		super.add(elems) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAbbr add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAbbr addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAbbr dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DAbbr dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DAbbr setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DAbbr setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DAbbr setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DAbbr setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DAbbr setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DAbbr setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DAbbr setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DAbbr setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DAbbr setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DAbbr setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAbbr setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DAbbr setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DAbbr setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DAbbr setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAbbr setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DAbbr setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DAbbr setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DAbbr setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DAbbr setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DAbbr setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DAbbr setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DAbbr setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DAbbr setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DAbbr setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAbbr setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DAbbr setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DAbbr setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DAbbr setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DAbbr setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DAbbr setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DAbbr setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DAbbr setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DAbbr setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DAbbr setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DAbbr setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DAbbr setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DAbbr setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DAbbr setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DAbbr setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DAbbr setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DAbbr setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DAbbr setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DAbbr setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DAbbr setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DAbbr add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DAbbr addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DAbbr addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DAbbr addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DAbbr jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
	...
	public DAbbr _a_(final int count) {
		_a(count) ;
		return this ;
	}
	...
	public DAbbr _a_(final String jif) {
		_a().jif(jif) ;
		return this ;
	}
	...
	public DAbbr _aText_(final String textValue) {
		_aText(textValue) ;
		return this ;
	}
	...
	public DAbbr _a_(final String value, final String url) {
		_a(value, url) ;
		return this ;
	}
	...
	public DAbbr _abbr_(final int count) {
		 _abbr(count) ;
		 return this ;
	}
	...
	public DAbbr _abbr_(final String jif) {
		_abbr(jif) ;
		return this ;
	}
	...
	public DAbbr _abbrText_(final String textValue) {
		_abbrText(textValue) ;
		return this ;
	}
	...
	public DAbbr _abbr_(BaseHtmlElement... elements) {
		_abbr(elements) ;
		return this ;
	}
	...
	public DAbbr _area_(final int count) {
		 _area(count) ;
		 return this;
	}
	...
	public DAbbr _area_(final String jif) {
		_area(jif) ;
		return this ;
	}
	...
	public DAbbr _audio_(final int count) {
		_audio(count) ;
		return this ;
	}
	...
	public DAbbr _audio_(final String jif) {
		_audio(jif) ;
		return this ;
	}
	...
	public DAbbr _b_(final int count) {
		_b(count) ;
		return this ;
	}
	...
	public DAbbr _b_(final String jif) {
		_b(jif) ;
		return this ;
	}
	...
	public DAbbr _bText_(final String textValue) {
		_bText(textValue) ;
		return this ;
	}
	...
	public DAbbr _b_(BaseHtmlElement... elements) {
		_b(elements) ;
		return this ;
	}
	...
	public DAbbr _bdo_(final int count) {
		_bdo(count) ;
		return this ;
	}
	...
	public DAbbr _bdo_(final String jif) {
		_bdo(jif) ;
		return this ;
	}
	...
	public DAbbr _bdo_(BaseHtmlElement... elements) {
		_bdo(elements) ;
		return this ;
	}
	...
	public DAbbr _br_(final int count) {
		 _br(count) ;
		 return this ;
	}
	...
	public DAbbr _br_(final String jif) {
		_br(jif) ;
		return this ;
	}
	...
	public DAbbr _button_(final int count) {
		_button(count) ;
		return this ;
	}
	...
	public DAbbr _button_(final String jif) {
		_button(jif) ;
		return this ;
	}
	...
	public DAbbr _buttonText_(final String textValue) {
	...
	public DAbbr _button_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DAbbr _canvas_(final int count) {
		_canvas(count) ;
		return this ;
	}
	...
	public DAbbr _canvas_(final String jif) {
		_canvas(jif) ;
		return this ;
	}
	...
	public DAbbr _cite_(final int count) {
		 _cite(count) ;
		 return this ;
	}
	...
	public DAbbr _cite_(final String jif) {
		_cite(jif) ;
		return this;
	}
	...
	public DAbbr _citeText_(final String textValue) {
		_citeText(textValue) ;
		return this ;
	}
	...
	public DAbbr _cite_(BaseHtmlElement... elements) {
		_button(elements) ;
		return this ;
	}
	...
	public DAbbr _code_(final int count) {
		_code(count) ;
		return this ;
	}
	...
	public DAbbr _code_(final String jif) {
		_code(jif) ;
		return this ;
	}
	...
	public DAbbr _codeText_(final String textValue) {
		_codeText(textValue) ;
		return this;
	}
	...
	public DAbbr _code_(BaseHtmlElement... elements) {
		_code(elements) ;
		return this ;
	}
	...
	public DAbbr _command_(final int count) {
		_command(count) ;
		return this ;
	}
	...
	public DAbbr _command_(final String jif) {
		_command(jif) ;
		return this ;
	}
	...
	public DAbbr _datalist_(final int count) {
		_datalist(count) ;
		return this ;
	}
	...
	public DAbbr _datalist_(final String jif) {
		_datalist(jif) ;
		return this ;
	}
	...
	public DAbbr _datalist_(BaseHtmlElement... elements) {
		_datalist(elements) ;
		return this ;
	}
	...
	public DAbbr _del_(final int count) {
		_del(count) ;
		return this ;
	}
	...
	public DAbbr _del_(final String jif) {
		_del(jif) ;
		return this ;
	}
	...
	public DAbbr _delText_(final String textValue) {
		_delText(textValue) ;
		return this ;
	}
	...
	public DAbbr _dfn_(final int count) {
		_dfn(count) ;
		return this ;
	}
	...
	public DAbbr _dfn_(final String jif) {
		_dfn().jif(jif) ;
		return this ;
	}
	...
	public DAbbr _dfnText_(final String textValue) {
		_dfnText(textValue) ;
		return this ;
	}
	...
	public DAbbr _dfn_(BaseHtmlElement... elements) {
		_dfn(elements) ;
		return this ;
	}
	...
	public DAbbr _em_(final int count) {
		_em(count) ;
		return this ;
	}
	...
	public DAbbr _em_(final String jif) {
		_em(jif) ;
		return this ;
	}
	...
	public DAbbr _emText_(final String textValue) {
		_emText(textValue) ;
		return this ;
	}
	...
	public DAbbr _em_(BaseHtmlElement... elements) {
		_em(elements) ;
		return this ;
	}
	...
	public DAbbr _embed_(final int count) {
		_embed(count) ;
		return this ;
	}
	...
	public DAbbr _embed_(final String jif) {
		_embed(jif) ;
		return this ;
	}
	...
	public DAbbr _i_(final int count) {
		_i(count) ;
		return this ;
	}
	...
	public DAbbr _i_(final String jif) {
		_i(jif) ;
		return this ;
	}
	...
	public DAbbr _iText_(final String textValue) {
		_iText(textValue) ;
		return this ;
	}
	...
	public DAbbr _i_(BaseHtmlElement... elements) {
		_i(elements) ;
		return this ;
	}
	...
	public DAbbr _iframe_(final int count) {
		_iframe(count) ;
		return this ;
	}
	...
	public DAbbr _iframe_(final String jif) {
		_iframe(jif) ;
		return this ;
	}
	...
	public DAbbr _img_(final int count) {
		_img(count) ;
		return this ;
	}
	...
	public DAbbr _img_(final String jif) {
		_img(jif) ;
		return this ;
	}
	...
	public DAbbr _img_(final String srcUrl, final String alt) {
		_img(srcUrl, alt) ;
		return this ;
	}
	...
	public DAbbr _input_(final int count) {
		_input(count) ;
		return this ;
	}
	...
	public DAbbr _input_(final String jif) {
		_input(jif) ;
		return this ;
	}
	...
	public DAbbr _inputValue_(final String value) {
		_inputValue(value) ;
		return this ;
	}
	...
	public DAbbr _ins_(final int count) {
		_ins(count) ;
		return this ;
	}
	...
	public DAbbr _ins_(final String jif) {
		_ins(jif) ;
		return this ;
	}
	...
	public DAbbr _insText_(final String textValue) {
		_insText(textValue) ;
		return this ;
	}
	...
	public DAbbr _kbd_(final int count) {
		_kbd(count) ;
		return this ;
	}
	...
	public DAbbr _kbd_(final String jif) {
		_kbd(jif) ;
		return this ;
	}
	...
	public DAbbr _kbdText_(final String textValue) {
		_kbdText(textValue) ;
		return this ;
	}
	...
	public DAbbr _kbd_(BaseHtmlElement... elements) {
		_kbd(elements) ;
		return this ;
	}
	...
	public DAbbr _keygen_(final int count) {
		_keygen(count) ;
		return this ;
	}
	...
	public DAbbr _keygen_(final String jif) {
		_keygen(jif) ;
		return this ;
	}
	...
	public DAbbr _label_(final int count) {
		_label(count) ;
		return this ;
	}
	...
	public DAbbr _label_(final String jif) {
		_label(jif) ;
		return this ;
	}
	...
	public DAbbr _labelText_(final String textValue) {
	...
	public DAbbr _label_(BaseHtmlElement... elements) {
		_label(elements) ;
		return this ;
	}
	...
	public DAbbr _map_(final int count) {
		_map(count) ;
		return this ;
	}
	...
	public DAbbr _map_(final String jif) {
		_map(jif) ;
		return this ;
	}
	...
	public DAbbr _map_(BaseHtmlElement... elements) {
		_map(elements) ;
		return this ;
	}
	...
	public DAbbr _mark_(final int count) {
		_mark(count) ;
		return this ;
	}
	...
	public DAbbr _mark_(final String jif) {
		_mark(jif) ;
		return this ;
	}
	...
	public DAbbr _mark_(BaseHtmlElement... elements) {
		_mark(elements) ;
		return this ;
	}
...
// MATH!!!
	...
	public DAbbr _meter_(final int count) {
		_meter(count) ;
		return this ;
	}
	...
	public DAbbr _meter_(final String jif) {
		_meter(jif) ;
		return this ;
	}
	...
	public DAbbr _meter_(final String min, final String max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DAbbr _meter_(final String min, final String max, final String value) {
	...
	public DAbbr _meter_(final double min, final double max) {
		_meter(min, max) ;
		return this ;
	}
	...
	public DAbbr _meter_(final double min, final double max, final double value) {
		_meter(min, max, value) ;
		return this ;
	}
	...
	public DAbbr _meter_(BaseHtmlElement... elements) {
		_meter(elements) ;
		return this ;
	}
	...
	public DAbbr _noscript_(final int count) {
		_noscript(count) ;
		return this ;
	}
	...
	public DAbbr _noscript_(final String jif) {
		_noscript(jif) ;
		return this ;
	}
	...
	public DAbbr _object_(final int count) {
		_object(count) ;
		return this ;
	}
	...
	public DAbbr _object_(final String jif) {
		_object(jif) ;
		return this ;
	}
	...
	public DAbbr _object_(DParam... elements) {
		_object(elements) ;
		return this ;
	}
	...
	public DAbbr _output_(final int count) {
		_output(count) ;
		return this ;
	}
	...
	public DAbbr _output_(final String jif) {
		_output(jif) ;
		return this ;
	}
	...
	public DAbbr _output_(BaseHtmlElement... elements) {
		_output(elements) ;
		return this ;
	}
	...
	public DAbbr _progress_(final int count) {
		_progress(count) ;
		return this ;
	}
	...
	public DAbbr _progress_(final String jif) {
		_progress(jif) ;
		return this ;
	}
	...
	public DAbbr _progress_(final double max, final double value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DAbbr _progress_(final String max, final String value) {
		_progress(max, value) ;
		return this ;
	}
	...
	public DAbbr _progress_(BaseHtmlElement... elements) {
		_progress(elements) ;
		return this ;
	}
	...
	public DAbbr _q_(final int count) {
		_q(count) ;
		return this ;
	}
	...
	public DAbbr _q_(final String jif) {
		_q(jif) ;
		return this ;
	}
	...
	public DAbbr _qText_(final String textValue) {
		_qText(textValue) ;
		return this ;
	}
	...
	public DAbbr _q_(BaseHtmlElement... elements) {
		_q(elements) ;
		return this ;
	}
	...
	public DAbbr _ruby_(final int count) {
		_ruby(count) ;
		return this ;
	}
	...
	public DAbbr _ruby_(final String jif) {
		_ruby(jif) ;
		return this ;
	}
	...
	public DAbbr _ruby_(BaseHtmlElement... elements) {
		_ruby(elements) ;
		return this ;
	}
	...
	public DAbbr _samp_(final int count) {
		_samp(count) ;
		return this ;
	}
	...
	public DAbbr _samp_(final String jif) {
		_samp(jif) ;
		return this ;
	}
	...
	public DAbbr _sampText_(final String textValue) {
		_sampText(textValue) ;
		return this ;
	}
	...
	public DAbbr _samp_(BaseHtmlElement... elements) {
		_samp(elements) ;
		return this ;
	}
	...
	public DAbbr _script_(final int count) {
		_script(count) ;
		return this ;
	}
	...
	public DAbbr _script_(final String jif) {
		_script(jif) ;
		return this ;
	}
	...
	public DAbbr _scriptText_(final String text) {
		_scriptText(text) ;
		return this ;
	}
	...
	public DAbbr _scriptText_(final String text, final String type) {
	...
	public DAbbr _select_(final int count) {
		_select(count);
		return this ;
	}
	...
	public DAbbr _select_(final String jif) {
		_select(jif) ;
		return this ;
	}
	...
	public DAbbr _select_(BaseHtmlElement... elements) {
		_select(elements) ;
		return this ;
	}
	...
	public DAbbr _small_(final int count) {
		_small(count) ;
		return this ;
	}
	...
	public DAbbr _small_(final String jif) {
		_small(jif) ;
		return this ;
	}
	...
	public DAbbr _smallText_(final String textValue) {
	...
	public DAbbr _small_(BaseHtmlElement... elements) {
		_small(elements) ;
		return this ;
	}
	...
	public DAbbr _span_(final int count) {
		_span(count) ;
		return this ;
	}
	...
	public DAbbr _span_(final String jif) {
		_span(jif) ;
		return this ;
	}
	...
	public DAbbr _span_(BaseHtmlElement... elements) {
		_span(elements) ;
		return this ;
	}
	...
	public DAbbr _strong_(final int count) {
		_strong(count) ;
		return this ;
	}
	...
	public DAbbr _strong_(final String jif) {
		_strong(jif) ;
		return this ;
	}
	...
	public DAbbr _strongText_(final String textValue) {
	...
	public DAbbr _strong_(BaseHtmlElement... elements) {
		_strong(elements) ;
		return this ;
	}
	...
	public DAbbr _sub_(final int count) {
		_sub(count) ;
		return this ;
	}
	...
	public DAbbr _sub_(final String jif) {
		_sub(jif) ;
		return this ;
	}
	...
	public DAbbr _subText_(final String textValue) {
		_subText(textValue) ;
		return this ;
	}
	...
	public DAbbr _sub_(BaseHtmlElement... elements) {
		_sub(elements) ;
		return this ;
	}
	...
	public DAbbr _sup_(final int count) {
		_sup(count) ;
		return this ;
	}
	...
	public DAbbr _sup_(final String jif) {
		_sup(jif) ;
		return this ;
	}
	...
	public DAbbr _supText_(final String textValue) {
		_supText(textValue) ;
		return this ;
	}
	...
	public DAbbr _sup_(BaseHtmlElement... elements) {
		_sup(elements) ;
		return this ;
	}
...
// SVG !!!
	...
	public DAbbr _textarea_(final int count) {
		_textarea(count);
		return this ;
	}
	...
	public DAbbr _textarea_(final String jif) {
		_textarea(jif) ;
		return this ;
	}
	...
	public DAbbr _time_(final int count) {
		_time(count) ;
		return this ;
	}
	...
	public DAbbr _time_(final String jif) {
		_time(jif) ;
		return this ;
	}
	...
	public DAbbr _timeDateTime_(final String dateTime) {
	...
	public DAbbr _time_(BaseHtmlElement... elements) {
		_time(elements) ;
		return this ;
	}
	...
	public DAbbr _var_(final int count) {
		_var(count) ;
		return this ;
	}
	...
	public DAbbr _var_(final String jif) {
		_var(jif) ;
		return this ;
	}
	...
	public DAbbr _varText_(final String textValue) {
		_varText(textValue) ;
		return this ;
	}
	...
	public DAbbr _var_(BaseHtmlElement... elements) {
		_var(elements) ;
		return this ;
	}
	...
	public DAbbr _video_(final int count) {
		_video(count) ;
		return this ;
	}
	...
	public DAbbr _video_(final String jif) {
		_video(jif) ;
		return this ;
	}
	...
	public DAbbr _wbr_(final int count) {
		_wbr(count);
		return this ;
	}
	...
	public DAbbr _wbr_(final String jif) {
		_wbr(jif) ;
		return this ;
	}
}
