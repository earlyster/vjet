...
* </pre>
*/
public class DParam extends BaseOrigNonAttrs
//	implements IDTransitional, INoStandardAttributes
{
	/** "data" */
	public static final String VALUE_TYPE_DATA = "data" ;
	/** "ref" */
	public static final String VALUE_TYPE_REF = "ref" ;
	/** "object" */
	public static final String VALUE_TYPE_OBJECT = "object" ; // ignoreHtmlKeyword
	...
	//
	public DParam() {
		super(null, HtmlTypeEnum.PARAM);
	}
	
	public DParam(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.PARAM);
	}
	
	public DParam(final String jif) {
		this() ;
		jif(jif) ;
	}
	...
	public DParam setHtmlName(final String name) {
	 ...
	 * @deprecated - Not supported in HTML 5.0
	 */
	public DParam setHtmlType(final String type) {
	...
	public DParam setHtmlValue(final String value) {
	 ...
	 * @deprecated - Not supported in HTML 5.0
	 */
	public DParam setHtmlValueType(final String valueType) {
	 ...
	 */
	@Override
	public DParam add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DParam add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DParam addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DParam dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DParam dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DParam setDsfRelationshipVerifier(
	...
	@Override
	public DParam cloned() {
		return (DParam)super.cloned() ;
	}
     ...
     */
    @Override
    public DParam setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DParam setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DParam setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DParam setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DParam setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DParam setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DParam setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DParam setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DParam setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DParam setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DParam setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DParam setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DParam setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DParam setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DParam setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DParam setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DParam setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DParam setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DParam setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DParam setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DParam setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DParam setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DParam setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DParam setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DParam setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DParam setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DParam setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DParam setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DParam setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DParam setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DParam setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DParam setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DParam setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DParam setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DParam setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DParam setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DParam setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DParam setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DParam setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DParam setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DParam setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DParam setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DParam setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DParam setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DParam setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DParam add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DParam addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DParam addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DParam addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DParam jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
