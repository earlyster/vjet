...
* <p>
* http://www.w3.org/TR/REC-html40/present/graphics.html#edef-STRIKE
* <p>
* Example:
* 	<STRIKE>this from the record</STRIKE>
*/
public class DStrike extends BaseAttrsHtmlElement
	/*implements IDFontStyle, IDTransitional, IAttrs*/
{
	...
	//
	public DStrike() {
		super(HtmlTypeEnum.STRIKE);
	}

	public DStrike(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.STRIKE);
	}
	
//	public DStrike(final String jif) {
//		this() ;
//		jif(jif) ;
//	}
	 ...
	 */
	public DStrike(final String textValue) {
		this() ;
	...
	public HtmlTypeEnum htmlType() {
		return HtmlTypeEnum.STRIKE ;
	}
			
	//
	// Extensions
	//
	public DStrike setHtmlExtTextValue(final String value) {
	 ...
	 */
	@Override
	public DStrike add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DStrike add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DStrike addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DStrike dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DStrike dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DStrike setDsfRelationshipVerifier(
	...
	@Override
	public DStrike cloned() {
		return (DStrike)super.cloned() ;
	}
     ...
     */
    @Override
    public DStrike setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DStrike setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DStrike setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DStrike setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DStrike setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DStrike setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DStrike setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DStrike setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DStrike setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DStrike setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DStrike setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DStrike setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DStrike setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DStrike setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DStrike setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DStrike setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DStrike setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DStrike setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DStrike setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DStrike setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DStrike setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DStrike setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DStrike setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DStrike setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DStrike setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DStrike setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DStrike setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DStrike setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DStrike setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DStrike setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DStrike setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DStrike setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DStrike setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DStrike setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DStrike setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DStrike setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DStrike setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DStrike setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DStrike setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DStrike setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DStrike setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DStrike setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DStrike setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DStrike add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	//
	@Override
	public DStrike addBr() {
		super.addBr() ;
		return this ;
	}
	
	@Override
	public DStrike addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DStrike addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DStrike addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DStrike jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}
