 ...
 */
public class DRule extends BaseHtml50Element {
	...
	//
	public DRule() {
		super(HtmlTypeEnum.RULE);
	}
	
	public DRule(final DHtmlDocument doc) {
		super(doc, HtmlTypeEnum.RULE);
	}
	
	public DRule(final String jif) {
		this() ;
		jif(jif) ;
	}
	...
	public String getHtmlCondition() {
		return getHtmlAttribute(EHtmlAttr.condition) ;
	}
	public DRule setHtmlCondition(final String conditionSelector) {
		setHtmlAttribute(EHtmlAttr.condition, conditionSelector) ;
		return this ;
	}
	
	// mode
	public String getHtmlMode() {
		return getHtmlAttribute(EHtmlAttr.mode) ;
	}
	public DRule setHtmlMode(final String mode) {
		setHtmlAttribute(EHtmlAttr.mode, mode) ;
		return this ;
	}
	...
	public String toString() {
		return super.toString()
			+ Z.fmt(EHtmlAttr.condition.getAttributeName(), "" + getHtmlCondition())
			+ Z.fmt(EHtmlAttr.mode.getAttributeName(), getHtmlMode()) ;	
	}
	 ...
	 */
	@Override
	public DRule add(final DNode newChild) throws DOMException {
		super.add(newChild) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DRule add(final String value) throws DOMException {
		super.add(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DRule addRaw(final String value) throws DOMException {
		super.addRaw(value) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DRule dsfAccept(final IDNodeVisitor visitor) {
	...
	@Override
	public DRule dsfBroadcast(final DsfEvent event) // must not be null
	 ...
	 */
	@Override
	public DRule setDsfRelationshipVerifier(
     ...
     */
    @Override
    public DRule setDsfNamespace(DNamespace namespace){
	 ...
	 */
	@Override
	public DRule setHtmlAccessKey(final String accessKey) {
	 ...
	 */
	@Override
	public DRule setHtmlClassName(final String className) {
		super.setHtmlClassName(className) ;
		return this ;
	}
	@Override
	public DRule setHtmlClassName(final CssClassConstant ccc) {
	 ...
	 */
	@Override
	public DRule setHtmlContentEditable(final String editable) {
	 ...
	 */
	@Override
	public DRule setHtmlContextMenu(final String contextMenu) {
	 ...
	 */
	@Override
	public DRule setHtmlDir(final String dir) {
	 ...
	 */
	@Override
	public DRule setHtmlDraggable(final String draggable) {  // true, false, auto
	 ...
	 */
	@Override
	public DRule setHtmlDraggable(final boolean draggable) {  // true, false
		super.setHtmlDraggable(draggable) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DRule setHtmlHidden(final String hidden) {
	 ...
	 */
	@Override
	public DRule setHtmlHidden(final boolean hidden) {
		super.setHtmlHidden(hidden);
		return this ;
	}
	 ...
	 */
	@Override
	public DRule setHtmlId(String id) {
		super.setHtmlId(id) ;
		return this ;
	}
	/**
	 ...
	 */	
	@Override
	public DRule setHtmlId(CssIdConstant id) {
		super.setHtmlId(id) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DRule setHtmlItem(final String item) {
	 ...
	 */
	@Override
	public DRule setHtmlItemProp(final String itemProp) {
	 ...
	 */
	@Override
	public DRule setHtmlLang(final String lang) {
	 ...
	 */
	@Override
	public DRule setHtmlSpellCheck(final String spellCheck) {
	 ...
	 */
	@Override
	public DRule setHtmlSpellCheck(final boolean spellCheck) {
		super.setHtmlSpellCheck(spellCheck) ;
		return this ;
	}	

	@Override
	public DRule setHtmlStyleAsString(final String styleString) {
	 ...
	 */
	@Override
	public DRule setHtmlStyle(final ICssStyleDeclaration style) {
	 ...
	 */
	@Override
	public DRule setHtmlSubject(final String subject) {
	 ...
	 */
	@Override
	public DRule setHtmlTabIndex(final String tabIndex) {  // HTML 5.0
	 ...
	 */
	@Override
	public DRule setHtmlTabIndex(final int tabIndex) {  // HTML 5.0
		super.setHtmlTabIndex(tabIndex) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DRule setHtmlTitle(final String title) {
	 ...
	 */
	@Override
	public DRule setHtmlOnAbort(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnBlur(final String onBlur) {
	 ...
	 */
	@Override
	public DRule setHtmlOnCanPlay(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnCanPlayThrough(final String script) {
	...
	// onchange
	@Override
	public DRule setHtmlOnChange(final String script) {
	...
	// onclick
	@Override
	public DRule setHtmlOnClick(final String script) {
	...
	// oncontextmenu
	@Override
	public DRule setHtmlOnContextMenu(final String script) {
	...
	// ondblclick
	@Override
	public DRule setHtmlOnDblClick(final String script) {
	...
	// ondrag
	@Override
	public DRule setHtmlOnDrag(final String script) {
	...
	// ondragend
	@Override
	public DRule setHtmlOnDragEnd(final String script) {
	...
	// ondragenter
	@Override
	public DRule setHtmlOnDragEnter(final String script) {
	...
	// ondragleave
	@Override
	public DRule setHtmlOnDragLeave(final String script) {
	...
	// ondragover
	@Override
	public DRule setHtmlOnDragOver(final String script) {
	...
	// ondragstart
	@Override
	public DRule setHtmlOnDragStart(final String script) {
	...
	// ondrop
	@Override
	public DRule setHtmlOnDrop(final String script) {
	...
	// ondurationchange
	@Override
	public DRule setHtmlOnDurationChange(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnEmptied(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnEnded(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnError(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnFocus(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnFormChange(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnFormInput(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnInput(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnInvalid(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnKeyDown(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnKeyPress(final String script) {
	 ...
	 */
	@Override
    public DRule setHtmlOnKeyUp(final String script) {
	 ...
	 */
	@Override
    public DRule setHtmlOnLoad(final String script) {
	 ...
	 */
	@Override
    public DRule setHtmlOnLoadedData(final String script) {
	 ...
	 */
	@Override
    public DRule setHtmlOnLoadedMetadata(final String script) {
	 ...
	 */
	@Override
    public DRule setHtmlOnLoadStart(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnMouseDown(final String script){
	 ...
	 */
	@Override
	public DRule setHtmlOnMouseMove(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnMouseOut(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnMouseOver(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnMouseUp(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnMouseWheel(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnPause(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnPlay(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnPlaying(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnProgress(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnRateChange(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnReadyStateChange(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnScroll(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnSeeked(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnSeeking(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnSelect(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnShow(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnStalled(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnSubmit(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnSuspend(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnTimeUpdate(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnVolumeChange(final String script) {
	 ...
	 */
	@Override
	public DRule setHtmlOnWaiting(final String script) {
...
//	@Override
//	public DRule add(final IDomActiveListener listener){
//		super.add(listener) ;
//		return this ;
//	}
//	
...
//	}
	...
	@Override
	public DRule addBr(final int howMany){
		super.addBr(howMany) ;
		return this ;
	}
	 ...
	 */
	@Override
	public DRule addHtmlClassName(final String className) {
		super.addHtmlClassName(className) ;
		return this ;
	}
	
	@Override
	public DRule addHtmlClassName(final CssClassConstant ccc) {
		super.addHtmlClassName(ccc) ;
		return this ;
	}
	
	@Override
	public DRule jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}
