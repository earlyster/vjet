...
/** #E {color:red} */
public class DIdCondition implements IAttributeCondition, Serializable {
	...
	// Constructor(s)
	//
	public DIdCondition(final String value) {
		m_value = value;
	}

	//
	// Satisfy ICondition form IAttributeCondition
	//
	public short getConditionType() {
		return ICondition.SAC_ID_CONDITION;
	}
