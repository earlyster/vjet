...
public interface ICssPrimitiveValue extends ICssValue {
    ...
    short CSS_RGBACOLOR             = 26;
    short CSS_HSLCOLOR              = 27;
    short CSS_HSLACOLOR             = 28;
     ...
     */
    ICounter getCounterValue() throws DOMException;
     ...
     */
    IRect getRectValue() throws DOMException;
     ...
     */
    IRgbColor getRGBColorValue() throws DOMException; 
    IRgbaColor getRGBAColorValue() throws DOMException; 
    IHslColor getHSLColorValue() throws DOMException; 
    IHslaColor getHSLAColorValue() throws DOMException;    
}
