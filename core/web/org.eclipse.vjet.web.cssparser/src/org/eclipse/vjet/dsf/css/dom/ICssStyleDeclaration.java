...
public interface ICssStyleDeclaration {
	String PRIORITY_IMPORTANT = "important";
	ICssStyleDeclaration addProperty(DCssProperty p) ;
	DCssProperty getPropertyDeclaration(String name) ;
	DCssProperty getPropertyDeclaration(int position) ;
     ...
     */
    String getCssText();
	ICssStyleDeclaration setCssText(String cssText) throws DOMException;
     ...
     *   <p>
     *   NOTE: Its possible to have more than one property of the same
     *   name - for example this occurs in cases like a rule with multiple
