...
/** E[foo |= "bar"] */
public class DBeginHyphenAttributeCondition
	implements IAttributeCondition, Serializable
{
	...
	// Constructor(s)
	//
	public DBeginHyphenAttributeCondition(final String localName, final String value) {
	...
	public short getConditionType() {
		return ICondition.SAC_BEGIN_HYPHEN_ATTRIBUTE_CONDITION;
	}
