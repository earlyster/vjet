...
public class DContainsAtLeastOneAttributeCondition
	implements IAttributeCondition, Serializable
{
	...
	// Constructor(s)
	//
	public DContainsAtLeastOneAttributeCondition(
	...
	public short getConditionType() {
		return ICondition.SAC_CONTAINS_AT_LEAST_ONE_ATTRIBUTE_CONDITION;
	}
