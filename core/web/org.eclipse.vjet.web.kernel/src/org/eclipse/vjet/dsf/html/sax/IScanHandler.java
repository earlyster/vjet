...
public interface IScanHandler {
	...
	**/
	...
	/**
	 * Return the argument as a valid XML name, used for XML scan
	 * @param buff
	 * @param offset
	 * @param length
	 * @return
	 */
	String makeName(char[] buff, int offset, int length);
	 ...
	 * @throws SAXException
	 */
	void etag_basic(char[] buff, int offset, int length) throws SAXException;
