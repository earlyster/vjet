...
public abstract class Schema {
	...
	private Map <String, Integer> theEntities = 
		new HashMap<String, Integer> ();		// String -> Character
	private Map <String, ElementType>theElementTypes = 
	...
	**/
	...
	public void entity(String name, int value) {
		theEntities.put(name, Integer.valueOf(value));
		}
...
//		System.err.println("%% Looking up entity " + name);
	...
	**/
	...
	public final Map<String, ElementType> getElements(){
		return Collections.unmodifiableMap(theElementTypes);
	}
}