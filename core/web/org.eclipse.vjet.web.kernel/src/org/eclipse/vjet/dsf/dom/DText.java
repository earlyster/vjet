...
public class DText extends DCharacterData implements Text {
	...
	public DText(final String data) {
		this(null, data);
	}

	public DText(final DDocument document, final String data) {
		super(document, data);
		if (data == null){
			throw new DOMException(
				DOMException.VALIDATION_ERR, "data cannnot null");
		}
	}

	//Don't enable this yet since app may be using it
	/*@Override
	public Node appendChild(final Node newChild) throws DOMException {
		throw new DOMException(
			DOMException.VALIDATION_ERR, 
			"Text does not support having children");
	}*/
	...
	@Override
	public DText jif(final String jif) { 
		super.jif(jif) ;
		return this ;
	}
}
