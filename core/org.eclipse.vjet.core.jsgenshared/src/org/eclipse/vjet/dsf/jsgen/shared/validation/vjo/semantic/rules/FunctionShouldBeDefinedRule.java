...
public class FunctionShouldBeDefinedRule extends
		VjoSemanticRule<BaseVjoSemanticRuleCtx> {

	public VjoSemanticProblem doFire(BaseVjoSemanticRuleCtx ctx) {

		final VjoSemanticProblem problem = VjoSemanticProblemFactory
				.getInstance().createProblem(ctx.getArguments(),
						ctx.getGroupId(), getProblemId(), getErrMsg(),
						ctx.getNode(), this);
		return problem;
