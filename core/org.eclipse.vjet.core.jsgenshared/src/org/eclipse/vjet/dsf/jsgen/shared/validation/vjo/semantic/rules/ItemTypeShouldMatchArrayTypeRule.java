...
//
//public class ItemTypeShouldMatchArrayTypeRule extends VjoSemanticRule<BaseVjoSemanticRuleCtx>{
//
//	public VjoSemanticProblem doFire(BaseVjoSemanticRuleCtx ctx) {
////		if (!TypeCheckUtil.isAssignable(ctx.getArrayType(), ctx.getItem().getResultType())){
