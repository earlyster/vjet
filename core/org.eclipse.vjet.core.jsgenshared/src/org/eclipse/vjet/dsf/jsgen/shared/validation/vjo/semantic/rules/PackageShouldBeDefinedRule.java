...
//
//public class PackageShouldBeDefinedRule extends VjoSemanticRule<BaseVjoSemanticRuleCtx>{
//	
//	public VjoSemanticProblem doFire(BaseVjoSemanticRuleCtx ctx) {
////		final IVjoSymbol packageSymbol = ctx.getPackageSymbol();
////		
////		if(packageSymbol == null || packageSymbol.getPackage() == null){
