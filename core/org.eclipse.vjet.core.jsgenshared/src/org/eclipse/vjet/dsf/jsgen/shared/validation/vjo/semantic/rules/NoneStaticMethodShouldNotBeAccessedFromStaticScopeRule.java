...
public class NoneStaticMethodShouldNotBeAccessedFromStaticScopeRule extends VjoSemanticRule<BaseVjoSemanticRuleCtx>{
...
//			if(ctx.getSymbolTable().getSymbolInScope(qualifierValue.getJstType(), ctx.getMethodName(), EVjoSymbolType.STATIC_FUNCTION) == null
//				 && ctx.getSymbolTable().getSymbolInScope(qualifierValue.getJstType(), ctx.getMethodName(), EVjoSymbolType.INSTANCE_FUNCTION) != null){
//				
