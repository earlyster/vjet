...
//
//public class QualifierShouldBeDefinedRule extends VjoSemanticRule<BaseVjoSemanticRuleCtx>{
//
////	private static final Logger s_logger = Logger.getInstance(QualifierShouldBeDefinedRule.class);
//	
