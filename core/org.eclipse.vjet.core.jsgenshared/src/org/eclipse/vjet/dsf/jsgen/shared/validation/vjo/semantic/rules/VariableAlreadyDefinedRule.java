...
public class VariableAlreadyDefinedRule extends VjoSemanticRule<BaseVjoSemanticRuleCtx> {

//	private static final Logger s_logger = Logger.getInstance(VariableAlreadyDefinedRule.class);
