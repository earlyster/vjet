...
//
//public class QualifierShouldNotBeNullRule extends VjoSemanticRule<BaseVjoSemanticRuleCtx>{
//	
////	private static final Logger s_logger = Logger.getInstance(QualifierShouldNotBeNullRule.class);
//	
//	public VjoSemanticProblem doFire(BaseVjoSemanticRuleCtx ctx) {
////		final IExpr qualifier = ctx.getQualifier();
////		
////		if(qualifier == null){
////			s_logger.log(LogLevel.ERROR, "FieldAccessExpr should have a qualifier, otherwise it should be an identifier node");	
//			
