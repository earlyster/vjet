...
public class ETypeShouldNotDefinePublicOrProtectedConstructorRule extends VjoSemanticRule<BaseVjoSemanticRuleCtx> {

//	private static final Logger s_logger = Logger.getInstance(ExprShouldBeBoolRule.class);
