...
public class StagePreExecutionEvent extends BaseStageEvent/*DsfEvent*/<IStage, IStageListener> {
	...
	// Constructor(s)
	//
	public StagePreExecutionEvent(final IStage stage) {
