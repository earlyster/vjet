...
/**
<a href='http://www.w3schools.com/tags/html5_keygen.asp'>W3C schools keygen</a>
 */
@Alias("HTMLKeyGenElement")
@DOMSupport(DomLevel.ONE)
@JsMetatype
public interface HtmlKeyGen extends HtmlElement { ;
	
	@Property boolean getAutoFocus();
	@Property void setAutoFocus(boolean autoFocus);
	
	@Property boolean getChallenge();
	@Property void setChallenge(boolean challenge);
	
	@Property boolean getDisabled();
	@Property void setDisabled(boolean disabled);
	
	@Property String getKeyType();
	@Property void setKeyType(String keyType);
