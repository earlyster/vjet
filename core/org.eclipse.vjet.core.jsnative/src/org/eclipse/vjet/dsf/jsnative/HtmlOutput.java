...
/**
<a href='http://www.w3schools.com/tags/html5_output.asp'>W3C schools output</a>
 */
@Alias("HTMLOutputElement")
@DOMSupport(DomLevel.ONE)
@JsMetatype
public interface HtmlOutput extends HtmlElement {		
	@Property String getFor();
	@Property void setFor(String _for);
	
	@Property String getForm();
	@Property void setForm(String form);
