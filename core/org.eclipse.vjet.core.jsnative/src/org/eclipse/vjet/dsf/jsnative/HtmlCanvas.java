...
/**
<a href='http://www.w3schools.com/tags/html5_canvas.asp'>W3C schools canvas</a>
 */
@Alias("HTMLCanvasElement")
@DOMSupport(DomLevel.ONE)
@JsMetatype
public interface HtmlCanvas extends HtmlElement {
	
	@Property int getHeight();
	@Property void setHeight(int height);
	
	@Property int getWidth();
	@Property void setWidth(int height);
	
	@Function String toDataURL(String type, Object... args);
	
	@FactoryFunc
	@Function Object getContext(String contextId, Object... args);
