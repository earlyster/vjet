...
/**
<a href='http://www.w3schools.com/tags/html5_command.asp'>W3C schools command</a>
 */
@Alias("HTMLCommandElement")
@DOMSupport(DomLevel.ONE)
@JsMetatype
public interface HtmlCommand extends HtmlElement {	
	...
	@Property void setIcon(String icon);
	
	@Property String getLabel();
	@Property void setLabel(String label);
	
	@Property String getRadioGroup();
	@Property void setRadioGroup(String radioGroup);
