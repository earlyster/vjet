 ...
 */
@Alias("HTMLUListElement")
@DOMSupport(DomLevel.ONE)
@JsMetatype
public interface HtmlUl extends HtmlElement {
	
	/** "circle" */
	@AJavaOnly @ARename(name="'cirle'")
	String TYPE_CIRCLE = "circle" ;
	/** "square" */
	@AJavaOnly @ARename(name="'square'")
	String TYPE_SQUARE = "square" ;
	/** "disc" */
	@AJavaOnly @ARename(name="'disc'")
	String TYPE_DISC = "disc" ;
