...
/**
<a href='http://www.w3schools.com/tags/html5_meter.asp'>W3C schools meter</a>
 */
@Alias("HTMLMeterElement")
@DOMSupport(DomLevel.ONE)
@JsMetatype
public interface HtmlMeter extends HtmlElement {
		
	@Property double getHigh();
	@Property void setHigh(double high);
	
	@Property double getLow();
	@Property void setLow(double low);
	
	@Property double getMax();
	@Property void setMax(double max);
	
	@Property double getMin();
	@Property void setMin(double min);
	
	@Property double getOptimum();
	@Property void setOptimum(double optimum);
	
	@Property double getValue();
	@Property void setValue(double value);
