...
/**
<a href='http://www.w3schools.com/tags/html5_article.asp'>W3C schools article</a>
 */
@Alias("HTMLArticleElement")
@DOMSupport(DomLevel.ONE)
@JsMetatype
public interface HtmlArticle extends HtmlElement {
	
	@Property String getCite();
	@Property void setCite(String cite);
	
	@Property String getPubDate();
	@Property void setPubDate(String pubDate);
