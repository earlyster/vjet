       ...
       implements GenericException, CommonException.SuperPrintStackTrace 
{
	...
	public BaseRuntimeException(String stringMessage) {
	 ...
	 * @param messageArgs
	 */
	public BaseRuntimeException(String stringMessage, Object[] messageArgs) {
		this(stringMessage, messageArgs, null) ;	
	}
	
	public BaseRuntimeException(String stringMessage, Throwable cause) {
	 ...
	 * @param cause
	 */	
	public BaseRuntimeException(String stringMessage, Object[] messageArgs, Throwable cause) {
