 ...
 *******************************************************************************/
/* 
 * $Id: EventHandlerEx9.java.java, July 27, 2009, 12:20:41 AM, liama. Exp$:
...
public class EventHandlerEx9 extends VjoValidationBaseTester {
    ...
    @Ignore
    // bug 8522 opened
    public void testEventHandlerEx9() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                VjoValidationBaseTester.VJLIB_FOLDER,
                "vjoPro.samples.basic.eventhandler.", "EventHandlerEx9.js",
                this.getClass());
