...
public class FinalClass1Tester extends VjoValidationBaseTester {

    @Before
    public void setUp() {
        expectProblems.clear();
        expectProblems.add(createNewProblem(TypeProbIds.ClassExtendFinalClass, 1, 0));
    }
    ...
    public void testAccesVisible1() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "access.finalcheck.","FinalClassExample1.js", this
                        .getClass());
