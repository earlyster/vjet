...
public class FatherPackageAccessPrivateTester extends VjoValidationBaseTester {
    ...
    @Test
    //@Category( { P1, FAST, UNIT })
    //@Description("Test access child package type's instance property wihch declared as private")
    public void testAccesVisible1() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "access.scope.",
                "FatherPrivateUser2.js", this.getClass());
