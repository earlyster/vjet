...
public class ChildPackageAccessProtectedTester extends VjoValidationBaseTester {

    @Before
    public void setUp(){
        expectProblems.clear();
        //bugfix by roy, all protected members should be visible
...
//        expectProblems.add(createNewProblem(MethodProbIds.NotVisibleMethod, 9, 0));
    ...
    @Test
    //@Category( { P1, FAST, UNIT })
    //@Description("Test access father package type's instance property wihch declared as default")
    public void testAccesVisible1() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "access.scope.protectedModifier.child.",
                "ChildProtectedUser1.js", this.getClass());
