 ...
 *******************************************************************************/
/* 
 * $Id: EventHandlerEx8.java.java, July 27, 2009, 12:20:41 AM, liama. Exp$:
...
public class EventHandlerEx8 extends VjoValidationBaseTester {
    ...
    @Ignore
    // bug 8522 opened
    public void testEventHandlerEx8() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                VjoValidationBaseTester.VJLIB_FOLDER,
                "vjoPro.samples.basic.eventhandler.", "EventHandlerEx8.js",
                this.getClass());
