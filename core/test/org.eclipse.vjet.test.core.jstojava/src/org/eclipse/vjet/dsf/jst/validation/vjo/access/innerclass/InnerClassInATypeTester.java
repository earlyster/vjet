...
public class InnerClassInATypeTester extends VjoValidationBaseTester {
    @Before
    public void setUp() {
    ...
    @Test
    //@Category( { P1, FAST, UNIT })
    //@Description("Test all Xtype as inner type in AType")
    public void testAccesVisible1() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "access.innerClass.","InnerclassInAType.js", this
                        .getClass());
