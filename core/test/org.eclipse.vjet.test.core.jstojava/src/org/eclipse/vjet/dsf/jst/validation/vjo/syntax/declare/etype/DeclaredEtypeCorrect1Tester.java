...
public class DeclaredEtypeCorrect1Tester extends VjoValidationBaseTester {
    ...
    @Test
    //@Category( { P3, FAST, UNIT })
    //@Description("Test declared etype ")
    public void testCTypes() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "syntax.declare.etype.","ETypeExample.js", this.getClass());
