...
public class SyntaxOverrideCorrectTester extends VjoValidationBaseTester {
    ...
    @Test
    //@Category( { P1, FAST, UNIT })
    //@Description("Test overriden with same visbility method")
    public void testOverrideType1() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "syntax.methodOverride/", "Employee.js", this.getClass());
