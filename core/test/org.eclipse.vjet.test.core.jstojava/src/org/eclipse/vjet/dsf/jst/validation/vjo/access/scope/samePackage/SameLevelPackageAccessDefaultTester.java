...
public class SameLevelPackageAccessDefaultTester extends VjoValidationBaseTester {
    ...
    @Test
    //@Category( { P1, FAST, UNIT })
    //@Description("Test access same level type's instance property wihch declared as default")
    public void testAccesVisible1() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "access.scope.privateModifier.",
                "PrivateUser2.js",  this.getClass());
