...
public class DeclaredItype3Tester extends VjoValidationBaseTester {
    ...
    @Test
    //@Category( { P3, FAST, UNIT })
    //@Description("Test declared itype with unexpect block")
    public void testCTypes() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "syntax.declare.itype.","ITypeExample3.js", this.getClass());
