...
import org.eclipse.vjet.dsf.vjolang.feature.tests.ParseUtils;
...
public class VjoValidationTesterHelper {
    ...
    public List<VjoSemanticProblem> getVjoProblemSequentialLoad(
        ...
        CodeCompletionUtil.loadSingleJsToTypeSpace(
                getTypespaceMgr(VjoValidationBaseTester.SINGLE_FOLDER),
                testFolderName, pacakgeName, checkedFileName);
        testFolderName = VjoValidationBaseTester.SINGLE_FOLDER;
        // }
    ...
    private static JstTypeSpaceMgr getTypespaceMgr(String testFolderName) {
        ...
        } else if (testFolderName
                .equalsIgnoreCase(VjoValidationBaseTester.VJLIB_FOLDER)) {
            return VjLibTypeSpaceLoader.getTestFileSpaceLoader();
        } else if (testFolderName
                .equalsIgnoreCase(VjoValidationBaseTester.SINGLE_FOLDER)) {
            return SingleTypeSpaceLoader.getInstance().getSingleTypeSpace();
        }
        return null;
    }
