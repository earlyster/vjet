...
public class CorrectThisWord10Tester extends VjoValidationBaseTester {
    ...
    @Test
    //@Category( { P1, FAST, UNIT })
    //@Description("Test use this. to invoking instance property")
    public void testAccesVisible1() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "access.scope.thiskeyword.",
                "ThisKeywordSample8.js", this.getClass());
