...
public class ValidationB5351Tester extends VjoValidationBaseTester {
    @Before
    public void setUp() {
    ...
    public void testBugfix1() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem("bugs.b5351/",
                "b5351.js", this.getClass());
