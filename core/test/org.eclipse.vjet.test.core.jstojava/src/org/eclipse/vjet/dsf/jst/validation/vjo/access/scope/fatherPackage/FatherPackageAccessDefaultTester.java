...
public class FatherPackageAccessDefaultTester extends VjoValidationBaseTester {
    ...
    @Test
    //@Category( { P1, FAST, UNIT })
    //@Description("Test access child package type's instance property wihch declared as default")
    public void testAccesVisible1() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "access.scope.",
                "FatherDefaultUser1.js",  this.getClass());
