...
public class StaticFatherAccessDefaultTester extends VjoValidationBaseTester {
    ...
    @Test
    //@Category( { P1, FAST, UNIT })
    //@Description("Test access child package type's static property which delcared as default")
    public void testAccesVisible1() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "access.scope.","FatherStaticDefaultUser5.js", this
                        .getClass());
