...
public class SyntaxInterface3Tester extends VjoValidationBaseTester {
    ...
    @Test
    //@Category( { P3, FAST, UNIT })
    //@Description("Test ctype can't assign final field")
    public void testInterfaceType1() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "syntax.interfaces/", "SatisfiesExample3.js", this.getClass());
