...
public class InnerClassInOTypeTester extends VjoValidationBaseTester {
    @Before
    public void setUp() {
...
//        expectProblems.add(createNewProblem(VjoSyntaxProbIds.OTypeAsInnerType, 26, 0));
    ...
    @Test
    //@Category( { P1, FAST, UNIT })
    //@Description("Test all Xtype as inner type in OType")
    public void testAccesVisible1() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "access.innerClass.","InnerclassInOType.js", this
                        .getClass());
