...
public class InnerClassInCTypeTester extends VjoValidationBaseTester {
    @Before
    public void setUp() {
    ...
    @Test
    //@Category( { P1, FAST, UNIT })
    //@Description("Test all Xtype as inner type in CType")
    public void testAccesVisible1() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "access.innerClass.","InnerclassInCType.js", this
                        .getClass());
