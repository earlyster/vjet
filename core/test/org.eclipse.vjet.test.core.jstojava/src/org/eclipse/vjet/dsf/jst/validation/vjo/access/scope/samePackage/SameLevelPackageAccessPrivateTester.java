...
public class SameLevelPackageAccessPrivateTester extends VjoValidationBaseTester {
    ...
    @Test
    //@Category( { P1, FAST, UNIT })
    //@Description("Test access same level type's instance property wihch declared as private")
    public void testAccesVisible1() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "access.scope.defaultModifier.",
                "DefaultUser2.js", this.getClass());
