...
public class SamePackageAccessProtectedTester extends VjoValidationBaseTester {
    ...
    @Test
    //@Category( { P1, FAST, UNIT })
    //@Description("Test access same package type's instance property wihch declared as protected")
    public void testAccesVisible1() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "access.scope.protectedModifier.",
                "ProtectedUser1.js", this.getClass());
