...
public class CorrectThisWord5Tester extends VjoValidationBaseTester {
    ...
    @Test
    //@Category( { P1, FAST, UNIT })
    //@Description("Test use this.vj$. to invoking current scope's type")
    public void testAccesVisible1() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "access.scope.thiskeyword.",
                "ThisKeywordSample3.js", this.getClass());
