 ...
 *******************************************************************************/
/* 
 * $Id: RemoteHandler.java.java, Jun 21, 2009, 12:20:41 AM, liama. Exp$:
...
public class RemoteHandler extends VjoValidationBaseTester {
    ...
    public void testRemoteHandler() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                VjoValidationBaseTester.VJLIB_FOLDER,
                "vjoPro.dsf.utils.logging.", "RemoteHandler.js", this
                        .getClass());
