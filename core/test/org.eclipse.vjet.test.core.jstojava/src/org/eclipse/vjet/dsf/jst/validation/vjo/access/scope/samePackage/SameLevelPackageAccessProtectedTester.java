 ...
 * Technologies.
 */
package org.eclipse.vjet.dsf.jst.validation.vjo.access.scope.samePackage;
...
public class SameLevelPackageAccessProtectedTester extends VjoValidationBaseTester {
    ...
    @Test
    //@Category( { P1, FAST, UNIT })
    //@Description("Test access same level type's instance property wihch declared as protected")
    public void testAccesVisible1() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "access.scope.defaultModifier.",
                "DefaultUser3.js", this.getClass());
