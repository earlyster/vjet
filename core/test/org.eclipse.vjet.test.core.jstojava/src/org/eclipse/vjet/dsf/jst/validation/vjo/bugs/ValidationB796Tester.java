...
public class ValidationB796Tester extends VjoValidationBaseTester {
    ...
    @Test
    //@Category( { P3, FAST, UNIT })
    //@Description("Test undefiend inherits")
    public void testBugfix() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem("bugs.b796/",
                "A.js", this.getClass());
