...
public class ProtosWithPropsInheritsTest {
	public static DNode test(){
		DDiv container = new DDiv();
		String text = "You should see alert(\"true\")";
		container.add(text);
		String js = FileUtils.getResourceString(VjBootstrapJsr.class, "VjBootstrap_3.js");
		js += FileUtils.getResourceString(ProtosWithPropsInheritsTest.class, "ProtosWithPropsInheritsTest.txt");
