...
public class VjoCcVjoCTypeOverrideTests extends VjoCcBaseTest{
	...
	@Test 
	public void testInheritsCtypeProtosProposals() {
		String js = "engine.override.CChild";
		String[] namesIncl = new String[] {"pubFunc","proFunc"};
		String[] namesExcl = new String[] {"pvtFunc","pubFinalFunc","pubStatFunc"};
		...
		excludeProposals(jstType, position, namesExcl);
	}
	
	@Test 
	public void testInheritsCtypePropsProposals() {
		String js = "engine.override.CChild";
		String[] namesExcl = new String[] {"pubFunc","proFunc","pvtFunc","pubFinalFunc","pubStatFunc"};
		IJstType jstType = getJstType(CodeCompletionUtil.GROUP_NAME, js);
		int position = lastPositionInFile(".props({", jstType);
	...
	public void testInheritsAtypeProposals() {
		String js = "engine.override.CChildInheritsAtype";
	...
	public void testSatisfyItypeProposals() {
		String js = "engine.override.CChild";
		String[] namesIncl = new String[] {"pubIFunc","iFunc1"};
		IJstType jstType = getJstType(CodeCompletionUtil.GROUP_NAME, js);
		int position = lastPositionInFile(".protos({", jstType);
	...
	@Test 
	public void testMixinMtypeProposals() {
		String js = "engine.override.CChild";
		String[] namesIncl = new String[] {"iFunc2"};
		String[] namesExcl = new String[] {"iFunc3"};
		IJstType jstType = getJstType(CodeCompletionUtil.GROUP_NAME, js);
		int position = lastPositionInFile(".protos({", jstType);
