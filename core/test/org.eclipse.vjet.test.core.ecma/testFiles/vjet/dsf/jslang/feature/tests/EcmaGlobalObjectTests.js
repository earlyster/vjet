vjo.ctype("vjet.dsf.jslang.feature.tests.EcmaGlobalObjectTests")
...
var DESCRIPTION = "var MY_GLOBAL = new this()";
var EXPECTED = "error";
...
var DESCRIPTION = "var MY_GLOBAL = this()";
var EXPECTED = "error";
...
this.TestCase( SECTION, "this.NaN",          Number.NaN,     Number.NaN );
...
this.TestCase( SECTION, "this.Infinity",          Number.POSITIVE_INFINITY,      Infinity );
...
this.TestCase( SECTION, "parseFloat.length",     1,              parseFloat('') );

this.TestCase( SECTION, "parseFloat.length = null; parseFloat.length",   1,      eval("parseFloat.length = null; parseFloat.length") );
this.TestCase( SECTION, "delete parseFloat.length",                      false,  delete parseFloat(''));
...
this.TestCase( SECTION, "parseFloat(' ')",       Number.NaN,     parseFloat(' ') );
this.TestCase( SECTION, "parseFloat(true)",      Number.NaN,     parseFloat('') );
this.TestCase( SECTION, "parseFloat(false)",     Number.NaN,     parseFloat('') );
