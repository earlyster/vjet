vjo.ctype("vjet.dsf.jslang.feature.tests.Js15LexicalConventionsTests")
...
{
this.reportCompare (expect[i], actual[i], status[i]);
}
...
this.reportCompare(expect, actual, summary + ': ' + words[i]);
}
