...
public class Js15StringTests extends VjoValidationBaseTester {
    ...
    public void setUp() {
        ...
        expectProblems.add(createNewProblem(MethodProbIds.UnreachableStmt, 155,
                0));
        expectProblems.add(createNewProblem(MethodProbIds.UnreachableStmt, 61,
                0));
        expectProblems.add(createNewProblem(MethodProbIds.UnreachableStmt, 131,
                0));
    }
