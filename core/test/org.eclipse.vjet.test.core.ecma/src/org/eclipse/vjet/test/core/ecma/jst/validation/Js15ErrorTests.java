...
public class Js15ErrorTests extends VjoValidationBaseTester {
    ...
    public void testJs15ErrorTests() {
    	expectProblems.add(createNewProblem(MethodProbIds.ParameterMismatch, 46, 0));
