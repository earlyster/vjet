 ...
 *******************************************************************************/
/* 
 * $Id: Ecma2StatementsTests.java.java, Jun 21, 2009, 12:20:41 AM, liama. Exp$:
...
public class Ecma2StatementsTests extends VjoValidationBaseTester {
    ...
    public void setUp() {
        ...
        expectProblems.add(createNewProblem(VarProbIds.LooseVarDecl, 541, 0));
        expectProblems.add(createNewProblem(VarProbIds.LooseVarDecl, 542, 0));
        ...
        expectProblems.add(createNewProblem(VarProbIds.LooseVarDecl, 547, 0));
        expectProblems.add(createNewProblem(VarProbIds.LooseVarDecl, 548, 0));
    }
    ...
    public void testEcma2StatementsTests() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "dsf.jslang.feature.tests.", "Ecma2StatementsTests.js", this
                        .getClass());
