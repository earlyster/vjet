 ...
 *******************************************************************************/
/* 
 * $Id: Ecma3ArrayTests.java.java, Jun 21, 2009, 12:20:41 AM, liama. Exp$:
...
public class Ecma3ArrayTests extends VjoValidationBaseTester {
    ...
    public void setUp() {
        ...
        expectProblems.add(createNewProblem(
        		TypeProbIds.IncompatibleTypesInEqualityOperator, 199, 0));
    }
    ...
    public void testEcma3ArrayTests() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "dsf.jslang.feature.tests.", "Ecma3ArrayTests.js", this
                        .getClass());
