 ...
 *******************************************************************************/
/* 
 * $Id: Ecma3ExpressionsTests.java.java, Jun 21, 2009, 12:20:41 AM, liama. Exp$:
...
public class Ecma3ExpressionsTests extends VjoValidationBaseTester {
    ...
    public void setUp() {
        ...
        expectProblems
                .add(createNewProblem(FieldProbIds.UndefinedField, 525, 0));
    }
    ...
    public void testEcma3ExpressionsTests() {
        List<VjoSemanticProblem> problems = getVjoSemanticProblem(
                "dsf.jslang.feature.tests.", "Ecma3ExpressionsTests.js", this
                        .getClass());
