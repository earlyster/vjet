...
public class ArrayListUtilJsr extends JsObj {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("vjo.java.util.ArrayListUtil", ArrayListUtilJsr.class, "ArrayListUtil");
    ...
    protected ArrayListUtilJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
