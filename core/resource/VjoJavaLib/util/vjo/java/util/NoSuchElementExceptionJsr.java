...
public class NoSuchElementExceptionJsr extends RuntimeExceptionJsr {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("vjo.java.util.NoSuchElementException", NoSuchElementExceptionJsr.class, "NoSuchElementException");
    ...
    protected NoSuchElementExceptionJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
