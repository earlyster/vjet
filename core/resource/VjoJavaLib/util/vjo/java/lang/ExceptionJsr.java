...
public class ExceptionJsr extends JsObj {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("vjo.java.lang.Exception", ExceptionJsr.class, "Exception");
    ...
    protected ExceptionJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
