 ...
 * </p>
 */
public class ChangeJsVariableValueInputDialog extends TrayDialog {
	 ...
	 */
	public ChangeJsVariableValueInputDialog(Shell parentShell,
	...
	protected void validateInput() {
		...
		// Bug 16256: important not to treat empty string (blank error) the same
		// as null (no error)
	...
	protected String getDialogSettingsSectionName() {
		return VjetDebugUIPlugin.PLUGIN_ID
				+ ".CHANGE_VARIABLE_VALUE_DIALOG_SECTION"; //$NON-NLS-1$
	}
	...
	protected IDialogSettings getDialogBoundsSettings() {
		IDialogSettings settings = VjetDebugUIPlugin.getDefault()
				.getDialogSettings();
