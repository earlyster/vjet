...
public class TypespaceView extends ViewPart {
	...
	private TypeSpaceListener m_typeSpaceListener = new TypeSpaceListener() {
		/* (non-Javadoc)
		 * @see org.eclipse.vjet.vjo.tool.typespace.TypeSpaceListener#loadTypesFinished()
		 */
		...
		/* (non-Javadoc)
		 * @see org.eclipse.vjet.vjo.tool.typespace.TypeSpaceListener#refreshFinished(java.util.List)
		 */
