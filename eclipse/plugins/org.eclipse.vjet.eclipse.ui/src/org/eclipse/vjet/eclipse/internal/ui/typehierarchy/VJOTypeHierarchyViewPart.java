...
import org.eclipse.dltk.mod.internal.ui.actions.NewWizardsActionGroup;
...
import org.eclipse.dltk.mod.internal.ui.typehierarchy.MethodsViewer;
import org.eclipse.dltk.mod.internal.ui.typehierarchy.SubTypeHierarchyViewer;
import org.eclipse.dltk.mod.internal.ui.typehierarchy.SuperTypeHierarchyViewer;
import org.eclipse.dltk.mod.internal.ui.typehierarchy.TraditionalHierarchyViewer;
...
import org.eclipse.dltk.mod.ui.ITypeHierarchyViewPart;
...
import org.eclipse.dltk.mod.ui.viewsupport.SelectionProviderMediator;
 ...
 */
public class VJOTypeHierarchyViewPart extends
		org.eclipse.dltk.mod.internal.ui.typehierarchy.TypeHierarchyViewPart
	...
	public VJOTypeHierarchyViewPart() {
		fSelectedType = null;
		fInputElement = null;
		fIsVisible = false;
		...
		fPartListener = new IPartListener2() {
			public void partVisible(IWorkbenchPartReference ref) {
				...
				if (part == VJOTypeHierarchyViewPart.this) {
	...
	public void createPartControl(Composite container) {
		...
		lowertbmanager = new ToolBarManager(methodViewerToolBar);
		...
		// Add by Oliver. 2009-11-02. add the F1 help for vjet type hirarchy
		// view.
		PlatformUI.getWorkbench().getHelpSystem().setHelp(container,
				IHelpContextIds.Hierarchy_VIEW);
	}
