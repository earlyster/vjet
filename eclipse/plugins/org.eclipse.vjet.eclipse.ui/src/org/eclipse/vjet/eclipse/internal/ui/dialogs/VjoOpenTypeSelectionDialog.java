...
/**
 * The main class for creating vjo open type dialog. Copy more part of
 * functionality from {@link OpenTypeSelectionDialog}.
 * 
 * 
 * 
 */
public class VjoOpenTypeSelectionDialog extends VjoTypeSelectionDialog {

	private IDialogSettings fSettings;
	private Point fLocation;
	private Point fSize;
	
	public static final int SHOWALLTYPE=0;
	public static final int SHOWCTYPEONLY=1;
	public static final int SHOWINTERFACEONLY=2;
	...
	public VjoOpenTypeSelectionDialog(Shell parent, boolean multi,
