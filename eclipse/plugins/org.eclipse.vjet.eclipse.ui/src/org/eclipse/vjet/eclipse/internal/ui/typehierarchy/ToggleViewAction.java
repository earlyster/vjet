...
public class ToggleViewAction extends Action {
	...
	public ToggleViewAction(VJOTypeHierarchyViewPart v, int viewerIndex) {
		super("", AS_RADIO_BUTTON); //$NON-NLS-1$
		String contextHelpId= null;
		if (viewerIndex == VJOTypeHierarchyViewPart.VIEW_ID_SUPER) {
		...
		} else if (viewerIndex == VJOTypeHierarchyViewPart.VIEW_ID_SUB) {
		...
		} else if (viewerIndex == VJOTypeHierarchyViewPart.VIEW_ID_TYPE) {
