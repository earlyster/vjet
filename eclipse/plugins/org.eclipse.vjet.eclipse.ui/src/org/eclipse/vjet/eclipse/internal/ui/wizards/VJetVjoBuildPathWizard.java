...
/**
  */
public class VJetVjoBuildPathWizard extends NewElementWizardPage implements IBuildpathContainerPage, IBuildpathContainerPageExtension {
	...
	public void setSelection(IBuildpathEntry containerEntry) {
		if (containerEntry != null) {
			...
			fEntryField.setText(VjetPlugin.VJOLIB_ID + "/" + VjetPlugin.VJOLIB_LABEL); //$NON-NLS-1$
		}
	}
