...
import org.eclipse.vjet.eclipse.internal.ui.refactoring.rename.RenameScriptFolderWizard;
import org.eclipse.vjet.eclipse.internal.ui.refactoring.rename.RenameVjoScriptFolderProcessor;
 ...
 * 
	 *
 */
public final class RenameVjoScriptFolderRefactoringContribution extends AbstractVjoRenameRefactoringContribution {
	


	@Override
	public RefactoringWizard getRenameWizard() throws CoreException{
		return new RenameScriptFolderWizard(createRefactoring(null));
	}

	@Override
	public Refactoring createNewRefactoring(RefactoringDescriptor descriptor) throws CoreException {
		return new ScriptRenameRefactoring(new RenameVjoScriptFolderProcessor(null));
	}
