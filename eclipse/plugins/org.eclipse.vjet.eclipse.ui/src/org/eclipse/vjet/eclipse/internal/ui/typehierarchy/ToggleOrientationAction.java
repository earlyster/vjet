...
public class ToggleOrientationAction extends Action {
	...
	public ToggleOrientationAction(VJOTypeHierarchyViewPart v, int orientation) {
		super("", AS_RADIO_BUTTON); //$NON-NLS-1$
		if (orientation == VJOTypeHierarchyViewPart.VIEW_ORIENTATION_HORIZONTAL) {
		...
		} else if (orientation == VJOTypeHierarchyViewPart.VIEW_ORIENTATION_VERTICAL) {
		...
		} else if (orientation == VJOTypeHierarchyViewPart.VIEW_ORIENTATION_AUTOMATIC) {
		...
		} else if (orientation == VJOTypeHierarchyViewPart.VIEW_ORIENTATION_SINGLE) {
