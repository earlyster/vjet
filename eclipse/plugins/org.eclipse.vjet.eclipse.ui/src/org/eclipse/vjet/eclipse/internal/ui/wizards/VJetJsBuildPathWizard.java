...
/**
  */
public class VJetJsBuildPathWizard extends NewElementWizardPage implements IBuildpathContainerPage, IBuildpathContainerPageExtension {
	...
	public void setSelection(IBuildpathEntry containerEntry) {
		if (containerEntry != null) {
			...
			fEntryField.setText(VjetPlugin.JS_DEFAULT_SDK + "/" + VjetPlugin.JS_DEFAULT_SDK_LABEL); //$NON-NLS-1$
		}
	}
