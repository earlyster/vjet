...
/**
 * A simple
 * {@linkplain org.eclipse.dltk.mod.ui.text.JavascriptSourceViewerConfiguration Javascript source viewer configuration}.
 * <p>
 ...
 * 
 */
public class SimpleVjoSourceViewerConfiguration extends
		VjoSourceViewerConfiguration {

	private boolean fConfigureFormatter;

	/**
	 * Creates a new Javascript source viewer configuration for viewers in the
	 * given editor using the given preference store, the color manager and the
	 ...
	 *            configured
	 */
	public SimpleVjoSourceViewerConfiguration(IColorManager colorManager,
	...
	/*
	 * @see org.eclipse.dltk.mod.ui.text.JavascriptSourceViewerConfiguration#getOutlinePresenter(org.eclipse.jface.text.source.ISourceViewer,
	 *      boolean)
	 */
	...
	/*
	 * @see org.eclipse.dltk.mod.ui.text.JavascriptSourceViewerConfiguration#getHierarchyPresenter(org.eclipse.jface.text.source.ISourceViewer,
	 *      boolean)
	 */
