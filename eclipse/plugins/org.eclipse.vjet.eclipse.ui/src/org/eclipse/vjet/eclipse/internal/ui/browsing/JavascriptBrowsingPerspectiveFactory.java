...
public class JavascriptBrowsingPerspectiveFactory implements
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		layout
				.addNewWizardShortcut("org.eclipse.vjet.eclipse.ui.VJETProjectWizard"); //$NON-NLS-1$
		layout
				.addNewWizardShortcut("org.eclipse.vjet.eclipse.ui.JsFileCreation"); //$NON-NLS-1$
		layout
				.addNewWizardShortcut("org.eclipse.vjet.eclipse.ui.VjoPackageCreationWizard"); //$NON-NLS-1$
		layout
				.addNewWizardShortcut("org.eclipse.vjet.eclipse.ui.VjoClassCreationWizard"); //$NON-NLS-1$
		layout
				.addNewWizardShortcut("org.eclipse.vjet.eclipse.ui.VjoInterfaceCreationWizard"); //$NON-NLS-1$
		layout
				.addNewWizardShortcut("org.eclipse.vjet.eclipse.ui.VjoEnumCreationWizard");
		layout
				.addNewWizardShortcut("org.eclipse.vjet.eclipse.ui.VjoMixinCreationWizard");
		layout
				.addNewWizardShortcut("org.eclipse.vjet.eclipse.ui.VjoOTypeCreationWizard");
		layout
				.addNewWizardShortcut("org.eclipse.vjet.eclipse.ui.NewSourceFolderCreationWizard");
